...
public class TS3BucketExistMainJava
{
  ...
  protected final String TEXT_182 = NL + "\tboolean bucketExist_";
  protected final String TEXT_183 = "=false;" + NL + "\ttry{" + NL + "\t\tbucketExist_";
  protected final String TEXT_184 = " = conn_";
  protected final String TEXT_185 = ".doesBucketExist(";
  protected final String TEXT_186 = ");" + NL + "\t\t";
  protected final String TEXT_187 = "\t" + NL + "\t\t\tif(bucketExist_";
  protected final String TEXT_188 = "){" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_189 = " - Bucket \"+";
  protected final String TEXT_190 = "+\" exists.\");" + NL + "\t\t\t}else{" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_191 = " - Bucket \"+";
  protected final String TEXT_192 = "+\" does not exist.\");" + NL + "\t\t\t}" + NL + "\t\t";
  ...
  protected final String TEXT_206 = "_BUCKET_NAME\", ";
  protected final String TEXT_207 = ");" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_208 = "_BUCKET_EXIST\", bucketExist_";
