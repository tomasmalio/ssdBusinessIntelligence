...
public class TMSSqlBulkExecBeginJava {
  ...
  protected final String TEXT_565 = "\",FIRE_TRIGGERS\" + ";
  protected final String TEXT_566 = " \",ROWTERMINATOR='\" + ";
  protected final String TEXT_567 = "+\"')\";" + NL + "    \t\t";
  protected final String TEXT_568 = NL + "    \t\t\tlog.debug(\"";
  protected final String TEXT_569 = " - Bulk SQL:\"+bulkSQL_";
  protected final String TEXT_570 = "+\".\");" + NL + "    \t\t\tlog.info(\"";
  protected final String TEXT_571 = " - Bulk inserting data into ";
  protected final String TEXT_572 = "\" + tableName_";
  protected final String TEXT_573 = " + \"";
  protected final String TEXT_574 = ".\" );" + NL + "    \t\t";
  protected final String TEXT_575 = NL + "    \t\tstmtBulkInsert_";
  protected final String TEXT_576 = ".execute(bulkSQL_";
  protected final String TEXT_577 = ");" + NL + "    \t\tstmtBulkInsert_";
  protected final String TEXT_578 = ".close();" + NL + "    \t\t";
  protected final String TEXT_579 = NL + "    \t\t\tlog.info(\"";
  protected final String TEXT_580 = " - Bulk insert data into ";
  protected final String TEXT_581 = "\" + tableName_";
  protected final String TEXT_582 = " + \"";
  protected final String TEXT_583 = " has finished.\");" + NL + "    \t\t";
  protected final String TEXT_584 = NL + "    \t\t\tint keyCount_";
  protected final String TEXT_585 = " = ";
  protected final String TEXT_586 = ";" + NL + "    \t\t\tif(keyCount_";
  protected final String TEXT_587 = " == 0) {" + NL + "    \t\t\t\tthrow new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "    \t\t\t}" + NL + "    \t\t\tString tmpTableName_";
  protected final String TEXT_588 = " = tableName_";
  protected final String TEXT_589 = ";" + NL + "    \t\t\ttableName_";
  protected final String TEXT_590 = " = \"tmp_";
  protected final String TEXT_591 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "    \t\t\tjava.sql.Statement stmtCreateTmp_";
  protected final String TEXT_592 = " = conn_";
  protected final String TEXT_593 = ".createStatement();" + NL + "    \t\t\t";
  protected final String TEXT_594 = NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_595 = " - Creating temp table ";
  protected final String TEXT_596 = "\" + tableName_";
  protected final String TEXT_597 = " + \"";
  protected final String TEXT_598 = ".\" );" + NL + "    \t\t\t";
  protected final String TEXT_599 = NL + "    \t\t\tstmtCreateTmp_";
  protected final String TEXT_600 = ".execute(\"";
  protected final String TEXT_601 = ")\");" + NL + "    \t\t\t";
  protected final String TEXT_602 = NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_603 = " - Create temp table ";
  protected final String TEXT_604 = "\" + tableName_";
  protected final String TEXT_605 = " + \"";
  protected final String TEXT_606 = " has succeeded.\");" + NL + "    \t\t\t";
  protected final String TEXT_607 = NL + "    \t\t\tstmtCreateTmp_";
  protected final String TEXT_608 = ".close();" + NL + "    \t\t\tjava.sql.Statement stmtTmpBulk_";
  protected final String TEXT_609 = " = conn_";
  protected final String TEXT_610 = ".createStatement();" + NL + "    \t\t\tString bulkSQL_";
  protected final String TEXT_611 = " = \"BULK INSERT ";
  protected final String TEXT_612 = "\" + tableName_";
  protected final String TEXT_613 = " + \"";
  protected final String TEXT_614 = " FROM '\" + ";
  protected final String TEXT_615 = " + \"' WITH ( CODEPAGE='\" + ";
  protected final String TEXT_616 = " + \"',DATAFILETYPE='";
  protected final String TEXT_617 = "',FIELDTERMINATOR='\" + ";
  protected final String TEXT_618 = " + \"',FIRSTROW =\" + ";
  protected final String TEXT_619 = " + \",ROWTERMINATOR='\" + ";
  protected final String TEXT_620 = "+\"')\";" + NL + "    \t\t\t";
  protected final String TEXT_621 = NL + "    \t\t\t\tlog.debug(\"";
  protected final String TEXT_622 = " - Bulk SQL:\"+bulkSQL_";
  protected final String TEXT_623 = "+\".\");" + NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_624 = " - Bulk inserting data into ";
  ...
  protected final String TEXT_629 = ".execute(bulkSQL_";
  protected final String TEXT_630 = ");" + NL + "    \t\t\tstmtTmpBulk_";
  protected final String TEXT_631 = ".close();" + NL + "    \t\t\t";
  protected final String TEXT_632 = NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_633 = " - Bulk insert data into ";
  protected final String TEXT_634 = "\" + tableName_";
  protected final String TEXT_635 = " + \"";
  protected final String TEXT_636 = " has finished.\");" + NL + "    \t\t\t";
  protected final String TEXT_637 = NL + "    \t\t\ttableName_";
  protected final String TEXT_638 = " = tmpTableName_";
  protected final String TEXT_639 = ";" + NL + "    \t\t\ttmpTableName_";
  protected final String TEXT_640 = " = \"tmp_";
  protected final String TEXT_641 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "    \t\t\tjava.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_642 = " = conn_";
  protected final String TEXT_643 = ".createStatement();" + NL + "    \t\t\t";
  protected final String TEXT_644 = NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_645 = " - Updating ";
  protected final String TEXT_646 = "\" + tableName_";
  protected final String TEXT_647 = " + \"";
  protected final String TEXT_648 = " from ";
  protected final String TEXT_649 = "\"+tmpTableName_";
  protected final String TEXT_650 = "+\"";
  protected final String TEXT_651 = ".\");" + NL + "    \t\t\t";
  protected final String TEXT_652 = NL + "    \t\t\tstmtUpdateBulk_";
  protected final String TEXT_653 = ".executeUpdate(\"";
  protected final String TEXT_654 = "\");" + NL + "    \t\t\t";
  protected final String TEXT_655 = NL + "    \t\t\tstmtUpdateBulk_";
  protected final String TEXT_656 = ".close();" + NL + "    \t\t\ttableName_";
  protected final String TEXT_657 = " = \"tmp_";
  protected final String TEXT_658 = "\" + \"_\" +pid + Thread.currentThread().getId();" + NL + "    \t\t\tjava.sql.Statement stmtTmpDrop_";
  protected final String TEXT_659 = " = conn_";
  protected final String TEXT_660 = ".createStatement();" + NL + "    \t\t\t";
  protected final String TEXT_661 = NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_662 = " - Droping temp table ";
  protected final String TEXT_663 = "\" + tableName_";
  protected final String TEXT_664 = " + \"";
  protected final String TEXT_665 = ".\");" + NL + "    \t\t\t";
  protected final String TEXT_666 = NL + "    \t\t\tstmtTmpDrop_";
  protected final String TEXT_667 = ".execute(\"";
  protected final String TEXT_668 = "\");" + NL + "    \t\t\t";
  protected final String TEXT_669 = NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_670 = " - Drop temp table ";
  protected final String TEXT_671 = "\" + tableName_";
  protected final String TEXT_672 = "+ \"";
  protected final String TEXT_673 = " has succeeded.\");" + NL + "    \t\t\t";
  protected final String TEXT_674 = NL + "    \t\t\tstmtTmpDrop_";
  protected final String TEXT_675 = ".close();" + NL + "    \t\t\t";
  protected final String TEXT_676 = NL + "\t\tif(conn_";
  protected final String TEXT_677 = " != null && !conn_";
  protected final String TEXT_678 = ".isClosed()) {" + NL + "\t\t   ";
