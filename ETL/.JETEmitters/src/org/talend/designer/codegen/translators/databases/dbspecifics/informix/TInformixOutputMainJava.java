...
public class TInformixOutputMainJava {
  ...
  protected final String TEXT_481 = ".prepareStatement(\"SELECT COUNT(*) FROM \" + tableName_";
  ...
  protected final String TEXT_610 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_629 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_678 = ".executeUpdate();" + NL + "        \t    ";
  ...
  protected final String TEXT_703 = NL + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_704 = " = pstmt_";
  protected final String TEXT_705 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_706 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_707 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_708 = " = rs_";
  protected final String TEXT_709 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  ...
  protected final String TEXT_753 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_800 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_801 = " = true;";
  protected final String TEXT_802 = NL + "                        throw(e);";
  ...
  protected final String TEXT_823 = NL + "            int updateFlag_";
  protected final String TEXT_824 = "=0;";
  ...
  protected final String TEXT_833 = ",updateSQLSplits_";
  protected final String TEXT_834 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_835 = NL + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_836 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_863 = NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_864 = "=pstmtUpdate_";
  protected final String TEXT_865 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_866 = " = updatedCount_";
  protected final String TEXT_867 = " + updateFlag_";
  protected final String TEXT_868 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_869 = " == 0) {" + NL + "            \t";
  protected final String TEXT_870 = NL + "\t\t\t\tquery_";
  protected final String TEXT_871 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_872 = NL + "                        ";
  protected final String TEXT_873 = NL + "                            query_";
  protected final String TEXT_874 = " = ";
  protected final String TEXT_875 = ";";
  protected final String TEXT_876 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_877 = ",";
  protected final String TEXT_878 = ".";
  protected final String TEXT_879 = ", ";
  protected final String TEXT_880 = ",insertSQLSplits_";
  protected final String TEXT_881 = ");" + NL + "\t                \t\t\t";
  protected final String TEXT_882 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_888 = NL + "                    globalMap.put(\"";
  protected final String TEXT_889 = "_QUERY\", query_";
  protected final String TEXT_890 = ".toString().trim());";
  protected final String TEXT_891 = NL + "                    insertedCount_";
  protected final String TEXT_892 = " = insertedCount_";
  protected final String TEXT_893 = " + pstmtInsert_";
  protected final String TEXT_894 = ".executeUpdate();" + NL + "             \t\tnb_line_";
  protected final String TEXT_895 = "++;";
  protected final String TEXT_896 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_897 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_898 = NL + "    \t\t\t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_934 = NL + "\t\t    \t\tpstmt_";
  protected final String TEXT_935 = ".addBatch();" + NL + "\t\t    \t\tbatchSizeCounter_";
  protected final String TEXT_936 = "++;" + NL + "\t\t\t\t\tnb_line_";
  protected final String TEXT_937 = "++;" + NL + "    \t\t\t";
  protected final String TEXT_938 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_939 = " = deletedCount_";
  protected final String TEXT_940 = " + pstmt_";
  protected final String TEXT_941 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_942 = "++;";
  protected final String TEXT_943 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_956 = NL + "                        rejectedCount_";
  protected final String TEXT_957 = " = rejectedCount_";
  protected final String TEXT_958 = " + 1;";
  protected final String TEXT_959 = NL + "                        ";
  protected final String TEXT_960 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_965 = NL + "            }" + NL + "\t\t";
  protected final String TEXT_966 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_977 = NL + "\t\t\t\tif ((batchSize_";
  protected final String TEXT_978 = " > 0) && (batchSize_";
  protected final String TEXT_979 = " <= batchSizeCounter_";
  protected final String TEXT_980 = ")) {" + NL + "                try {" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_981 = " = 0;" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_982 = " = 0;" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_983 = NL + "\t\t\t\t\t\tfor(int countEach_";
  ...
  protected final String TEXT_999 = NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_1000 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_1001 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_1002 = NL + "                \t}" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_1003 = NL + "            commitCounter_";
  protected final String TEXT_1004 = "++;" + NL + "" + NL + "            if(commitEvery_";
  protected final String TEXT_1005 = "<=commitCounter_";
  protected final String TEXT_1006 = ") {" + NL + "            \t";
  protected final String TEXT_1007 = NL + "                conn_";
  protected final String TEXT_1008 = ".commit();";
  protected final String TEXT_1009 = NL + "                commitCounter_";
  protected final String TEXT_1010 = " = 0;" + NL + "" + NL + "            }" + NL;
