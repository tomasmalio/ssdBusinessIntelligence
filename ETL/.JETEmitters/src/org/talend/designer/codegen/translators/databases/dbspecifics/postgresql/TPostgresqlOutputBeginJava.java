...
public class TPostgresqlOutputBeginJava {
  ...
  protected final String TEXT_162 = ".commit();";
  ...
  protected final String TEXT_183 = NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_220 = NL + "                                java.sql.Statement isExistStmt_";
  protected final String TEXT_221 = " = conn_";
  protected final String TEXT_222 = ".createStatement();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_223 = " = false;" + NL + "                                try {" + NL + "                                    isExistStmt_";
  ...
  protected final String TEXT_227 = " = false;" + NL + "                                }" + NL + "                                isExistStmt_";
  ...
  protected final String TEXT_283 = ".toUpperCase()";
  ...
  protected final String TEXT_289 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_290 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_299 = " = false;" + NL + "                                String defaultSchema_";
  protected final String TEXT_300 = " = \"public\";" + NL + "                                if(dbschema_";
  protected final String TEXT_301 = " == null || dbschema_";
  protected final String TEXT_302 = ".trim().length() == 0) {" + NL + "                                    java.sql.Statement stmtSchema_";
  protected final String TEXT_303 = " = conn_";
  protected final String TEXT_304 = ".createStatement();" + NL + "                                    java.sql.ResultSet rsSchema_";
  protected final String TEXT_305 = " = stmtSchema_";
  protected final String TEXT_306 = ".executeQuery(\"select current_schema() \");" + NL + "                                    while(rsSchema_";
  protected final String TEXT_307 = ".next()){" + NL + "                                        defaultSchema_";
  protected final String TEXT_308 = " = rsSchema_";
  protected final String TEXT_309 = ".getString(\"current_schema\");" + NL + "                                    }" + NL + "                                    rsSchema_";
  protected final String TEXT_310 = ".close();" + NL + "                                    stmtSchema_";
  protected final String TEXT_311 = ".close();" + NL + "                                }" + NL + "                                while(rsTable_";
  ...
  protected final String TEXT_326 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_327 = ".equals";
  protected final String TEXT_328 = "IgnoreCase";
  protected final String TEXT_329 = "(schema_";
  ...
  protected final String TEXT_333 = NL + "\t\t\t\t            \tString tableForSearch_";
  protected final String TEXT_334 = " = ";
  protected final String TEXT_335 = ";" + NL + "\t\t\t\t            \tif(tableForSearch_";
  protected final String TEXT_336 = " != null){" + NL + "\t\t\t\t            \t\tif(tableForSearch_";
  protected final String TEXT_337 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_338 = ".endsWith(\"\\\"\")){" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_339 = " =  tableForSearch_";
  protected final String TEXT_340 = ".substring(1,tableForSearch_";
  protected final String TEXT_341 = ".length()-1);" + NL + "\t\t\t\t            \t\t}else{" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_342 = " =  tableForSearch_";
  protected final String TEXT_343 = ".toUpperCase();" + NL + "\t\t\t\t            \t\t}" + NL + "\t\t\t\t            \t}" + NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_347 = ".getTables(null, conn_";
  protected final String TEXT_348 = ".getSchema(), tableForSearch_";
  protected final String TEXT_349 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_350 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_351 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_352 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  ...
  protected final String TEXT_358 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_359 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_360 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_361 = ".next()) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_362 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  ...
  protected final String TEXT_380 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_388 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_400 = NL + "                                if(whetherExist_";
  protected final String TEXT_401 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_415 = NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_437 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_454 = NL + "            java.sql.ResultSet rsTruncCount_";
  ...
  protected final String TEXT_458 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_459 = ".next()) {" + NL + "                rsTruncCountNumber_";
  protected final String TEXT_460 = " = rsTruncCount_";
  protected final String TEXT_461 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_462 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_463 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_474 = NL + "                if(!conn_";
  protected final String TEXT_475 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_476 = ".commit();" + NL + "                }";
  protected final String TEXT_477 = NL + "            deletedCount_";
  protected final String TEXT_478 = " += rsTruncCountNumber_";
  ...
  protected final String TEXT_494 = NL + "            while(rsTruncCount_";
  protected final String TEXT_495 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_496 = " += rsTruncCount_";
  protected final String TEXT_497 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_498 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_499 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_511 = " = null;" + NL + "\t\t\tString keyPsmt_";
  ...
  protected final String TEXT_550 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_557 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_561 = NL + "\t    String delete_";
  protected final String TEXT_562 = " = \"DELETE FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_566 = ".prepareStatement(delete_";
  ...
  protected final String TEXT_598 = NL + "    \tString geometryColumnName_";
  protected final String TEXT_599 = " = null;" + NL + "    \t// Initialize SRID" + NL + "    \tint SRID_";
  protected final String TEXT_600 = " = 0;" + NL + "    \tint dimension_";
  protected final String TEXT_601 = " = 0;" + NL + "    \tboolean firstGeometry_";
  protected final String TEXT_602 = " = true;" + NL + "    \t";
  ...
  protected final String TEXT_611 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_612 = " =  null;";
  protected final String TEXT_613 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_614 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  ...
  protected final String TEXT_620 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
