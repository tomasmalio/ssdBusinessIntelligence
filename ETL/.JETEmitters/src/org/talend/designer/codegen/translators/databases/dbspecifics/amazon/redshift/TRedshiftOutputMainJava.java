...
public class TRedshiftOutputMainJava {
  ...
  protected final String TEXT_427 = NL + "\t\t\t\t\t\tStringBuilder extendInsertValueStmt_";
  protected final String TEXT_428 = " = new StringBuilder();";
  protected final String TEXT_429 = NL + "\t\t\t\t\t\t\tString valueList_";
  protected final String TEXT_430 = " = \"(";
  protected final String TEXT_431 = ",\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_432 = ".";
  protected final String TEXT_433 = ")+\")\";";
  protected final String TEXT_434 = NL + "\t\t\t\t\t\t\tString valueList_";
  protected final String TEXT_435 = " = \"(\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_436 = ".";
  protected final String TEXT_437 = ")+\")\";";
  protected final String TEXT_438 = NL + "\t\t\t\t\t\t\tnumPerInsert_";
  protected final String TEXT_439 = " = util_";
  protected final String TEXT_440 = ".correctNumPerInsert(valueList_";
  protected final String TEXT_441 = ", numPerInsert_";
  protected final String TEXT_442 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t" + NL + "              for(int i_";
  protected final String TEXT_443 = "=0;i_";
  protected final String TEXT_444 = " < numPerInsert_";
  protected final String TEXT_445 = ";i_";
  protected final String TEXT_446 = "++){" + NL + "            \t\textendInsertValueStmt_";
  protected final String TEXT_447 = ".append(valueList_";
  protected final String TEXT_448 = ");" + NL + "            \t\tif (i_";
  protected final String TEXT_449 = "!=numPerInsert_";
  protected final String TEXT_450 = "-1) extendInsertValueStmt_";
  protected final String TEXT_451 = ".append(\",\");" + NL + "            \t}";
  ...
  protected final String TEXT_458 = "\")+\") VALUES \" + extendInsertValueStmt_";
  ...
  protected final String TEXT_465 = "\")+\") VALUES \" + extendInsertValueStmt_";
  ...
  protected final String TEXT_527 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_532 = ");" + NL + "\t\t\t    pstmtUpdate_";
  ...
  protected final String TEXT_554 = NL + "\t\t\t\t\tString update_";
  protected final String TEXT_555 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_556 = " + \"\\\" SET ";
  protected final String TEXT_557 = ", \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_564 = " + \"\\\" SET \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_565 = ".";
  protected final String TEXT_566 = ", \"";
  protected final String TEXT_567 = "\")+\" WHERE ";
  protected final String TEXT_568 = "\";";
  protected final String TEXT_569 = NL + "\t\t\t    pstmtUpdate_";
  ...
  protected final String TEXT_581 = ".prepareStatement(delete_";
  protected final String TEXT_582 = ");";
  protected final String TEXT_583 = NL + "\t\t}" + NL + "\t";
  protected final String TEXT_584 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_585 = " = buffersSize_";
  protected final String TEXT_586 = ";";
  protected final String TEXT_587 = NL + "            batchSize_";
  protected final String TEXT_588 = " = buffersSize_";
  protected final String TEXT_589 = ";";
  protected final String TEXT_590 = NL + "        whetherReject_";
  protected final String TEXT_591 = " = false;";
  protected final String TEXT_592 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_593 = NL + "                        DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_594 = ".";
  protected final String TEXT_595 = ", pstmt_";
  protected final String TEXT_596 = ", ";
  protected final String TEXT_597 = ", \"";
  protected final String TEXT_598 = "\");";
  protected final String TEXT_599 = NL + "                       pstmt_";
  protected final String TEXT_600 = ".addBatch();" + NL + "                       batchSizeCounter_";
  protected final String TEXT_601 = "++;" + NL + "                       nb_line_";
  protected final String TEXT_602 = "++;";
  protected final String TEXT_603 = NL + NL + "                                    try {" + NL + "                                        insertedCount_";
  protected final String TEXT_604 = " = insertedCount_";
  protected final String TEXT_605 = " + pstmt_";
  protected final String TEXT_606 = ".executeUpdate();" + NL + "                                        nb_line_";
  ...
  protected final String TEXT_634 = ",java.sql.Types.CHAR);" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_635 = NL + "\t\t\t\t\t\t\tif(";
  protected final String TEXT_636 = ".";
  protected final String TEXT_637 = "==null){" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_638 = ".setNull(counter";
  protected final String TEXT_639 = ",java.sql.Types.DATE);" + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_644 = ",java.sql.Types.ARRAY);" + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_649 = ",java.sql.Types.INTEGER);" + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_654 = ",java.sql.Types.VARCHAR);" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_655 = NL + "\t\t\t\t\t\t\tif(";
  protected final String TEXT_656 = ".";
  protected final String TEXT_657 = "==null){" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_658 = ".setNull(counter";
  protected final String TEXT_659 = ",java.sql.Types.OTHER);" + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_664 = ",java.sql.Types.BOOLEAN);" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_665 = NL + "\t\t\t\t\t\t\tif(";
  protected final String TEXT_666 = ".";
  protected final String TEXT_667 = "==null){" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_668 = ".setNull(counter";
  protected final String TEXT_669 = ",java.sql.Types.DOUBLE);" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_670 = NL + "\t\t\t\t\t\t\tif(";
  protected final String TEXT_671 = ".";
  protected final String TEXT_672 = "==null){" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_673 = ".setNull(counter";
  protected final String TEXT_674 = ",java.sql.Types.FLOAT);" + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_680 = NL + "\t\t\t\t\t\t\t\tif((\"null\").equals(String.valueOf(";
  protected final String TEXT_681 = ".";
  protected final String TEXT_682 = ").toLowerCase())){" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_683 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_684 = ".setNull(counter";
  protected final String TEXT_685 = ",java.sql.Types.CHAR);" + NL + "" + NL + "\t\t\t\t\t\t\t}else if(";
  protected final String TEXT_686 = ".";
  protected final String TEXT_687 = " == '\\0'){" + NL + "" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_688 = ".setString(counter";
  protected final String TEXT_689 = ",\"\");" + NL + "" + NL + "\t\t\t\t\t\t\t}else{" + NL + "" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_690 = ".setString(counter";
  protected final String TEXT_691 = ",String.valueOf(";
  protected final String TEXT_692 = ".";
  protected final String TEXT_693 = "));" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_694 = NL + "\t\t\t\t\t\t\tif(";
  protected final String TEXT_695 = ".";
  protected final String TEXT_696 = "!=null){" + NL + "\t\t\t\t\t\t\t\t// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL" + NL + "\t\t\t\t\t\t\t\tdate_";
  protected final String TEXT_697 = " = ";
  protected final String TEXT_698 = ".";
  protected final String TEXT_699 = ".getTime();" + NL + "\t\t\t\t\t\t\t\tif (date_";
  protected final String TEXT_700 = " < year1_";
  protected final String TEXT_701 = " || date_";
  protected final String TEXT_702 = " >= year10000_";
  protected final String TEXT_703 = ") {" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_704 = ".setString(counter";
  protected final String TEXT_705 = ", \"0000-00-00 00:00:00\");" + NL + "\t\t\t\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_706 = ".setTimestamp(counter";
  protected final String TEXT_707 = ", new java.sql.Timestamp(date_";
  protected final String TEXT_708 = "));" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t}else{" + NL + "" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_709 = ".setNull(counter";
  protected final String TEXT_710 = ",java.sql.Types.DATE);" + NL + "" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_711 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_712 = ".set";
  protected final String TEXT_713 = "(counter";
  protected final String TEXT_714 = ",";
  protected final String TEXT_715 = ".";
  protected final String TEXT_716 = ");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_717 = NL + NL + "\t\t\t\t\t\t\t}" + NL + "" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_718 = NL + "\t\t\t\tint counter";
  protected final String TEXT_719 = " = rowCount";
  protected final String TEXT_720 = " *" + NL + "\t\t\t\t\t(";
  protected final String TEXT_721 = NL + "\t\t\t\t\t\t+ ";
  protected final String TEXT_722 = ".";
  protected final String TEXT_723 = ".getColumnCount()";
  protected final String TEXT_724 = NL + "\t\t\t\t\t)" + NL + "\t\t\t\t+ 1;";
  protected final String TEXT_725 = NL + "\t\t\t\t\t\tcounter";
  protected final String TEXT_726 = "++;" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_727 = NL + "                    \tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_728 = ".";
  protected final String TEXT_729 = ", pstmt_";
  protected final String TEXT_730 = ", counter";
  protected final String TEXT_731 = "-1, \"";
  protected final String TEXT_732 = "\");";
  protected final String TEXT_733 = NL + "\t\t\t\texInsertColValue";
  protected final String TEXT_734 = " = new BufferLine_";
  ...
  protected final String TEXT_742 = NL + "\t\t\t\t\t\texInsertColValue";
  protected final String TEXT_743 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_744 = NL + "\t\t\t\t\t\t.c";
  protected final String TEXT_745 = "(";
  protected final String TEXT_746 = ".";
  protected final String TEXT_747 = ".clone())";
  protected final String TEXT_748 = NL + "\t\t\t\t;";
  protected final String TEXT_749 = NL + NL + "\t\t\t\texInsertColValueList";
  protected final String TEXT_750 = ".add(exInsertColValue";
  protected final String TEXT_751 = ");" + NL + "\t\t\t\trowCount";
  protected final String TEXT_752 = "++;" + NL + "" + NL + "                nb_line_";
  protected final String TEXT_753 = "++;" + NL + "" + NL + "\t\t\t\tif(rowCount";
  protected final String TEXT_754 = " == numPerInsert_";
  protected final String TEXT_755 = "){" + NL + "\t                insertedCount_";
  protected final String TEXT_756 = " = insertedCount_";
  protected final String TEXT_757 = " + pstmt_";
  protected final String TEXT_758 = ".executeUpdate();" + NL + "\t                exInsertColValueList";
  protected final String TEXT_759 = ".clear();" + NL + "\t                rowCount";
  protected final String TEXT_760 = " = 0;" + NL + "\t\t\t\t\tcounter";
  protected final String TEXT_761 = "=1;" + NL + "\t\t\t\t}";
  protected final String TEXT_762 = NL + "                    ";
  protected final String TEXT_763 = NL + "                    int count_";
  protected final String TEXT_764 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_776 = ".addBatch();" + NL + "                       batchSizeCounter_";
  protected final String TEXT_777 = "++;" + NL + "                       nb_line_";
  protected final String TEXT_778 = "++;";
  protected final String TEXT_779 = NL + "                           try {" + NL + "                               updatedCount_";
  ...
  protected final String TEXT_809 = NL + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_810 = " = pstmt_";
  protected final String TEXT_811 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_812 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_813 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_814 = " = rs_";
  protected final String TEXT_815 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_816 = " > 0) {";
  protected final String TEXT_817 = NL + "                        ";
  protected final String TEXT_818 = NL + "                        int count_";
  ...
  protected final String TEXT_830 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_831 = " = updatedCount_";
  protected final String TEXT_832 = " + pstmtUpdate_";
  protected final String TEXT_833 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_834 = "++;" + NL + "        \t\t\t";
  protected final String TEXT_835 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_852 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_859 = NL + "                        DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_860 = ".";
  protected final String TEXT_861 = ", pstmtInsert_";
  protected final String TEXT_862 = ", ";
  protected final String TEXT_863 = ", \"";
  protected final String TEXT_864 = "\");";
  protected final String TEXT_865 = NL + "                try {" + NL + "                    insertedCount_";
  ...
  protected final String TEXT_870 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_893 = NL + "            int updateFlag_";
  protected final String TEXT_894 = "=0;";
  protected final String TEXT_895 = NL + "                    ";
  protected final String TEXT_896 = NL + "                    int count_";
  protected final String TEXT_897 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_898 = ".";
  protected final String TEXT_899 = ", pstmtUpdate_";
  ...
  protected final String TEXT_909 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_910 = "=pstmtUpdate_";
  protected final String TEXT_911 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_912 = " = updatedCount_";
  protected final String TEXT_913 = "+updateFlag_";
  protected final String TEXT_914 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_915 = " == 0) {";
  protected final String TEXT_916 = NL + "                        ";
  protected final String TEXT_917 = NL + "                        DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_924 = " = insertedCount_";
  protected final String TEXT_925 = " + pstmtInsert_";
  protected final String TEXT_926 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_927 = "++;";
  protected final String TEXT_928 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_929 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_930 = NL + "             }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_931 = " = true;";
  ...
  protected final String TEXT_943 = NL + "                            rejectedCount_";
  protected final String TEXT_944 = " = rejectedCount_";
  protected final String TEXT_945 = " + 1;";
  protected final String TEXT_946 = NL + "                            ";
  protected final String TEXT_947 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_948 = NL + "                            ";
  protected final String TEXT_949 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_950 = ";";
  protected final String TEXT_951 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_952 = NL + "                }";
  protected final String TEXT_953 = NL + "\t\t\t\t\t";
  protected final String TEXT_954 = NL + "                    \t";
  protected final String TEXT_955 = NL + "\t                        query_";
  protected final String TEXT_956 = " = ";
  protected final String TEXT_957 = ";" + NL + "\t                        ";
  protected final String TEXT_958 = NL + "                    ";
  protected final String TEXT_959 = NL + "                       pstmt_";
  protected final String TEXT_960 = ".addBatch();" + NL + "                       batchSizeCounter_";
  protected final String TEXT_961 = "++;" + NL + "                       nb_line_";
  protected final String TEXT_962 = "++;";
  protected final String TEXT_963 = NL + "                       try {" + NL + "                           deletedCount_";
  protected final String TEXT_964 = " = deletedCount_";
  protected final String TEXT_965 = " + pstmt_";
  protected final String TEXT_966 = ".executeUpdate();" + NL + "                           nb_line_";
  ...
  protected final String TEXT_971 = NL + "                            nb_line_";
  ...
  protected final String TEXT_985 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_986 = NL + "                                   ";
  protected final String TEXT_987 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_988 = ";";
  protected final String TEXT_989 = NL + "                                   System.err.print(e.getMessage());";
  protected final String TEXT_990 = NL + "                       }";
  protected final String TEXT_991 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_1002 = NL + "                if ((batchSize_";
  protected final String TEXT_1003 = " > 0) && (batchSize_";
  protected final String TEXT_1004 = " <= batchSizeCounter_";
  protected final String TEXT_1005 = ")) {" + NL + "            \t\t";
  protected final String TEXT_1006 = NL + NL + "int[] status_";
  protected final String TEXT_1007 = " = null;" + NL + "int countSum_";
  protected final String TEXT_1008 = " = 0;" + NL + "try {" + NL + "    batchSizeCounter_";
  protected final String TEXT_1009 = " = 0;";
  protected final String TEXT_1010 = NL + "    status_";
  protected final String TEXT_1011 = " = pstmt_";
  protected final String TEXT_1012 = ".executeBatch();";
  protected final String TEXT_1013 = NL + "    for(int countEach_";
  protected final String TEXT_1014 = ": status_";
  protected final String TEXT_1015 = ") {" + NL + "        countSum_";
  protected final String TEXT_1016 = " += (countEach_";
  protected final String TEXT_1017 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1018 = ");" + NL + "    }" + NL + "}catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_1019 = NL + "        throw(e);";
  protected final String TEXT_1020 = NL + "    for(int countEach_";
  protected final String TEXT_1021 = ": e.getUpdateCounts()) {" + NL + "        countSum_";
  ...
  protected final String TEXT_1025 = NL + "    System.err.println(e.getMessage());";
  protected final String TEXT_1026 = NL + "}" + NL + "try {" + NL + "    tmp_batchUpdateCount_";
  protected final String TEXT_1027 = " = pstmt_";
  protected final String TEXT_1028 = ".getUpdateCount();" + NL + "}catch (java.sql.SQLException e){";
  protected final String TEXT_1029 = NL + "    System.err.println(e.getMessage());" + NL + "}" + NL + "tmp_batchUpdateCount_";
  ...
  protected final String TEXT_1064 = ");" + NL + "    }" + NL + "}catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_1065 = NL + "        throw(e);";
  protected final String TEXT_1066 = NL + "    for(int countEach_";
  protected final String TEXT_1067 = ": e.getUpdateCounts()) {" + NL + "        countSum_";
  ...
  protected final String TEXT_1071 = NL + "    System.err.println(e.getMessage());";
  protected final String TEXT_1072 = NL + "}" + NL + "try {" + NL + "    tmp_batchUpdateCount_";
  protected final String TEXT_1073 = " = pstmt_";
  protected final String TEXT_1074 = ".getUpdateCount();" + NL + "}catch (java.sql.SQLException e){";
  protected final String TEXT_1075 = NL + "    System.err.println(e.getMessage());" + NL + "}" + NL + "tmp_batchUpdateCount_";
  protected final String TEXT_1076 = " = tmp_batchUpdateCount_";
  protected final String TEXT_1077 = " > countSum_";
  protected final String TEXT_1078 = " ? tmp_batchUpdateCount_";
  ...
  protected final String TEXT_1085 = " += tmp_batchUpdateCount_";
  protected final String TEXT_1086 = ";";
  protected final String TEXT_1087 = NL + "    deletedCount_";
  ...
  protected final String TEXT_1091 = NL + "                    conn_";
  protected final String TEXT_1092 = ".commit();";
  protected final String TEXT_1093 = NL + "                   \tcommitCounter_";
  protected final String TEXT_1094 = "=0;" + NL + "                }";
