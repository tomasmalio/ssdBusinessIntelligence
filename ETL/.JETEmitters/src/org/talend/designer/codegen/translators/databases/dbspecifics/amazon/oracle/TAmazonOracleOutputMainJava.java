...
public class TAmazonOracleOutputMainJava {
  ...
  protected final String TEXT_448 = "    " + NL + "" + NL + "\t\t\t\tpstmt_";
  ...
  protected final String TEXT_464 = " + \" SET \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_472 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_473 = " = new StringBuffer(update_";
  protected final String TEXT_474 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_475 = ".insert(update_";
  protected final String TEXT_476 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_477 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_478 = " =updateStringBuffer_";
  ...
  protected final String TEXT_486 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  ...
  protected final String TEXT_514 = ", \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_551 = NL + "\t\t\t\tpstmtUpdate_";
  ...
  protected final String TEXT_621 = NL + "\t\t\t\tString delete_";
  protected final String TEXT_622 = " = \"DELETE FROM \" + tableName_";
  protected final String TEXT_623 = " + \" WHERE ";
  protected final String TEXT_624 = "\";" + NL + "\t\t\t\t";
  protected final String TEXT_625 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_626 = " = new StringBuffer(delete_";
  protected final String TEXT_627 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_628 = ".insert(delete_";
  protected final String TEXT_629 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_630 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_631 = " =deleteStringBuffer_";
  protected final String TEXT_632 = ".toString();  ";
  protected final String TEXT_633 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_634 = " = conn_";
  protected final String TEXT_635 = ".prepareStatement(delete_";
  ...
  protected final String TEXT_669 = " = new StringBuffer(\"\");";
  protected final String TEXT_670 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_671 = " = buffersSize_";
  protected final String TEXT_672 = ";";
  protected final String TEXT_673 = NL + "\t\t\t\tbatchSize_";
  protected final String TEXT_674 = " = buffersSize_";
  protected final String TEXT_675 = ";";
  protected final String TEXT_676 = NL + NL;
  protected final String TEXT_677 = NL + "        whetherReject_";
  protected final String TEXT_678 = " = false;";
  protected final String TEXT_679 = NL + "\t\t\t\t\t     \t// TODO unable to parse integer: ";
  protected final String TEXT_680 = NL + "\t\t\t\t\t     \t// TODO error: ";
  protected final String TEXT_681 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_682 = NL + "                    \torg.talend.sdi.geometry.Geometry tGeometry_";
  protected final String TEXT_683 = " = (org.talend.sdi.geometry.Geometry)";
  protected final String TEXT_684 = ".";
  protected final String TEXT_685 = ";" + NL + "\t                    com.vividsolutions.jts.geom.Geometry geometry_";
  protected final String TEXT_686 = " = tGeometry_";
  protected final String TEXT_687 = "._getInternalGeometry();" + NL + "" + NL + "                    \tcom.vividsolutions.jts.geom.Envelope extends_";
  protected final String TEXT_688 = " = geometryColumnToExtends.get(\"";
  protected final String TEXT_689 = "\");" + NL + "                    \tif (extends_";
  protected final String TEXT_690 = " == null) {" + NL + "                    \t    geometryColumnToExtends.put(\"";
  protected final String TEXT_691 = "\", geometry_";
  protected final String TEXT_692 = ".getEnvelopeInternal());" + NL + "                    \t}" + NL + "                    \telse {" + NL + "                    \t    extends_";
  protected final String TEXT_693 = ".expandToInclude(geometry_";
  protected final String TEXT_694 = ".getEnvelopeInternal());" + NL + "                    \t}" + NL + "" + NL + "\t\t\t\t\t\tString wkt_";
  protected final String TEXT_695 = " = geometry_";
  protected final String TEXT_696 = ".toText();" + NL + "\t\t\t\t\t\toracle.spatial.util.WKT oracle_wkt_";
  protected final String TEXT_697 = " = new oracle.spatial.util.WKT();" + NL + "\t\t\t\t\t\toracle.spatial.geometry.JGeometry jgeometry_";
  protected final String TEXT_698 = " = oracle_wkt_";
  protected final String TEXT_699 = ".toJGeometry(wkt_";
  protected final String TEXT_700 = ".getBytes());" + NL;
  protected final String TEXT_701 = NL + "\t\t\t\t\t\t\tjgeometry_";
  protected final String TEXT_702 = ".setSRID(";
  protected final String TEXT_703 = ");";
  protected final String TEXT_704 = NL + "               \t\tpstmt_";
  protected final String TEXT_705 = ".setObject(";
  protected final String TEXT_706 = ", oracle.spatial.geometry.JGeometry.store(jgeometry_";
  ...
  protected final String TEXT_713 = NL + "\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_714 = ",";
  protected final String TEXT_715 = ".";
  protected final String TEXT_716 = ", ";
  protected final String TEXT_717 = ",insertSQLSplits_";
  protected final String TEXT_718 = ");";
  protected final String TEXT_719 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_730 = ".addBatch();" + NL + "            batchSizeCounter_";
  ...
  protected final String TEXT_801 = ".addBatch();" + NL + "            batchSizeCounter_";
  protected final String TEXT_802 = "++;" + NL + "    \t\tnb_line_";
  protected final String TEXT_803 = "++;" + NL + "    \t\t";
  protected final String TEXT_804 = NL + "    \t\t";
  protected final String TEXT_805 = NL + "             try {" + NL + "                nb_line_";
  protected final String TEXT_806 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_807 = " = updatedCount_";
  protected final String TEXT_808 = " + pstmt_";
  protected final String TEXT_809 = ".executeUpdate();";
  ...
  protected final String TEXT_836 = NL + NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_837 = " = pstmt_";
  protected final String TEXT_838 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_839 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_840 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_841 = " = rs_";
  protected final String TEXT_842 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  protected final String TEXT_843 = " > 0) {";
  ...
  protected final String TEXT_854 = NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_855 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_856 = ".";
  protected final String TEXT_857 = ", pstmtUpdate_";
  ...
  protected final String TEXT_883 = " + pstmtUpdate_";
  protected final String TEXT_884 = ".executeUpdate();" + NL + "        \t\t\tnb_line_";
  protected final String TEXT_885 = "++;" + NL + "        \t\t\t";
  protected final String TEXT_886 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_908 = NL + "                }" + NL + "    \t\t} else {";
  protected final String TEXT_909 = NL + "                        ";
  protected final String TEXT_910 = NL + "                            query_";
  protected final String TEXT_911 = " = ";
  protected final String TEXT_912 = ";";
  protected final String TEXT_913 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_914 = ",";
  protected final String TEXT_915 = ".";
  protected final String TEXT_916 = ", ";
  protected final String TEXT_917 = ",insertSQLSplits_";
  protected final String TEXT_918 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_919 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_920 = ".";
  protected final String TEXT_921 = ", pstmtInsert_";
  protected final String TEXT_922 = ", ";
  protected final String TEXT_923 = ", \"";
  protected final String TEXT_924 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_925 = NL + "                    globalMap.put(\"";
  protected final String TEXT_926 = "_QUERY\", query_";
  protected final String TEXT_927 = ".toString().trim());";
  protected final String TEXT_928 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_929 = " = insertedCount_";
  protected final String TEXT_930 = " + pstmtInsert_";
  ...
  protected final String TEXT_956 = NL + "    \t    int updateFlag_";
  ...
  protected final String TEXT_966 = ",updateSQLSplits_";
  protected final String TEXT_967 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_968 = NL + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_969 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_970 = ".";
  protected final String TEXT_971 = ", pstmtUpdate_";
  ...
  protected final String TEXT_996 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_997 = " = pstmtUpdate_";
  protected final String TEXT_998 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_999 = " = updatedCount_";
  protected final String TEXT_1000 = "+updateFlag_";
  protected final String TEXT_1001 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_1002 = " == 0) {" + NL + "" + NL + "\t\t\t\t";
  protected final String TEXT_1003 = NL + "\t\t\t\tquery_";
  protected final String TEXT_1004 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_1013 = ",insertSQLSplits_";
  protected final String TEXT_1014 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_1015 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_1016 = ".";
  protected final String TEXT_1017 = ", pstmtInsert_";
  ...
  protected final String TEXT_1025 = " = insertedCount_";
  protected final String TEXT_1026 = " + pstmtInsert_";
  protected final String TEXT_1027 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_1028 = "++;";
  protected final String TEXT_1029 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_1030 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_1031 = NL + "    \t\t\t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_1032 = " = true;";
  protected final String TEXT_1033 = NL + "                        throw(e);";
  protected final String TEXT_1034 = NL + "                    \tnb_line_";
  ...
  protected final String TEXT_1063 = NL + "                globalMap.put(\"";
  protected final String TEXT_1064 = "_QUERY\", query_";
  protected final String TEXT_1065 = ".toString().trim());";
  protected final String TEXT_1066 = NL + "    \t\t";
  protected final String TEXT_1067 = NL + "    \t\tpstmt_";
  protected final String TEXT_1068 = ".addBatch();" + NL + "            batchSizeCounter_";
  protected final String TEXT_1069 = "++;" + NL + "    \t\tnb_line_";
  protected final String TEXT_1070 = "++;" + NL + "    \t\t";
  protected final String TEXT_1071 = NL + "    \t\t";
  protected final String TEXT_1072 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_1073 = " = deletedCount_";
  protected final String TEXT_1074 = " + pstmt_";
  protected final String TEXT_1075 = ".executeUpdate();" + NL + "                nb_line_";
  ...
  protected final String TEXT_1080 = NL + "                \tnb_line_";
  ...
  protected final String TEXT_1115 = ")) {" + NL + "                \ttry {" + NL + "                \t\t";
  protected final String TEXT_1116 = NL + "\t\t\t\t\t\tpstmt_";
  protected final String TEXT_1117 = ".executeBatch();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1118 = NL + "                \t}catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_1119 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_1120 = NL + "                \t\tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_1121 = NL + "                \t}" + NL + "\t\t\t\t\ttmp_batchUpdateCount_";
  protected final String TEXT_1122 = " = pstmt_";
  protected final String TEXT_1123 = ".getUpdateCount();" + NL + "        \t    \t";
  protected final String TEXT_1124 = NL + "        \t    \t\tinsertedCount_";
  protected final String TEXT_1125 = NL + "        \t    \t";
  protected final String TEXT_1126 = NL + "        \t    \t\tupdatedCount_";
  ...
  protected final String TEXT_1133 = " = 0;" + NL + "    \t\t\t}" + NL + "\t    \t\t";
  ...
  protected final String TEXT_1138 = NL + "\t                \tif(batchSizeCounter_";
  protected final String TEXT_1139 = " > 0){" + NL + "\t\t                try {" + NL + "\t\t                \t";
  protected final String TEXT_1140 = NL + "\t                \t\tpstmt_";
  protected final String TEXT_1141 = ".executeBatch();" + NL + "\t\t                \t";
  protected final String TEXT_1142 = NL + "\t\t                }catch (java.sql.BatchUpdateException e){" + NL + "\t\t                \t";
  protected final String TEXT_1143 = NL + "\t\t\t\t\t\t\t\tthrow(e);" + NL + "\t\t                \t";
  protected final String TEXT_1144 = NL + "\t\t                        System.err.println(e.getMessage());" + NL + "\t\t                \t";
  protected final String TEXT_1145 = NL + NL + "\t\t                }" + NL + "\t\t        \t\ttmp_batchUpdateCount_";
  protected final String TEXT_1146 = " = pstmt_";
  protected final String TEXT_1147 = ".getUpdateCount();" + NL + "\t\t    \t    \t";
  protected final String TEXT_1148 = NL + "\t\t    \t    \t\tinsertedCount_";
  ...
  protected final String TEXT_1154 = NL + "\t\t    \t    \t+= (tmp_batchUpdateCount_";
  protected final String TEXT_1155 = "!=-1?tmp_batchUpdateCount_";
  protected final String TEXT_1156 = ":0);" + NL + "\t\t    \t    \tbatchSizeCounter_";
  protected final String TEXT_1157 = " = 0;" + NL + "\t\t    \t    \t}" + NL + "\t                ";
  protected final String TEXT_1158 = NL + "\t                ";
  protected final String TEXT_1159 = NL + "                \tconn_";
  protected final String TEXT_1160 = ".commit();" + NL + "    \t\t\t\t";
  protected final String TEXT_1161 = NL + "                \tcommitCounter_";
  protected final String TEXT_1162 = "=0;" + NL + "                }";
