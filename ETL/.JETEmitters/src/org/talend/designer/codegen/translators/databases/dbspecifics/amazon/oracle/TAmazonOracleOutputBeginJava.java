...
public class TAmazonOracleOutputBeginJava {
  ...
  protected final String TEXT_191 = ".commit();";
  ...
  protected final String TEXT_196 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_197 = "));";
  protected final String TEXT_198 = NL + "                    stmtCreate_";
  protected final String TEXT_199 = ".execute(((\"";
  protected final String TEXT_200 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_201 = ".";
  protected final String TEXT_202 = ", \"";
  protected final String TEXT_203 = "\")";
  protected final String TEXT_204 = ".toUpperCase()";
  ...
  protected final String TEXT_212 = NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_216 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_217 = "));";
  protected final String TEXT_218 = NL + "                    stmtCreate_";
  protected final String TEXT_219 = ".execute(((\"";
  protected final String TEXT_220 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_221 = ".";
  protected final String TEXT_222 = ", \"";
  protected final String TEXT_223 = "\")";
  protected final String TEXT_224 = ".toUpperCase()";
  ...
  protected final String TEXT_233 = NL + "                    String keyCheckTable_";
  protected final String TEXT_234 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_241 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_242 = " = conn_";
  protected final String TEXT_243 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_244 = " + \"]\";";
  protected final String TEXT_245 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_246 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_247 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_248 = ")== null){//}";
  protected final String TEXT_249 = NL + "                                java.sql.Statement isExistStmt_";
  protected final String TEXT_250 = " = conn_";
  protected final String TEXT_251 = ".createStatement();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_252 = " = false;" + NL + "                                try {" + NL + "                                    isExistStmt_";
  protected final String TEXT_253 = ".execute(\"SELECT TOP 1 1 FROM [\" + tableName_";
  protected final String TEXT_254 = " + \"]\" );" + NL + "                                    whetherExist_";
  protected final String TEXT_255 = " = true;" + NL + "                                } catch (java.lang.Exception e){" + NL + "                                    whetherExist_";
  protected final String TEXT_256 = " = false;" + NL + "                                }" + NL + "                                isExistStmt_";
  ...
  protected final String TEXT_266 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_267 = " = dbMetaData_";
  protected final String TEXT_268 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_269 = ", tableNameForSearch_";
  protected final String TEXT_270 = ", new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_271 = " = false;" + NL + "                                if(rsTable_";
  protected final String TEXT_272 = ".next()) {" + NL + "                                    whetherExist_";
  protected final String TEXT_273 = " = true;" + NL + "                                }" + NL + "                                rsTable_";
  ...
  protected final String TEXT_294 = ".trim().length() ==0)) {" + NL + "                                        whetherExist_";
  protected final String TEXT_295 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  ...
  protected final String TEXT_301 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  ...
  protected final String TEXT_328 = " = false;" + NL + "                                String defaultSchema_";
  protected final String TEXT_329 = " = \"public\";" + NL + "                                if(dbschema_";
  protected final String TEXT_330 = " == null || dbschema_";
  protected final String TEXT_331 = ".trim().length() == 0) {" + NL + "                                    java.sql.Statement stmtSchema_";
  protected final String TEXT_332 = " = conn_";
  protected final String TEXT_333 = ".createStatement();" + NL + "                                    java.sql.ResultSet rsSchema_";
  protected final String TEXT_334 = " = stmtSchema_";
  protected final String TEXT_335 = ".executeQuery(\"select current_schema() \");" + NL + "                                    while(rsSchema_";
  protected final String TEXT_336 = ".next()){" + NL + "                                        defaultSchema_";
  protected final String TEXT_337 = " = rsSchema_";
  protected final String TEXT_338 = ".getString(\"current_schema\");" + NL + "                                    }" + NL + "                                    rsSchema_";
  protected final String TEXT_339 = ".close();" + NL + "                                    stmtSchema_";
  protected final String TEXT_340 = ".close();" + NL + "                                }" + NL + "                                while(rsTable_";
  ...
  protected final String TEXT_349 = ")" + NL + "                                        && (schema_";
  ...
  protected final String TEXT_353 = ") || ((dbschema_";
  protected final String TEXT_354 = " ==null || dbschema_";
  protected final String TEXT_355 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_356 = ".equals";
  protected final String TEXT_357 = "IgnoreCase";
  protected final String TEXT_358 = "(schema_";
  ...
  protected final String TEXT_362 = NL + "\t\t\t\t            \tString tableForSearch_";
  protected final String TEXT_363 = " = ";
  protected final String TEXT_364 = ";" + NL + "\t\t\t\t            \tif(tableForSearch_";
  protected final String TEXT_365 = " != null){" + NL + "\t\t\t\t            \t\tif(tableForSearch_";
  protected final String TEXT_366 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_367 = ".endsWith(\"\\\"\")){" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_368 = " =  tableForSearch_";
  protected final String TEXT_369 = ".substring(1,tableForSearch_";
  protected final String TEXT_370 = ".length()-1);" + NL + "\t\t\t\t            \t\t}else{" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_371 = " =  tableForSearch_";
  protected final String TEXT_372 = ".toUpperCase();" + NL + "\t\t\t\t            \t\t}" + NL + "\t\t\t\t            \t}" + NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_376 = ".getTables(null, conn_";
  protected final String TEXT_377 = ".getSchema(), tableForSearch_";
  protected final String TEXT_378 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_379 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_380 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_381 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  ...
  protected final String TEXT_385 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_386 = " = dbMetaData_";
  protected final String TEXT_387 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_388 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  ...
  protected final String TEXT_428 = ".close();" + NL + "                                }";
  protected final String TEXT_429 = NL + "                                if(whetherExist_";
  protected final String TEXT_430 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_535 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_536 = " = new StringBuffer(insert_";
  protected final String TEXT_537 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_538 = ".insert(insert_";
  protected final String TEXT_539 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_540 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_541 = " =insertStringBuffer_";
  protected final String TEXT_542 = ".toString(); ";
  protected final String TEXT_543 = "    " + NL + "" + NL + "        java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_564 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_565 = " = conn_";
  protected final String TEXT_566 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  ...
  protected final String TEXT_597 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_606 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_607 = " = new StringBuffer(update_";
  protected final String TEXT_608 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_609 = ".insert(update_";
  protected final String TEXT_610 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_611 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_612 = " =updateStringBuffer_";
  protected final String TEXT_613 = ".toString(); ";
  protected final String TEXT_614 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_615 = " = conn_";
  protected final String TEXT_616 = ".prepareStatement(update_";
  ...
  protected final String TEXT_630 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_638 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_639 = " = new StringBuffer(delete_";
  protected final String TEXT_640 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_641 = ".insert(delete_";
  protected final String TEXT_642 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_643 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_644 = " =deleteStringBuffer_";
  ...
  protected final String TEXT_648 = ".prepareStatement(delete_";
  protected final String TEXT_649 = ");" + NL + "\t    ";
  protected final String TEXT_650 = NL + "        StringBuffer query_";
  ...
  protected final String TEXT_656 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  ...
  protected final String TEXT_662 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_663 = " = insert_";
  protected final String TEXT_664 = ".split(\"\\\\?\");";
  protected final String TEXT_665 = NL + "\t\t\tdelete_";
  protected final String TEXT_666 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_667 = " = delete_";
  protected final String TEXT_668 = ".split(\"\\\\?\");";
  protected final String TEXT_669 = NL + "\t\t\treplace_";
  protected final String TEXT_670 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_671 = " = replace_";
  protected final String TEXT_672 = ".split(\"\\\\?\");";
  protected final String TEXT_673 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_674 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_675 = " = insertIgnore_";
  protected final String TEXT_676 = ".split(\"\\\\?\");";
  protected final String TEXT_677 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_678 = " = insert_";
  protected final String TEXT_679 = ".split(\"\\\\?\");";
  protected final String TEXT_680 = NL + "\t   ";
  protected final String TEXT_681 = NL + "    \t// Initialize SRID" + NL + "    \tint SRID_";
  protected final String TEXT_682 = " = 0;" + NL + "    \tint dimension_";
  protected final String TEXT_683 = " = 0;" + NL + "    \tboolean firstGeometry_";
  protected final String TEXT_684 = " = true;" + NL + "    \t";
  protected final String TEXT_685 = NL + NL + "\tclass ClobTypeUtil_";
  protected final String TEXT_686 = " {" + NL + "\t\tpublic Object getCLOB(Object data, java.sql.Connection conn) throws java.sql.SQLException{" + NL + "\t\t\toracle.sql.CLOB tempClob = null;" + NL + "\t\t\ttry{" + NL + "\t\t\t\t// If the temporary CLOB has not yet been created, create one" + NL + "\t\t\t\ttempClob = oracle.sql.CLOB.createTemporary(conn, true, oracle.sql.CLOB.DURATION_SESSION);" + NL + "\t\t\t\t// Open the temporary CLOB in readwrite mode, to enable writing" + NL + "\t\t\t\ttempClob.open(oracle.sql.CLOB.MODE_READWRITE);" + NL + "\t\t\t\t// Get the output stream to write" + NL + "\t\t\t\tjava.io.Writer tempClobWriter = tempClob.getCharacterOutputStream();" + NL + "\t\t\t\tif(data instanceof oracle.sql.CLOB) {" + NL + "\t\t\t\t\toracle.sql.CLOB inClob = (oracle.sql.CLOB) data;" + NL + "\t\t\t        java.io.Reader inReader = inClob.getCharacterStream();" + NL + "\t\t\t        char[] chs = new char[128];" + NL + "\t\t\t       \tint len = 0;" + NL + "\t\t\t\t\twhile ((len = inReader.read(chs)) != -1) {" + NL + "\t\t\t        \ttempClobWriter.write(chs, 0, len);" + NL + "\t\t\t        }" + NL + "\t\t\t    }else if(data instanceof String) {" + NL + "\t\t\t       // Write the data into the temporary CLOB" + NL + "\t\t\t\t\ttempClobWriter.write((String)data);" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\treturn data;" + NL + "\t\t\t\t}" + NL + "\t\t\t\t// Flush and close the stream" + NL + "\t\t\t\ttempClobWriter.flush();" + NL + "\t\t\t\ttempClobWriter.close();" + NL + "\t\t\t\t// Close the temporary CLOB" + NL + "\t\t\t\ttempClob.close();" + NL + "\t\t\t} catch( java.sql.SQLException sqlexp){" + NL + "\t  \t\t\t";
  protected final String TEXT_687 = NL + "\t\t\t\ttempClob.freeTemporary();" + NL + "\t\t\t\tsqlexp.printStackTrace();" + NL + "\t\t\t} catch(java.lang.Exception exp){" + NL + "\t  \t\t\t";
  protected final String TEXT_688 = NL + "\t\t\t\ttempClob.freeTemporary();" + NL + "\t\t\t\texp.printStackTrace();" + NL + "\t\t\t}" + NL + "\t\t\treturn tempClob;" + NL + "\t\t}" + NL + "\t}" + NL + "\tClobTypeUtil_";
  protected final String TEXT_689 = " clobTypeUtil_";
  protected final String TEXT_690 = "=new ClobTypeUtil_";
  protected final String TEXT_691 = "();";
  protected final String TEXT_692 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_693 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_694 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_695 = " =null;" + NL + "\t";
  protected final String TEXT_696 = NL + "\t\tStringBuffer query_";
  ...
  protected final String TEXT_702 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_703 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  ...
  protected final String TEXT_707 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_708 = " = null;";
  protected final String TEXT_709 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
