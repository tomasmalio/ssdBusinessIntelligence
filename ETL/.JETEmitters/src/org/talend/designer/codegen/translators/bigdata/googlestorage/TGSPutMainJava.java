...
public class TGSPutMainJava
{
  ...
  protected final String TEXT_27 = NL + "\t\torg.talend.gs.util.GSObjectUtil gsUtil_";
  protected final String TEXT_28 = "=new  org.talend.gs.util.GSObjectUtil();" + NL + "\t\tgsUtil_";
  protected final String TEXT_29 = ".initMimeTypes();" + NL + "\t\tjava.io.File dataDir_";
  protected final String TEXT_30 = "=new java.io.File(";
  protected final String TEXT_31 = ");" + NL + "\t\tjava.util.List<org.jets3t.service.model.GSObject>objects_";
  protected final String TEXT_32 = " =new java.util.ArrayList<org.jets3t.service.model.GSObject>();" + NL + "\t\tjava.util.List<java.util.Map<String,String>> list_";
  protected final String TEXT_33 = " = new java.util.ArrayList<java.util.Map<String,String>>();\t" + NL + "\t\t\t" + NL + "\t\t";
  ...
  protected final String TEXT_49 = ");" + NL + "\t\t\tobjects_";
  protected final String TEXT_50 = " = gsUtil_";
  protected final String TEXT_51 = ".genObjectByFileMap(fileMap_";
  protected final String TEXT_52 = ");\t" + NL + "\t\t";
  protected final String TEXT_53 = NL + "\t\t\tobjects_";
  protected final String TEXT_54 = "=gsUtil_";
  protected final String TEXT_55 = ".genGSObjectList(objects_";
  protected final String TEXT_56 = ", dataDir_";
  protected final String TEXT_57 = ", ";
  protected final String TEXT_58 = ",true,false);" + NL + "\t\t";
  protected final String TEXT_59 = NL + "\t\tfor(org.jets3t.service.model.GSObject obj_";
  protected final String TEXT_60 = ":objects_";
  protected final String TEXT_61 = "){" + NL + "\t\t\tnb_line_";
  protected final String TEXT_62 = " ++;" + NL + "\t\t\tservice_";
  protected final String TEXT_63 = ".putObject(";
  protected final String TEXT_64 = ", obj_";
  protected final String TEXT_65 = ");" + NL + "\t\t}" + NL + "\t" + NL + "\t}catch(java.lang.Exception e_";
  protected final String TEXT_66 = ") {" + NL + "\t\t";
  protected final String TEXT_67 = NL + "\t\t\tthrow(e_";
  protected final String TEXT_68 = ");" + NL + "\t\t";
  protected final String TEXT_69 = NL + "\t\t\tif(e_";
  protected final String TEXT_70 = " instanceof org.jets3t.service.ServiceException){" + NL + "\t\t\t\torg.jets3t.service.ServiceException servError_";
  protected final String TEXT_71 = " = (org.jets3t.service.ServiceException)e_";
  protected final String TEXT_72 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_73 = NL + "\t\t\t\t\tlog.error(\"";
  protected final String TEXT_74 = " - Exception in component ";
  protected final String TEXT_75 = ":\" + servError_";
  protected final String TEXT_76 = ".getMessage());" + NL + "\t\t\t\t";
  protected final String TEXT_77 = NL + "\t\t\t\tSystem.err.println(\"Exception in component ";
  protected final String TEXT_78 = ":\");" + NL + "\t\t\t\tSystem.err.println(servError_";
  protected final String TEXT_79 = ".getMessage());" + NL + "\t\t\t\tif(servError_";
  protected final String TEXT_80 = ".getErrorCode()!=null){" + NL + "\t\t\t\t\t";
  protected final String TEXT_81 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_82 = " - \" + servError_";
  protected final String TEXT_83 = ".getErrorCode());" + NL + "\t\t\t\t\t";
  protected final String TEXT_84 = NL + "\t\t\t\t\tSystem.err.println(servError_";
  protected final String TEXT_85 = ".getErrorCode());" + NL + "\t\t\t\t}" + NL + "\t\t\t\tif(servError_";
  protected final String TEXT_86 = ".getErrorMessage()!=null){" + NL + "\t\t\t\t\t";
  protected final String TEXT_87 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_88 = " - \" + servError_";
  protected final String TEXT_89 = ".getErrorMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_90 = NL + "\t\t\t\t\tSystem.err.println(servError_";
  protected final String TEXT_91 = ".getErrorMessage());" + NL + "\t\t\t\t}" + NL + "\t" + NL + "\t\t\t}else{" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_96 = ".getMessage());" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_97 = NL + "\t\t\t}finally{" + NL + "\t\t\t\tif(service_";
  protected final String TEXT_98 = " !=null){" + NL + "\t\t\t\t\tservice_";
  protected final String TEXT_99 = ".shutdown();" + NL + "\t\t\t\t}" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_100 = NL + "\t}" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_101 = "_NB_LINE\", nb_line_";
