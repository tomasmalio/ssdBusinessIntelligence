...
public class TVerticaOutputBeginJava {
  ...
  protected final String TEXT_180 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_181 = "));";
  protected final String TEXT_182 = NL + "                    stmtCreate_";
  protected final String TEXT_183 = ".execute(((\"";
  protected final String TEXT_184 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_213 = NL + "                                java.sql.Statement isExistStmt_";
  protected final String TEXT_214 = " = conn_";
  protected final String TEXT_215 = ".createStatement();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_216 = " = false;" + NL + "                                try {" + NL + "                                    isExistStmt_";
  ...
  protected final String TEXT_220 = " = false;" + NL + "                                }" + NL + "                                isExistStmt_";
  ...
  protected final String TEXT_225 = ".getMetaData();" + NL + "                                if(tableNameForSearch_";
  protected final String TEXT_226 = ".indexOf(\"\\\"\")==-1){" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_227 = " = tableNameForSearch_";
  protected final String TEXT_228 = ".toUpperCase();" + NL + "                                }else{" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_229 = " = tableNameForSearch_";
  protected final String TEXT_230 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_234 = ", new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_235 = " = false;" + NL + "                                if(rsTable_";
  protected final String TEXT_236 = ".next()) {" + NL + "                                    whetherExist_";
  protected final String TEXT_237 = " = true;" + NL + "                                }" + NL + "                                rsTable_";
  ...
  protected final String TEXT_244 = " = false;" + NL + "                                while(rsTable_";
  ...
  protected final String TEXT_258 = ".trim().length() ==0)) {" + NL + "                                        whetherExist_";
  ...
  protected final String TEXT_352 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_353 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_354 = ".next()) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_355 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  ...
  protected final String TEXT_363 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  ...
  protected final String TEXT_373 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_408 = NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_447 = NL + "            java.sql.ResultSet rsTruncCount_";
  ...
  protected final String TEXT_487 = NL + "            while(rsTruncCount_";
  protected final String TEXT_488 = ".next()) {" + NL + "                deletedCount_";
  ...
  protected final String TEXT_492 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_493 = ".close();";
  protected final String TEXT_494 = NL + "\t\t\t\tjava.sql.Statement stmtCreateProjection_";
  protected final String TEXT_495 = " = conn_";
  protected final String TEXT_496 = ".createStatement();" + NL + "\t\t\t\tstmtCreateProjection_";
  protected final String TEXT_497 = ".execute(\"CREATE PROJECTION \" + tableName_";
  protected final String TEXT_498 = " + \"_proj (";
  protected final String TEXT_499 = ") AS SELECT ";
  protected final String TEXT_500 = " FROM \" + tableName_";
  protected final String TEXT_501 = ");" + NL + "\t\t\t\tstmtCreateProjection_";
  protected final String TEXT_502 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_503 = NL + "\t\t\t\tif(!whetherExist_";
  ...
  protected final String TEXT_514 = NL + "        int batchCount_";
  ...
  protected final String TEXT_547 = "\";" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_558 = NL + "        String delete_";
  protected final String TEXT_559 = " = \"DELETE  FROM \" + tableName_";
  ...
  protected final String TEXT_565 = NL + "\t\tStringBuilder stmtBuilder_";
  protected final String TEXT_566 = " = new StringBuilder();" + NL + "        java.sql.Statement stmt_";
  protected final String TEXT_567 = " = conn_";
  protected final String TEXT_568 = ".createStatement();" + NL + "        String template_";
  protected final String TEXT_569 = " = \"COPY \" + tableName_";
  protected final String TEXT_570 = " +\" (";
  protected final String TEXT_571 = ")\"" + NL + "\t\t\t\t\t\t          + \" FROM STDIN UNCOMPRESSED WITH DELIMITER ';' RECORD TERMINATOR '\\n' ENCLOSED BY '|' NULL AS '' ";
  protected final String TEXT_572 = "DIRECT";
  protected final String TEXT_573 = "\";" + NL + "\t\t";
  protected final String TEXT_574 = NL + "        StringBuffer query_";
  ...
  protected final String TEXT_580 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_581 = " = update_";
  ...
  protected final String TEXT_586 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_587 = " = insert_";
  protected final String TEXT_588 = ".split(\"\\\\?\");";
  protected final String TEXT_589 = NL + "\t\t\tdelete_";
  protected final String TEXT_590 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_591 = " = delete_";
  protected final String TEXT_592 = ".split(\"\\\\?\");";
  protected final String TEXT_593 = NL + "\t\t\treplace_";
  protected final String TEXT_594 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_595 = " = replace_";
  protected final String TEXT_596 = ".split(\"\\\\?\");";
  protected final String TEXT_597 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_598 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_599 = " = insertIgnore_";
  ...
  protected final String TEXT_604 = NL + "\tjava.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_608 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_609 = " = null;" + NL + "\t\t";
  protected final String TEXT_610 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_614 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_615 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_616 = " = null;";
  protected final String TEXT_617 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_618 = " = null;";
  protected final String TEXT_619 = NL + "\t\t\tString[] replaceSQLSplits_";
  ...
  protected final String TEXT_623 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_624 = " = null;";
  protected final String TEXT_625 = NL + "\t\tjava.sql.Statement stmt_";
  protected final String TEXT_626 = " = null;" + NL + "\t\tStringBuilder stmtBuilder_";
  protected final String TEXT_627 = " = null;" + NL + "\t\tString template_";
