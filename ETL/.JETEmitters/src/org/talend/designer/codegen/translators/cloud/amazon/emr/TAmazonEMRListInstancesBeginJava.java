...
public class TAmazonEMRListInstancesBeginJava
{
  ...
  protected final String TEXT_37 = "," + NL + "\t\tcom.amazonaws.PredefinedClientConfigurations.defaultConfig().withUserAgent(\"";
  ...
  protected final String TEXT_42 = NL + "\t\t" + NL + "\tcom.amazonaws.services.elasticmapreduce.model.ListInstanceGroupsRequest request_";
  protected final String TEXT_43 = " = new com.amazonaws.services.elasticmapreduce.model.ListInstanceGroupsRequest()" + NL + "\t\t.withClusterId(";
  protected final String TEXT_44 = ");" + NL + "\t\t" + NL + "\tcom.amazonaws.services.elasticmapreduce.model.ListInstanceGroupsResult result_";
  protected final String TEXT_45 = " = emr_";
  protected final String TEXT_46 = ".listInstanceGroups(request_";
  protected final String TEXT_47 = ");" + NL + "\t\t " + NL + "\tList<com.amazonaws.services.elasticmapreduce.model.InstanceGroup> groupList_";
  protected final String TEXT_48 = " = result_";
  protected final String TEXT_49 = ".getInstanceGroups();" + NL + "\t" + NL + "\tjava.util.Iterator<com.amazonaws.services.elasticmapreduce.model.InstanceGroup> iterator_";
  protected final String TEXT_50 = " = groupList_";
  protected final String TEXT_51 = ".iterator();" + NL + "\t" + NL + "\tcom.amazonaws.services.elasticmapreduce.model.InstanceGroup instanceGroup_";
  protected final String TEXT_52 = " = null;" + NL + "\t" + NL + "\twhile (iterator_";
  protected final String TEXT_53 = ".hasNext()) {" + NL + "" + NL + "\t\tnb_line_";
  protected final String TEXT_54 = "++;" + NL + "\t\tinstanceGroup_";
  protected final String TEXT_55 = " = iterator_";
  protected final String TEXT_56 = ".next();" + NL + "\t\tString instanceGroupName_";
  protected final String TEXT_57 = " = instanceGroup_";
  protected final String TEXT_58 = ".getName();\t" + NL + "\t\tString instanceGroupId_";
  protected final String TEXT_59 = " = instanceGroup_";
  protected final String TEXT_60 = ".getId();" + NL + "\t\tString instanceGroupType_";
  protected final String TEXT_61 = " = instanceGroup_";
  protected final String TEXT_62 = ".getInstanceGroupType();" + NL + "\t\t\t\t" + NL + "\t\t";
  protected final String TEXT_63 = " " + NL + "\t\t\tif(!instanceGroupType_";
  protected final String TEXT_64 = ".equalsIgnoreCase(\"TASK\"))\t" + NL + "\t\t\t{" + NL + "\t\t\t\tcontinue;" + NL + "\t\t\t}\t\t\t\t\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_65 = NL + "\t\t\t\t" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_66 = "_CURRENT_GROUP_ID\", instanceGroupId_";
  protected final String TEXT_67 = ");" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_68 = "_CURRENT_GROUP_NAME\", instanceGroupName_";
  protected final String TEXT_69 = ");" + NL + "" + NL + "\t\t\t\t\t" + NL + "" + NL + "" + NL + "\t" + NL + "\t";
