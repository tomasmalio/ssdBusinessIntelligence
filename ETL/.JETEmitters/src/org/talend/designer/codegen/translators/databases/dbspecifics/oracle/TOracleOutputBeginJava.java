...
public class TOracleOutputBeginJava {
  ...
  protected final String TEXT_204 = NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_208 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_209 = "));";
  protected final String TEXT_210 = NL + "                    stmtCreate_";
  protected final String TEXT_211 = ".execute(((\"";
  protected final String TEXT_212 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_213 = ".";
  protected final String TEXT_214 = ", \"";
  protected final String TEXT_215 = "\")";
  protected final String TEXT_216 = ".toUpperCase()";
  ...
  protected final String TEXT_224 = NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_228 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_229 = "));";
  protected final String TEXT_230 = NL + "                    stmtCreate_";
  protected final String TEXT_231 = ".execute(((\"";
  protected final String TEXT_232 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_245 = NL + "                    String keyCheckTable_";
  protected final String TEXT_246 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_253 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_254 = " = conn_";
  protected final String TEXT_255 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_256 = " + \"]\";";
  protected final String TEXT_257 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_258 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_259 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  ...
  protected final String TEXT_330 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_331 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_340 = " = false;" + NL + "                                String defaultSchema_";
  protected final String TEXT_341 = " = \"public\";" + NL + "                                if(dbschema_";
  protected final String TEXT_342 = " == null || dbschema_";
  protected final String TEXT_343 = ".trim().length() == 0) {" + NL + "                                    java.sql.Statement stmtSchema_";
  protected final String TEXT_344 = " = conn_";
  protected final String TEXT_345 = ".createStatement();" + NL + "                                    java.sql.ResultSet rsSchema_";
  protected final String TEXT_346 = " = stmtSchema_";
  protected final String TEXT_347 = ".executeQuery(\"select current_schema() \");" + NL + "                                    while(rsSchema_";
  protected final String TEXT_348 = ".next()){" + NL + "                                        defaultSchema_";
  protected final String TEXT_349 = " = rsSchema_";
  protected final String TEXT_350 = ".getString(\"current_schema\");" + NL + "                                    }" + NL + "                                    rsSchema_";
  protected final String TEXT_351 = ".close();" + NL + "                                    stmtSchema_";
  protected final String TEXT_352 = ".close();" + NL + "                                }" + NL + "                                while(rsTable_";
  protected final String TEXT_353 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_354 = " = rsTable_";
  protected final String TEXT_355 = ".getString(\"TABLE_NAME\");" + NL + "                                    String schema_";
  protected final String TEXT_356 = " = rsTable_";
  protected final String TEXT_357 = ".getString(\"TABLE_SCHEM\");" + NL + "                                    if(table_";
  protected final String TEXT_358 = ".equals";
  protected final String TEXT_359 = "IgnoreCase";
  protected final String TEXT_360 = "(";
  protected final String TEXT_361 = ")" + NL + "                                        && (schema_";
  protected final String TEXT_362 = ".equals";
  protected final String TEXT_363 = "IgnoreCase";
  protected final String TEXT_364 = "(dbschema_";
  protected final String TEXT_365 = ") || ((dbschema_";
  protected final String TEXT_366 = " ==null || dbschema_";
  protected final String TEXT_367 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_368 = ".equals";
  protected final String TEXT_369 = "IgnoreCase";
  protected final String TEXT_370 = "(schema_";
  ...
  protected final String TEXT_374 = NL + "\t\t\t\t            \tString tableForSearch_";
  protected final String TEXT_375 = " = ";
  protected final String TEXT_376 = ";" + NL + "\t\t\t\t            \tif(tableForSearch_";
  protected final String TEXT_377 = " != null){" + NL + "\t\t\t\t            \t\tif(tableForSearch_";
  protected final String TEXT_378 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_379 = ".endsWith(\"\\\"\")){" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_380 = " =  tableForSearch_";
  protected final String TEXT_381 = ".substring(1,tableForSearch_";
  protected final String TEXT_382 = ".length()-1);" + NL + "\t\t\t\t            \t\t}else{" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_383 = " =  tableForSearch_";
  protected final String TEXT_384 = ".toUpperCase();" + NL + "\t\t\t\t            \t\t}" + NL + "\t\t\t\t            \t}" + NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_388 = ".getTables(null, conn_";
  protected final String TEXT_389 = ".getSchema(), tableForSearch_";
  protected final String TEXT_390 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_391 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_392 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_393 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  ...
  protected final String TEXT_399 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_400 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_401 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_402 = ".next()) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_403 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  ...
  protected final String TEXT_412 = " = false;" + NL + "                                while(rsTable_";
  ...
  protected final String TEXT_429 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_430 = ".";
  protected final String TEXT_431 = ", \"";
  protected final String TEXT_432 = "\")";
  protected final String TEXT_433 = ".toUpperCase()";
  ...
  protected final String TEXT_441 = NL + "                                if(whetherExist_";
  protected final String TEXT_442 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_456 = NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_464 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_471 = NL + "                                    stmtCreate_";
  protected final String TEXT_472 = ".execute(\"";
  protected final String TEXT_473 = ")\");";
  protected final String TEXT_474 = NL + "                                stmtCreate_";
  protected final String TEXT_475 = ".close();";
  protected final String TEXT_476 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_477 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  ...
  protected final String TEXT_487 = NL + "            stmtClear_";
  protected final String TEXT_488 = ".close();";
  protected final String TEXT_489 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_490 = " = conn_";
  protected final String TEXT_491 = ".createStatement();";
  protected final String TEXT_492 = NL + "                              stmtTruncCount_";
  protected final String TEXT_493 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_494 = "));";
  protected final String TEXT_495 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_496 = " = stmtTruncCount_";
  protected final String TEXT_497 = ".executeQuery(\"";
  protected final String TEXT_498 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_499 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_500 = ".next()) {" + NL + "                rsTruncCountNumber_";
  ...
  protected final String TEXT_504 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_505 = " = conn_";
  protected final String TEXT_506 = ".createStatement();";
  protected final String TEXT_507 = NL + "                              stmtTrunc_";
  protected final String TEXT_508 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_515 = NL + "                if(!conn_";
  protected final String TEXT_516 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_517 = ".commit();" + NL + "                }";
  protected final String TEXT_518 = NL + "            deletedCount_";
  protected final String TEXT_519 = " += rsTruncCountNumber_";
  protected final String TEXT_520 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_521 = ".close();";
  protected final String TEXT_522 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_523 = " = conn_";
  protected final String TEXT_524 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_525 = " = stmtTruncCount_";
  protected final String TEXT_526 = ".executeQuery(\"";
  protected final String TEXT_527 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_528 = " = conn_";
  protected final String TEXT_529 = ".createStatement();";
  protected final String TEXT_530 = NL + "                conn_";
  protected final String TEXT_531 = ".commit();";
  protected final String TEXT_532 = NL + "            stmtTrunc_";
  protected final String TEXT_533 = ".executeUpdate(\"";
  protected final String TEXT_534 = "\");";
  protected final String TEXT_535 = NL + "            while(rsTruncCount_";
  protected final String TEXT_536 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_537 = " += rsTruncCount_";
  protected final String TEXT_538 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_539 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_540 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_547 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_548 = " = new StringBuffer(insert_";
  protected final String TEXT_549 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_550 = ".insert(insert_";
  protected final String TEXT_551 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_552 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_553 = " =insertStringBuffer_";
  ...
  protected final String TEXT_561 = " = null;" + NL + "                        // [%connection%][psmt][tableName]" + NL + "                        String keyPsmt_";
  protected final String TEXT_562 = " = conn_";
  protected final String TEXT_563 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_564 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_565 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_566 = ",insert_";
  protected final String TEXT_567 = ",keyPsmt_";
  ...
  protected final String TEXT_588 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  ...
  protected final String TEXT_595 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_596 = " = new StringBuffer(insert_";
  protected final String TEXT_597 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_598 = ".insert(insert_";
  protected final String TEXT_599 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_600 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_601 = " =insertStringBuffer_";
  protected final String TEXT_602 = ".toString(); ";
  protected final String TEXT_603 = "    " + NL + "                java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_604 = " = conn_";
  protected final String TEXT_605 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_636 = NL + "                java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_642 = ") VALUES (";
  ...
  protected final String TEXT_652 = "    " + NL + "                java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_653 = " = conn_";
  protected final String TEXT_654 = ".prepareStatement(insert_";
  protected final String TEXT_655 = ");";
  protected final String TEXT_656 = NL + "                String delete_";
  protected final String TEXT_657 = " = \"DELETE FROM \" + tableName_";
  protected final String TEXT_658 = " + \" WHERE ";
  protected final String TEXT_659 = "\";";
  protected final String TEXT_660 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_661 = " = new StringBuffer(delete_";
  protected final String TEXT_662 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_663 = ".insert(delete_";
  protected final String TEXT_664 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_665 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_666 = " =deleteStringBuffer_";
  ...
  protected final String TEXT_702 = NL + "                // Initialize SRID" + NL + "                int SRID_";
  protected final String TEXT_703 = " = 0;" + NL + "                int dimension_";
  protected final String TEXT_704 = " = 0;" + NL + "                boolean firstGeometry_";
  protected final String TEXT_705 = " = true;";
  protected final String TEXT_706 = NL + NL + "        class ClobTypeUtil_";
  protected final String TEXT_707 = " {" + NL + "            public Object getCLOB(Object data, java.sql.Connection conn) throws java.sql.SQLException{" + NL + "                oracle.sql.CLOB tempClob = null;" + NL + "                try{" + NL + "                    // If the temporary CLOB has not yet been created, create one" + NL + "                    tempClob = oracle.sql.CLOB.createTemporary(conn, true, oracle.sql.CLOB.DURATION_SESSION);" + NL + "                    // Open the temporary CLOB in readwrite mode, to enable writing" + NL + "                    tempClob.open(oracle.sql.CLOB.MODE_READWRITE);" + NL + "                    // Get the output stream to write" + NL + "                    java.io.Writer tempClobWriter = tempClob.getCharacterOutputStream();" + NL + "                    if(data instanceof java.sql.Clob) {" + NL + "                        java.sql.Clob inClob = (java.sql.Clob) data;" + NL + "                        java.io.Reader inReader = inClob.getCharacterStream();" + NL + "                        char[] chs = new char[128];" + NL + "                        int len = 0;" + NL + "                        while ((len = inReader.read(chs)) != -1) {" + NL + "                            tempClobWriter.write(chs, 0, len);" + NL + "                        }" + NL + "                    }else if(data instanceof String) {" + NL + "                       // Write the data into the temporary CLOB" + NL + "                        tempClobWriter.write((String)data);" + NL + "                    }else{" + NL + "                        return data;" + NL + "                    }" + NL + "                    // Flush and close the stream" + NL + "                    tempClobWriter.flush();" + NL + "                    tempClobWriter.close();" + NL + "                    // Close the temporary CLOB" + NL + "                    tempClob.close();" + NL + "                } catch( java.sql.SQLException sqlexp){";
  protected final String TEXT_708 = NL + "                    tempClob.freeTemporary();" + NL + "                    sqlexp.printStackTrace();" + NL + "                } catch(java.lang.Exception exp){";
  protected final String TEXT_709 = NL + "                    tempClob.freeTemporary();" + NL + "                    exp.printStackTrace();" + NL + "                }" + NL + "                return tempClob;" + NL + "            }" + NL + "        }" + NL + "        ClobTypeUtil_";
  protected final String TEXT_710 = " clobTypeUtil_";
  protected final String TEXT_711 = "=new ClobTypeUtil_";
  protected final String TEXT_712 = "();";
  protected final String TEXT_713 = NL + NL + "        class BlobTypeUtil_";
  protected final String TEXT_714 = " {" + NL + "            public Object getBLOB(Object data, java.sql.Connection conn) throws java.sql.SQLException {" + NL + "                if(!(data instanceof java.sql.Blob) || (data instanceof oracle.sql.BLOB)) {" + NL + "                \treturn data;" + NL + "                }" + NL + "" + NL + "                oracle.sql.BLOB blob = null;" + NL + "                java.io.InputStream in = null;" + NL + "                java.io.OutputStream out = null;" + NL + "                try{" + NL + "                \t//in" + NL + "                \tjava.sql.Blob blobData = (java.sql.Blob) data;" + NL + "                \tin = blobData.getBinaryStream();" + NL + "" + NL + "                \t//out" + NL + "                \tblob = oracle.sql.BLOB.createTemporary(conn, true, oracle.sql.BLOB.DURATION_SESSION);" + NL + "                    blob.open(oracle.sql.BLOB.MODE_READWRITE);" + NL + "                    //blob = conn.createBlob(); oracle jdbc don't support it" + NL + "                \tout = blob.setBinaryStream(1);" + NL + "" + NL + "                    byte[] cache = new byte[8192];" + NL + "                    int len = 0;" + NL + "                    while ((len = in.read(cache)) != -1) {" + NL + "                        out.write(cache, 0, len);" + NL + "                    }" + NL + "" + NL + "                    return blob;" + NL + "                } catch(java.sql.SQLException sqlexp){";
  protected final String TEXT_715 = NL + "                \tif(blob!=null) {" + NL + "                \t\ttry {" + NL + "                    \t\tblob.freeTemporary();" + NL + "                    \t} catch(java.sql.SQLException e_";
  protected final String TEXT_716 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "                    sqlexp.printStackTrace();" + NL + "                } catch(java.lang.Exception exp){";
  protected final String TEXT_717 = NL + "                   \tif(blob!=null) {" + NL + "                \t\ttry {" + NL + "                    \t\tblob.freeTemporary();" + NL + "                    \t} catch(java.sql.SQLException e_";
  protected final String TEXT_718 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "                    exp.printStackTrace();" + NL + "                } finally {" + NL + "                \tif(out!=null) {" + NL + "                \t\ttry {" + NL + "                \t\t\tout.flush();" + NL + "                    \t\tout.close();" + NL + "                    \t} catch(java.io.IOException e_";
  protected final String TEXT_719 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "" + NL + "            \t \tif(in!=null) {" + NL + "                \t\ttry {" + NL + "                    \t\tin.close();" + NL + "                    \t} catch(java.io.IOException e_";
  protected final String TEXT_720 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "" + NL + "                    if(blob!=null) {" + NL + "                \t\ttry {" + NL + "                    \t\tblob.close();" + NL + "                    \t} catch(java.sql.SQLException e_";
  protected final String TEXT_721 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "                }" + NL + "" + NL + "                return null;" + NL + "" + NL + "            }" + NL + "" + NL + "        }" + NL + "        BlobTypeUtil_";
  protected final String TEXT_722 = " blobTypeUtil_";
  protected final String TEXT_723 = "=new BlobTypeUtil_";
  protected final String TEXT_724 = "();";
  protected final String TEXT_725 = NL + "        java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_729 = NL + "            StringBuffer query_";
  protected final String TEXT_730 = " = null;";
  protected final String TEXT_731 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_732 = " = null;";
  protected final String TEXT_733 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_734 = " =  null;";
  protected final String TEXT_735 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_736 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  ...
  protected final String TEXT_740 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_741 = " = null;";
  protected final String TEXT_742 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_743 = " = null;";
  protected final String TEXT_744 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_745 = " = null;";
  protected final String TEXT_746 = NL + NL + NL + NL;
