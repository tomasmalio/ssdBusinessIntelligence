...
public class TEXAOutputBeginJava {
  ...
  protected final String TEXT_345 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_346 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_347 = ".next()) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_348 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  ...
  protected final String TEXT_387 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_401 = NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_518 = "\";" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_575 = " =null;" + NL + "    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_576 = " =null;" + NL + "    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_585 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_586 = " = null;";
  protected final String TEXT_587 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_588 = " = null;";
  protected final String TEXT_589 = NL + "\t\t\tString[] replaceSQLSplits_";
