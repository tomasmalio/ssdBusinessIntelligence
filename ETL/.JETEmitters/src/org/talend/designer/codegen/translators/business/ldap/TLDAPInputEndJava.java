...
public class TLDAPInputEndJava
{
  ...
  protected final String TEXT_34 = " - Closing the TLS connection.\");";
  protected final String TEXT_35 = NL + "        javax.naming.ldap.StartTlsResponse tls_";
  protected final String TEXT_36 = " =(javax.naming.ldap.StartTlsResponse)globalMap.get(\"tls_";
  protected final String TEXT_37 = "\");" + NL + "        if(tls_";
  protected final String TEXT_38 = "!=null){" + NL + "            tls_";
  protected final String TEXT_39 = ".close();" + NL + "        }" + NL;
  protected final String TEXT_40 = NL + "\t         log.info(\"";
  protected final String TEXT_41 = " - TLS connection closed.\");";
  protected final String TEXT_42 = "  " + NL + "\t\tif(ctx_";
  protected final String TEXT_43 = "!=null){" + NL + "\t\t\t";
  protected final String TEXT_44 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_45 = " - Closing the connection to the server.\");" + NL + "\t\t\t";
  protected final String TEXT_46 = NL + "\t\t\tctx_";
  ...
  protected final String TEXT_52 = "_NB_LINE\", ";
  protected final String TEXT_53 = "_NB_LINE);";
  protected final String TEXT_54 = NL + "\tlog.info(\"";
  protected final String TEXT_55 = " - Retrieved records count: \" + ";
  protected final String TEXT_56 = "_NB_LINE + \" .\");";
