...
public class TTeradataOutputBeginJava {
  ...
  protected final String TEXT_232 = ".commit();";
  protected final String TEXT_233 = NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_237 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_238 = "));";
  protected final String TEXT_239 = NL + "                    stmtCreate_";
  protected final String TEXT_240 = ".execute(((\"";
  protected final String TEXT_241 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_253 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_254 = " = conn_";
  protected final String TEXT_255 = ".createStatement();";
  protected final String TEXT_256 = NL + "                              stmtCreate_";
  protected final String TEXT_257 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_290 = NL + "                                java.sql.Statement isExistStmt_";
  protected final String TEXT_291 = " = conn_";
  protected final String TEXT_292 = ".createStatement();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_293 = " = false;" + NL + "                                try {" + NL + "                                    isExistStmt_";
  protected final String TEXT_294 = ".execute(\"SELECT TOP 1 1 FROM [\" + tableName_";
  protected final String TEXT_295 = " + \"]\" );" + NL + "                                    whetherExist_";
  protected final String TEXT_296 = " = true;" + NL + "                                } catch (java.lang.Exception e){" + NL + "                                    whetherExist_";
  protected final String TEXT_297 = " = false;" + NL + "                                }" + NL + "                                isExistStmt_";
  ...
  protected final String TEXT_302 = ".getMetaData();" + NL + "                                if(tableNameForSearch_";
  protected final String TEXT_303 = ".indexOf(\"\\\"\")==-1){" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_304 = " = tableNameForSearch_";
  protected final String TEXT_305 = ".toUpperCase();" + NL + "                                }else{" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_306 = " = tableNameForSearch_";
  protected final String TEXT_307 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_308 = " = dbMetaData_";
  protected final String TEXT_309 = ".getTables(null, dbschemaForSearch_";
  ...
  protected final String TEXT_354 = ")" + NL + "                                        && (schema_";
  ...
  protected final String TEXT_359 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_360 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_369 = " = false;" + NL + "                                String defaultSchema_";
  protected final String TEXT_370 = " = \"public\";" + NL + "                                if(dbschema_";
  protected final String TEXT_371 = " == null || dbschema_";
  protected final String TEXT_372 = ".trim().length() == 0) {" + NL + "                                    java.sql.Statement stmtSchema_";
  protected final String TEXT_373 = " = conn_";
  protected final String TEXT_374 = ".createStatement();" + NL + "                                    java.sql.ResultSet rsSchema_";
  protected final String TEXT_375 = " = stmtSchema_";
  protected final String TEXT_376 = ".executeQuery(\"select current_schema() \");" + NL + "                                    while(rsSchema_";
  protected final String TEXT_377 = ".next()){" + NL + "                                        defaultSchema_";
  protected final String TEXT_378 = " = rsSchema_";
  protected final String TEXT_379 = ".getString(\"current_schema\");" + NL + "                                    }" + NL + "                                    rsSchema_";
  protected final String TEXT_380 = ".close();" + NL + "                                    stmtSchema_";
  protected final String TEXT_381 = ".close();" + NL + "                                }" + NL + "                                while(rsTable_";
  protected final String TEXT_382 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_383 = " = rsTable_";
  protected final String TEXT_384 = ".getString(\"TABLE_NAME\");" + NL + "                                    String schema_";
  protected final String TEXT_385 = " = rsTable_";
  protected final String TEXT_386 = ".getString(\"TABLE_SCHEM\");" + NL + "                                    if(table_";
  protected final String TEXT_387 = ".equals";
  protected final String TEXT_388 = "IgnoreCase";
  protected final String TEXT_389 = "(";
  protected final String TEXT_390 = ")" + NL + "                                        && (schema_";
  protected final String TEXT_391 = ".equals";
  protected final String TEXT_392 = "IgnoreCase";
  protected final String TEXT_393 = "(dbschema_";
  protected final String TEXT_394 = ") || ((dbschema_";
  protected final String TEXT_395 = " ==null || dbschema_";
  protected final String TEXT_396 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_397 = ".equals";
  protected final String TEXT_398 = "IgnoreCase";
  protected final String TEXT_399 = "(schema_";
  ...
  protected final String TEXT_403 = NL + "\t\t\t\t            \tString tableForSearch_";
  protected final String TEXT_404 = " = ";
  protected final String TEXT_405 = ";" + NL + "\t\t\t\t            \tif(tableForSearch_";
  protected final String TEXT_406 = " != null){" + NL + "\t\t\t\t            \t\tif(tableForSearch_";
  protected final String TEXT_407 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_408 = ".endsWith(\"\\\"\")){" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_409 = " =  tableForSearch_";
  protected final String TEXT_410 = ".substring(1,tableForSearch_";
  protected final String TEXT_411 = ".length()-1);" + NL + "\t\t\t\t            \t\t}else{" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_412 = " =  tableForSearch_";
  protected final String TEXT_413 = ".toUpperCase();" + NL + "\t\t\t\t            \t\t}" + NL + "\t\t\t\t            \t}" + NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_414 = " = conn_";
  protected final String TEXT_415 = ".getMetaData();" + NL + "\t\t\t\t                java.sql.ResultSet rsTable_";
  protected final String TEXT_416 = " = dbMetaData_";
  protected final String TEXT_417 = ".getTables(null, conn_";
  protected final String TEXT_418 = ".getSchema(), tableForSearch_";
  protected final String TEXT_419 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_420 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_421 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_422 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  protected final String TEXT_423 = ".close();" + NL + "\t\t\t\t            ";
  protected final String TEXT_424 = NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_425 = " = conn_";
  protected final String TEXT_426 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_427 = " = dbMetaData_";
  protected final String TEXT_428 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_429 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_430 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_431 = ".next()) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_432 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  ...
  protected final String TEXT_470 = NL + "                                if(whetherExist_";
  protected final String TEXT_471 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_477 = NL + "                                    stmtDrop_";
  ...
  protected final String TEXT_485 = NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  protected final String TEXT_486 = " = conn_";
  protected final String TEXT_487 = ".createStatement();";
  protected final String TEXT_488 = NL + "                                                  stmtCreate_";
  ...
  protected final String TEXT_493 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_501 = ".execute(\"";
  protected final String TEXT_502 = ")\");";
  protected final String TEXT_503 = NL + "                                stmtCreate_";
  protected final String TEXT_504 = ".close();";
  protected final String TEXT_505 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_506 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_507 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_511 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_512 = "));";
  protected final String TEXT_513 = NL + "            stmtClear_";
  protected final String TEXT_514 = ".executeUpdate(\"";
  protected final String TEXT_515 = "\");";
  protected final String TEXT_516 = NL + "            stmtClear_";
  protected final String TEXT_517 = ".close();";
  protected final String TEXT_518 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_519 = " = conn_";
  protected final String TEXT_520 = ".createStatement();";
  protected final String TEXT_521 = NL + "                              stmtTruncCount_";
  protected final String TEXT_522 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_523 = "));";
  protected final String TEXT_524 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_525 = " = stmtTruncCount_";
  protected final String TEXT_526 = ".executeQuery(\"";
  protected final String TEXT_527 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_528 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_529 = ".next()) {" + NL + "                rsTruncCountNumber_";
  ...
  protected final String TEXT_533 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_534 = " = conn_";
  protected final String TEXT_535 = ".createStatement();";
  protected final String TEXT_536 = NL + "                              stmtTrunc_";
  protected final String TEXT_537 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_538 = "));";
  protected final String TEXT_539 = NL + "                conn_";
  protected final String TEXT_540 = ".commit();";
  protected final String TEXT_541 = NL + "            stmtTrunc_";
  protected final String TEXT_542 = ".executeUpdate(\"";
  protected final String TEXT_543 = "\");";
  protected final String TEXT_544 = NL + "                if(!conn_";
  protected final String TEXT_545 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_546 = ".commit();" + NL + "                }";
  protected final String TEXT_547 = NL + "            deletedCount_";
  protected final String TEXT_548 = " += rsTruncCountNumber_";
  protected final String TEXT_549 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_550 = ".close();";
  protected final String TEXT_551 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_552 = " = conn_";
  protected final String TEXT_553 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_554 = " = stmtTruncCount_";
  protected final String TEXT_555 = ".executeQuery(\"";
  protected final String TEXT_556 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_557 = " = conn_";
  protected final String TEXT_558 = ".createStatement();";
  protected final String TEXT_559 = NL + "                conn_";
  protected final String TEXT_560 = ".commit();";
  protected final String TEXT_561 = NL + "            stmtTrunc_";
  protected final String TEXT_562 = ".executeUpdate(\"";
  protected final String TEXT_563 = "\");";
  protected final String TEXT_564 = NL + "            while(rsTruncCount_";
  protected final String TEXT_565 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_566 = " += rsTruncCount_";
  protected final String TEXT_567 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_568 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_569 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_570 = ".close();";
  protected final String TEXT_571 = NL + "\t conn_";
  protected final String TEXT_572 = ".commit();";
  ...
  protected final String TEXT_624 = " = \"DELETE FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_630 = NL + "        StringBuffer query_";
  protected final String TEXT_631 = " = null;" + NL + "       \t";
  protected final String TEXT_632 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_633 = " = insert_";
  protected final String TEXT_634 = ".split(\"\\\\?\");";
  protected final String TEXT_635 = NL + "\t\t\tupdate_";
  protected final String TEXT_636 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  ...
  protected final String TEXT_642 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  ...
  protected final String TEXT_650 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  ...
  protected final String TEXT_654 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  ...
  protected final String TEXT_661 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_662 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_671 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  ...
  protected final String TEXT_677 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
