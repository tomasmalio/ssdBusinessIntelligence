...
public class TS3BucketCreateMainJava
{
  ...
  protected final String TEXT_184 = " - Creating a bucket with name:\" + ";
  protected final String TEXT_185 = ");" + NL + "\t\t";
  protected final String TEXT_186 = NL + "\t\tconn_";
  protected final String TEXT_187 = ".createBucket(";
  protected final String TEXT_188 = ");" + NL + "\t\t";
  protected final String TEXT_189 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_190 = " - Create the bucket successfully.\");" + NL + "\t\t";
