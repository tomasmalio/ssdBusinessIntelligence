...
public class TSQSMessageDeleteBeginJava
{
  ...
  protected final String TEXT_78 = " - Deleting a message with recipet handle:\" + ";
  protected final String TEXT_79 = ");" + NL + "\t\t";
  protected final String TEXT_80 = NL + "        conn_";
  protected final String TEXT_81 = ".deleteMessage(new com.amazonaws.services.sqs.model.DeleteMessageRequest(";
  protected final String TEXT_82 = ",";
  protected final String TEXT_83 = "));" + NL + "        " + NL + "\t\t";
  protected final String TEXT_84 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_85 = " - Delete the message successfully.\");" + NL + "\t\t";
