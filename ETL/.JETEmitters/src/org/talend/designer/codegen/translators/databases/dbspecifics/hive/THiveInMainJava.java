...
public class THiveInMainJava
{
  ...
  protected final String TEXT_118 = NL + "\t\troutines.system.GetJarsToRegister getJarsToRegister_";
  protected final String TEXT_119 = " = new routines.system.GetJarsToRegister();";
  protected final String TEXT_120 = NL + "                        bw_";
  protected final String TEXT_121 = ".write(\"ADD JAR \" + wasbPath_";
  protected final String TEXT_122 = " + new java.io.File(getJarsToRegister_";
  protected final String TEXT_123 = ".replaceJarPaths(\"";
  protected final String TEXT_124 = "\")).getName() + \";\");" + NL + "                        libjars_";
  protected final String TEXT_125 = ".append(getJarsToRegister_";
  protected final String TEXT_126 = ".replaceJarPaths(\"";
  protected final String TEXT_127 = "\") + \",\");";
  protected final String TEXT_128 = NL + "                            log.debug(\"Query for ";
  protected final String TEXT_129 = ": \" + \"ADD JAR \" + stagingBucketPath_";
  protected final String TEXT_130 = " + new java.io.File(getJarsToRegister_";
  protected final String TEXT_131 = ".replaceJarPaths(\"";
  protected final String TEXT_132 = "\")).getName() + \";\");";
  protected final String TEXT_133 = NL + "                        instance_";
  protected final String TEXT_134 = ".addQuery(\"ADD JAR \" + stagingBucketPath_";
  protected final String TEXT_135 = " + new java.io.File(getJarsToRegister_";
  protected final String TEXT_136 = ".replaceJarPaths(\"";
  protected final String TEXT_137 = "\")).getName() + \";\");" + NL + "                        libjars_";
  protected final String TEXT_138 = ".append(getJarsToRegister_";
  protected final String TEXT_139 = ".replaceJarPaths(\"";
  ...
  protected final String TEXT_144 = "_QUERY\", ";
  protected final String TEXT_145 = ");" + NL + "" + NL + "        bw_";
  protected final String TEXT_146 = ".close();" + NL + "" + NL + "        if (libjars_";
  protected final String TEXT_147 = ".length() > 0) {" + NL + "            instance_";
  protected final String TEXT_148 = ".setLibJars(libjars_";
  protected final String TEXT_149 = ".toString().substring(0, libjars_";
  protected final String TEXT_150 = ".length()-1));" + NL + "        }" + NL + "        instance_";
  protected final String TEXT_151 = ".callWS(instance_";
  protected final String TEXT_152 = ".sendFiles());" + NL + "        int exitCode_";
  protected final String TEXT_153 = " = instance_";
  protected final String TEXT_154 = ".execute();" + NL + "        if (exitCode_";
  protected final String TEXT_155 = " > 0) {" + NL;
  protected final String TEXT_156 = NL + "                throw new Exception(\"The Hive job failed. Please read the logs for more details\");";
  protected final String TEXT_157 = NL + "                    log.error(\"";
  protected final String TEXT_158 = " - The Hive job failed. Please read the logs for more details\");";
  protected final String TEXT_159 = NL + "                    System.err.println(\"The Hive job failed. Please read the logs for more details\");";
  protected final String TEXT_160 = NL + "        }" + NL + "        java.io.InputStream ";
  protected final String TEXT_161 = " = instance_";
  protected final String TEXT_162 = ".getStdOut();";
  protected final String TEXT_163 = NL + "            log.debug(\"Query for ";
  protected final String TEXT_164 = ": \" + ";
  protected final String TEXT_165 = ".replace(\"';'\", \"'\\\\;'\") + \";\");";
  protected final String TEXT_166 = NL + "        // First we dump the select query of the user into google storage" + NL + "        // In order to do that we modify the query to add as a prefix:" + NL + "        // INSERT OVERWRITE DIRECTORY '$GOOGLE_JARS_BUCKET/hivetmp/' ROW FORMAT DELIMITED FIELDS TERMINATED BY '\\t'" + NL;
  protected final String TEXT_167 = NL + "        instance_";
  protected final String TEXT_168 = ".addQuery(\"INSERT OVERWRITE DIRECTORY '\" + ";
  protected final String TEXT_169 = " + \"' ROW FORMAT DELIMITED FIELDS TERMINATED BY '\\t' \"" + NL + "                + ";
  protected final String TEXT_170 = ".replace(\"';'\", \"'\\\\;'\") + \";\");" + NL + "        if (libjars_";
  protected final String TEXT_171 = ".length() > 0) {" + NL + "            instance_";
  protected final String TEXT_172 = ".addLibJars(libjars_";
  protected final String TEXT_173 = ".toString().substring(0, libjars_";
  protected final String TEXT_174 = ".length()-1));" + NL + "        }" + NL + "        int exitCode_";
  protected final String TEXT_175 = " = instance_";
  protected final String TEXT_176 = ".executeJob();" + NL + "        System.out.println(instance_";
  protected final String TEXT_177 = ".getJobLog());" + NL + "" + NL + "        if (exitCode_";
  protected final String TEXT_178 = " > 0) {";
  protected final String TEXT_179 = NL + "                throw new Exception(\"The Hive job failed. Please read the logs for more details\");";
  protected final String TEXT_180 = NL + "                    log.error(\"";
  protected final String TEXT_181 = " - The Hive job failed. Please read the logs for more details\");";
  protected final String TEXT_182 = NL + "                    System.err.println(\"The Hive job failed. Please read the logs for more details\");";
  protected final String TEXT_183 = NL + "        }" + NL + "" + NL + "        // We have the Hive table dump on google storage, we now need to retrieve it and transmit it to the tFileInputDelimtied";
  protected final String TEXT_184 = NL + "        org.jets3t.service.impl.rest.httpclient.GoogleStorageService service_";
  protected final String TEXT_185 = " = null;" + NL + "        java.util.List<java.io.InputStream> inputStreamList_";
  protected final String TEXT_186 = " = new java.util.ArrayList<>();" + NL + "        try {";
  ...
  protected final String TEXT_193 = NL + NL + "            org.jets3t.service.security.GSCredentials credentials_";
  protected final String TEXT_194 = " = new org.jets3t.service.security.GSCredentials(";
  protected final String TEXT_195 = ",decryptedPassword_";
  protected final String TEXT_196 = ");" + NL + "" + NL + "            service_";
  protected final String TEXT_197 = " = new org.jets3t.service.impl.rest.httpclient.GoogleStorageService(credentials_";
  protected final String TEXT_198 = ",\" ";
  protected final String TEXT_199 = "\",null);" + NL + "            service_";
  protected final String TEXT_200 = ".getAccountOwner();" + NL + "" + NL + "            java.util.regex.Matcher m = org.talend.bigdata.launcher.google.dataproc.DataprocJobUtil.GS_URI_PATTERN.matcher(";
  protected final String TEXT_201 = ");" + NL + "            if (m.find()) {" + NL + "                String bucketName_";
  protected final String TEXT_202 = " = m.group(1);" + NL + "                String objectKey_";
  protected final String TEXT_203 = " = m.group(2);" + NL + "" + NL + "                org.jets3t.service.model.GSObject[] objects_";
  protected final String TEXT_204 = " = service_";
  protected final String TEXT_205 = ".listObjects(" + NL + "                    bucketName_";
  protected final String TEXT_206 = "," + NL + "                    objectKey_";
  protected final String TEXT_207 = "," + NL + "                    null" + NL + "                    );" + NL + "                for (org.jets3t.service.model.GSObject objectSummary_";
  protected final String TEXT_208 = " : objects_";
  protected final String TEXT_209 = ") {" + NL + "                    String objkey_";
  protected final String TEXT_210 = " = objectSummary_";
  protected final String TEXT_211 = ".getKey();" + NL + "                    org.jets3t.service.model.GSObject obj_";
  protected final String TEXT_212 = " = service_";
  protected final String TEXT_213 = ".getObject(bucketName_";
  protected final String TEXT_214 = ", objkey_";
  protected final String TEXT_215 = ");" + NL + "                    System.out.println(obj_";
  protected final String TEXT_216 = ");" + NL + "                    if (obj_";
  protected final String TEXT_217 = " != null) {" + NL + "                        if (!obj_";
  protected final String TEXT_218 = ".isDirectoryPlaceholder()) {" + NL + "                            inputStreamList_";
  protected final String TEXT_219 = ".add(obj_";
  protected final String TEXT_220 = ".getDataInputStream());" + NL + "                        }" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "        } catch (java.lang.Exception e_";
  protected final String TEXT_221 = ") {";
  protected final String TEXT_222 = NL + "                throw(e_";
  protected final String TEXT_223 = ");";
  protected final String TEXT_224 = NL + "                if (e_";
  protected final String TEXT_225 = " instanceof org.jets3t.service.ServiceException) {" + NL + "                    org.jets3t.service.ServiceException servError_";
  protected final String TEXT_226 = " = (org.jets3t.service.ServiceException)e_";
  protected final String TEXT_227 = ";";
  protected final String TEXT_228 = NL + "                        log.error(\"";
  protected final String TEXT_229 = " - \" + servError_";
  protected final String TEXT_230 = ".getErrorCode());";
  protected final String TEXT_231 = NL + "                        System.err.println(\"Exception in component ";
  protected final String TEXT_232 = ":\");" + NL + "                        System.err.println(servError_";
  protected final String TEXT_233 = ".getMessage());";
  protected final String TEXT_234 = NL + "                    if (servError_";
  protected final String TEXT_235 = ".getErrorCode() != null) {";
  protected final String TEXT_236 = NL + "                            log.error(\"";
  protected final String TEXT_237 = " - \" + servError_";
  protected final String TEXT_238 = ".getErrorMessage());";
  protected final String TEXT_239 = NL + "                            System.err.println(servError_";
  protected final String TEXT_240 = ".getErrorCode());";
  protected final String TEXT_241 = NL + "                    }" + NL + "                    if (servError_";
  protected final String TEXT_242 = ".getErrorMessage() != null) {";
  protected final String TEXT_243 = NL + "                            log.error(\"";
  protected final String TEXT_244 = " - \" + e_";
  protected final String TEXT_245 = ".getMessage());";
  protected final String TEXT_246 = NL + "                            System.err.println(servError_";
  protected final String TEXT_247 = ".getErrorMessage());";
  protected final String TEXT_248 = NL + "                    }" + NL + "                } else {";
  protected final String TEXT_249 = NL + "                        log.error(\"";
  protected final String TEXT_250 = " - \" + e_";
  protected final String TEXT_251 = ".getMessage());";
  protected final String TEXT_252 = NL + "                        System.err.println(e_";
  protected final String TEXT_253 = ".getMessage());";
  protected final String TEXT_254 = NL + "                }";
  protected final String TEXT_255 = NL + "        } finally {" + NL + "            if (service_";
  protected final String TEXT_256 = " != null) {" + NL + "                service_";
  protected final String TEXT_257 = ".shutdown();" + NL + "            }" + NL + "        }" + NL + "        java.io.InputStream ";
  protected final String TEXT_258 = " =" + NL + "                new java.io.SequenceInputStream(java.util.Collections.enumeration(inputStreamList_";
