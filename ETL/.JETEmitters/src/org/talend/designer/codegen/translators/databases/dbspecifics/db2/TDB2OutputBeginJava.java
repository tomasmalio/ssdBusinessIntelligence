...
public class TDB2OutputBeginJava {
  ...
  protected final String TEXT_159 = ".commit();";
  ...
  protected final String TEXT_412 = NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_433 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_434 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_448 = NL + "                              stmtTruncCount_";
  protected final String TEXT_449 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_450 = "));";
  protected final String TEXT_451 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_452 = " = stmtTruncCount_";
  protected final String TEXT_453 = ".executeQuery(\"";
  protected final String TEXT_454 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_455 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_456 = ".next()) {" + NL + "                rsTruncCountNumber_";
  ...
  protected final String TEXT_460 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_478 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_479 = " = conn_";
  protected final String TEXT_480 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_481 = " = stmtTruncCount_";
  protected final String TEXT_482 = ".executeQuery(\"";
  protected final String TEXT_483 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_491 = NL + "            while(rsTruncCount_";
  protected final String TEXT_492 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_493 = " += rsTruncCount_";
  protected final String TEXT_494 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_495 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_496 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_516 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_522 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_529 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_537 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_567 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_568 = " = insert_";
  protected final String TEXT_569 = ".split(\"\\\\?\");";
  protected final String TEXT_570 = NL + "\t\t\tdelete_";
  protected final String TEXT_571 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_572 = " = delete_";
  protected final String TEXT_573 = ".split(\"\\\\?\");";
  protected final String TEXT_574 = NL + "\t\t\treplace_";
  protected final String TEXT_575 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_576 = " = replace_";
  protected final String TEXT_577 = ".split(\"\\\\?\");";
  protected final String TEXT_578 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_579 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_580 = " = insertIgnore_";
  ...
  protected final String TEXT_586 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_587 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_596 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_597 = " = null;";
  protected final String TEXT_598 = NL + "\t\t   \tString[] deleteSQLSplits_";
  ...
  protected final String TEXT_606 = NL + "class SetPrepareStatementUtil_";
  protected final String TEXT_607 = " {";
  protected final String TEXT_608 = NL + "\t\t\tvoid set";
  protected final String TEXT_609 = "_";
  protected final String TEXT_610 = "(" + NL + "\t\t\t\tfinal ";
  protected final String TEXT_611 = "Struct ";
  protected final String TEXT_612 = "," + NL + "\t\t\t\tfinal java.sql.PreparedStatement";
  ...
  protected final String TEXT_616 = NL + "\t\t\t\t," + NL + "\t\t\t\tfinal StringBuffer query_";
  protected final String TEXT_617 = NL + "\t\t\t\t," + NL + "\t\t\t\tfinal String[] ";
  protected final String TEXT_618 = NL + "\t\t\t) throws java.sql.SQLException {" + NL + "\t\t\t//}";
  ...
  protected final String TEXT_624 = NL + "}" + NL + "" + NL + "SetPrepareStatementUtil_";
  protected final String TEXT_625 = " setPrepareStatementUtil_";
  protected final String TEXT_626 = " = new SetPrepareStatementUtil_";
  protected final String TEXT_627 = "();" + NL;
  protected final String TEXT_628 = NL + NL + "class DataPropagateUtil_";
  protected final String TEXT_629 = " {";
  protected final String TEXT_630 = NL + "\t\t\tvoid assign_";
  protected final String TEXT_631 = "_";
  protected final String TEXT_632 = "(final ";
  protected final String TEXT_633 = "Struct ";
  protected final String TEXT_634 = ",final ";
  ...
  protected final String TEXT_644 = NL + "}" + NL + "" + NL + "DataPropagateUtil_";
  protected final String TEXT_645 = " dataPropagateUtil_";
  protected final String TEXT_646 = " = new DataPropagateUtil_";
