...
public class TCloudStopBeginJava
{
  ...
  protected final String TEXT_11 = " = org.jclouds.ContextBuilder.newBuilder(\"";
  protected final String TEXT_12 = "\").credentials(";
  protected final String TEXT_13 = ", decryptedPassword_";
  protected final String TEXT_14 = ").buildView(org.jclouds.compute.ComputeServiceContext.class);" + NL + "\torg.jclouds.compute.ComputeService client_";
