...
public class TS3BucketListBeginJava
{
  ...
  protected final String TEXT_182 = NL + "\tint nb_bucket_";
  protected final String TEXT_183 = " = 0;" + NL + "\t";
  protected final String TEXT_184 = NL + "\t\tlog.info(\"";
  protected final String TEXT_185 = " - Retrieving buckets from the server.\");" + NL + "\t";
  protected final String TEXT_186 = NL + "\tjava.util.List<com.amazonaws.services.s3.model.Bucket> buckets_";
  protected final String TEXT_187 = " = conn_";
  protected final String TEXT_188 = ".listBuckets();" + NL + "\t";
  protected final String TEXT_189 = NL + "\t\ttry{" + NL + "\t";
  protected final String TEXT_190 = NL + "\tfor (com.amazonaws.services.s3.model.Bucket bucket_";
  protected final String TEXT_191 = " : buckets_";
  protected final String TEXT_192 = ") {" + NL + "\t\tnb_bucket_";
  protected final String TEXT_193 = "++;" + NL + "\t\tString currentBucketName_";
  protected final String TEXT_194 = " = bucket_";
  protected final String TEXT_195 = ".getName();" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_196 = "_CURRENT_BUCKET_NAME\", currentBucketName_";
  protected final String TEXT_197 = ");" + NL + "\t\t";
  protected final String TEXT_198 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_199 = " - Retrieving the bucket \" + nb_bucket_";
  protected final String TEXT_200 = " + \".\");" + NL + "\t\t\tlog.trace(\"";
  protected final String TEXT_201 = " - Name of current bucket : \" + currentBucketName_";
