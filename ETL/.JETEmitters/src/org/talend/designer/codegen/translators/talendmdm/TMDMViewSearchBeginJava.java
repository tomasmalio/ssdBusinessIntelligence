...
public class TMDMViewSearchBeginJava
{
  ...
  protected final String TEXT_136 = " == null){" + NL + "                                Boolean transInitStart_";
  protected final String TEXT_137 = " = false;" + NL + "                                synchronized(globalMap){" + NL + "                                    if(globalMap.containsKey(transKey_";
  protected final String TEXT_138 = " + \"_initStart\")){" + NL + "                                        transInitStart_";
  protected final String TEXT_139 = " = true;" + NL + "                                    }else{" + NL + "                                        globalMap.put(transKey_";
  protected final String TEXT_140 = " + \"_initStart\", true);" + NL + "                                    }" + NL + "                                }" + NL + "                                if(transInitStart_";
  protected final String TEXT_141 = " == false){" + NL + "                                    if((Boolean)globalMap.get(\"useClientTranId_";
  protected final String TEXT_142 = "\")){" + NL + "                                        List<String> cookies_";
  protected final String TEXT_143 = " = com.talend.mdm.transaction.client.MDMTransactionClient.getCookies(turl_";
  protected final String TEXT_144 = ",username_";
  protected final String TEXT_145 = ",password_";
  protected final String TEXT_146 = ");" + NL + "                                        mdmTransaction_";
  protected final String TEXT_147 = " = new com.talend.mdm.transaction.client.MDMTransaction();" + NL + "                                        mdmTransaction_";
  protected final String TEXT_148 = ".setUrl(turl_";
  protected final String TEXT_149 = ");" + NL + "                                        mdmTransaction_";
  protected final String TEXT_150 = ".setId(\"";
  protected final String TEXT_151 = "_\" + java.util.UUID.randomUUID());" + NL + "                                        mdmTransaction_";
  protected final String TEXT_152 = ".setUsername(username_";
  protected final String TEXT_153 = ");" + NL + "                                        mdmTransaction_";
  protected final String TEXT_154 = ".setPassword(password_";
  protected final String TEXT_155 = ");" + NL + "                                        mdmTransaction_";
  protected final String TEXT_156 = ".setCookies(cookies_";
  protected final String TEXT_157 = ");" + NL + "                                    }else{";
  protected final String TEXT_158 = NL + "                                        mdmTransaction_";
  protected final String TEXT_159 = " = com.talend.mdm.transaction.client.MDMTransactionClient.newTransaction(turl_";
  protected final String TEXT_160 = ",username_";
  protected final String TEXT_161 = ",password_";
  protected final String TEXT_162 = ");" + NL + "                                    }" + NL + "                                }else{" + NL + "                                    while(mdmTransaction_";
  protected final String TEXT_163 = " == null){" + NL + "                                        Thread.sleep(10);" + NL + "                                        mdmTransaction_";
  protected final String TEXT_164 = " = (com.talend.mdm.transaction.client.MDMTransaction)globalMap.get(transKey_";
  protected final String TEXT_165 = ");" + NL + "                                    }" + NL + "                                }" + NL + "" + NL + "                                java.util.List<org.apache.cxf.headers.Header> soapHeaders_";
  protected final String TEXT_166 = " = new java.util.ArrayList<org.apache.cxf.headers.Header>();" + NL + "                                javax.xml.namespace.QName qName_";
  protected final String TEXT_167 = " = new javax.xml.namespace.QName(\"http://www.talend.com/mdm\", \"transaction-id\");" + NL + "                                org.apache.cxf.databinding.DataBinding dataBinding_";
  protected final String TEXT_168 = " = new org.apache.cxf.jaxb.JAXBDataBinding(String.class);" + NL + "                                soapHeaders_";
  protected final String TEXT_169 = ".add(new org.apache.cxf.headers.Header(qName_";
  protected final String TEXT_170 = ", mdmTransaction_";
  protected final String TEXT_171 = ".getId(), dataBinding_";
  protected final String TEXT_172 = "));" + NL + "                                context_";
  protected final String TEXT_173 = ".put(org.apache.cxf.headers.Header.HEADER_LIST, soapHeaders_";
  protected final String TEXT_174 = ");" + NL + "" + NL + "                                java.util.Map<String, java.util.List<String>> httpHeaders_";
  protected final String TEXT_175 = " = new java.util.HashMap<String, java.util.List<String>>();" + NL + "                                httpHeaders_";
  protected final String TEXT_176 = ".put(\"Cookie\", mdmTransaction_";
  protected final String TEXT_177 = ".getCookies());" + NL + "                                context_";
  protected final String TEXT_178 = ".put(org.apache.cxf.message.Message.PROTOCOL_HEADERS, httpHeaders_";
  protected final String TEXT_179 = ");" + NL + "" + NL + "                                globalMap.put(transKey_";
  protected final String TEXT_180 = ", mdmTransaction_";
  protected final String TEXT_181 = ");";
  protected final String TEXT_182 = NL + "                            }" + NL + "                        }" + NL + "                        service_";
  protected final String TEXT_183 = ".ping(new org.talend.mdm.webservice.WSPing());";
  protected final String TEXT_184 = NL + "                        globalMap.put(connKey_";
  protected final String TEXT_185 = ", service_";
  protected final String TEXT_186 = ");" + NL + "                    }";
  protected final String TEXT_187 = NL + NL + "                org.talend.mdm.webservice.WSDataClusterPK dataCluster_";
  protected final String TEXT_188 = " = new org.talend.mdm.webservice.WSDataClusterPK(";
  protected final String TEXT_189 = " + \"";
  protected final String TEXT_190 = "\");" + NL + "                org.talend.mdm.webservice.WSWhereCondition wc_";
  protected final String TEXT_191 = " = null;" + NL + "                java.util.List<org.talend.mdm.webservice.WSWhereItem> conditions_";
  protected final String TEXT_192 = " = new java.util.ArrayList<org.talend.mdm.webservice.WSWhereItem>();";
  protected final String TEXT_193 = NL + "                    wc_";
  protected final String TEXT_194 = " =new org.talend.mdm.webservice.WSWhereCondition(";
  protected final String TEXT_195 = ",org.talend.mdm.webservice.WSWhereOperator.";
  protected final String TEXT_196 = ", ";
  protected final String TEXT_197 = ", false, org.talend.mdm.webservice.WSStringPredicate.";
  protected final String TEXT_198 = ");" + NL + "                    org.talend.mdm.webservice.WSWhereItem wsItem_";
  protected final String TEXT_199 = "=new org.talend.mdm.webservice.WSWhereItem(null,wc_";
  protected final String TEXT_200 = ",null);" + NL + "                    conditions_";
  protected final String TEXT_201 = ".add(wsItem_";
  protected final String TEXT_202 = ");";
  protected final String TEXT_203 = NL + "                org.talend.mdm.webservice.WSWhereItem wsItem_";
  protected final String TEXT_204 = " = null;" + NL + "                if(conditions_";
  protected final String TEXT_205 = ".size() > 0){";
  protected final String TEXT_206 = NL + "                    org.talend.mdm.webservice.WSWhereAnd whereAnd_";
  protected final String TEXT_207 = " = new org.talend.mdm.webservice.WSWhereAnd(conditions_";
  protected final String TEXT_208 = ");" + NL + "                    wsItem_";
  protected final String TEXT_209 = " =new org.talend.mdm.webservice.WSWhereItem(whereAnd_";
  protected final String TEXT_210 = ",null,null);";
  protected final String TEXT_211 = NL + "                    org.talend.mdm.webservice.WSWhereOr whereOr_";
  protected final String TEXT_212 = " = new org.talend.mdm.webservice.WSWhereOr(conditions_";
  protected final String TEXT_213 = ");" + NL + "                    wsItem_";
  protected final String TEXT_214 = " =new org.talend.mdm.webservice.WSWhereItem(null,null,whereOr_";
  protected final String TEXT_215 = ");";
  protected final String TEXT_216 = NL + "                }" + NL + "" + NL + "                org.talend.mdm.webservice.WSViewSearch wsViewSearch_";
  protected final String TEXT_217 = " = null;" + NL + "" + NL + "                int limit_";
  protected final String TEXT_218 = " = ";
  protected final String TEXT_219 = ";" + NL + "                int recordsPerPage_";
  protected final String TEXT_220 = " = ";
  protected final String TEXT_221 = ";" + NL + "                int skip_";
  protected final String TEXT_222 = " = ";
  protected final String TEXT_223 = ";" + NL + "" + NL + "                if (skip_";
  protected final String TEXT_224 = " < 0)" + NL + "                    skip_";
  protected final String TEXT_225 = " = 0;" + NL + "" + NL + "                if (recordsPerPage_";
  protected final String TEXT_226 = " <= 0)" + NL + "                    recordsPerPage_";
  protected final String TEXT_227 = " = -1;// read whole records in one time" + NL + "" + NL + "                if (limit_";
  protected final String TEXT_228 = " <= 0)" + NL + "                    limit_";
  protected final String TEXT_229 = " = -1;// no limit" + NL + "" + NL + "                int retrievedCount_";
  protected final String TEXT_230 = " = 0;" + NL + "                   int readRecordsSize_";
  protected final String TEXT_231 = " = limit_";
  protected final String TEXT_232 = " == -1 ? recordsPerPage_";
  protected final String TEXT_233 = " : (recordsPerPage_";
  protected final String TEXT_234 = " == -1 ? limit_";
  protected final String TEXT_235 = " : (recordsPerPage_";
  protected final String TEXT_236 = " > limit_";
  protected final String TEXT_237 = " ? limit_";
  protected final String TEXT_238 = NL + "                : recordsPerPage_";
  protected final String TEXT_239 = "));" + NL + "" + NL + "                boolean continueFlag_";
  protected final String TEXT_240 = " = true;" + NL + "                int totalCount_";
  protected final String TEXT_241 = " = -1;";
  protected final String TEXT_242 = NL + "                while (continueFlag_";
  protected final String TEXT_243 = ") {" + NL + "                    wsViewSearch_";
  protected final String TEXT_244 = " = new org.talend.mdm.webservice.WSViewSearch();" + NL + "                    wsViewSearch_";
  protected final String TEXT_245 = ".setWsDataClusterPK(dataCluster_";
  protected final String TEXT_246 = ");" + NL + "                    wsViewSearch_";
  protected final String TEXT_247 = ".setWsViewPK(new org.talend.mdm.webservice.WSViewPK(";
  protected final String TEXT_248 = "));" + NL + "" + NL + "                    wsViewSearch_";
  protected final String TEXT_249 = ".setSpellTreshold(";
  protected final String TEXT_250 = ");" + NL + "                    wsViewSearch_";
  protected final String TEXT_251 = ".setSkip(skip_";
  protected final String TEXT_252 = " + retrievedCount_";
  protected final String TEXT_253 = ");" + NL + "                    wsViewSearch_";
  protected final String TEXT_254 = ".setMaxItems(readRecordsSize_";
  protected final String TEXT_255 = ");" + NL;
  protected final String TEXT_256 = NL + "                        wsViewSearch_";
  protected final String TEXT_257 = ".setOrderBy(";
  protected final String TEXT_258 = "); // OPTIONAL" + NL + "                        wsViewSearch_";
  protected final String TEXT_259 = ".setDirection(\"";
  protected final String TEXT_260 = "\"); // OPTIONAL";
  protected final String TEXT_261 = NL + "                    wsViewSearch_";
  protected final String TEXT_262 = ".setWhereItem(wsItem_";
  protected final String TEXT_263 = "); // OPTIONAL" + NL + "" + NL + "                    String[] items_";
  protected final String TEXT_264 = " = service_";
  protected final String TEXT_265 = ".viewSearch(wsViewSearch_";
  protected final String TEXT_266 = ").getStrings().toArray(new String[0]);" + NL;
  protected final String TEXT_267 = NL + NL + "                    if(totalCount_";
  protected final String TEXT_268 = " < 0){" + NL + "                        totalCount_";
  protected final String TEXT_269 = " = Integer.valueOf(items_";
  protected final String TEXT_270 = "[0].replaceAll(\"<totalCount>\", \"\").replaceAll(\"</totalCount>\", \"\"));";
  protected final String TEXT_271 = NL + "                    }" + NL + "" + NL + "                    retrievedCount_";
  protected final String TEXT_272 = " += items_";
  protected final String TEXT_273 = ".length - 1; // for header" + NL + "                    if (totalCount_";
  protected final String TEXT_274 = " == retrievedCount_";
  protected final String TEXT_275 = " || recordsPerPage_";
  protected final String TEXT_276 = " == -1 || items_";
  protected final String TEXT_277 = ".length < readRecordsSize_";
  ...
  protected final String TEXT_289 = "=1;i_";
  ...
  protected final String TEXT_296 = " = items_";
