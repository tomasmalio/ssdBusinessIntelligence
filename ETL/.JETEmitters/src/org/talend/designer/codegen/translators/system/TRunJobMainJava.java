...
public class TRunJobMainJava
{
  ...
  protected final String TEXT_210 = ".getException().getClass().getName() + \": \" + childJob_";
  protected final String TEXT_211 = ".getException().getMessage());" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_212 = NL + "\t  \t";
  protected final String TEXT_213 = NL + "\t\t\tfor (String[] item_";
  protected final String TEXT_214 = " : childReturn_";
  protected final String TEXT_215 = ") { " + NL + "\t\t\t\tif(childJob_";
  protected final String TEXT_216 = ".hastBufferOutputComponent() || ";
  protected final String TEXT_217 = "){" + NL + "\t\t\t    \t";
  protected final String TEXT_218 = "\t\t" + NL + "\t\t\t\t\t\tif(";
  protected final String TEXT_219 = " < item_";
  protected final String TEXT_220 = ".length){\t\t\t\t" + NL + "\t\t\t           \t\t";
  ...
  protected final String TEXT_260 = NL + "\t\tRuntime runtime_";
  protected final String TEXT_261 = " = Runtime.getRuntime();" + NL + "\t\tfinal Process ps_";
  protected final String TEXT_262 = ";" + NL + "\t\tps_";
  protected final String TEXT_263 = " = runtime_";
  protected final String TEXT_264 = ".exec((String[])paraList_";
  protected final String TEXT_265 = ".toArray(new String[paraList_";
  protected final String TEXT_266 = ".size()]));" + NL + "" + NL + "\t\tThread normal_";
  protected final String TEXT_267 = " = new Thread() {" + NL + "\t\t\tpublic void run() {" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps_";
  protected final String TEXT_268 = ".getInputStream()));" + NL + "\t\t\t\t\tString line = \"\";" + NL + "\t\t\t\t\ttry {" + NL + "\t\t\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t\t\tSystem.out.println(line);" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t} finally {" + NL + "\t\t\t\t\treader.close();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_269 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_270 = " - \" + ioe.getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_271 = NL + "\t\t\t\t\tioe.printStackTrace();" + NL + "\t\t\t\t}" + NL + "\t    \t}" + NL + "  \t\t};" + NL + "\t\t";
  protected final String TEXT_272 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_273 = " - The child job '";
  protected final String TEXT_274 = "\"+";
  protected final String TEXT_275 = "+\"";
  protected final String TEXT_276 = "' starts on the version '";
  protected final String TEXT_277 = "' with the context '";
  protected final String TEXT_278 = "'.\");" + NL + "\t\t";
  protected final String TEXT_279 = NL + "\t\tnormal_";
  protected final String TEXT_280 = ".start();" + NL + "\t\t";
  protected final String TEXT_281 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_282 = " - The child job '";
  protected final String TEXT_283 = "\"+";
  protected final String TEXT_284 = "+\"";
  protected final String TEXT_285 = "' is done.\");" + NL + "\t\t";
  protected final String TEXT_286 = NL + NL + "\t\tfinal StringBuffer errorMsg_";
  protected final String TEXT_287 = " = new StringBuffer();" + NL + "\t\tThread error_";
  protected final String TEXT_288 = " = new Thread() {" + NL + "\t\t\tpublic void run() {" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps_";
  protected final String TEXT_289 = ".getErrorStream()));" + NL + "\t\t\t\t\tString line = \"\";" + NL + "        \t\t\ttry {" + NL + "          \t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "            \t\t\t\terrorMsg_";
  protected final String TEXT_290 = ".append(line).append(\"\\n\");" + NL + "          \t\t\t\t}" + NL + "        \t\t\t} finally {" + NL + "          \t\t\t\treader.close();" + NL + "        \t\t\t}" + NL + "      \t\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_291 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_292 = " - \" + ioe.getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_293 = NL + "\t\t\t        ioe.printStackTrace();" + NL + "      \t\t\t}" + NL + "    \t\t}" + NL + "\t\t};" + NL + "\t\terror_";
  protected final String TEXT_294 = ".start();" + NL + "" + NL + "\t\t//0 indicates normal termination\t" + NL + "\t\tint result_";
  protected final String TEXT_295 = " = ps_";
  protected final String TEXT_296 = ".waitFor();" + NL + "\t\tnormal_";
  protected final String TEXT_297 = ".join(10000);" + NL + "\t\terror_";
  protected final String TEXT_298 = ".join(10000);" + NL + "  " + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_299 = "_CHILD_RETURN_CODE\",result_";
  protected final String TEXT_300 = ");" + NL + "\t\tif(result_";
  protected final String TEXT_301 = " != 0){" + NL + "   \t\t\tglobalMap.put(\"";
  protected final String TEXT_302 = "_CHILD_EXCEPTION_STACKTRACE\",errorMsg_";
  protected final String TEXT_303 = ".toString());" + NL + "\t\t\t";
  protected final String TEXT_304 = "  " + NL + "\t    \t\tthrow new RuntimeException(\"Child job returns \" + result_";
  protected final String TEXT_305 = " + \". It doesn't terminate normally.\\n\" + errorMsg_";
  protected final String TEXT_306 = ".toString());" + NL + "\t\t\t";
  protected final String TEXT_307 = NL + "\t\t\t\t";
  protected final String TEXT_308 = NL + "\t\t\t\t\tlog.error(\"";
  protected final String TEXT_309 = " - Child job returns \" + result_";
  protected final String TEXT_310 = " + \". It doesn't terminate normally.\\n\" + errorMsg_";
  protected final String TEXT_311 = ".toString());" + NL + "\t\t\t\t";
  protected final String TEXT_312 = NL + "\t\t\t\tSystem.err.println(\"Child job returns \" + result_";
  ...
  protected final String TEXT_317 = NL + "\t\t\t\t\tlog.error(\"";
  protected final String TEXT_318 = " - Child job returns \" + result_";
  protected final String TEXT_319 = " + \". It doesn't terminate normally.\\n\" + errorMsg_";
  protected final String TEXT_320 = ".toString());" + NL + "\t\t\t\t";
  protected final String TEXT_321 = NL + "  \t\t\t\tSystem.err.println(\"when tRunJob runs in an independent process, it can't extract datas from tBufferOutput of child job.\"); " + NL + "\t\t\t";
