...
public class TContextDumpBeginJava
{
  ...
  protected final String TEXT_24 = ".toString().replaceAll(\".\",\"*\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\telse " + NL + "\t\t\t\t\t";
  protected final String TEXT_25 = "\t\t" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_26 = ".";
  protected final String TEXT_27 = " = value_";
  protected final String TEXT_28 = ".toString();";
  protected final String TEXT_29 = NL + "\t\t\t\t\t\t\tif((\"";
  protected final String TEXT_30 = "\").equals(key_";
  protected final String TEXT_31 = ".toString())){" + NL + "\t\t\t\t\t\t\t\tif(value_";
  protected final String TEXT_32 = ".toString().indexOf(\";\")>-1){" + NL + "\t\t\t                    \t";
  protected final String TEXT_33 = ".";
  protected final String TEXT_34 = " = value_";
  protected final String TEXT_35 = ".toString().substring(value_";
  protected final String TEXT_36 = ".toString().indexOf(\";\")+1);" + NL + "\t\t\t                    }" + NL + "\t\t\t                }" + NL + "\t\t\t\t\t\t";
