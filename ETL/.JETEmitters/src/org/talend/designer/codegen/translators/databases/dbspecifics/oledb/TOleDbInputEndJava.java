...
public class TOleDbInputEndJava
{
  ...
  protected final String TEXT_50 = ".booleanValue();" + NL + "}";
  protected final String TEXT_51 = NL + "reader_";
  protected final String TEXT_52 = ".invoke(\"Close\");" + NL + "conn_";
  protected final String TEXT_53 = ".invoke(\"Close\");";
