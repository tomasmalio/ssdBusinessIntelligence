...
public class TS3CopyBeginJava
{
  ...
  protected final String TEXT_184 = " - Copying an object with key:\" + ";
  protected final String TEXT_185 = ");" + NL + "\t\t";
  protected final String TEXT_186 = NL + "\t\tcom.amazonaws.services.s3.model.CopyObjectRequest copyRequest_";
  protected final String TEXT_187 = " = new com.amazonaws.services.s3.model.CopyObjectRequest(";
  ...
  protected final String TEXT_194 = " - No KMS - Normal SSE\");" + NL + "\t\t\t\t";
  protected final String TEXT_195 = NL + "\t\t\tcom.amazonaws.services.s3.model.ObjectMetadata objectMetadata_";
  protected final String TEXT_196 = " = new com.amazonaws.services.s3.model.ObjectMetadata();" + NL + "\t\t\tobjectMetadata_";
  protected final String TEXT_197 = ".setSSEAlgorithm(com.amazonaws.services.s3.model.ObjectMetadata.AES_256_SERVER_SIDE_ENCRYPTION);" + NL + "\t\t\tcopyRequest_";
  protected final String TEXT_198 = ".setNewObjectMetadata(objectMetadata_";
  protected final String TEXT_199 = ");" + NL + "\t\t";
  protected final String TEXT_200 = NL + "\t\t\t\t";
  protected final String TEXT_201 = "\t" + NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_202 = " - KMS-Enabled - kmsid=\"+";
  protected final String TEXT_203 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_204 = NL + "\t\t\t\t";
  protected final String TEXT_205 = NL + "\t\t\t\t\t";
  protected final String TEXT_206 = "\t" + NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_207 = " - No KMS key - use default\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_208 = NL + "\t\t\t\t\tcopyRequest_";
  protected final String TEXT_209 = ".setSSEAwsKeyManagementParams(new com.amazonaws.services.s3.model.SSEAwsKeyManagementParams ());" + NL + "\t\t\t\t";
  protected final String TEXT_210 = NL + "\t\t\t\t\t";
  protected final String TEXT_211 = "\t" + NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_212 = " - Key found - use key\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_213 = NL + "\t\t\t\t\tcopyRequest_";
  protected final String TEXT_214 = ".setSSEAwsKeyManagementParams(new com.amazonaws.services.s3.model.SSEAwsKeyManagementParams (";
  protected final String TEXT_215 = "));" + NL + "\t\t\t\t";
  protected final String TEXT_216 = NL + "\t\t\t";
  protected final String TEXT_217 = NL + "\t\t" + NL + "\t\tconn_";
  protected final String TEXT_218 = ".copyObject(copyRequest_";
  protected final String TEXT_219 = ");" + NL + "\t\t";
  protected final String TEXT_220 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_221 = " - Copied the object successfully.\");" + NL + "\t\t";
  protected final String TEXT_222 = NL + "\t}catch(java.lang.Exception e_";
  protected final String TEXT_223 = "){" + NL + "\t\t";
  protected final String TEXT_224 = NL + "\t\t\tthrow(e_";
  protected final String TEXT_225 = ");" + NL + "\t\t";
  protected final String TEXT_226 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_227 = " - \" + e_";
  protected final String TEXT_228 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_229 = NL + "\t\t\tSystem.err.println(e_";
  protected final String TEXT_230 = ".getMessage());" + NL + "\t\t";
  protected final String TEXT_231 = NL + "\t}finally{" + NL + "\t\tif(conn_";
  protected final String TEXT_232 = " !=null){" + NL + "\t\t\tconn_";
  protected final String TEXT_233 = ".shutdown();" + NL + "\t\t}" + NL + "\t\t";
