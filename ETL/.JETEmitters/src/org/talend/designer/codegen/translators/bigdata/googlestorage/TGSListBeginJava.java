...
public class TGSListBeginJava
{
  ...
  protected final String TEXT_56 = ".put(\"OBJECT_PREFIX\",";
  protected final String TEXT_57 = ");" + NL + "\t\t\t";
  protected final String TEXT_58 = NL + "\t\t\t\tmap_";
  protected final String TEXT_59 = "_";
  protected final String TEXT_60 = ".put(\"OBJECT_DELIMITER\",";
  protected final String TEXT_61 = ");" + NL + "\t\t\t";
  protected final String TEXT_62 = NL + "\t\t\tlist_";
  protected final String TEXT_63 = ".add(map_";
  protected final String TEXT_64 = "_";
  protected final String TEXT_65 = ");" + NL + "\t\t";
  protected final String TEXT_66 = NL + "\t\tfor (java.util.Map<String, String> map_";
  protected final String TEXT_67 = ": list_";
  protected final String TEXT_68 = ") {" + NL + "\t\t\tString currentBucketName_";
  protected final String TEXT_69 = "=map_";
  protected final String TEXT_70 = ".get(\"BUCKET_NAME\");" + NL + "\t\t\torg.jets3t.service.model.GSObject[] objects_";
  protected final String TEXT_71 = " =new org.jets3t.service.model.GSObject[0];" + NL + "\t\t\ttry {" + NL + "\t\t\t\tobjects_";
  protected final String TEXT_72 = " = service_";
  protected final String TEXT_73 = ".listObjects(currentBucketName_";
  protected final String TEXT_74 = ",map_";
  protected final String TEXT_75 = ".get(\"OBJECT_PREFIX\"),map_";
  protected final String TEXT_76 = ".get(\"OBJECT_DELIMITER\"));" + NL + "\t\t\t}catch(org.jets3t.service.ServiceException e_";
  protected final String TEXT_77 = "){" + NL + "\t\t\t\t";
  protected final String TEXT_78 = NL + "\t\t\t\t\tthrow(e_";
  protected final String TEXT_79 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_80 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_81 = " - Exception in component ";
  protected final String TEXT_82 = ":\" + e_";
  protected final String TEXT_83 = ".getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_84 = NL + "\t\t\t\t\tSystem.err.println(\"Exception in component ";
  protected final String TEXT_85 = ":\");" + NL + "\t\t\t\t\tSystem.err.println(e_";
  protected final String TEXT_86 = ".getMessage());" + NL + "\t\t\t\t\tif(e_";
  protected final String TEXT_87 = ".getErrorCode()!=null){" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_88 = NL + "\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_89 = " - \" + e_";
  protected final String TEXT_90 = ".getErrorCode());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_91 = NL + "\t\t\t\t\t\tSystem.err.println(e_";
  protected final String TEXT_92 = ".getErrorCode());" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\tif(e_";
  protected final String TEXT_93 = ".getErrorMessage()!=null){" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_94 = NL + "\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_95 = " - \" + e_";
  protected final String TEXT_96 = ".getErrorMessage());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_97 = NL + "\t\t\t\t\t\tSystem.err.println(e_";
  protected final String TEXT_98 = ".getErrorMessage());" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_104 = "_CURRENT_BUCKET\", currentBucketName_";
  protected final String TEXT_105 = ");" + NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_106 = "_CURRENT_KEY\", objectSummary_";
  protected final String TEXT_107 = ".getKey());" + NL + "\t";
