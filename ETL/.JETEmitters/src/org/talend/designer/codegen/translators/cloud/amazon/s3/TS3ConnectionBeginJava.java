...
public class TS3ConnectionBeginJava
{
  ...
  protected final String TEXT_182 = NL + "\t" + NL + "\ttry{" + NL + "\t\t\tconn_";
  protected final String TEXT_183 = ".getBucketLoggingConfiguration(\"Check-Connection-Only\");" + NL + "\t}catch(com.amazonaws.AmazonServiceException ase){" + NL + "\t\t\tif(ase.getErrorCode().equals(\"NoSuchBucket\")){" + NL + "\t\t\t//ignore" + NL + "\t\t\t}else{" + NL + "\t\t\t\t\tthrow ase;" + NL + "\t\t\t}" + NL + "\t}" + NL + "\t" + NL + "\tglobalMap.put(\"conn_\" + \"";
