...
public class TNetezzaRowMainJava
{
  ...
  protected final String TEXT_85 = ", java.sql.Types.TIMESTAMP);" + NL + "\t\t\t} else {" + NL + "\t\t\t\tpstmt_";
  ...
  protected final String TEXT_108 = ".getUpdateCount();" + NL + "\t\tglobalMap.put(\"";
  ...
  protected final String TEXT_113 = ".getUpdateCount();" + NL + "\t\tglobalMap.put(\"";
  ...
  protected final String TEXT_118 = ".getUpdateCount();" + NL + "\t\tglobalMap.put(\"";
  ...
  protected final String TEXT_123 = ".getUpdateCount();" + NL + "\t\tglobalMap.put(\"";
  ...
  protected final String TEXT_128 = ".getUpdateCount();" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_129 = "_NB_LINE_UPDATED\", nb_line_update_";
  protected final String TEXT_130 = ");";
  protected final String TEXT_131 = NL + "\t\tnb_line_deleted_";
  protected final String TEXT_132 = " += stmt_";
  protected final String TEXT_133 = ".getUpdateCount();" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_134 = "_NB_LINE_DELETED\", nb_line_deleted_";
  protected final String TEXT_135 = ");";
  protected final String TEXT_136 = NL + "\t} catch (java.lang.Exception e) {" + NL + "\t\twhetherReject_";
  protected final String TEXT_137 = " = true;" + NL + "\t\t";
  protected final String TEXT_138 = NL + "\t\t\tthrow(e);" + NL + "\t\t\t";
  ...
  protected final String TEXT_148 = ".errorCode = ((java.sql.SQLException)e).getSQLState();" + NL + "\t\t\t\t";
  protected final String TEXT_149 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_150 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_151 = NL + "\t\t\t\tSystem.err.print(e.getMessage());" + NL + "\t\t\t\t";
  protected final String TEXT_152 = NL + "\t}" + NL + "\t";
  protected final String TEXT_153 = NL + "\tif(!whetherReject_";
  protected final String TEXT_154 = ") {" + NL + "\t\t";
  protected final String TEXT_155 = NL + "\t\t\t\t\t";
  protected final String TEXT_156 = " = new ";
  protected final String TEXT_157 = "Struct();" + NL + "\t\t\t\t\t";
  protected final String TEXT_158 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_159 = ".";
  protected final String TEXT_160 = " = rs_";
  ...
  protected final String TEXT_168 = NL + "\t\tcommitCounter_";
  protected final String TEXT_169 = "++;" + NL + "\t\tif(commitEvery_";
  protected final String TEXT_170 = " <= commitCounter_";
  protected final String TEXT_171 = ") {" + NL + "\t\t\t";
  protected final String TEXT_172 = NL + "\t\t\tcommitCounter_";
  protected final String TEXT_173 = "=0;" + NL + "\t\t}" + NL + "\t\t";
  ...
  protected final String TEXT_177 = NL + "\tnb_";
  protected final String TEXT_178 = " += stmt_";
  protected final String TEXT_179 = ".getUpdateCount();";
