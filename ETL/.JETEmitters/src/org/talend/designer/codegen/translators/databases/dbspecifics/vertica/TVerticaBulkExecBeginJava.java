...
public class TVerticaBulkExecBeginJava {
  ...
  protected final String TEXT_440 = NL + "\t\tString sql_";
  protected final String TEXT_441 = " = \"COPY \" + tableName_";
  protected final String TEXT_442 = " " + NL + "\t\t";
  protected final String TEXT_443 = NL + "\t\t\t+ \"";
  protected final String TEXT_444 = "\"" + NL + "\t\t";
  protected final String TEXT_445 = "\t\t" + NL + "\t\t+ \" FROM STDIN ";
  protected final String TEXT_446 = " ";
  protected final String TEXT_447 = " DELIMITER '\" + OUT_DELIM_";
  protected final String TEXT_448 = " + \"'\"" + NL + "\t\t";
  protected final String TEXT_449 = NL + "\t\t+ \" TRAILING NULLCOLS\"" + NL + "\t\t";
  protected final String TEXT_450 = NL + "\t\t";
  protected final String TEXT_451 = NL + "\t\t+ \" SKIP \" + ";
  protected final String TEXT_452 = NL + "\t\t";
  protected final String TEXT_453 = NL + "\t\t";
  protected final String TEXT_454 = NL + "\t\t+ \" RECORD TERMINATOR E'\" + ";
  protected final String TEXT_455 = " + \"'\"" + NL + "\t\t";
  protected final String TEXT_456 = NL + "\t\t";
  protected final String TEXT_457 = NL + "\t\t+ \" ENCLOSED BY E'\" + ";
  protected final String TEXT_458 = " + \"'\"" + NL + "\t\t";
  protected final String TEXT_459 = NL + "\t\t";
  protected final String TEXT_460 = NL + "\t\t+ \" ENFORCELENGTH\"" + NL + "\t\t";
  protected final String TEXT_461 = NL + "\t\t";
  protected final String TEXT_462 = NL + "\t\t+ \" REJECTMAX \" + ";
  protected final String TEXT_463 = NL + "\t\t";
  protected final String TEXT_464 = NL + "\t\t";
  protected final String TEXT_465 = NL + "\t\t+ \" ABORT ON ERROR\"" + NL + "\t\t";
  protected final String TEXT_466 = NL + "\t\t";
  protected final String TEXT_467 = NL + "\t\t+ \" ESCAPE AS '\" + escapechar_";
  protected final String TEXT_468 = " + \"'\"" + NL + "\t\t";
  protected final String TEXT_469 = NL + "\t\t+\" NO ESCAPE\"" + NL + "\t\t";
  protected final String TEXT_470 = NL + "\t    ";
  protected final String TEXT_471 = " + \" NULL '\"  + ";
  protected final String TEXT_472 = " + \"'\"" + NL + "\t\t";
  protected final String TEXT_473 = NL + "\t\t";
  protected final String TEXT_474 = " + \" DIRECT\"";
  protected final String TEXT_475 = NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_476 = NL + "\t\t\t+ \" REJECTED DATA '\" + ";
  protected final String TEXT_477 = " + \"'\"" + NL + "\t\t";
  protected final String TEXT_478 = NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_479 = NL + "\t\t\t+ \" EXCEPTIONS '\" + ";
  protected final String TEXT_480 = " + \"'\"" + NL + "\t\t";
  protected final String TEXT_481 = NL + "\t    ";
  protected final String TEXT_482 = NL + "\t        + \" NO COMMIT\"" + NL + "\t    ";
  protected final String TEXT_483 = NL + "\t\t;" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_484 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_485 = " - Bulk SQL:\"+sql_";
  protected final String TEXT_486 = "+\".\");" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_487 = " - Bulk inserting data into ";
  protected final String TEXT_488 = "\" + tableName_";
  protected final String TEXT_489 = " + \"";
  protected final String TEXT_490 = ".\" );";
  protected final String TEXT_491 = NL + "\t    java.sql.Statement stmt_";
  protected final String TEXT_492 = " = conn_";
  protected final String TEXT_493 = ".createStatement();" + NL + "\t    java.sql.ResultSet rs_";
  protected final String TEXT_494 = " = stmt_";
  protected final String TEXT_495 = ".executeQuery(\"select count(*) from \" + tableName_";
  protected final String TEXT_496 = ");" + NL + "\t    int nbLineBeforeLoad_";
  protected final String TEXT_497 = " = 0;" + NL + "\t    while (rs_";
  protected final String TEXT_498 = ".next()) {" + NL + "\t    \tnbLineBeforeLoad_";
  protected final String TEXT_499 = " = rs_";
  protected final String TEXT_500 = ".getInt(1);" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_501 = NL + "\t\tcom.vertica.jdbc.VerticaCopyStream vcs_";
  protected final String TEXT_502 = " = new com.vertica.jdbc.VerticaCopyStream((com.vertica.jdbc.VerticaConnection)conn_";
  protected final String TEXT_503 = ",sql_";
  protected final String TEXT_504 = ");" + NL + "\t\tvcs_";
  protected final String TEXT_505 = ".start();";
