...
public class TSQLDWHBulkExecBeginJava {
  ...
  protected final String TEXT_47 = NL + NL + "    //AZURE DW CODE" + NL;
  protected final String TEXT_48 = NL + NL + "    final String OUT_DELIM_";
  protected final String TEXT_49 = " = ";
  protected final String TEXT_50 = ";" + NL + "    " + NL + "    String randomIdentifier_";
  protected final String TEXT_51 = " = java.util.UUID.randomUUID().toString().replaceAll(\"-\",\"\");" + NL + "    " + NL + "    String azureCredIdentity_";
  protected final String TEXT_52 = " = \"\";" + NL + "    String azureCredName_";
  protected final String TEXT_53 = " = \"\";" + NL + "    String azureContainer_";
  protected final String TEXT_54 = " = \"\";    " + NL + "    " + NL + "    String dbschema_";
  protected final String TEXT_55 = " = null;" + NL + "    //external tableName" + NL + "    String ext_tableName_";
  protected final String TEXT_56 = " = null;" + NL + "" + NL + "    String tableName_";
  protected final String TEXT_57 = " = null;" + NL + "    String azureFolder_";
  protected final String TEXT_58 = " = ";
  protected final String TEXT_59 = ";" + NL + "    " + NL + "    String clientId_";
  protected final String TEXT_60 = " = ";
  protected final String TEXT_61 = ";" + NL + "    String oauthEndpoint_";
  protected final String TEXT_62 = " = ";
  protected final String TEXT_63 = ";" + NL + "    ";
  protected final String TEXT_64 = " " + NL + "        final String azureAccessKey_";
  protected final String TEXT_65 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_66 = ");";
  protected final String TEXT_67 = NL + "        final String azureAccessKey_";
  protected final String TEXT_68 = " = ";
  protected final String TEXT_69 = "; ";
  protected final String TEXT_70 = NL + "        azureCredIdentity_";
  protected final String TEXT_71 = " = clientId_";
  protected final String TEXT_72 = " + \"@\" + oauthEndpoint_";
  protected final String TEXT_73 = ";" + NL + "        azureCredName_";
  protected final String TEXT_74 = " = \"talend_ADLCredential_\" + randomIdentifier_";
  protected final String TEXT_75 = ";";
  protected final String TEXT_76 = NL + "        azureCredIdentity_";
  protected final String TEXT_77 = " = \"talend\";" + NL + "        azureCredName_";
  protected final String TEXT_78 = " = \"talend_AzureStorageCredential_\" + randomIdentifier_";
  protected final String TEXT_79 = ";" + NL + "        azureContainer_";
  protected final String TEXT_80 = " = ";
  protected final String TEXT_81 = ";";
  protected final String TEXT_82 = NL + "    " + NL + "    String azureAccountName_";
  protected final String TEXT_83 = " = ";
  protected final String TEXT_84 = ";" + NL + "    String azureExtDataSrc_";
  protected final String TEXT_85 = " = \"talend_DataSource_\" + randomIdentifier_";
  protected final String TEXT_86 = ";" + NL + "    String azureExtFileFormat_";
  protected final String TEXT_87 = " = \"talend_FileFormat_\" + randomIdentifier_";
  protected final String TEXT_88 = ";" + NL + "    " + NL + "    String azureFileLoadType_";
  protected final String TEXT_89 = " = \"";
  protected final String TEXT_90 = "\";" + NL + "    " + NL + "    String dwDistributionOptions_";
  protected final String TEXT_91 = " = \"\";" + NL + "    String dwTableOptions_";
  protected final String TEXT_92 = " = \"\";" + NL + "    String dwPartition_";
  protected final String TEXT_93 = " = \"\";" + NL;
  protected final String TEXT_94 = NL + NL + "    //BEGIN CONNECTION Code " + NL + "    " + NL + "    java.sql.Connection conn_";
  ...
  protected final String TEXT_113 = " = \"jdbc:sqlserver://\" + ";
  protected final String TEXT_114 = " ; " + NL + "        if (!\"\".equals(port_";
  protected final String TEXT_115 = ")) {" + NL + "            url_";
  protected final String TEXT_116 = " += \":\" + ";
  protected final String TEXT_117 = ";" + NL + "        }" + NL + "        if (!\"\".equals(dbname_";
  protected final String TEXT_118 = ")) {" + NL + "        url_";
  protected final String TEXT_119 = " += \";database=\" + ";
  protected final String TEXT_120 = "; " + NL + "        }" + NL + "        url_";
  protected final String TEXT_121 = " += \";appName=\" + projectName + \";\" + ";
  protected final String TEXT_122 = ";" + NL + "        dbUser_";
  ...
  protected final String TEXT_137 = ",dbUser_";
  protected final String TEXT_138 = ",dbPwd_";
  protected final String TEXT_139 = ");";
  protected final String TEXT_140 = NL + NL + "// END CONNECTION Code" + NL;
  ...
  protected final String TEXT_144 = ".setAutoCommit(true);";
  protected final String TEXT_145 = NL + "    if(dbschema_";
  protected final String TEXT_146 = " == null || dbschema_";
  protected final String TEXT_147 = ".trim().length() == 0) {" + NL + "        ext_tableName_";
  protected final String TEXT_148 = " = ";
  protected final String TEXT_149 = " + \"_\" + randomIdentifier_";
  protected final String TEXT_150 = ";" + NL + "    } else {" + NL + "        ext_tableName_";
  protected final String TEXT_151 = " = dbschema_";
  protected final String TEXT_152 = " + \"].[\" + ";
  protected final String TEXT_153 = " + \"_\" + randomIdentifier_";
  protected final String TEXT_154 = ";" + NL + "    }" + NL + "" + NL + "    if(dbschema_";
  protected final String TEXT_155 = " == null || dbschema_";
  protected final String TEXT_156 = ".trim().length() == 0) {" + NL + "        tableName_";
  protected final String TEXT_157 = " = ";
  protected final String TEXT_158 = ";" + NL + "    } else {" + NL + "        tableName_";
  protected final String TEXT_159 = " = dbschema_";
  protected final String TEXT_160 = " + \"].[\" + ";
  protected final String TEXT_161 = ";" + NL + "    }";
  protected final String TEXT_162 = NL + "        String externalTableRejectOptions_";
  protected final String TEXT_163 = " = \"REJECT_TYPE = ";
  protected final String TEXT_164 = "\" + \",REJECT_VALUE = \" + ";
  protected final String TEXT_165 = ";";
  protected final String TEXT_166 = NL + "            externalTableRejectOptions_";
  protected final String TEXT_167 = " += \",REJECT_SAMPLE_VALUE = \" + ";
  protected final String TEXT_168 = ";";
  protected final String TEXT_169 = "    " + NL + "            dwTableOptions_";
  protected final String TEXT_170 = " = \"CLUSTERED COLUMNSTORE INDEX, \";";
  protected final String TEXT_171 = "    " + NL + "            dwTableOptions_";
  protected final String TEXT_172 = " = \"HEAP, \";";
  protected final String TEXT_173 = "    " + NL + "            dwTableOptions_";
  protected final String TEXT_174 = " = \"CLUSTERED INDEX (\" + ";
  protected final String TEXT_175 = " + \"), \";";
  protected final String TEXT_176 = "    " + NL + "            dwDistributionOptions_";
  protected final String TEXT_177 = " = \"DISTRIBUTION = ROUND_ROBIN\";";
  protected final String TEXT_178 = "    " + NL + "            dwDistributionOptions_";
  protected final String TEXT_179 = " = \"DISTRIBUTION = REPLICATE\";";
  protected final String TEXT_180 = "    " + NL + "            dwDistributionOptions_";
  protected final String TEXT_181 = " = \"DISTRIBUTION = HASH(\" + ";
  protected final String TEXT_182 = " + \")\";";
  protected final String TEXT_183 = NL + "            dwPartition_";
  protected final String TEXT_184 = " = \", PARTITION ( [\" + ";
  protected final String TEXT_185 = " + \"] RANGE ";
  protected final String TEXT_186 = " FOR VALUES (\" + ";
  protected final String TEXT_187 = " + \") )\";    ";
  protected final String TEXT_188 = NL + "            int count_";
  protected final String TEXT_189 = "=0;";
  protected final String TEXT_190 = NL + "            //Create a database scoped credential using Azure Access Key" + NL + "            //IDENTITY: Provide any string, it is not used for authentication to Azure storage." + NL + "            //SECRET: Provide your Azure storage account key." + NL + "    " + NL + "            java.sql.Statement stmtCreateDBCredentials_";
  protected final String TEXT_191 = " = conn_";
  protected final String TEXT_192 = ".createStatement();" + NL + "            stmtCreateDBCredentials_";
  protected final String TEXT_193 = ".execute(\"CREATE DATABASE SCOPED CREDENTIAL \" + azureCredName_";
  protected final String TEXT_194 = " + \" WITH IDENTITY = '\" + azureCredIdentity_";
  protected final String TEXT_195 = " + \"', SECRET = '\" + azureAccessKey_";
  protected final String TEXT_196 = " + \"'\");" + NL + "            stmtCreateDBCredentials_";
  protected final String TEXT_197 = ".close();" + NL + "    ";
  protected final String TEXT_198 = NL + "                log.info(\"";
  protected final String TEXT_199 = " - Created Database Scoped Credential: \" + azureCredName_";
  protected final String TEXT_200 = " + \" WITH IDENTITY \" + azureCredIdentity_";
  protected final String TEXT_201 = " + \" successfully.\");";
  protected final String TEXT_202 = "     " + NL + "" + NL + "            //Create an external data source" + NL + "            //TYPE: HADOOP - PolyBase uses Hadoop APIs to access data in Azure blob storage." + NL + "            //LOCATION: Provide Azure storage account name and blob container name." + NL + "            //CREDENTIAL: Provide the credential created in the previous step." + NL + "    " + NL + "            java.sql.Statement stmtCreateExtDataSource_";
  protected final String TEXT_203 = " = conn_";
  protected final String TEXT_204 = ".createStatement();" + NL + "        ";
  protected final String TEXT_205 = "    " + NL + "                stmtCreateExtDataSource_";
  protected final String TEXT_206 = ".execute(\"CREATE EXTERNAL DATA SOURCE \" + azureExtDataSrc_";
  protected final String TEXT_207 = " + \" WITH (TYPE=HADOOP, LOCATION = 'adl://\" + azureAccountName_";
  protected final String TEXT_208 = " + \".azuredatalakestore.net', CREDENTIAL = \" + azureCredName_";
  protected final String TEXT_209 = " + \")\");";
  protected final String TEXT_210 = "    " + NL + "                stmtCreateExtDataSource_";
  protected final String TEXT_211 = ".execute(\"CREATE EXTERNAL DATA SOURCE \" + azureExtDataSrc_";
  protected final String TEXT_212 = " + \" WITH (TYPE=HADOOP, LOCATION = 'wasbs://\" + azureContainer_";
  protected final String TEXT_213 = " + \"@\" + azureAccountName_";
  protected final String TEXT_214 = " + \".blob.core.windows.net', CREDENTIAL = \" + azureCredName_";
  protected final String TEXT_215 = " + \")\");";
  protected final String TEXT_216 = "    " + NL + "            stmtCreateExtDataSource_";
  protected final String TEXT_217 = ".close();" + NL + "    ";
  protected final String TEXT_218 = NL + "                log.info(\"";
  protected final String TEXT_219 = " - Created External Data Source: \" + azureExtDataSrc_";
  protected final String TEXT_220 = " + \" WITH Credential \" + azureCredName_";
  protected final String TEXT_221 = " + \" successfully.\");";
  protected final String TEXT_222 = " " + NL + "            //newCode END" + NL + "" + NL + "            StringBuilder cmdExtFileFormat_";
  protected final String TEXT_223 = " = new StringBuilder(); " + NL + "            java.sql.Statement stmtCreateExtFileFormat_";
  protected final String TEXT_224 = " = conn_";
  protected final String TEXT_225 = ".createStatement();" + NL + "            " + NL + "            cmdExtFileFormat_";
  protected final String TEXT_226 = ".append(\"CREATE EXTERNAL FILE FORMAT \").append(azureExtFileFormat_";
  protected final String TEXT_227 = ").append(\" WITH (FORMAT_TYPE = ";
  protected final String TEXT_228 = "\");";
  protected final String TEXT_229 = "    " + NL + "                cmdExtFileFormat_";
  protected final String TEXT_230 = ".append(\", FORMAT_OPTIONS (FIELD_TERMINATOR = '\").append(OUT_DELIM_";
  protected final String TEXT_231 = ").append(\"'\");" + NL + "                cmdExtFileFormat_";
  protected final String TEXT_232 = ".append(\", USE_TYPE_DEFAULT = ";
  protected final String TEXT_233 = "\");";
  protected final String TEXT_234 = NL + "                    cmdExtFileFormat_";
  protected final String TEXT_235 = ".append(\", STRING_DELIMITER = '\").append(";
  protected final String TEXT_236 = ").append(\"'\");";
  protected final String TEXT_237 = NL + "                    cmdExtFileFormat_";
  protected final String TEXT_238 = ".append(\", DATE_FORMAT = '\").append(";
  protected final String TEXT_239 = ").append(\"'\");";
  protected final String TEXT_240 = NL + "                cmdExtFileFormat_";
  protected final String TEXT_241 = ".append(\")\");";
  protected final String TEXT_242 = "        " + NL + "                cmdExtFileFormat_";
  protected final String TEXT_243 = ".append(\", SERDE_METHOD = '";
  protected final String TEXT_244 = "'\");";
  protected final String TEXT_245 = NL + "                cmdExtFileFormat_";
  protected final String TEXT_246 = ".append(\", DATA_COMPRESSION = '";
  protected final String TEXT_247 = "'\");";
  protected final String TEXT_248 = NL + "            cmdExtFileFormat_";
  protected final String TEXT_249 = ".append(\")\");" + NL + "            stmtCreateExtFileFormat_";
  protected final String TEXT_250 = ".execute(cmdExtFileFormat_";
  protected final String TEXT_251 = ".toString());" + NL + "            stmtCreateExtFileFormat_";
  protected final String TEXT_252 = ".close();";
  protected final String TEXT_253 = NL + "                log.info(\"";
  protected final String TEXT_254 = " - Created External File Format: \" + azureExtFileFormat_";
  protected final String TEXT_255 = " + \" successfully.\");";
  protected final String TEXT_256 = " " + NL + "            //CREATE EXTERNAL TABLE" + NL + "            java.sql.Statement stmtCreateExt_";
  protected final String TEXT_257 = " = conn_";
  protected final String TEXT_258 = ".createStatement();";
  protected final String TEXT_259 = NL + "            stmtCreateExt_";
  protected final String TEXT_260 = ".execute(\"";
  protected final String TEXT_261 = ")  WITH (LOCATION='/ \" + azureFolder_";
  protected final String TEXT_262 = " + \"', DATA_SOURCE=\" + azureExtDataSrc_";
  protected final String TEXT_263 = " + \", FILE_FORMAT= \" + azureExtFileFormat_";
  protected final String TEXT_264 = " ";
  protected final String TEXT_265 = " " + NL + "            + \",\" + externalTableRejectOptions_";
  protected final String TEXT_266 = " ";
  protected final String TEXT_267 = "  " + NL + "            + \")\");";
  protected final String TEXT_268 = NL + "            stmtCreateExt_";
  protected final String TEXT_269 = ".close();";
  protected final String TEXT_270 = NL + "                log.info(\"";
  protected final String TEXT_271 = " - Created External Table : [\" + ext_tableName_";
  protected final String TEXT_272 = " + \"] successfully.\");";
  protected final String TEXT_273 = "  " + NL + "            // CREATE DW TABLE AND / OR INSERT INTO DW TABLE" + NL + "            try{";
  protected final String TEXT_274 = NL + "                        java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_278 = ".execute(\"DROP TABLE [\" + tableName_";
  ...
  protected final String TEXT_285 = ".execute(\"CREATE TABLE [\" +  tableName_";
  protected final String TEXT_286 = " + \"] WITH (\" + dwTableOptions_";
  protected final String TEXT_287 = " + dwDistributionOptions_";
  protected final String TEXT_288 = " + dwPartition_";
  protected final String TEXT_289 = " + \") AS SELECT * FROM [\" + ext_tableName_";
  protected final String TEXT_290 = " + \"] WHERE 1=2\");";
  protected final String TEXT_291 = NL + "                        stmtCreate_";
  protected final String TEXT_292 = ".close();" + NL + "" + NL + "                        java.sql.Statement stmtInsert_";
  ...
  protected final String TEXT_296 = " - Starting INSERT into table : [\" + tableName_";
  protected final String TEXT_297 = " + \"].\");";
  protected final String TEXT_298 = "  " + NL + "                        int insertedCount_";
  protected final String TEXT_299 = " = stmtInsert_";
  protected final String TEXT_300 = ".executeUpdate(\"INSERT INTO [\" +  tableName_";
  protected final String TEXT_301 = " + \"] SELECT * FROM [\" + ext_tableName_";
  protected final String TEXT_302 = " + \"]\");" + NL + "                        globalMap.put(\"";
  protected final String TEXT_303 = "_NB_LINE_INSERTED\",insertedCount_";
  protected final String TEXT_304 = ");" + NL + "                        stmtInsert_";
  protected final String TEXT_305 = ".close();";
  protected final String TEXT_306 = NL + "                            log.info(\"";
  protected final String TEXT_307 = " - INSERT into table : [\" + tableName_";
  protected final String TEXT_308 = " + \"] completed successfully.\");" + NL + "                            log.info(\"";
  protected final String TEXT_309 = " - Number of Rows Inserted : \" + insertedCount_";
  protected final String TEXT_310 = " + \".\");";
  protected final String TEXT_311 = NL + "                        java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_315 = ".execute(\"CREATE TABLE [\" +  tableName_";
  protected final String TEXT_316 = " + \"] WITH (\" + dwTableOptions_";
  protected final String TEXT_317 = " + dwDistributionOptions_";
  protected final String TEXT_318 = " + dwPartition_";
  protected final String TEXT_319 = " + \") AS SELECT * FROM [\" + ext_tableName_";
  protected final String TEXT_320 = " + \"] WHERE 1=2\");";
  protected final String TEXT_321 = NL + "                        stmtCreate_";
  protected final String TEXT_322 = ".close();" + NL + "" + NL + "                        java.sql.Statement stmtInsert_";
  ...
  protected final String TEXT_326 = " - Starting INSERT into table : [\" + tableName_";
  protected final String TEXT_327 = " + \"].\");";
  protected final String TEXT_328 = "  " + NL + "                        int insertedCount_";
  protected final String TEXT_329 = " = stmtInsert_";
  protected final String TEXT_330 = ".executeUpdate(\"INSERT INTO [\" +  tableName_";
  protected final String TEXT_331 = " + \"] SELECT * FROM [\" + ext_tableName_";
  protected final String TEXT_332 = " + \"]\");" + NL + "                        globalMap.put(\"";
  protected final String TEXT_333 = "_NB_LINE_INSERTED\",insertedCount_";
  protected final String TEXT_334 = ");" + NL + "                        stmtInsert_";
  protected final String TEXT_335 = ".close();";
  protected final String TEXT_336 = NL + "                            log.info(\"";
  protected final String TEXT_337 = " - INSERT into table : [\" + tableName_";
  protected final String TEXT_338 = " + \"] completed successfully.\");" + NL + "                            log.info(\"";
  protected final String TEXT_339 = " - Number of Rows Inserted : \" + insertedCount_";
  protected final String TEXT_340 = " + \".\");";
  protected final String TEXT_341 = NL + "                        //check if table exists" + NL + "                        java.sql.Statement isExistStmt_";
  protected final String TEXT_342 = " = conn_";
  protected final String TEXT_343 = ".createStatement();" + NL + "                        boolean whetherExist_";
  protected final String TEXT_344 = " = false;" + NL + "" + NL + "                        try {" + NL + "                            isExistStmt_";
  protected final String TEXT_345 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_346 = " + \"]\" );" + NL + "                            whetherExist_";
  protected final String TEXT_347 = " = true;" + NL + "                        } catch (java.lang.Exception e){" + NL + "                            whetherExist_";
  protected final String TEXT_348 = " = false;" + NL + "                        }" + NL + "                        isExistStmt_";
  ...
  protected final String TEXT_355 = ".execute(\"CREATE TABLE [\" +  tableName_";
  protected final String TEXT_356 = " + \"] WITH (\" + dwTableOptions_";
  protected final String TEXT_357 = " + dwDistributionOptions_";
  protected final String TEXT_358 = " + dwPartition_";
  protected final String TEXT_359 = " + \") AS SELECT * FROM [\" + ext_tableName_";
  protected final String TEXT_360 = " + \"] WHERE 1=2\");";
  protected final String TEXT_361 = NL + "                                stmtCreate_";
  protected final String TEXT_362 = ".close();" + NL + "                            }" + NL + "                    " + NL + "                            java.sql.Statement stmtInsert_";
  ...
  protected final String TEXT_366 = " - Starting INSERT into table : [\" + tableName_";
  protected final String TEXT_367 = " + \"].\");";
  protected final String TEXT_368 = "  " + NL + "                            int insertedCount_";
  protected final String TEXT_369 = " = stmtInsert_";
  protected final String TEXT_370 = ".executeUpdate(\"INSERT INTO [\" +  tableName_";
  protected final String TEXT_371 = " + \"] SELECT * FROM [\" + ext_tableName_";
  protected final String TEXT_372 = " + \"]\");" + NL + "                            globalMap.put(\"";
  protected final String TEXT_373 = "_NB_LINE_INSERTED\",insertedCount_";
  protected final String TEXT_374 = ");" + NL + "                            stmtInsert_";
  protected final String TEXT_375 = ".close();";
  protected final String TEXT_376 = NL + "                                log.info(\"";
  protected final String TEXT_377 = " - INSERT into table : [\" + tableName_";
  protected final String TEXT_378 = " + \"] completed successfully.\");" + NL + "                                log.info(\"";
  protected final String TEXT_379 = " - Number of Rows Inserted : \" + insertedCount_";
  protected final String TEXT_380 = " + \".\");";
  protected final String TEXT_381 = NL + "                            if(whetherExist_";
  protected final String TEXT_382 = ") {" + NL + "                                java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_386 = ".execute(\"DROP TABLE [\" + tableName_";
  ...
  protected final String TEXT_393 = ".execute(\"CREATE TABLE [\" +  tableName_";
  protected final String TEXT_394 = " + \"] WITH (\" + dwTableOptions_";
  protected final String TEXT_395 = " + dwDistributionOptions_";
  protected final String TEXT_396 = " + dwPartition_";
  protected final String TEXT_397 = " + \") AS SELECT * FROM [\" + ext_tableName_";
  protected final String TEXT_398 = " + \"] WHERE 1=2\");";
  protected final String TEXT_399 = NL + "                            stmtCreate_";
  protected final String TEXT_400 = ".close();" + NL + "                            java.sql.Statement stmtInsert_";
  ...
  protected final String TEXT_404 = " - Starting INSERT into table : [\" + tableName_";
  protected final String TEXT_405 = " + \"].\");";
  protected final String TEXT_406 = "  " + NL + "                            int insertedCount_";
  protected final String TEXT_407 = " = stmtInsert_";
  protected final String TEXT_408 = ".executeUpdate(\"INSERT INTO [\" +  tableName_";
  protected final String TEXT_409 = " + \"] SELECT * FROM [\" + ext_tableName_";
  protected final String TEXT_410 = " + \"]\");" + NL + "                            globalMap.put(\"";
  protected final String TEXT_411 = "_NB_LINE_INSERTED\",insertedCount_";
  protected final String TEXT_412 = ");" + NL + "                            stmtInsert_";
  protected final String TEXT_413 = ".close();";
  protected final String TEXT_414 = NL + "                                log.info(\"";
  protected final String TEXT_415 = " - INSERT into table : [\" + tableName_";
  protected final String TEXT_416 = " + \"] completed successfully.\");" + NL + "                                log.info(\"";
  protected final String TEXT_417 = " - Number of Rows Inserted : \" + insertedCount_";
  ...
  protected final String TEXT_426 = ".close();" + NL + "                        java.sql.Statement stmtInsert_";
  ...
  protected final String TEXT_430 = " - Starting INSERT into table : [\" + tableName_";
  protected final String TEXT_431 = " + \"].\");";
  protected final String TEXT_432 = "  " + NL + "                        int insertedCount_";
  protected final String TEXT_433 = " = stmtInsert_";
  protected final String TEXT_434 = ".executeUpdate(\"INSERT INTO [\" +  tableName_";
  protected final String TEXT_435 = " + \"] SELECT * FROM [\" + ext_tableName_";
  protected final String TEXT_436 = " + \"]\");" + NL + "                        globalMap.put(\"";
  protected final String TEXT_437 = "_NB_LINE_INSERTED\",insertedCount_";
  protected final String TEXT_438 = ");" + NL + "                        stmtInsert_";
  protected final String TEXT_439 = ".close();";
  protected final String TEXT_440 = NL + "                            log.info(\"";
  protected final String TEXT_441 = " - INSERT into table : [\" + tableName_";
  protected final String TEXT_442 = " + \"] completed successfully.\");" + NL + "                            log.info(\"";
  protected final String TEXT_443 = " - Number of Rows Inserted : \" + insertedCount_";
  protected final String TEXT_444 = " + \".\");";
  protected final String TEXT_445 = NL + "                        java.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_450 = "\");" + NL + "                        int rsTruncCountNumber_";
  protected final String TEXT_451 = " = 0;" + NL + "                        if(rsTruncCount_";
  protected final String TEXT_452 = ".next()) {" + NL + "                            rsTruncCountNumber_";
  protected final String TEXT_453 = " = rsTruncCount_";
  protected final String TEXT_454 = ".getInt(1);" + NL + "                        }" + NL + "                        rsTruncCount_";
  protected final String TEXT_455 = ".close();" + NL + "                        stmtTruncCount_";
  protected final String TEXT_456 = ".close();" + NL + "                        java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_463 = " - Number of Rows Truncated : \" + rsTruncCountNumber_";
  protected final String TEXT_464 = " + \".\");";
  protected final String TEXT_465 = NL + "                        stmtTrunc_";
  protected final String TEXT_466 = ".close();" + NL + "                        " + NL + "                        java.sql.Statement stmtInsert_";
  ...
  protected final String TEXT_470 = " - Starting INSERT into table : [\" + tableName_";
  protected final String TEXT_471 = " + \"].\");";
  protected final String TEXT_472 = "  " + NL + "                        int insertedCount_";
  protected final String TEXT_473 = " = stmtInsert_";
  protected final String TEXT_474 = ".executeUpdate(\"INSERT INTO [\" +  tableName_";
  protected final String TEXT_475 = " + \"] SELECT * FROM [\" + ext_tableName_";
  protected final String TEXT_476 = " + \"]\");" + NL + "                        globalMap.put(\"";
  protected final String TEXT_477 = "_NB_LINE_INSERTED\",insertedCount_";
  protected final String TEXT_478 = ");" + NL + "                        stmtInsert_";
  protected final String TEXT_479 = ".close();";
  protected final String TEXT_480 = NL + "                            log.info(\"";
  protected final String TEXT_481 = " - INSERT into table : [\" + tableName_";
  protected final String TEXT_482 = " + \"] completed successfully.\");" + NL + "                            log.info(\"";
  protected final String TEXT_483 = " - Number of Rows Inserted : \" + insertedCount_";
  protected final String TEXT_484 = " + \".\");";
  protected final String TEXT_485 = NL + "                    java.sql.Statement stmtInsert_";
  ...
  protected final String TEXT_489 = " - Starting INSERT into table : [\" + tableName_";
  protected final String TEXT_490 = " + \"].\");";
  protected final String TEXT_491 = "  " + NL + "                    int insertedCount_";
  protected final String TEXT_492 = " = stmtInsert_";
  protected final String TEXT_493 = ".executeUpdate(\"INSERT INTO [\" +  tableName_";
  protected final String TEXT_494 = " + \"] SELECT * FROM [\" + ext_tableName_";
  protected final String TEXT_495 = " + \"]\");" + NL + "                    globalMap.put(\"";
  protected final String TEXT_496 = "_NB_LINE_INSERTED\",insertedCount_";
  protected final String TEXT_497 = ");" + NL + "                    stmtInsert_";
  protected final String TEXT_498 = ".close();";
  protected final String TEXT_499 = NL + "                        log.info(\"";
  protected final String TEXT_500 = " - INSERT into table : [\" + tableName_";
  protected final String TEXT_501 = " + \"] completed successfully.\");" + NL + "                        log.info(\"";
  protected final String TEXT_502 = " - Number of Rows Inserted : \" + insertedCount_";
  protected final String TEXT_503 = " + \".\");";
  protected final String TEXT_504 = NL + "            } catch (java.sql.SQLException e_";
  protected final String TEXT_505 = ") {";
  protected final String TEXT_506 = NL + "                    log.error(\"";
  protected final String TEXT_507 = " - \" + e_";
  protected final String TEXT_508 = ".getMessage());";
  protected final String TEXT_509 = NL + NL + "                java.sql.Statement stmtDropExtTable_";
  protected final String TEXT_510 = " = conn_";
  protected final String TEXT_511 = ".createStatement();" + NL + "                stmtDropExtTable_";
  protected final String TEXT_512 = ".execute(\"DROP EXTERNAL TABLE [\" + ext_tableName_";
  protected final String TEXT_513 = " + \"]\");" + NL + "                stmtDropExtTable_";
  protected final String TEXT_514 = ".close();";
  protected final String TEXT_515 = NL + "                    log.info(\"";
  protected final String TEXT_516 = " - Dropped External Table : [\" + ext_tableName_";
  protected final String TEXT_517 = " + \"] successfully.\");";
  protected final String TEXT_518 = "  " + NL + "                java.sql.Statement stmtDropExtFileFormat_";
  protected final String TEXT_519 = " = conn_";
  protected final String TEXT_520 = ".createStatement();" + NL + "                stmtDropExtFileFormat_";
  protected final String TEXT_521 = ".execute(\"DROP EXTERNAL FILE FORMAT [\" + azureExtFileFormat_";
  protected final String TEXT_522 = " + \"]\");" + NL + "                stmtDropExtFileFormat_";
  protected final String TEXT_523 = ".close();";
  protected final String TEXT_524 = NL + "                    log.info(\"";
  protected final String TEXT_525 = " - Dropped External File Format : [\" + azureExtFileFormat_";
  protected final String TEXT_526 = " + \"] successfully.\");";
  protected final String TEXT_527 = "  " + NL + "                java.sql.Statement stmtDropExtDataSrc_";
  protected final String TEXT_528 = " = conn_";
  protected final String TEXT_529 = ".createStatement();" + NL + "                stmtDropExtDataSrc_";
  protected final String TEXT_530 = ".execute(\"DROP EXTERNAL DATA SOURCE [\" + azureExtDataSrc_";
  protected final String TEXT_531 = " + \"]\");" + NL + "                stmtDropExtDataSrc_";
  protected final String TEXT_532 = ".close();";
  protected final String TEXT_533 = NL + "                    log.info(\"";
  protected final String TEXT_534 = " - Dropped External Data Source : [\" + azureExtDataSrc_";
  protected final String TEXT_535 = " + \"] successfully.\");";
  protected final String TEXT_536 = NL + "                java.sql.Statement stmtDropDatabaseCred_";
  protected final String TEXT_537 = " = conn_";
  protected final String TEXT_538 = ".createStatement();" + NL + "                stmtDropDatabaseCred_";
  protected final String TEXT_539 = ".execute(\"DROP DATABASE SCOPED CREDENTIAL [\" + azureCredName_";
  protected final String TEXT_540 = " + \"]\");" + NL + "                stmtDropDatabaseCred_";
  protected final String TEXT_541 = ".close();";
  protected final String TEXT_542 = NL + "                    log.info(\"";
  protected final String TEXT_543 = " - Dropped Database Scoped Credential : [\" + azureCredName_";
  protected final String TEXT_544 = " + \"] successfully.\");";
  protected final String TEXT_545 = "   " + NL + "                throw e_";
  protected final String TEXT_546 = ";" + NL + "            }" + NL + "        " + NL + "            java.sql.Statement stmtDropExtTable_";
  protected final String TEXT_547 = " = conn_";
  protected final String TEXT_548 = ".createStatement();" + NL + "            stmtDropExtTable_";
  protected final String TEXT_549 = ".execute(\"DROP EXTERNAL TABLE [\" + ext_tableName_";
  protected final String TEXT_550 = " + \"]\");" + NL + "            stmtDropExtTable_";
  protected final String TEXT_551 = ".close();";
  protected final String TEXT_552 = NL + "                log.info(\"";
  protected final String TEXT_553 = " - Dropped External Table : [\" + ext_tableName_";
  protected final String TEXT_554 = " + \"] successfully.\");";
  protected final String TEXT_555 = "  " + NL + "            java.sql.Statement stmtDropExtFileFormat_";
  protected final String TEXT_556 = " = conn_";
  protected final String TEXT_557 = ".createStatement();" + NL + "            stmtDropExtFileFormat_";
  protected final String TEXT_558 = ".execute(\"DROP EXTERNAL FILE FORMAT [\" + azureExtFileFormat_";
  protected final String TEXT_559 = " + \"]\");" + NL + "            stmtDropExtFileFormat_";
  protected final String TEXT_560 = ".close();";
  protected final String TEXT_561 = NL + "                log.info(\"";
  protected final String TEXT_562 = " - Dropped External File Format : [\" + azureExtFileFormat_";
  protected final String TEXT_563 = " + \"] successfully.\");";
  protected final String TEXT_564 = "  " + NL + "            java.sql.Statement stmtDropExtDataSrc_";
  protected final String TEXT_565 = " = conn_";
  protected final String TEXT_566 = ".createStatement();" + NL + "            stmtDropExtDataSrc_";
  protected final String TEXT_567 = ".execute(\"DROP EXTERNAL DATA SOURCE [\" + azureExtDataSrc_";
  protected final String TEXT_568 = " + \"]\");" + NL + "            stmtDropExtDataSrc_";
  protected final String TEXT_569 = ".close();";
  protected final String TEXT_570 = NL + "                log.info(\"";
  protected final String TEXT_571 = " - Dropped External Data Source : [\" + azureExtDataSrc_";
  protected final String TEXT_572 = " + \"] successfully.\");";
  protected final String TEXT_573 = NL + NL + "            java.sql.Statement stmtDropDatabaseCred_";
  protected final String TEXT_574 = " = conn_";
  protected final String TEXT_575 = ".createStatement();" + NL + "            stmtDropDatabaseCred_";
  protected final String TEXT_576 = ".execute(\"DROP DATABASE SCOPED CREDENTIAL [\" + azureCredName_";
  protected final String TEXT_577 = " + \"]\");" + NL + "            stmtDropDatabaseCred_";
  protected final String TEXT_578 = ".close();";
  protected final String TEXT_579 = NL + "                log.info(\"";
  protected final String TEXT_580 = " - Dropped Database Scoped Credential : [\" + azureCredName_";
  protected final String TEXT_581 = " + \"] successfully.\");";
  protected final String TEXT_582 = NL + "            boolean isShareIdentity_";
  protected final String TEXT_583 = " = globalMap.get(\"shareIdentitySetting_";
  protected final String TEXT_584 = "\") != null && (Boolean)globalMap.get(\"shareIdentitySetting_";
  protected final String TEXT_585 = "\") == true;";
  protected final String TEXT_586 = NL + "        conn_";
  protected final String TEXT_587 = ".close();";
