...
public class TSybaseSPBeginJava
{
  ...
  protected final String TEXT_53 = NL + "\t\tjava.lang.Class.forName(\"sap.jdbc4.sqlanywhere.IDriver\");";
  protected final String TEXT_54 = NL + "\t\tjava.lang.Class.forName(\"com.sybase.jdbc4.jdbc.SybDriver\");" + NL + "\t";
  protected final String TEXT_55 = NL + "\t    java.lang.Class.forName(\"com.sybase.jdbc3.jdbc.SybDriver\");" + NL + "\t";
  protected final String TEXT_56 = NL + "\t\t\tString connectionString_";
  protected final String TEXT_57 = " = \"jdbc:sqlanywhere:Host=\" + ";
  protected final String TEXT_58 = " + \":\" + ";
  protected final String TEXT_59 = " + \";DatabaseName=\" + ";
  protected final String TEXT_60 = "; ";
  protected final String TEXT_61 = NL + "\t\t\tString connectionString_";
  protected final String TEXT_62 = " = \"jdbc:sqlanywhere:Host=\" + ";
  protected final String TEXT_63 = " + \":\" + ";
  protected final String TEXT_64 = " + \";DatabaseName\" + ";
  protected final String TEXT_65 = " + \";\" + ";
  protected final String TEXT_66 = ";";
  protected final String TEXT_67 = NL + "\t\t\t String connectionString_";
  protected final String TEXT_68 = " = \"jdbc:sybase:Tds:\" + ";
  protected final String TEXT_69 = " + \":\" + ";
  protected final String TEXT_70 = " + \"/\" + ";
  protected final String TEXT_71 = ";";
  protected final String TEXT_72 = NL + "\t\t\t String connectionString_";
  protected final String TEXT_73 = " = \"jdbc:sybase:Tds:\" + ";
  ...
  protected final String TEXT_87 = NL + "    java.sql.Connection connection_";
  protected final String TEXT_88 = " = java.sql.DriverManager.getConnection(connectionString_";
  protected final String TEXT_89 = ", ";
  protected final String TEXT_90 = ", decryptedPassword_";
  protected final String TEXT_91 = ");" + NL + "\t";
  protected final String TEXT_92 = NL + NL + "\tString dbschema_";
  protected final String TEXT_93 = "= ";
  protected final String TEXT_94 = "; ";
  protected final String TEXT_95 = NL + "String spName_";
  protected final String TEXT_96 = " = ";
  protected final String TEXT_97 = ";" + NL + "if(dbschema_";
  protected final String TEXT_98 = " != null && dbschema_";
  protected final String TEXT_99 = ".trim().length() != 0) {" + NL + "\tspName_";
  protected final String TEXT_100 = " = dbschema_";
  protected final String TEXT_101 = " + \".\" + spName_";
  protected final String TEXT_102 = ";" + NL + "} ";
  protected final String TEXT_103 = NL + "java.sql.PreparedStatement statement_";
  protected final String TEXT_104 = " = connection_";
  protected final String TEXT_105 = ".prepareStatement(\"select \" + spName_";
  protected final String TEXT_106 = " + \"(";
  protected final String TEXT_107 = NL + "java.sql.CallableStatement statement_";
  protected final String TEXT_108 = " = connection_";
  protected final String TEXT_109 = ".prepareCall(\"{call \" + ";
  ...
  protected final String TEXT_117 = ".setQueryTimeout(";
  protected final String TEXT_118 = ");";
  protected final String TEXT_119 = NL + NL + "java.sql.Date tmpDate_";
  protected final String TEXT_120 = ";" + NL + "String tmpString_";
