...
public class TMSSqlOutputBeginJava {
  ...
  protected final String TEXT_537 = NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_538 = " = null;" + NL + "\t\tString keyPsmt_";
  protected final String TEXT_539 = " = conn_";
  protected final String TEXT_540 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_541 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_542 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_543 = ",insert_";
  protected final String TEXT_544 = ",keyPsmt_";
  ...
  protected final String TEXT_584 = ")\";" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_585 = " = conn_";
  protected final String TEXT_586 = ".prepareStatement(insert_";
  protected final String TEXT_587 = ");";
  protected final String TEXT_588 = NL + "        String delete_";
  protected final String TEXT_589 = " = \"DELETE FROM [\" + tableName_";
  ...
  protected final String TEXT_593 = ".prepareStatement(delete_";
  protected final String TEXT_594 = ");";
  protected final String TEXT_595 = NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_596 = " = conn_";
  protected final String TEXT_597 = ".prepareStatement(\"SELECT COUNT(1) FROM [\" + tableName_";
  ...
  protected final String TEXT_607 = NL + NL + "    class BufferLine_";
  protected final String TEXT_608 = " {";
  protected final String TEXT_609 = NL + "                ";
  protected final String TEXT_610 = " ";
  protected final String TEXT_611 = ";";
  protected final String TEXT_612 = NL + NL + "        public BufferLine_";
  ...
  protected final String TEXT_621 = NL + "        }" + NL + "    }" + NL + "" + NL + "    java.util.List<BufferLine_";
  protected final String TEXT_622 = "> sInsertColValueList";
  protected final String TEXT_623 = " = new java.util.ArrayList();" + NL + "    BufferLine_";
  protected final String TEXT_624 = " sInsertColValue";
  protected final String TEXT_625 = " = null;" + NL + "" + NL + "    StringBuilder extendInsertValueStmt_";
  protected final String TEXT_626 = " = new StringBuilder();" + NL + "    for(int i=0;i < ";
  protected final String TEXT_627 = ";i++){" + NL + "         extendInsertValueStmt_";
  protected final String TEXT_628 = ".append(\"(";
  protected final String TEXT_629 = ")\");" + NL + "         if (i!=";
  protected final String TEXT_630 = "-1) extendInsertValueStmt_";
  protected final String TEXT_631 = ".append(\",\");" + NL + "    }" + NL + "" + NL + "\tString insert_";
  protected final String TEXT_632 = " = \"INSERT INTO \"+";
  protected final String TEXT_633 = "+\" (";
  protected final String TEXT_634 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_635 = ".toString();" + NL + "" + NL + "\tjava.sql.PreparedStatement pstmt_";
