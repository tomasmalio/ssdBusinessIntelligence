...
public class TSocketOutputMainJava
{
  ...
  protected final String TEXT_7 = NL + "\t\t\t     CsvWriter";
  protected final String TEXT_8 = ".setEscapeChar('\\\\');" + NL + "\t\t\t";
  protected final String TEXT_9 = NL + "\t\t\t\t CsvWriter";
  protected final String TEXT_10 = ".setEscapeChar('";
  protected final String TEXT_11 = "');" + NL + "\t\t\t";
  protected final String TEXT_12 = NL + "        \tCsvWriter";
  protected final String TEXT_13 = ".setQuoteChar('";
  protected final String TEXT_14 = "'); " + NL + "        \tCsvWriter";
  protected final String TEXT_15 = ".setQuoteStatus(com.talend.csv.CSVWriter.QuoteStatus.FORCE);";
  protected final String TEXT_16 = NL + "        \tCsvWriter";
  protected final String TEXT_17 = ".setQuoteStatus(com.talend.csv.CSVWriter.QuoteStatus.NO);";
