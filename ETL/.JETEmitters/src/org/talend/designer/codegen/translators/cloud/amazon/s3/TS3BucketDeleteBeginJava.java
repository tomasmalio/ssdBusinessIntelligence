...
public class TS3BucketDeleteBeginJava
{
  ...
  protected final String TEXT_184 = " - Deleting a bucket with name:\" + ";
  protected final String TEXT_185 = ");" + NL + "\t\t";
  protected final String TEXT_186 = NL + "\t\tconn_";
  protected final String TEXT_187 = ".deleteBucket(";
  protected final String TEXT_188 = ");" + NL + "\t\t";
  protected final String TEXT_189 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_190 = " - Delete the bucket successfully.\");" + NL + "\t\t";
  protected final String TEXT_191 = NL + "\t}catch(java.lang.Exception e_";
