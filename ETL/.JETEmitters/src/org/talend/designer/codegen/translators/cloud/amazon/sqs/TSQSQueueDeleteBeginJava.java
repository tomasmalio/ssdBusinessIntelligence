...
public class TSQSQueueDeleteBeginJava
{
  ...
  protected final String TEXT_78 = " - Deleting a queue with name:\" + ";
  protected final String TEXT_79 = ");" + NL + "\t\t";
  protected final String TEXT_80 = NL + "        conn_";
  protected final String TEXT_81 = ".deleteQueue(new com.amazonaws.services.sqs.model.DeleteQueueRequest(";
  protected final String TEXT_82 = "));" + NL + "        " + NL + "\t\t";
  protected final String TEXT_83 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_84 = " - Delete the queue successfully.\");" + NL + "\t\t";
