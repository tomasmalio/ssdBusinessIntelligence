...
public class TGSBucketListBeginJava
{
  ...
  protected final String TEXT_32 = NL + "\t\tbuckets_";
  protected final String TEXT_33 = "=service_";
  protected final String TEXT_34 = ".listAllBuckets();" + NL + "\t";
  protected final String TEXT_35 = NL + "\tfor (org.jets3t.service.model.GSBucket bucket_";
  protected final String TEXT_36 = " : buckets_";
  protected final String TEXT_37 = ") {" + NL + "\t\tnb_bucket_";
  protected final String TEXT_38 = "++;" + NL + "\t\tString currentBucketName_";
  protected final String TEXT_39 = " = bucket_";
  protected final String TEXT_40 = ".getName();" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_41 = "_CURRENT_BUCKET_NAME\", currentBucketName_";
