...
public class TFTPFileExistBeginJava
{
  ...
  protected final String TEXT_148 = " {" + NL + "" + NL + "\t\tprivate javax.net.ssl.TrustManager[] getTrustManagers() " + NL + "\t\tthrows java.security.KeyStoreException, java.security.NoSuchAlgorithmException, " + NL + "\t\t\tjava.security.cert.CertificateException, java.security.UnrecoverableKeyException," + NL + "\t\t\tjava.io.IOException {" + NL + "\t\t\tjava.security.KeyStore ks = java.security.KeyStore.getInstance(\"JKS\");" + NL;
  protected final String TEXT_149 = " " + NL + "\t\t\t\tString decryptedKeyStorePassword_";
  protected final String TEXT_150 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_151 = ");";
  protected final String TEXT_152 = NL + "\t\t\t\tString decryptedKeyStorePassword_";
  protected final String TEXT_153 = " = ";
  protected final String TEXT_154 = "; ";
  protected final String TEXT_155 = NL + "\t\t\tks.load(new java.io.FileInputStream(";
  protected final String TEXT_156 = "), decryptedKeyStorePassword_";
  protected final String TEXT_157 = ".toCharArray());" + NL + "\t\t\tjavax.net.ssl.TrustManagerFactory tmf = javax.net.ssl.TrustManagerFactory.getInstance(javax.net.ssl.KeyManagerFactory.getDefaultAlgorithm());" + NL + "\t\t\ttmf.init(ks);" + NL + "\t\t\treturn tmf.getTrustManagers();" + NL + "\t\t}" + NL + "\t}" + NL + "\t" + NL + "\t\tclass SSLSessionReuseFTPSClient_";
  protected final String TEXT_158 = " extends org.apache.commons.net.ftp.FTPSClient {" + NL + "" + NL + "\t\tpublic SSLSessionReuseFTPSClient_";
  protected final String TEXT_159 = "(boolean isImplicit, javax.net.ssl.SSLContext context) {" + NL + "\t\t\tsuper(isImplicit, context);" + NL + "\t\t}" + NL + "" + NL + "\t\t// changed to support TLS session resumption" + NL + "\t\t@Override" + NL + "\t\tprotected void _prepareDataSocket_(final java.net.Socket socket) throws IOException {" + NL + "\t\t\tif(socket instanceof javax.net.ssl.SSLSocket) {" + NL + "\t\t\t\tfinal javax.net.ssl.SSLSession session = ((javax.net.ssl.SSLSocket) _socket_).getSession();" + NL + "\t\t\t\tfinal javax.net.ssl.SSLSessionContext context = session.getSessionContext();" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tfinal java.lang.reflect.Field sessionHostPortCache = context.getClass().getDeclaredField(\"sessionHostPortCache\");" + NL + "\t\t\t\t\tsessionHostPortCache.setAccessible(true);" + NL + "\t\t\t\t\tfinal Object cache = sessionHostPortCache.get(context);" + NL + "\t\t\t\t\tfinal java.lang.reflect.Method putMethod = cache.getClass().getDeclaredMethod(\"put\", Object.class, Object.class);" + NL + "\t\t\t\t\tputMethod.setAccessible(true);" + NL + "\t\t\t\t\tfinal java.lang.reflect.Method getHostMethod = socket.getClass().getDeclaredMethod(\"getHost\");" + NL + "\t\t\t\t\tgetHostMethod.setAccessible(true);" + NL + "\t\t\t\t\tObject host = getHostMethod.invoke(socket);" + NL + "\t\t\t\t\tfinal String key = String.format(\"%s:%s\", host, String.valueOf(socket.getPort())).toLowerCase(java.util.Locale.ROOT);" + NL + "\t\t\t\t\tputMethod.invoke(cache, key, session);" + NL + "\t\t\t\t} catch(Exception e) {";
  protected final String TEXT_160 = NL + "\t\t\t\t\t\tlog.error(\"Can't adapt ftps client to support TLS session resumption\");";
  protected final String TEXT_161 = NL + "\t\t\t\t\tthrow new RuntimeException(e);" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t}" + NL + "\t\tjavax.net.ssl.SSLContext sslContext_";
  protected final String TEXT_162 = " = null;" + NL + "\t\tjavax.net.ssl.TrustManager[] trustManager_";
  protected final String TEXT_163 = " = null;" + NL + "\t\tjavax.net.ssl.SSLSocketFactory sslSocketFactory_";
  protected final String TEXT_164 = " = null;" + NL + "\t\torg.apache.commons.net.ftp.FTPSClient ftp_";
  protected final String TEXT_165 = " =null;" + NL + "\t\tMyTrust_";
  protected final String TEXT_166 = " myTrust_";
  protected final String TEXT_167 = " = null;" + NL + "" + NL + "\t\ttry {" + NL + "\t\t\tsslContext_";
  protected final String TEXT_168 = " = javax.net.ssl.SSLContext.getInstance(\"SSL\");" + NL + "\t\t\tmyTrust_";
  protected final String TEXT_169 = " = new MyTrust_";
  protected final String TEXT_170 = "();" + NL + "\t\t\ttrustManager_";
  protected final String TEXT_171 = " = myTrust_";
  protected final String TEXT_172 = ".getTrustManagers();" + NL + "\t\t\tsslContext_";
  protected final String TEXT_173 = ".init(null, trustManager_";
  protected final String TEXT_174 = ", new java.security.SecureRandom());" + NL + "\t\t\tsslSocketFactory_";
  protected final String TEXT_175 = " = sslContext_";
  protected final String TEXT_176 = ".getSocketFactory();" + NL + "\t\t\tftp_";
  protected final String TEXT_177 = " = new SSLSessionReuseFTPSClient_";
  protected final String TEXT_178 = "(";
  protected final String TEXT_179 = ", sslContext_";
  protected final String TEXT_180 = ");" + NL + "\t\t\tftp_";
  protected final String TEXT_181 = ".setControlEncoding(";
  protected final String TEXT_182 = ");" + NL + "" + NL + "\t\t\t";
  protected final String TEXT_183 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_184 = " -FTPS security Mode is ";
  protected final String TEXT_185 = ".\");" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_186 = " - Attempt to connect to '\" + ";
  protected final String TEXT_187 = " + \"' with username '\" + ";
  protected final String TEXT_188 = "+ \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_189 = NL + "\t\t\tftp_";
  protected final String TEXT_190 = ".connect(";
  protected final String TEXT_191 = ",";
  protected final String TEXT_192 = ");" + NL + "\t\t\t";
  protected final String TEXT_193 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_194 = " - Connect to '\" + ";
  ...
  protected final String TEXT_203 = NL + NL + "\t\t\t\tboolean isLoginSuccessful_";
  protected final String TEXT_204 = " = ftp_";
  protected final String TEXT_205 = ".login(";
  protected final String TEXT_206 = ", decryptedPassword_";
  protected final String TEXT_207 = ");" + NL + "" + NL + "\t\t\t\tif (!isLoginSuccessful_";
  protected final String TEXT_208 = ") {" + NL + "\t\t\t\t\tthrow new RuntimeException(\"Login failed\");" + NL + "\t\t\t\t}" + NL + "" + NL + "\t\t\t\tftp_";
  protected final String TEXT_209 = ".execPROT(";
  protected final String TEXT_210 = ");" + NL + "\t\t\t\tftp_";
  protected final String TEXT_211 = ".execPBSZ(";
  protected final String TEXT_212 = ");" + NL + "\t\t} catch (Exception e) {" + NL + "\t\t\t";
  protected final String TEXT_213 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_214 = " - Can't create connection: \" + e.getMessage());" + NL + "\t\t\t";
  protected final String TEXT_215 = NL + "\t\t\tthrow e;" + NL + "\t\t}";
  protected final String TEXT_216 = NL + "\t\t\tftp_";
  protected final String TEXT_217 = ".enterLocalPassiveMode();";
  protected final String TEXT_218 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_219 = " - Using the passive mode.\");";
  protected final String TEXT_220 = NL + "\t\torg.apache.commons.net.ftp.FTPSClient ftp_";
  protected final String TEXT_221 = " = (org.apache.commons.net.ftp.FTPSClient) globalMap.get(\"";
  protected final String TEXT_222 = "\");";
  protected final String TEXT_223 = NL + "\tcom.enterprisedt.net.ftp.FTPClient ftp_";
  protected final String TEXT_224 = " = null;" + NL + "" + NL + "\t";
  protected final String TEXT_225 = NL + "\t\tftp_";
  protected final String TEXT_226 = " = (com.enterprisedt.net.ftp.FTPClient)globalMap.get(\"";
  protected final String TEXT_227 = "\");" + NL + "\t\t";
  protected final String TEXT_228 = NL + "\t\t\tif(ftp_";
  protected final String TEXT_229 = "!=null) {" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_230 = " - Use an existing connection. Connection hostname: \" + ftp_";
  protected final String TEXT_231 = ".getRemoteHost() + \", Connection port: \" + ftp_";
  protected final String TEXT_232 = ".getRemotePort() + \".\"); " + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_233 = NL + "  \t";
  protected final String TEXT_234 = "    " + NL + "\t   \tftp_";
  protected final String TEXT_235 = " = new com.enterprisedt.net.ftp.FTPClient();" + NL + "\t   \tftp_";
  protected final String TEXT_236 = ".setRemoteHost(";
  protected final String TEXT_237 = ");" + NL + "\t   \tftp_";
  protected final String TEXT_238 = ".setRemotePort(";
  ...
  protected final String TEXT_245 = ".setConnectMode(com.enterprisedt.net.ftp.FTPConnectMode.ACTIVE);" + NL + "\t    ";
  protected final String TEXT_246 = NL + "\t      ftp_";
  protected final String TEXT_247 = ".setConnectMode(com.enterprisedt.net.ftp.FTPConnectMode.PASV);" + NL + "\t    ";
  ...
  protected final String TEXT_252 = " - Attempt to connect to '\" + ";
  protected final String TEXT_253 = " + \"' with username: '\" +";
  protected final String TEXT_254 = "+ \"'.\");" + NL + "\t\t";
  protected final String TEXT_255 = NL + "\t    ftp_";
  protected final String TEXT_256 = ".connect();  " + NL + "\t    " + NL + "\t\t";
  ...
  protected final String TEXT_264 = NL + NL + "\t    ftp_";
  protected final String TEXT_265 = ".login(";
  protected final String TEXT_266 = ", decryptedPassword_";
  protected final String TEXT_267 = ");" + NL + "\t\t";
  protected final String TEXT_268 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_269 = " - Connect to '\" + ";
