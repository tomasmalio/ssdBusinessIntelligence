...
public class TSybaseOutputMainJava {
  ...
  protected final String TEXT_567 = ".createStatement();" + NL + "        stmt_";
  protected final String TEXT_568 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_569 = " +\" ON\");";
  ...
  protected final String TEXT_670 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_671 = " = updatedCount_";
  protected final String TEXT_672 = " + pstmt_";
  protected final String TEXT_673 = ".executeUpdate();";
  protected final String TEXT_674 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_689 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_690 = NL + "                        ";
  protected final String TEXT_691 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_692 = ";";
  protected final String TEXT_693 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_740 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_741 = " = updatedCount_";
  protected final String TEXT_742 = " + pstmtUpdate_";
  protected final String TEXT_743 = ".executeUpdate();" + NL + "                    nb_line_";
  ...
  protected final String TEXT_748 = NL + "                        nb_line_";
  ...
  protected final String TEXT_762 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_763 = NL + "                            ";
  protected final String TEXT_764 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_765 = ";";
  protected final String TEXT_766 = NL + "                            System.err.print(e.getMessage());";
  ...
  protected final String TEXT_815 = NL + "            int updateFlag_";
  protected final String TEXT_816 = " = 0;";
  protected final String TEXT_817 = NL + "                    ";
  protected final String TEXT_818 = NL + "                        query_";
  protected final String TEXT_819 = " = ";
  protected final String TEXT_820 = ";";
  protected final String TEXT_821 = NL + "                        routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_822 = ",";
  protected final String TEXT_823 = ".";
  protected final String TEXT_824 = ", ";
  protected final String TEXT_825 = ",updateSQLSplits_";
  protected final String TEXT_826 = ");";
  protected final String TEXT_827 = NL + NL + "                    int count_";
  protected final String TEXT_828 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_829 = ".";
  protected final String TEXT_830 = ", pstmtUpdate_";
  ...
  protected final String TEXT_849 = NL + "                globalMap.put(\"";
  protected final String TEXT_850 = "_QUERY\", query_";
  protected final String TEXT_851 = ".toString().trim());";
  protected final String TEXT_852 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_853 = "=pstmtUpdate_";
  protected final String TEXT_854 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_855 = " = updatedCount_";
  protected final String TEXT_856 = "+updateFlag_";
  protected final String TEXT_857 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_858 = " == 0) {";
  protected final String TEXT_859 = NL + "                query_";
  protected final String TEXT_860 = " = new StringBuffer(\"\");";
  protected final String TEXT_861 = NL + "                        ";
  protected final String TEXT_862 = NL + "                            query_";
  protected final String TEXT_863 = " = ";
  protected final String TEXT_864 = ";";
  protected final String TEXT_865 = NL + "                            routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_866 = ",";
  protected final String TEXT_867 = ".";
  protected final String TEXT_868 = ", ";
  protected final String TEXT_869 = ",insertSQLSplits_";
  ...
  protected final String TEXT_885 = NL + "                }else{" + NL + "                    nb_line_";
  protected final String TEXT_886 = "++;";
  protected final String TEXT_887 = NL + "                }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_924 = NL + "                    batchSizeCounter_";
  protected final String TEXT_925 = "++;";
  protected final String TEXT_926 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_927 = " = deletedCount_";
  protected final String TEXT_928 = " + pstmt_";
  protected final String TEXT_929 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_930 = "++;";
  protected final String TEXT_931 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_932 = " = true;";
  protected final String TEXT_933 = NL + "                    throw(e);";
  protected final String TEXT_934 = NL + "                    nb_line_";
  ...
  protected final String TEXT_946 = " + 1;";
  protected final String TEXT_947 = NL + "                        ";
  protected final String TEXT_948 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_949 = NL + "                        ";
  protected final String TEXT_950 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_951 = ";";
  protected final String TEXT_952 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_987 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_988 = NL + "                        throw(e);";
  protected final String TEXT_989 = NL + "                    int countSum_";
  protected final String TEXT_990 = " = 0;" + NL + "                    for(int countEach_";
  protected final String TEXT_991 = ": e.getUpdateCounts()) {" + NL + "                        countSum_";
  protected final String TEXT_992 = " += (countEach_";
  protected final String TEXT_993 = " < 0 ? 0 : countEach_";
  protected final String TEXT_994 = ");" + NL + "                    }";
  protected final String TEXT_995 = NL + "                        insertedCount_";
  ...
  protected final String TEXT_1006 = NL + "                commitCounter_";
  protected final String TEXT_1007 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_1008 = " <= commitCounter_";
  protected final String TEXT_1009 = ") {";
  protected final String TEXT_1010 = NL + "                try {" + NL + "                        if ( batchSizeCounter_";
  protected final String TEXT_1011 = " > 0 ) {" + NL + "                        int countSum_";
  ...
  protected final String TEXT_1015 = ".executeBatch()) {" + NL + "                            countSum_";
  ...
  protected final String TEXT_1029 = " = 0;" + NL + "                        }" + NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_1030 = NL + "                        throw(e);";
  protected final String TEXT_1031 = NL + "                        int countSum_";
  ...
  protected final String TEXT_1046 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_1047 = NL + "                }";
  protected final String TEXT_1048 = NL + "                    conn_";
  protected final String TEXT_1049 = ".commit();";
