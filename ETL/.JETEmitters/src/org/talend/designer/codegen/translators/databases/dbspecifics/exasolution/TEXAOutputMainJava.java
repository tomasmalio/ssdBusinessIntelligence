...
public class TEXAOutputMainJava {
  ...
  protected final String TEXT_598 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_599 = "++;" + NL + "                insertedCount_";
  protected final String TEXT_600 = " = insertedCount_";
  protected final String TEXT_601 = " + pstmt_";
  protected final String TEXT_602 = ".executeUpdate();";
  protected final String TEXT_603 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_618 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_619 = NL + "                        ";
  protected final String TEXT_620 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_621 = ";";
  protected final String TEXT_622 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_628 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_629 = ",";
  protected final String TEXT_630 = ".";
  protected final String TEXT_631 = ", ";
  protected final String TEXT_632 = ",updateSQLSplits_";
  protected final String TEXT_633 = ");";
  protected final String TEXT_634 = NL + "                    int count_";
  protected final String TEXT_635 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_665 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_666 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_667 = " = updatedCount_";
  protected final String TEXT_668 = " + pstmt_";
  protected final String TEXT_669 = ".executeUpdate();";
  protected final String TEXT_670 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_693 = NL + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_694 = " = pstmt_";
  protected final String TEXT_695 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_696 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_697 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_698 = " = rs_";
  protected final String TEXT_699 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  ...
  protected final String TEXT_709 = ",updateSQLSplits_";
  ...
  protected final String TEXT_736 = NL + "                try {" + NL + "                    updatedCount_";
  ...
  protected final String TEXT_762 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_763 = NL + "                }" + NL + "            } else {";
  ...
  protected final String TEXT_809 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_810 = NL + "                }" + NL + "            }";
  protected final String TEXT_811 = NL + "            int updateFlag_";
  protected final String TEXT_812 = "=0;";
  ...
  protected final String TEXT_846 = NL + "                globalMap.put(\"";
  protected final String TEXT_847 = "_QUERY\", query_";
  protected final String TEXT_848 = ".toString().trim());";
  ...
  protected final String TEXT_857 = " = new StringBuffer(\"\");";
  protected final String TEXT_858 = NL + "                        ";
  protected final String TEXT_859 = NL + "                            query_";
  protected final String TEXT_860 = " = ";
  protected final String TEXT_861 = ";";
  protected final String TEXT_862 = NL + "                            routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_863 = ",";
  protected final String TEXT_864 = ".";
  protected final String TEXT_865 = ", ";
  protected final String TEXT_866 = ",insertSQLSplits_";
  protected final String TEXT_867 = ");";
  protected final String TEXT_868 = NL + "                        DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_869 = ".";
  protected final String TEXT_870 = ", pstmtInsert_";
  ...
  protected final String TEXT_880 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_881 = "++;";
  protected final String TEXT_882 = NL + "                    }else{" + NL + "                        nb_line_";
  protected final String TEXT_883 = "++;";
  protected final String TEXT_884 = NL + "                    }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_905 = NL + "                            System.err.print(e.getMessage());";
  ...
  protected final String TEXT_919 = ".addBatch();" + NL + "            nb_line_";
  protected final String TEXT_920 = "++;";
  protected final String TEXT_921 = NL + "              batchSizeCounter_";
  protected final String TEXT_922 = "++;";
  protected final String TEXT_923 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_924 = " = deletedCount_";
  protected final String TEXT_925 = " + pstmt_";
  protected final String TEXT_926 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_927 = "++;";
  protected final String TEXT_928 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_945 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_946 = NL + "                        ";
  protected final String TEXT_947 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_948 = ";";
  protected final String TEXT_949 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_950 = NL + "            }";
  protected final String TEXT_951 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_962 = NL + "                if ((batchSize_";
  protected final String TEXT_963 = " > 0) && (batchSize_";
  protected final String TEXT_964 = " <= batchSizeCounter_";
  protected final String TEXT_965 = ")) {" + NL + "                try {" + NL + "                        int countSum_";
  protected final String TEXT_966 = " = 0;";
  protected final String TEXT_967 = NL + "                        for(int countEach_";
  protected final String TEXT_968 = ": pstmt_";
  protected final String TEXT_969 = ".executeBatch()) {" + NL + "                            countSum_";
  ...
  protected final String TEXT_983 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_984 = "){" + NL + "\t\t\t    \tjava.sql.SQLException ne_";
  protected final String TEXT_985 = " = e_";
  protected final String TEXT_986 = ".getNextException(),sqle_";
  protected final String TEXT_987 = "=null;" + NL + "\t\t\t    \tString errormessage_";
  protected final String TEXT_988 = ";" + NL + "\t\t\t\t\tif (ne_";
  protected final String TEXT_989 = " != null) {" + NL + "\t\t\t\t\t\t// build new exception to provide the original cause" + NL + "\t\t\t\t\t\tsqle_";
  protected final String TEXT_990 = " = new java.sql.SQLException(e_";
  protected final String TEXT_991 = ".getMessage() + \"\\ncaused by: \" + ne_";
  protected final String TEXT_992 = ".getMessage(), ne_";
  protected final String TEXT_993 = ".getSQLState(), ne_";
  protected final String TEXT_994 = ".getErrorCode(), ne_";
  protected final String TEXT_995 = ");" + NL + "\t\t\t\t\t\terrormessage_";
  protected final String TEXT_996 = " = sqle_";
  protected final String TEXT_997 = ".getMessage();" + NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\terrormessage_";
  protected final String TEXT_998 = " = e_";
  protected final String TEXT_999 = ".getMessage();" + NL + "\t\t\t\t\t}";
  protected final String TEXT_1000 = NL + "\t\t\t    \t\tif (ne_";
  protected final String TEXT_1001 = " != null) {" + NL + "\t\t\t    \t\t\tthrow(sqle_";
  protected final String TEXT_1002 = ");" + NL + "\t\t\t    \t\t}else{" + NL + "\t\t\t            \tthrow(e_";
  protected final String TEXT_1003 = ");" + NL + "\t\t\t            }";
  protected final String TEXT_1004 = NL + "                        int countSum_";
  protected final String TEXT_1005 = " = 0;" + NL + "                        for(int countEach_";
  protected final String TEXT_1006 = ": e_";
  protected final String TEXT_1007 = ".getUpdateCounts()) {" + NL + "                            countSum_";
  ...
  protected final String TEXT_1020 = NL + "                        System.err.println(errormessage_";
  protected final String TEXT_1021 = ");";
  protected final String TEXT_1022 = NL + "                }" + NL + "                }";
  protected final String TEXT_1023 = NL + "                commitCounter_";
  protected final String TEXT_1024 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_1025 = " <= commitCounter_";
  protected final String TEXT_1026 = ") {";
  protected final String TEXT_1027 = NL + "                if ((batchSize_";
  protected final String TEXT_1028 = " > 0) && (batchSizeCounter_";
  protected final String TEXT_1029 = " > 0)) {" + NL + "                try {" + NL + "                        int countSum_";
  protected final String TEXT_1030 = " = 0;";
  ...
  protected final String TEXT_1047 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_1048 = "){" + NL + "\t\t\t    \tjava.sql.SQLException ne_";
  protected final String TEXT_1049 = " = e_";
  protected final String TEXT_1050 = ".getNextException(),sqle_";
  protected final String TEXT_1051 = "=null;" + NL + "\t\t\t    \tString errormessage_";
  protected final String TEXT_1052 = ";" + NL + "\t\t\t\t\tif (ne_";
  protected final String TEXT_1053 = " != null) {" + NL + "\t\t\t\t\t\t// build new exception to provide the original cause" + NL + "\t\t\t\t\t\tsqle_";
  protected final String TEXT_1054 = " = new java.sql.SQLException(e_";
  protected final String TEXT_1055 = ".getMessage() + \"\\ncaused by: \" + ne_";
  protected final String TEXT_1056 = ".getMessage(), ne_";
  protected final String TEXT_1057 = ".getSQLState(), ne_";
  protected final String TEXT_1058 = ".getErrorCode(), ne_";
  protected final String TEXT_1059 = ");" + NL + "\t\t\t\t\t\terrormessage_";
  protected final String TEXT_1060 = " = sqle_";
  protected final String TEXT_1061 = ".getMessage();" + NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\terrormessage_";
  protected final String TEXT_1062 = " = e_";
  protected final String TEXT_1063 = ".getMessage();" + NL + "\t\t\t\t\t}";
  protected final String TEXT_1064 = NL + "\t\t\t    \t\tif (ne_";
  protected final String TEXT_1065 = " != null) {" + NL + "\t\t\t    \t\t\tthrow(sqle_";
  protected final String TEXT_1066 = ");" + NL + "\t\t\t    \t\t}else{" + NL + "\t\t\t            \tthrow(e_";
  ...
  protected final String TEXT_1071 = ".getUpdateCounts()) {" + NL + "                            countSum_";
  ...
  protected final String TEXT_1075 = NL + "                            insertedCount_";
  protected final String TEXT_1076 = " += countSum_";
  protected final String TEXT_1077 = ";";
  protected final String TEXT_1078 = NL + "                            updatedCount_";
  protected final String TEXT_1079 = " += countSum_";
  protected final String TEXT_1080 = ";";
  protected final String TEXT_1081 = NL + "                            deletedCount_";
  protected final String TEXT_1082 = " += countSum_";
  protected final String TEXT_1083 = ";";
  protected final String TEXT_1084 = NL + "                        System.err.println(errormessage_";
  protected final String TEXT_1085 = ");";
  protected final String TEXT_1086 = NL + "                }" + NL + "            }";
  protected final String TEXT_1087 = NL + "                    conn_";
  protected final String TEXT_1088 = ".commit();";
  protected final String TEXT_1089 = NL + "                    commitCounter_";
  protected final String TEXT_1090 = "=0;" + NL + "                }";
