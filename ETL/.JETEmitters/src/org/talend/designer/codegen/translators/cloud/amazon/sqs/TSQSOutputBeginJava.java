...
public class TSQSOutputBeginJava
{
  ...
  protected final String TEXT_76 = NL + "\t" + NL + "\t" + NL + "\tint nbline_";
  ...
  protected final String TEXT_80 = NL + "\t\tjava.util.List<com.amazonaws.services.sqs.model.SendMessageBatchRequestEntry> entries_";
  protected final String TEXT_81 = " = new java.util.ArrayList<>();" + NL + "\t\tjava.util.List<com.amazonaws.services.sqs.model.BatchResultErrorEntry> resultErrorEntries_";
  protected final String TEXT_82 = " = null;" + NL + "\t\tjava.util.List<com.amazonaws.services.sqs.model.SendMessageBatchResultEntry> resultSuccessEntries_";
  protected final String TEXT_83 = " = null;" + NL + "\t";
  protected final String TEXT_84 = NL + "\tcom.amazonaws.services.sqs.model.";
  protected final String TEXT_85 = " sendMsgRequest_";
  protected final String TEXT_86 = " = null;" + NL + "\ttry{" + NL + "\t\t";
  protected final String TEXT_87 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_88 = " - Sending messages to :\" + ";
