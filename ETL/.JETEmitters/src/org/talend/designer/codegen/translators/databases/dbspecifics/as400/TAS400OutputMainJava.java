...
public class TAS400OutputMainJava {
  ...
  protected final String TEXT_426 = ", java.sql.Statement.RETURN_GENERATED_KEYS);" + NL + "\t    ";
  ...
  protected final String TEXT_531 = " = \"DELETE FROM \" + ";
  ...
  protected final String TEXT_560 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_561 = " = insertIgnore_";
  protected final String TEXT_562 = ".split(\"\\\\?\");";
  protected final String TEXT_563 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_564 = " = insert_";
  protected final String TEXT_565 = ".split(\"\\\\?\");";
  protected final String TEXT_566 = NL + "\t}";
  protected final String TEXT_567 = NL + "\t\t\t\t\tcommitEvery_";
  protected final String TEXT_568 = " = buffersSize_";
  protected final String TEXT_569 = ";";
  protected final String TEXT_570 = NL + "\t\t\t\t\tbatchSize_";
  protected final String TEXT_571 = " = buffersSize_";
  ...
  protected final String TEXT_598 = NL + "    \t\t  \tbatchSizeCounter_";
  protected final String TEXT_599 = "++;" + NL + "    \t\t";
  protected final String TEXT_600 = NL + "            try {" + NL + "                nb_line_";
  ...
  protected final String TEXT_604 = ".executeUpdate();";
  protected final String TEXT_605 = NL + "            } catch(java.sql.SQLException e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_624 = NL + "                         System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  ...
  protected final String TEXT_675 = NL + "            } catch(java.sql.SQLException e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_694 = NL + "                         System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  protected final String TEXT_695 = NL + "            }";
  protected final String TEXT_696 = NL + "                    \t";
  protected final String TEXT_697 = NL + "                    ";
  protected final String TEXT_698 = NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_699 = " = pstmt_";
  protected final String TEXT_700 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_701 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_702 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_703 = " = rs_";
  protected final String TEXT_704 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  protected final String TEXT_705 = " > 0) {" + NL + "    \t\t\ttry {" + NL + "    \t\t\t";
  ...
  protected final String TEXT_744 = NL + "        \t\t\tupdatedCount_";
  protected final String TEXT_745 = " = updatedCount_";
  protected final String TEXT_746 = " + pstmtUpdate_";
  protected final String TEXT_747 = ".executeUpdate();" + NL + "        \t\t\tnb_line_";
  protected final String TEXT_748 = "++;" + NL + "        \t\t\t";
  protected final String TEXT_749 = NL + "                } catch(java.sql.SQLException e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_770 = NL + "                             System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  protected final String TEXT_771 = NL + "                }" + NL + "    \t\t} else {" + NL + "    \t\t\ttry {" + NL + "    \t\t\t";
  protected final String TEXT_772 = NL + "                        ";
  protected final String TEXT_773 = NL + "                            query_";
  protected final String TEXT_774 = " = ";
  protected final String TEXT_775 = ";";
  protected final String TEXT_776 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_777 = ",";
  protected final String TEXT_778 = ".";
  protected final String TEXT_779 = ", ";
  protected final String TEXT_780 = ",insertSQLSplits_";
  ...
  protected final String TEXT_791 = NL + "                    insertedCount_";
  protected final String TEXT_792 = " = insertedCount_";
  protected final String TEXT_793 = " + pstmtInsert_";
  protected final String TEXT_794 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_795 = "++;";
  protected final String TEXT_796 = NL + "                } catch(java.sql.SQLException e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_817 = NL + "                             System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  protected final String TEXT_818 = NL + "                }" + NL + "    \t\t}" + NL + "" + NL + "    \t\t";
  protected final String TEXT_819 = NL + "    \t    int updateFlag_";
  protected final String TEXT_820 = "=0;" + NL + "            try {" + NL + "    \t    ";
  protected final String TEXT_821 = NL + "                    ";
  protected final String TEXT_822 = NL + "                        query_";
  protected final String TEXT_823 = " = ";
  protected final String TEXT_824 = ";";
  protected final String TEXT_825 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_826 = ",";
  protected final String TEXT_827 = ".";
  protected final String TEXT_828 = ", ";
  protected final String TEXT_829 = ",updateSQLSplits_";
  protected final String TEXT_830 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_831 = NL + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_832 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_859 = NL + "                updateFlag_";
  ...
  protected final String TEXT_864 = ";" + NL + "" + NL + "            if(updateFlag_";
  protected final String TEXT_865 = " == 0) {" + NL + "" + NL + "\t\t\t\t";
  protected final String TEXT_866 = NL + "\t\t\t\tquery_";
  protected final String TEXT_867 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_894 = NL + "    \t\t\t}" + NL + "                } catch(java.sql.SQLException e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_915 = NL + "                             System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  ...
  protected final String TEXT_930 = NL + "    \t\tpstmt_";
  protected final String TEXT_931 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_932 = "++;" + NL + "\t\t\t";
  protected final String TEXT_933 = NL + "   \t\t\tbatchSizeCounter_";
  protected final String TEXT_934 = "++;" + NL + "   \t\t   ";
  protected final String TEXT_935 = NL + "            try {" + NL + "                deletedCount_";
  ...
  protected final String TEXT_940 = NL + "            } catch(java.sql.SQLException e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_961 = NL + "                         System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  protected final String TEXT_962 = NL + "            }" + NL + "    \t";
  protected final String TEXT_963 = NL + "            if(!whetherReject_";
  protected final String TEXT_964 = ") {";
  protected final String TEXT_965 = NL + "                            ";
  protected final String TEXT_966 = " = new ";
  protected final String TEXT_967 = "Struct();";
  ...
  protected final String TEXT_974 = NL + "    \t\t\tif ((batchSize_";
  protected final String TEXT_975 = " > 0) && (batchSize_";
  protected final String TEXT_976 = " <= batchSizeCounter_";
  protected final String TEXT_977 = ")) {" + NL + "    \t\t\t    try {" + NL + "    \t\t\t    \t";
  protected final String TEXT_978 = NL + "                            pstmt_";
  protected final String TEXT_979 = ".executeBatch();";
  protected final String TEXT_980 = NL + "                            int countSum_";
  protected final String TEXT_981 = " = 0;" + NL + "                            for(int countEach_";
  protected final String TEXT_982 = ": pstmt_";
  protected final String TEXT_983 = ".executeBatch()) {" + NL + "                                countSum_";
  ...
  protected final String TEXT_993 = NL + "                    }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_994 = "){";
  protected final String TEXT_995 = NL + "                            throw(e_";
  protected final String TEXT_996 = ");";
  protected final String TEXT_997 = NL + "                                int countSum_";
  protected final String TEXT_998 = " = 0;" + NL + "                                for(int countEach_";
  protected final String TEXT_999 = ": e_";
  protected final String TEXT_1000 = ".getUpdateCounts()) {" + NL + "                                    countSum_";
  ...
  protected final String TEXT_1005 = " += countSum_";
  ...
  protected final String TEXT_1010 = NL + "                            System.err.println(e_";
  protected final String TEXT_1011 = ".getMessage());";
  protected final String TEXT_1012 = NL + "                    }";
  protected final String TEXT_1013 = NL + "                        tmp_batchUpdateCount_";
  protected final String TEXT_1014 = " = pstmt_";
  protected final String TEXT_1015 = ".getUpdateCount();" + NL + "                        insertedCount_";
  protected final String TEXT_1016 = "+= (tmp_batchUpdateCount_";
  protected final String TEXT_1017 = " >0 ? tmp_batchUpdateCount_";
  protected final String TEXT_1018 = ":0);";
  protected final String TEXT_1019 = NL + "                    batchSizeCounter_";
  protected final String TEXT_1020 = " = 0;" + NL + "\t\t\t\t}" + NL + "\t    \t\t";
  protected final String TEXT_1021 = NL + "                    commitCounter_";
  protected final String TEXT_1022 = "++;" + NL + "                    if(commitEvery_";
  protected final String TEXT_1023 = " <= commitCounter_";
  protected final String TEXT_1024 = ") {" + NL + "\t                ";
  protected final String TEXT_1025 = NL + "\t                if(batchSizeCounter_";
  protected final String TEXT_1026 = " > 0){" + NL + "    \t                try {" + NL + "    \t                \t";
  protected final String TEXT_1027 = NL + "                                pstmt_";
  protected final String TEXT_1028 = ".executeBatch();";
  protected final String TEXT_1029 = NL + "                                int countSum_";
  protected final String TEXT_1030 = " = 0;" + NL + "                                for(int countEach_";
  protected final String TEXT_1031 = ": pstmt_";
  protected final String TEXT_1032 = ".executeBatch()) {" + NL + "                                    countSum_";
  protected final String TEXT_1033 = " += (countEach_";
  protected final String TEXT_1034 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_1042 = NL + "                        }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_1043 = "){";
  protected final String TEXT_1044 = NL + "                                throw(e_";
  protected final String TEXT_1045 = ");";
  protected final String TEXT_1046 = NL + "                                    int countSum_";
  protected final String TEXT_1047 = " = 0;" + NL + "                                    for(int countEach_";
  protected final String TEXT_1048 = ": e_";
  protected final String TEXT_1049 = ".getUpdateCounts()) {" + NL + "                                        countSum_";
  ...
  protected final String TEXT_1059 = NL + "                                System.err.println(e_";
  protected final String TEXT_1060 = ".getMessage());";
  protected final String TEXT_1061 = NL + "                        }";
  protected final String TEXT_1062 = NL + "                            tmp_batchUpdateCount_";
  protected final String TEXT_1063 = " = pstmt_";
  protected final String TEXT_1064 = ".getUpdateCount();" + NL + "                            insertedCount_";
  protected final String TEXT_1065 = "+= (tmp_batchUpdateCount_";
  protected final String TEXT_1066 = " >0 ? tmp_batchUpdateCount_";
  protected final String TEXT_1067 = ":0);";
  protected final String TEXT_1068 = NL + "                        batchSizeCounter_";
  protected final String TEXT_1069 = " = 0;" + NL + "                    }" + NL + "\t                ";
  protected final String TEXT_1070 = NL + "\t                \t";
  protected final String TEXT_1071 = NL + "                        conn_";
  protected final String TEXT_1072 = ".commit();";
