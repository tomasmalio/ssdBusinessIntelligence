...
public class TRedshiftOutputBeginJava {
  ...
  protected final String TEXT_188 = ".commit();";
  ...
  protected final String TEXT_441 = NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_461 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_462 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  ...
  protected final String TEXT_477 = NL + "                              stmtTruncCount_";
  protected final String TEXT_478 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_479 = "));";
  protected final String TEXT_480 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_481 = " = stmtTruncCount_";
  protected final String TEXT_482 = ".executeQuery(\"";
  protected final String TEXT_483 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_484 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_485 = ".next()) {" + NL + "                rsTruncCountNumber_";
  protected final String TEXT_486 = " = rsTruncCount_";
  protected final String TEXT_487 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_488 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_489 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_500 = NL + "                if(!conn_";
  protected final String TEXT_501 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_502 = ".commit();" + NL + "                }";
  protected final String TEXT_503 = NL + "            deletedCount_";
  protected final String TEXT_504 = " += rsTruncCountNumber_";
  protected final String TEXT_505 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_506 = ".close();";
  protected final String TEXT_507 = NL + "            java.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_523 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_524 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_525 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_529 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_530 = " + \"\\\" (";
  protected final String TEXT_531 = ") VALUES (";
  protected final String TEXT_532 = ")\");";
  protected final String TEXT_533 = NL + "\t\t\tint rowCount";
  protected final String TEXT_534 = " = 0;" + NL + "\t\t\tclass BufferLine_";
  protected final String TEXT_535 = " {";
  protected final String TEXT_536 = "\t\t\t\t" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_537 = " ";
  protected final String TEXT_538 = ";" + NL + "\t\t\t\t\t\t" + NL + "\t            \t\tpublic BufferLine_";
  protected final String TEXT_539 = " c";
  protected final String TEXT_540 = "(";
  protected final String TEXT_541 = " ";
  protected final String TEXT_542 = "){" + NL + "\t\t\t\t\t\t\tthis.";
  protected final String TEXT_543 = " = ";
  protected final String TEXT_544 = ";" + NL + "\t\t\t\t\t\t\treturn this;" + NL + "\t\t\t\t\t\t}";
  protected final String TEXT_545 = "\t\t" + NL + "\t\t\t}" + NL + "" + NL + "\t\t\tjava.util.List<BufferLine_";
  protected final String TEXT_546 = "> exInsertColValueList";
  protected final String TEXT_547 = " = new java.util.ArrayList();" + NL + "\t\t\tBufferLine_";
  protected final String TEXT_548 = " exInsertColValue";
  protected final String TEXT_549 = " = null;" + NL + "" + NL + "\t\t\tString valueList_";
  protected final String TEXT_550 = " = \"(";
  protected final String TEXT_551 = ")\";" + NL + "\t\t\tnumPerInsert_";
  protected final String TEXT_552 = " = util_";
  protected final String TEXT_553 = ".correctNumPerInsert(valueList_";
  protected final String TEXT_554 = ", numPerInsert_";
  protected final String TEXT_555 = ");" + NL + "\t\t\t" + NL + "\t\t\tStringBuilder extendInsertValueStmt_";
  protected final String TEXT_556 = " = new StringBuilder();" + NL + "\t\t\tfor(int i_";
  protected final String TEXT_557 = "=0;i_";
  protected final String TEXT_558 = " < numPerInsert_";
  protected final String TEXT_559 = ";i_";
  protected final String TEXT_560 = "++){" + NL + "\t\t\t\t extendInsertValueStmt_";
  protected final String TEXT_561 = ".append(valueList_";
  protected final String TEXT_562 = ");" + NL + "\t\t\t\t if (i_";
  protected final String TEXT_563 = "!=numPerInsert_";
  protected final String TEXT_564 = "-1) extendInsertValueStmt_";
  protected final String TEXT_565 = ".append(\",\");" + NL + "\t\t\t}" + NL + "" + NL + "\t\t\tString insert_";
  protected final String TEXT_566 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_567 = " + \"\\\" (";
  protected final String TEXT_568 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_569 = ".toString();" + NL + "\t\t\tjava.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_585 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  ...
  protected final String TEXT_590 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  ...
  protected final String TEXT_596 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  ...
  protected final String TEXT_601 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_602 = " + \"\\\" (";
  protected final String TEXT_603 = ") VALUES (";
  protected final String TEXT_604 = ")\");" + NL + "\t    ";
  protected final String TEXT_605 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_606 = " = conn_";
  protected final String TEXT_607 = ".prepareStatement(\"DELETE FROM \\\"\" + tableName_";
  protected final String TEXT_608 = " + \"\\\" WHERE ";
  protected final String TEXT_609 = "\");" + NL + "\t    ";
  protected final String TEXT_610 = NL + "\tclass BufferLine_";
  protected final String TEXT_611 = " {";
  protected final String TEXT_612 = NL + "\t\t\t";
  protected final String TEXT_613 = " ";
  protected final String TEXT_614 = ";" + NL + "\t\t\t" + NL + "    \t\tpublic BufferLine_";
  protected final String TEXT_615 = " c";
  protected final String TEXT_616 = "(";
  protected final String TEXT_617 = " ";
  protected final String TEXT_618 = "){" + NL + "\t\t\t\tthis.";
  protected final String TEXT_619 = " = ";
  protected final String TEXT_620 = ";" + NL + "\t\t\t\treturn this;" + NL + "\t\t\t}";
  protected final String TEXT_621 = NL + "\t\t\troutines.system.Dynamic ";
  protected final String TEXT_622 = ";" + NL + "\t\t\t" + NL + "\t\t\tpublic BufferLine_";
  protected final String TEXT_623 = " c";
  protected final String TEXT_624 = "(routines.system.Dynamic ";
  protected final String TEXT_625 = "){" + NL + "\t\t\t\tthis.";
  protected final String TEXT_626 = " = ";
  protected final String TEXT_627 = ";" + NL + "\t\t\t\treturn this;" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_628 = NL + "    }" + NL + "" + NL + "    java.util.List<BufferLine_";
  protected final String TEXT_629 = "> exInsertColValueList";
  protected final String TEXT_630 = " = new java.util.ArrayList();" + NL + "    BufferLine_";
  protected final String TEXT_631 = " exInsertColValue";
  protected final String TEXT_632 = " = null;" + NL + "    String insert_";
  protected final String TEXT_633 = " = \"\";" + NL + "    int rowCount";
  protected final String TEXT_634 = " = 0;";
  protected final String TEXT_635 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_636 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_637 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
