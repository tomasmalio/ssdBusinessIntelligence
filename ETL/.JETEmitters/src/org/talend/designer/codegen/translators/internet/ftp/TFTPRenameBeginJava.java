...
public class TFTPRenameBeginJava
{
  ...
  protected final String TEXT_173 = NL + "\t\t\tks.load(new java.io.FileInputStream(";
  protected final String TEXT_174 = "), decryptedKeyStorePassword_";
  protected final String TEXT_175 = ".toCharArray());" + NL + "\t\t\tjavax.net.ssl.TrustManagerFactory tmf = javax.net.ssl.TrustManagerFactory.getInstance(javax.net.ssl.KeyManagerFactory.getDefaultAlgorithm());" + NL + "\t\t\ttmf.init(ks);" + NL + "\t\t\treturn tmf.getTrustManagers();" + NL + "\t\t}" + NL + "\t}" + NL + "\t" + NL + "\t\tclass SSLSessionReuseFTPSClient_";
  protected final String TEXT_176 = " extends org.apache.commons.net.ftp.FTPSClient {" + NL + "" + NL + "\t\tpublic SSLSessionReuseFTPSClient_";
  protected final String TEXT_177 = "(boolean isImplicit, javax.net.ssl.SSLContext context) {" + NL + "\t\t\tsuper(isImplicit, context);" + NL + "\t\t}" + NL + "" + NL + "\t\t// changed to support TLS session resumption" + NL + "\t\t@Override" + NL + "\t\tprotected void _prepareDataSocket_(final java.net.Socket socket) throws IOException {" + NL + "\t\t\tif(socket instanceof javax.net.ssl.SSLSocket) {" + NL + "\t\t\t\tfinal javax.net.ssl.SSLSession session = ((javax.net.ssl.SSLSocket) _socket_).getSession();" + NL + "\t\t\t\tfinal javax.net.ssl.SSLSessionContext context = session.getSessionContext();" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tfinal java.lang.reflect.Field sessionHostPortCache = context.getClass().getDeclaredField(\"sessionHostPortCache\");" + NL + "\t\t\t\t\tsessionHostPortCache.setAccessible(true);" + NL + "\t\t\t\t\tfinal Object cache = sessionHostPortCache.get(context);" + NL + "\t\t\t\t\tfinal java.lang.reflect.Method putMethod = cache.getClass().getDeclaredMethod(\"put\", Object.class, Object.class);" + NL + "\t\t\t\t\tputMethod.setAccessible(true);" + NL + "\t\t\t\t\tfinal java.lang.reflect.Method getHostMethod = socket.getClass().getDeclaredMethod(\"getHost\");" + NL + "\t\t\t\t\tgetHostMethod.setAccessible(true);" + NL + "\t\t\t\t\tObject host = getHostMethod.invoke(socket);" + NL + "\t\t\t\t\tfinal String key = String.format(\"%s:%s\", host, String.valueOf(socket.getPort())).toLowerCase(java.util.Locale.ROOT);" + NL + "\t\t\t\t\tputMethod.invoke(cache, key, session);" + NL + "\t\t\t\t} catch(Exception e) {";
  protected final String TEXT_178 = NL + "\t\t\t\t\t\tlog.error(\"Can't adapt ftps client to support TLS session resumption\");";
  protected final String TEXT_179 = NL + "\t\t\t\t\tthrow new RuntimeException(e);" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t}" + NL + "\t\tjavax.net.ssl.SSLContext sslContext_";
  protected final String TEXT_180 = " = null;" + NL + "\t\tjavax.net.ssl.TrustManager[] trustManager_";
  protected final String TEXT_181 = " = null;" + NL + "\t\tjavax.net.ssl.SSLSocketFactory sslSocketFactory_";
  protected final String TEXT_182 = " = null;" + NL + "\t\torg.apache.commons.net.ftp.FTPSClient ftp_";
  protected final String TEXT_183 = " =null;" + NL + "\t\tMyTrust_";
  protected final String TEXT_184 = " myTrust_";
  protected final String TEXT_185 = " = null;" + NL + "\t\ttry {" + NL + "\t\t\tsslContext_";
  protected final String TEXT_186 = " = javax.net.ssl.SSLContext.getInstance(\"SSL\");" + NL + "\t\t\tmyTrust_";
  protected final String TEXT_187 = " = new MyTrust_";
  protected final String TEXT_188 = "();" + NL + "\t\t\ttrustManager_";
  protected final String TEXT_189 = " = myTrust_";
  protected final String TEXT_190 = ".getTrustManagers();" + NL + "\t\t\tsslContext_";
  protected final String TEXT_191 = ".init(null, trustManager_";
  protected final String TEXT_192 = ", new java.security.SecureRandom());" + NL + "\t\t\tsslSocketFactory_";
  protected final String TEXT_193 = " = sslContext_";
  protected final String TEXT_194 = ".getSocketFactory();" + NL + "\t\t\tftp_";
  protected final String TEXT_195 = " = new SSLSessionReuseFTPSClient_";
  protected final String TEXT_196 = "(";
  protected final String TEXT_197 = ", sslContext_";
  protected final String TEXT_198 = ");" + NL + "\t\t\tftp_";
  protected final String TEXT_199 = ".setControlEncoding(";
  protected final String TEXT_200 = ");" + NL + "" + NL + "\t\t\t";
  protected final String TEXT_201 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_202 = " -FTPS security Mode is ";
  protected final String TEXT_203 = ".\");" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_204 = " - Attempt to connect to '\" + ";
  protected final String TEXT_205 = " + \"' with username '\" + ";
  protected final String TEXT_206 = "+ \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_207 = NL + "\t\t\tftp_";
  protected final String TEXT_208 = ".connect(";
  ...
  protected final String TEXT_221 = NL + NL + "\t\t\tboolean isLoginSuccessful_";
  protected final String TEXT_222 = " = ftp_";
  protected final String TEXT_223 = ".login(";
  protected final String TEXT_224 = ", decryptedPassword_";
  protected final String TEXT_225 = ");" + NL + "" + NL + "\t\t\tif (!isLoginSuccessful_";
  protected final String TEXT_226 = ") {" + NL + "\t\t\t\tthrow new RuntimeException(\"Login failed\");" + NL + "\t\t\t}" + NL + "" + NL + "\t\t\tftp_";
  protected final String TEXT_227 = ".execPROT(";
  protected final String TEXT_228 = ");" + NL + "\t\t\tftp_";
  protected final String TEXT_229 = ".execPBSZ(";
  protected final String TEXT_230 = ");" + NL + "\t\t} catch (Exception e) {" + NL + "\t\t\t";
  protected final String TEXT_231 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_232 = " - Can't create connection: \" + e.getMessage());" + NL + "\t\t\t";
  protected final String TEXT_233 = NL + "\t\t\t\tthrow e;";
  protected final String TEXT_234 = NL + "\t\t\t\te.printStackTrace();";
  protected final String TEXT_235 = NL + "\t\t}";
  protected final String TEXT_236 = NL + "\t\t\tftp_";
  protected final String TEXT_237 = ".enterLocalPassiveMode();";
  protected final String TEXT_238 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_239 = " - Using the passive mode.\");";
  protected final String TEXT_240 = NL + "\t\torg.apache.commons.net.ftp.FTPSClient ftp_";
  protected final String TEXT_241 = " = (org.apache.commons.net.ftp.FTPSClient) globalMap.get(\"";
  protected final String TEXT_242 = "\");";
  protected final String TEXT_243 = NL + "\tjava.util.List<java.util.Map<String,String>> list";
  protected final String TEXT_244 = " = new java.util.ArrayList<java.util.Map<String,String>>();" + NL;
  protected final String TEXT_245 = NL + "\t\tjava.util.Map<String,String> map";
  protected final String TEXT_246 = " = new java.util.HashMap<String,String>();  " + NL + "\t\tmap";
  protected final String TEXT_247 = ".put(";
  protected final String TEXT_248 = ",";
  protected final String TEXT_249 = ");" + NL + "\t\tlist";
  protected final String TEXT_250 = ".add(map";
  protected final String TEXT_251 = ");       ";
  protected final String TEXT_252 = NL + "\t\t\tString rootDir_";
  protected final String TEXT_253 = " = ftp_";
  protected final String TEXT_254 = ".printWorkingDirectory();";
  protected final String TEXT_255 = NL + "\tboolean cwdSuccess_";
  protected final String TEXT_256 = " = ftp_";
  protected final String TEXT_257 = ".changeWorkingDirectory(";
  protected final String TEXT_258 = ");" + NL + "" + NL + "\tif (!cwdSuccess_";
  protected final String TEXT_259 = ") {" + NL + "\t\tthrow new RuntimeException(\"Failed to change remote directory. \" + ftp_";
  protected final String TEXT_260 = ".getReplyString());" + NL + "\t}" + NL + "" + NL + "\tfor (java.util.Map<String, String> map";
  protected final String TEXT_261 = " : list";
  protected final String TEXT_262 = ") { ";
  protected final String TEXT_263 = NL + "\tcom.enterprisedt.net.ftp.FTPClient ftp_";
  protected final String TEXT_264 = " =null;" + NL + "" + NL + "\t";
  protected final String TEXT_265 = NL + "    \tftp_";
  protected final String TEXT_266 = " = (com.enterprisedt.net.ftp.FTPClient)globalMap.get(\"";
  protected final String TEXT_267 = "\");" + NL + "\t\t";
  protected final String TEXT_268 = NL + "\t\t\tif(ftp_";
  protected final String TEXT_269 = "!=null) {" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_270 = " - Use an existing connection. Connection hostname: \" + ftp_";
  protected final String TEXT_271 = ".getRemoteHost() + \", Connection port: \" + ftp_";
  protected final String TEXT_272 = ".getRemotePort() + \".\"); " + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_273 = NL + "\t  \t";
  protected final String TEXT_274 = NL + "\t  \t\tString rootDir_";
  protected final String TEXT_275 = " = ftp_";
  protected final String TEXT_276 = ".pwd();" + NL + "\t  \t";
  protected final String TEXT_277 = NL + "\t";
  protected final String TEXT_278 = "    " + NL + "\t    ftp_";
  protected final String TEXT_279 = " = new com.enterprisedt.net.ftp.FTPClient();" + NL + "\t    ftp_";
  protected final String TEXT_280 = ".setRemoteHost(";
  protected final String TEXT_281 = ");" + NL + "\t    ftp_";
  protected final String TEXT_282 = ".setRemotePort(";
  protected final String TEXT_283 = ");" + NL + "" + NL + "\t    ";
  protected final String TEXT_284 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_285 = " - \" + ";
  protected final String TEXT_286 = ");" + NL + "\t\t";
  protected final String TEXT_287 = NL + "\t\t";
  protected final String TEXT_288 = NL + "\t\t\tftp_";
  protected final String TEXT_289 = ".setConnectMode(com.enterprisedt.net.ftp.FTPConnectMode.ACTIVE);" + NL + "\t\t";
  protected final String TEXT_290 = NL + "\t\t\tftp_";
  protected final String TEXT_291 = ".setConnectMode(com.enterprisedt.net.ftp.FTPConnectMode.PASV);" + NL + "\t\t";
  protected final String TEXT_292 = NL + "\t\tftp_";
  protected final String TEXT_293 = ".setControlEncoding(";
  protected final String TEXT_294 = ");" + NL + "\t\t";
  protected final String TEXT_295 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_296 = " - Attempt to connect to '\" + ";
  protected final String TEXT_297 = " + \"' with username '\" +";
  protected final String TEXT_298 = "+ \"'.\");" + NL + "\t\t";
  protected final String TEXT_299 = NL + "\t\tftp_";
  protected final String TEXT_300 = ".connect();  " + NL + "\t\t" + NL + "\t\t";
  ...
  protected final String TEXT_308 = NL + "\t\t\t" + NL + "\t\tftp_";
  protected final String TEXT_309 = ".login(";
  protected final String TEXT_310 = ", decryptedPassword_";
  protected final String TEXT_311 = ");" + NL + "\t\t";
  protected final String TEXT_312 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_313 = " - Connect to '\" + ";
  protected final String TEXT_314 = " + \"' has succeeded.\");" + NL + "\t\t";
  protected final String TEXT_315 = "   " + NL + "\t";
  protected final String TEXT_316 = NL + "\tjava.util.List<java.util.Map<String,String>> list";
  protected final String TEXT_317 = " = new java.util.ArrayList<java.util.Map<String,String>>();" + NL + "" + NL + "\t";
  protected final String TEXT_318 = "    " + NL + "\t\tjava.util.Map<String,String> map";
  protected final String TEXT_319 = " = new java.util.HashMap<String,String>();  " + NL + "\t\tmap";
  protected final String TEXT_320 = ".put(";
  ...
  protected final String TEXT_331 = " - Renaming file from server.\");" + NL + "\t";
  protected final String TEXT_332 = NL + "\tfor (java.util.Map<String, String> map";
  protected final String TEXT_333 = " : list";
