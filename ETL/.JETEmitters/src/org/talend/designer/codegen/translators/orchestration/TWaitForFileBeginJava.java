...
public class TWaitForFileBeginJava
{
  ...
  protected final String TEXT_82 = ".contains(cachedFile))" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\tintersectionList.add(cachedFile);" + NL + "\t\t\t\t}" + NL + "\t\t\t}     " + NL + "            " + NL + "            util_";
  protected final String TEXT_83 = " = new Util_";
  protected final String TEXT_84 = "();";
  protected final String TEXT_85 = NL + "\t\t\t\toriginalFiles_";
  protected final String TEXT_86 = " = intersectionList;" + NL + "            \tif(globalMap.get(\"";
