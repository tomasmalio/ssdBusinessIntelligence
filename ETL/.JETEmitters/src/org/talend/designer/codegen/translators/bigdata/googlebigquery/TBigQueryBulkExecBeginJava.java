...
public class TBigQueryBulkExecBeginJava
{
  ...
  protected final String TEXT_121 = NL + "\t\torg.jets3t.service.impl.rest.httpclient.GoogleStorageService gsService_";
  protected final String TEXT_122 = " = new org.jets3t.service.impl.rest.httpclient.GoogleStorageService(gsCredentials_";
  protected final String TEXT_123 = ",\" ";
  protected final String TEXT_124 = "\",null);" + NL + "" + NL + "\t\tjava.io.File fileData_";
  protected final String TEXT_125 = " = new java.io.File(";
  protected final String TEXT_126 = ");" + NL + "\t\torg.jets3t.service.model.GSObject fileObject_";
  protected final String TEXT_127 = " = new org.jets3t.service.model.GSObject(fileData_";
  protected final String TEXT_128 = ");" + NL + "\t\t";
  protected final String TEXT_129 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_130 = " - Upload \"+";
  protected final String TEXT_131 = " + \" to Google Service Bucket: \"+";
  protected final String TEXT_132 = ");" + NL + "\t\t";
  protected final String TEXT_133 = NL + "\t\tgsService_";
  protected final String TEXT_134 = ".putObject(";
  protected final String TEXT_135 = ", fileObject_";
  protected final String TEXT_136 = ");" + NL + "\t\t";
  protected final String TEXT_137 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_138 = " - Upload Done.\");" + NL + "\t\t";
  protected final String TEXT_139 = NL + NL + "/* ------------------------------------------- */" + NL + "" + NL + "\t";
  protected final String TEXT_140 = NL + "\t\tlog.info(\"";
  protected final String TEXT_141 = " - Starting build a job.\");" + NL + "\t";
  protected final String TEXT_142 = NL + "\tcom.google.api.services.bigquery.model.Job job_";
  protected final String TEXT_143 = " = new com.google.api.services.bigquery.model.Job();" + NL + "\tjob_";
  protected final String TEXT_144 = ".setJobReference(new com.google.api.services.bigquery.model.JobReference().setProjectId(PROJECT_ID_";
  protected final String TEXT_145 = "));" + NL + "" + NL + "\tcom.google.api.services.bigquery.model.JobConfiguration config_";
  protected final String TEXT_146 = " = new com.google.api.services.bigquery.model.JobConfiguration();" + NL + "\tcom.google.api.services.bigquery.model.JobConfigurationLoad queryLoad_";
  protected final String TEXT_147 = " = new com.google.api.services.bigquery.model.JobConfigurationLoad();" + NL + "\tcom.google.api.services.bigquery.model.TableSchema schema_";
  protected final String TEXT_148 = " = new com.google.api.services.bigquery.model.TableSchema();" + NL + "" + NL + "\t";
  protected final String TEXT_149 = NL + "\t\tlog.info(\"";
  protected final String TEXT_150 = " - Table field schema:\");" + NL + "\t";
  protected final String TEXT_151 = NL + "\tjava.util.List<com.google.api.services.bigquery.model.TableFieldSchema> fields_";
  protected final String TEXT_152 = " = new java.util.ArrayList<com.google.api.services.bigquery.model.TableFieldSchema>();" + NL + "\t";
  protected final String TEXT_153 = NL + "\t\t\t\tcom.google.api.services.bigquery.model.TableFieldSchema ";
  protected final String TEXT_154 = "_";
  protected final String TEXT_155 = " = new com.google.api.services.bigquery.model.TableFieldSchema();" + NL + "\t\t\t\t";
  protected final String TEXT_156 = "_";
  protected final String TEXT_157 = ".setName(\"";
  protected final String TEXT_158 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_159 = "_";
  protected final String TEXT_160 = ".setType(\"";
  protected final String TEXT_161 = "\");" + NL + "\t\t\t\tfields_";
  protected final String TEXT_162 = ".add(";
  protected final String TEXT_163 = "_";
  protected final String TEXT_164 = ");\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_165 = NL + "\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_166 = " - Field index[";
  protected final String TEXT_167 = "] {\\\"name\\\":\\\"";
  protected final String TEXT_168 = "\\\",\\\"type\\\":\\\"";
  protected final String TEXT_169 = "\\\"}\");" + NL + "\t\t\t\t";
  protected final String TEXT_170 = NL + "\t" + NL + "" + NL + "\tschema_";
  protected final String TEXT_171 = ".setFields(fields_";
  protected final String TEXT_172 = ");" + NL + "" + NL + "\tqueryLoad_";
  protected final String TEXT_173 = ".setSchema(schema_";
  protected final String TEXT_174 = ");" + NL + "\t";
  protected final String TEXT_175 = NL + "\t\tqueryLoad_";
  protected final String TEXT_176 = ".setCreateDisposition(\"CREATE_IF_NEEDED\");" + NL + "\t";
  protected final String TEXT_177 = NL + "\t\tqueryLoad_";
  protected final String TEXT_178 = ".setCreateDisposition(\"CREATE_NEVER\");" + NL + "\t";
  protected final String TEXT_179 = NL + "\t\tqueryLoad_";
  protected final String TEXT_180 = ".setFieldDelimiter(";
  protected final String TEXT_181 = ");" + NL + "\t";
  protected final String TEXT_182 = NL + "\tqueryLoad_";
  protected final String TEXT_183 = ".setAllowQuotedNewlines(true);" + NL + "" + NL + "\tqueryLoad_";
  protected final String TEXT_184 = ".setWriteDisposition(\"WRITE_";
  protected final String TEXT_185 = "\");" + NL + "\tcom.google.api.services.bigquery.model.TableReference destinationTable_";
  protected final String TEXT_186 = " = new com.google.api.services.bigquery.model.TableReference();" + NL + "\tdestinationTable_";
  protected final String TEXT_187 = ".setProjectId(PROJECT_ID_";
  protected final String TEXT_188 = ");" + NL + "\tdestinationTable_";
  protected final String TEXT_189 = ".setDatasetId(";
  protected final String TEXT_190 = ");" + NL + "\tdestinationTable_";
  protected final String TEXT_191 = ".setTableId(";
  protected final String TEXT_192 = ");" + NL + "" + NL + "\tqueryLoad_";
  protected final String TEXT_193 = ".setDestinationTable(destinationTable_";
  protected final String TEXT_194 = ");" + NL + "\tqueryLoad_";
  protected final String TEXT_195 = ".setSourceUris(java.util.Arrays.asList(";
  protected final String TEXT_196 = "));" + NL + "\tqueryLoad_";
  protected final String TEXT_197 = ".setSkipLeadingRows(";
  protected final String TEXT_198 = ");" + NL + "" + NL + "\tconfig_";
  protected final String TEXT_199 = ".setLoad(queryLoad_";
  protected final String TEXT_200 = ");" + NL + "\t" + NL + "\tjob_";
  protected final String TEXT_201 = ".setConfiguration(config_";
  protected final String TEXT_202 = ");" + NL + "" + NL + "\tcom.google.api.services.bigquery.Bigquery.Jobs.Insert insertReq_";
  protected final String TEXT_203 = " = bigqueryclient_";
  protected final String TEXT_204 = ".jobs().insert(\"\", job_";
  protected final String TEXT_205 = ");" + NL + "\tinsertReq_";
  protected final String TEXT_206 = ".setProjectId(PROJECT_ID_";
  protected final String TEXT_207 = ");" + NL + "\t";
  protected final String TEXT_208 = NL + "\t\tlog.info(\"";
  protected final String TEXT_209 = " - Build a job successfully.\");" + NL + "\t\tlog.info(\"";
  protected final String TEXT_210 = " - Starting load the job.\");" + NL + "\t";
  protected final String TEXT_211 = NL + "\tSystem.out.println(\"Starting load job.\");" + NL + "\tcom.google.api.services.bigquery.model.Job jobExec_";
  protected final String TEXT_212 = " = null;" + NL + "\ttry {" + NL + "\t\tjobExec_";
  protected final String TEXT_213 = " = insertReq_";
  protected final String TEXT_214 = ".execute();" + NL + "\t} catch (Exception ee_";
  protected final String TEXT_215 = ") {" + NL + "\t\t";
  protected final String TEXT_216 = NL + "\t\t\tthrow ee_";
  protected final String TEXT_217 = ";" + NL + "\t\t";
  protected final String TEXT_218 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_219 = " - \"+ ee_";
  protected final String TEXT_220 = ".getMessage() + \"\\n\" + ee_";
  protected final String TEXT_221 = ".getCause());" + NL + "\t\t\t";
  protected final String TEXT_222 = NL + "\t\t\tSystem.err.println(ee_";
  protected final String TEXT_223 = ".getMessage() + \"\\n\" + ee_";
  protected final String TEXT_224 = ".getCause());" + NL + "\t\t";
  protected final String TEXT_225 = NL + "\t}" + NL + "\tif (jobExec_";
  protected final String TEXT_226 = ".getStatus().getState().equals(\"RUNNING\")" + NL + "\t\t\t|| jobExec_";
  protected final String TEXT_227 = ".getStatus().getState().equals(\"PENDING\")) {" + NL + "\t\tcom.google.api.services.bigquery.model.Job pollJob_";
  protected final String TEXT_228 = " = bigqueryclient_";
  protected final String TEXT_229 = ".jobs().get(PROJECT_ID_";
  protected final String TEXT_230 = ",jobExec_";
  protected final String TEXT_231 = ".getJobReference().getJobId()).execute();" + NL + "\t\twhile (pollJob_";
  protected final String TEXT_232 = ".getStatus().getState().equals(\"RUNNING\") || pollJob_";
  protected final String TEXT_233 = ".getStatus().getState().equals(\"PENDING\")) {" + NL + "\t\t\tThread.sleep(1000);" + NL + "\t\t\tpollJob_";
  protected final String TEXT_234 = " = bigqueryclient_";
  protected final String TEXT_235 = ".jobs().get(PROJECT_ID_";
  protected final String TEXT_236 = ",jobExec_";
  protected final String TEXT_237 = ".getJobReference().getJobId()).execute();" + NL + "\t\t\tSystem.out.println(String.format(" + NL + "\t\t\t\t\t\"Waiting on job %s ... Current status: %s\", jobExec_";
  protected final String TEXT_238 = NL + "\t\t\t\t\t\t\t.getJobReference().getJobId(), pollJob_";
  protected final String TEXT_239 = NL + "\t\t\t\t\t\t\t.getStatus().getState()));" + NL + "\t\t\t";
  protected final String TEXT_240 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_241 = " - \"+String.format(\"Waiting on job %s ... Current status: %s\", jobExec_";
  protected final String TEXT_242 = ".getJobReference().getJobId(), pollJob_";
  protected final String TEXT_243 = ".getStatus().getState()));" + NL + "\t\t\t";
  protected final String TEXT_244 = NL + "\t\t}" + NL + "" + NL + "\t\tcom.google.api.services.bigquery.model.Job doneJob_";
  protected final String TEXT_245 = " = pollJob_";
  protected final String TEXT_246 = ";" + NL + "" + NL + "\t\tif ((doneJob_";
  protected final String TEXT_247 = ".getStatus() != null) && (doneJob_";
  protected final String TEXT_248 = ".getStatus().getErrors() != null)) {" + NL + "\t\t\tstatus = \"failure\";" + NL + "\t\t\tthrow new Exception(doneJob_";
  protected final String TEXT_249 = ".getStatus().getErrors().toString());" + NL + "\t\t}" + NL + "" + NL + "\t\tSystem.out.println(\"Done: \" + doneJob_";
  protected final String TEXT_250 = ".toString());" + NL + "\t\tcom.google.api.services.bigquery.model.JobStatistics jobStatistics_";
  protected final String TEXT_251 = "= doneJob_";
  protected final String TEXT_252 = ".getStatistics();" + NL + "\t\tif(jobStatistics_";
  protected final String TEXT_253 = "!=null && jobStatistics_";
  protected final String TEXT_254 = ".getLoad() != null){" + NL + "\t\t\tcom.google.api.services.bigquery.model.JobStatistics3 loadObject_";
  protected final String TEXT_255 = " = jobStatistics_";
  protected final String TEXT_256 = ".getLoad();" + NL + "\t\t\tif(loadObject_";
  protected final String TEXT_257 = "!= null){" + NL + "\t\t\t\tnb_line_";
  protected final String TEXT_258 = " = loadObject_";
  protected final String TEXT_259 = ".getOutputRows();" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_260 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_261 = " - Load Done: \" + doneJob_";
  protected final String TEXT_262 = ".toString());" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_263 = " - \" + nb_line_";
  protected final String TEXT_264 = " + \" records load successfully.\");" + NL + "\t\t";
  protected final String TEXT_265 = NL + "\t} else {" + NL + "\t\t";
  protected final String TEXT_266 = NL + "\t\t\tthrow new Exception(jobExec_";
  protected final String TEXT_267 = ".toString());" + NL + "\t\t";
  protected final String TEXT_268 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_269 = " - Error: \" + jobExec_";
  protected final String TEXT_270 = ".toString());" + NL + "\t\t\t";
  protected final String TEXT_271 = NL + "\t\t\tSystem.err.println(\"Error: \" + jobExec_";
