...
public class TSQSQueueCreateMainJava
{
  ...
  protected final String TEXT_77 = NL + "\t\t\tjava.util.Map<String,String> attributes_";
  protected final String TEXT_78 = " = new java.util.HashMap<String,String>();" + NL + "\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_79 = NL + "\t\t\t\t\tattributes_";
  ...
  protected final String TEXT_84 = " - Creating a queue with name:\" + ";
  protected final String TEXT_85 = ");" + NL + "\t\t";
  protected final String TEXT_86 = NL + "\t\tcom.amazonaws.services.sqs.model.CreateQueueRequest createQueueRequest_";
  protected final String TEXT_87 = " = new com.amazonaws.services.sqs.model.CreateQueueRequest(";
  protected final String TEXT_88 = ")";
  protected final String TEXT_89 = ".withAttributes(attributes_";
  protected final String TEXT_90 = ")";
  protected final String TEXT_91 = ";" + NL + "        String queueUrl_";
  protected final String TEXT_92 = " = conn_";
  protected final String TEXT_93 = ".createQueue(createQueueRequest_";
  protected final String TEXT_94 = ").getQueueUrl();" + NL + "\t\t";
  protected final String TEXT_95 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_96 = " - Create the queue successfully [\" + queueUrl_";
  ...
  protected final String TEXT_103 = " - \" + e_";
  ...
  protected final String TEXT_107 = NL + "\t}finally{" + NL + "\t\tif(conn_";
  protected final String TEXT_108 = " !=null){" + NL + "\t\t\tconn_";
  protected final String TEXT_109 = ".shutdown();" + NL + "\t\t}" + NL + "\t\t";
