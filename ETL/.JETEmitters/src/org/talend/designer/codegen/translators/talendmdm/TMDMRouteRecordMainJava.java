...
public class TMDMRouteRecordMainJava
{
  ...
  protected final String TEXT_190 = "\");" + NL + "" + NL + "org.talend.mdm.webservice.WSRouteItemV2 wsRouteItem_";
  protected final String TEXT_191 = " = new org.talend.mdm.webservice.WSRouteItemV2();" + NL + "" + NL + "List<String> pkIds = new java.util.ArrayList<String>();";
  protected final String TEXT_192 = NL + "pkIds.add(";
  protected final String TEXT_193 = ");";
  protected final String TEXT_194 = NL + "org.talend.mdm.webservice.WSItemPK wsItemPK_";
  protected final String TEXT_195 = " = new org.talend.mdm.webservice.WSItemPK(";
  protected final String TEXT_196 = ",pkIds,dataCluster_";
  protected final String TEXT_197 = ");" + NL + "" + NL + "wsRouteItem_";
  protected final String TEXT_198 = ".setWsItemPK(wsItemPK_";
  protected final String TEXT_199 = ");" + NL + "" + NL + "//" + NL + "service_";
  protected final String TEXT_200 = ".routeItemV2(wsRouteItem_";
