...
public class TRedshiftOutputBulkEndJava
{
  ...
  protected final String TEXT_157 = ".setUserAgent(\"";
  protected final String TEXT_158 = "\");" + NL + "\t\t";
  protected final String TEXT_159 = NL + "\t\t\t\t\tint scketSendBufferSizeHints_";
  protected final String TEXT_160 = " = 0;" + NL + "\t\t\t\t\tint socketReceiveBufferSizeHints_";
  protected final String TEXT_161 = " = 0;" + NL + "\t\t\t\t";
  protected final String TEXT_162 = NL + "\t\t\t\t\tscketSendBufferSizeHints_";
  protected final String TEXT_163 = " = ";
  protected final String TEXT_164 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_165 = NL + "\t\t\t\t\tsocketReceiveBufferSizeHints_";
  protected final String TEXT_166 = " = ";
  protected final String TEXT_167 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_168 = NL + "\t\t\t\t\tcc_";
  protected final String TEXT_169 = ".setProtocol(com.amazonaws.Protocol.";
  ...
  protected final String TEXT_176 = ".setSocketBufferSizeHints(scketSendBufferSizeHints_";
  protected final String TEXT_177 = ",socketReceiveBufferSizeHints_";
  protected final String TEXT_178 = ");" + NL + "\t\t\t";
  protected final String TEXT_179 = NL + "\t\t\tint sessionDurationSeconds_";
  protected final String TEXT_180 = " = ";
  protected final String TEXT_181 = " * 60;" + NL + "\t\t\tcom.amazonaws.auth.STSAssumeRoleSessionCredentialsProvider.Builder stsBuilder_";
  protected final String TEXT_182 = " = " + NL + "\t\t\t\t\tnew com.amazonaws.auth.STSAssumeRoleSessionCredentialsProvider.Builder(";
  protected final String TEXT_183 = ", ";
  protected final String TEXT_184 = ").withLongLivedCredentialsProvider(credentialsProvider_";
  protected final String TEXT_185 = ")" + NL + "\t\t\t\t\t.withRoleSessionDurationSeconds(sessionDurationSeconds_";
  protected final String TEXT_186 = ");" + NL + "\t\t\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_187 = NL + "\t\t\t\tstsBuilder_";
  protected final String TEXT_188 = ".withServiceEndpoint(";
  protected final String TEXT_189 = ");" + NL + "\t\t\t";
  protected final String TEXT_190 = NL + "\t\t\tstsBuilder_";
  protected final String TEXT_191 = ".withClientConfiguration(cc_";
  protected final String TEXT_192 = ");" + NL + "\t\t\t" + NL + "\t\t\tcredentialsProvider_";
  protected final String TEXT_193 = " = stsBuilder_";
  protected final String TEXT_194 = ".build();" + NL + "\t\t\t" + NL + "\t\t";
  protected final String TEXT_195 = NL + "\t\t\t\tcom.amazonaws.services.s3.AmazonS3Client conn_";
  protected final String TEXT_196 = " = new com.amazonaws.services.s3.AmazonS3EncryptionClient(" + NL + "\t\t\t\t\tcredentialsProvider_";
  protected final String TEXT_197 = "," + NL + "\t\t\t\t\tencryptionMaterialsProvider_";
  protected final String TEXT_198 = ", " + NL + "\t\t\t\t\tcc_";
  protected final String TEXT_199 = "," + NL + "\t\t\t\t\tnew com.amazonaws.services.s3.model.CryptoConfiguration()" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_200 = NL + "\t\t\t\t\t\t.withAwsKmsRegion(com.amazonaws.regions.RegionUtils.getRegion(";
  protected final String TEXT_201 = "))" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_202 = NL + "\t\t\t\t);" + NL + "\t\t\t";
  protected final String TEXT_203 = NL + "\t\t\t\tcom.amazonaws.services.s3.AmazonS3Client conn_";
  protected final String TEXT_204 = " = new com.amazonaws.services.s3.AmazonS3Client(" + NL + "\t\t\t\t\tcredentialsProvider_";
  protected final String TEXT_205 = "," + NL + "\t\t\t\t\tcc_";
  protected final String TEXT_206 = NL + "\t\t\t\t);" + NL + "\t\t\t";
  protected final String TEXT_207 = NL + "\t\t\tconn_";
  protected final String TEXT_208 = ".setRegion(com.amazonaws.regions.RegionUtils.getRegion(";
  protected final String TEXT_209 = "));" + NL + "\t\t";
  protected final String TEXT_210 = NL + "\t\t\tconn_";
  protected final String TEXT_211 = ".setEndpoint(";
  protected final String TEXT_212 = ");" + NL + "\t\t";
  protected final String TEXT_213 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_214 = " - Creating new connection successfully.\");" + NL + "\t\t";
  protected final String TEXT_215 = NL + "\t\ttry{" + NL + "\t\t\t";
  protected final String TEXT_216 = "\t" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_217 = " - Uploading an object with key:\" + ";
  protected final String TEXT_218 = ");" + NL + "\t\t\t";
  protected final String TEXT_219 = NL + "\t\t\tconn_";
  protected final String TEXT_220 = ".putObject(";
  protected final String TEXT_221 = ", ";
  protected final String TEXT_222 = ", file_";
  protected final String TEXT_223 = ");" + NL + "\t\t\t";
  protected final String TEXT_224 = "\t" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_225 = " - Upload the object successfully.\");" + NL + "\t\t\t";
  protected final String TEXT_226 = NL + "\t\t} finally {" + NL + "\t\t\tif(conn_";
  protected final String TEXT_227 = " !=null){" + NL + "\t\t\t\tconn_";
  protected final String TEXT_228 = ".shutdown();" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t} else {";
  protected final String TEXT_229 = NL + "\t\t  log.debug(\"";
  protected final String TEXT_230 = " - \" + \"file \\\"\"+file_";
  protected final String TEXT_231 = ".getPath()+\"\\\" doesn't exist or content is empty.\");";
  protected final String TEXT_232 = NL + "\t}";
  protected final String TEXT_233 = NL + "\tif(file_";
  protected final String TEXT_234 = ".exists()) {" + NL + "\t\tfile_";
  protected final String TEXT_235 = ".delete();" + NL + "\t}";
  protected final String TEXT_236 = NL + "\tresourceMap.put(\"finish_";
