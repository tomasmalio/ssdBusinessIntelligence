...
public class TLDAPAttributesInputEndJava
{
  ...
  protected final String TEXT_29 = " - Closing the TLS connection.\");";
  protected final String TEXT_30 = NL + "        tls_";
  protected final String TEXT_31 = ".close();" + NL;
  protected final String TEXT_32 = NL + "\t         log.info(\"";
  protected final String TEXT_33 = " - TLS connection closed.\");";
  ...
  protected final String TEXT_42 = "_NB_LINE\", ";
  protected final String TEXT_43 = "_NB_LINE);";
  protected final String TEXT_44 = NL + "\tlog.info(\"";
  protected final String TEXT_45 = " - Retrieved records count: \" + ";
  protected final String TEXT_46 = "_NB_LINE +  \" .\");";
