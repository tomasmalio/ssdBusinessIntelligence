...
public class TMysqlOutputBeginJava {
  ...
  protected final String TEXT_166 = ".commit();";
  ...
  protected final String TEXT_171 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_208 = NL + "                    String keyCheckTable_";
  protected final String TEXT_209 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_216 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_217 = " = conn_";
  protected final String TEXT_218 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_219 = " + \"]\";";
  protected final String TEXT_220 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_221 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_222 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  ...
  protected final String TEXT_337 = NL + "\t\t\t\t            \tString tableForSearch_";
  protected final String TEXT_338 = " = ";
  protected final String TEXT_339 = ";" + NL + "\t\t\t\t            \tif(tableForSearch_";
  protected final String TEXT_340 = " != null){" + NL + "\t\t\t\t            \t\tif(tableForSearch_";
  protected final String TEXT_341 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_342 = ".endsWith(\"\\\"\")){" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_343 = " =  tableForSearch_";
  protected final String TEXT_344 = ".substring(1,tableForSearch_";
  protected final String TEXT_345 = ".length()-1);" + NL + "\t\t\t\t            \t\t}else{" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_346 = " =  tableForSearch_";
  protected final String TEXT_347 = ".toUpperCase();" + NL + "\t\t\t\t            \t\t}" + NL + "\t\t\t\t            \t}" + NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_348 = " = conn_";
  protected final String TEXT_349 = ".getMetaData();" + NL + "\t\t\t\t                java.sql.ResultSet rsTable_";
  protected final String TEXT_350 = " = dbMetaData_";
  protected final String TEXT_351 = ".getTables(null, conn_";
  protected final String TEXT_352 = ".getSchema(), tableForSearch_";
  protected final String TEXT_353 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_354 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_355 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_356 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  ...
  protected final String TEXT_405 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_418 = ".commit();";
  protected final String TEXT_419 = NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_427 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_428 = ".";
  protected final String TEXT_429 = ", \"";
  protected final String TEXT_430 = "\")";
  protected final String TEXT_431 = ".toUpperCase()";
  ...
  protected final String TEXT_439 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_440 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  ...
  protected final String TEXT_455 = NL + "                              stmtTruncCount_";
  protected final String TEXT_456 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_457 = "));";
  protected final String TEXT_458 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_459 = " = stmtTruncCount_";
  protected final String TEXT_460 = ".executeQuery(\"";
  protected final String TEXT_461 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_462 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_463 = ".next()) {" + NL + "                rsTruncCountNumber_";
  ...
  protected final String TEXT_467 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_478 = NL + "                if(!conn_";
  protected final String TEXT_479 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_480 = ".commit();" + NL + "                }";
  protected final String TEXT_481 = NL + "            deletedCount_";
  protected final String TEXT_482 = " += rsTruncCountNumber_";
  protected final String TEXT_483 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_484 = ".close();";
  protected final String TEXT_485 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_486 = " = conn_";
  protected final String TEXT_487 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_488 = " = stmtTruncCount_";
  protected final String TEXT_489 = ".executeQuery(\"";
  protected final String TEXT_490 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_498 = NL + "            while(rsTruncCount_";
  protected final String TEXT_499 = ".next()) {" + NL + "                deletedCount_";
  ...
  protected final String TEXT_503 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_504 = ".close();";
  protected final String TEXT_505 = NL + "\t\t\tStringBuffer duplidateClause_";
  protected final String TEXT_506 = " = new StringBuffer(\" ON DUPLICATE KEY UPDATE \");" + NL + "\t\t\t\t";
  protected final String TEXT_507 = NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_508 = ".append(\",\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_509 = NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_510 = ".append (\"`\" +  ";
  protected final String TEXT_511 = " + \"`\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_512 = ".append (\"=\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  ...
  protected final String TEXT_521 = NL + "\t\t\t\tinsert_";
  protected final String TEXT_522 = " += \tduplidateClause_";
  protected final String TEXT_523 = ".toString();";
  ...
  protected final String TEXT_540 = " = null;" + NL + "                        // [%connection%][psmt][tableName]" + NL + "                        String keyPsmt_";
  protected final String TEXT_541 = " = conn_";
  protected final String TEXT_542 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_543 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_544 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_545 = ",insert_";
  protected final String TEXT_546 = ",keyPsmt_";
  protected final String TEXT_547 = ");";
  protected final String TEXT_548 = NL;
  protected final String TEXT_549 = NL + "\t            class BufferLine_";
  ...
  protected final String TEXT_560 = NL + "                                this.";
  protected final String TEXT_561 = " = ";
  protected final String TEXT_562 = ";";
  protected final String TEXT_563 = NL + "                    }" + NL + "\t            }" + NL + "" + NL + "\t            java.util.List<BufferLine_";
  protected final String TEXT_564 = "> exInsertColValueList";
  protected final String TEXT_565 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_566 = " exInsertColValue";
  protected final String TEXT_567 = " = null;" + NL + "" + NL + "" + NL + "\t            StringBuilder extendInsertValueStmt_";
  protected final String TEXT_568 = " = new StringBuilder();" + NL + "                for(int i=0;i < ";
  protected final String TEXT_569 = ";i++){" + NL + "                     extendInsertValueStmt_";
  protected final String TEXT_570 = ".append(\"(";
  protected final String TEXT_571 = ")\");" + NL + "                     if (i!=";
  protected final String TEXT_572 = "-1) extendInsertValueStmt_";
  protected final String TEXT_573 = ".append(\",\");" + NL + "                }" + NL + "" + NL + "" + NL + "\t\t\t\tString insert_";
  protected final String TEXT_574 = " = \"INSERT INTO `\"+";
  protected final String TEXT_575 = "+\"` (";
  protected final String TEXT_576 = ") VALUES \" + extendInsertValueStmt_";
  ...
  protected final String TEXT_592 = ".prepareStatement(insert_";
  protected final String TEXT_593 = ");" + NL + "" + NL + "\t            String insertColName";
  protected final String TEXT_594 = " = \"";
  protected final String TEXT_595 = "\";" + NL + "\t            String insertColValue";
  protected final String TEXT_596 = " =  \"";
  protected final String TEXT_597 = "\";" + NL + "\t            int rowCount";
  protected final String TEXT_598 = " = 0;";
  protected final String TEXT_599 = NL + "\t\t\t\tString insert_";
  protected final String TEXT_600 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_601 = " + \"` (";
  protected final String TEXT_602 = ") VALUES (";
  protected final String TEXT_603 = ")\";";
  protected final String TEXT_604 = NL + "\t\t\t\tinsert_";
  protected final String TEXT_605 = " += \tduplidateClause_";
  protected final String TEXT_606 = ".toString();";
  protected final String TEXT_607 = NL + "\t\t        int batchSize_";
  protected final String TEXT_608 = " = ";
  protected final String TEXT_609 = ";" + NL + "\t   \t\t\tint batchSizeCounter_";
  protected final String TEXT_610 = "=0;" + NL + "\t\t        ";
  ...
  protected final String TEXT_624 = " = \"UPDATE `\" + ";
  ...
  protected final String TEXT_642 = ".prepareStatement(\"SELECT COUNT(1) FROM `\" + ";
  protected final String TEXT_643 = " + \"` WHERE ";
  protected final String TEXT_644 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_645 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_646 = " + \"` (";
  protected final String TEXT_647 = ") VALUES (";
  protected final String TEXT_648 = ")\";" + NL + "\t    ";
  protected final String TEXT_649 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_650 = " = new StringBuffer(insert_";
  protected final String TEXT_651 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_652 = ".insert(insert_";
  protected final String TEXT_653 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_654 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_655 = " =insertStringBuffer_";
  protected final String TEXT_656 = ".toString(); ";
  protected final String TEXT_657 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_690 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_694 = " = \"INSERT INTO `\" + ";
  ...
  protected final String TEXT_706 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_756 = "    " + NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_760 = NL + "        StringBuffer query_";
  protected final String TEXT_761 = " = null;" + NL + "       \t";
  ...
  protected final String TEXT_766 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  ...
  protected final String TEXT_784 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_785 = " = insertIgnore_";
  protected final String TEXT_786 = ".split(\"\\\\?\");";
  protected final String TEXT_787 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_788 = " = insert_";
  protected final String TEXT_789 = ".split(\"\\\\?\");";
  protected final String TEXT_790 = NL + NL + "\tclass BufferLine_";
  protected final String TEXT_791 = " {" + NL + "    \t            ";
  protected final String TEXT_792 = NL + "                            ";
  protected final String TEXT_793 = " ";
  protected final String TEXT_794 = ";";
  protected final String TEXT_795 = NL + "\t\t\t\troutines.system.Dynamic ";
  protected final String TEXT_796 = ";" + NL + "\t\t\t";
  protected final String TEXT_797 = NL + NL + "\t                public BufferLine_";
  protected final String TEXT_798 = "(";
  protected final String TEXT_799 = NL + "                                ,";
  protected final String TEXT_800 = NL + "                            ";
  protected final String TEXT_801 = " ";
  protected final String TEXT_802 = NL + "\t\t\t\t, routines.system.Dynamic ";
  protected final String TEXT_803 = NL + "\t\t\t";
  protected final String TEXT_804 = NL + "\t                ){" + NL + "\t                    ";
  protected final String TEXT_805 = NL + "                                this.";
  protected final String TEXT_806 = " = ";
  protected final String TEXT_807 = ";";
  protected final String TEXT_808 = NL + "\t\t\t\tthis.";
  protected final String TEXT_809 = "=";
  protected final String TEXT_810 = ";" + NL + "\t\t\t";
  protected final String TEXT_811 = NL + "                    }" + NL + "\t            }" + NL + "" + NL + "\t\t    java.util.List<BufferLine_";
  protected final String TEXT_812 = "> exInsertColValueList";
  protected final String TEXT_813 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_814 = " exInsertColValue";
  protected final String TEXT_815 = " = null;" + NL + "\t\t    String insert_";
  protected final String TEXT_816 = "=\"\";" + NL + "\t\t    String insertColValue";
  protected final String TEXT_817 = "=\"\";" + NL + "\t\t    String insertColName";
  protected final String TEXT_818 = "=\"\";" + NL + "\t\t    int counter";
  protected final String TEXT_819 = "=1;";
  protected final String TEXT_820 = NL + "\tint batchSizeCounter_";
  protected final String TEXT_821 = "=0;" + NL + "\tint batchSize_";
  protected final String TEXT_822 = "=0;";
  protected final String TEXT_823 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_824 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_825 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_826 = " =null;" + NL + "\tint rowCount";
  protected final String TEXT_827 = "=0;" + NL + "\t";
  protected final String TEXT_828 = NL + "\t\tStringBuffer query_";
  ...
  protected final String TEXT_832 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_833 = " =  null;";
  protected final String TEXT_834 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_835 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_836 = " = null;";
  protected final String TEXT_837 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_838 = " = null;";
  protected final String TEXT_839 = NL + "\t\t\tString[] replaceSQLSplits_";
  ...
  protected final String TEXT_843 = NL + "\t\t \tString[] insertSQLSplits_";
