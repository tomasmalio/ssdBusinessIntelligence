...
public class TPostgresqlConnectionBeginJava
{
  ...
  protected final String TEXT_33 = NL + "\t\tjava.util.Enumeration<java.sql.Driver> drivers_";
  protected final String TEXT_34 = " =  java.sql.DriverManager.getDrivers();" + NL + "    while (drivers_";
  protected final String TEXT_35 = ".hasMoreElements()) {" + NL + "        java.sql.Driver d_";
  protected final String TEXT_36 = " = drivers_";
  protected final String TEXT_37 = ".nextElement();" + NL + "        java.util.List<String> driverList_";
  protected final String TEXT_38 = " = java.util.Arrays.<String>asList(\"com.amazon.redshift.jdbc.Driver\",\"com.amazon.redshift.jdbc41.Driver\");" + NL + "        if (driverList_";
  protected final String TEXT_39 = ".contains(d_";
  protected final String TEXT_40 = ".getClass().getName())) {" + NL + "            try {" + NL + "                java.sql.DriverManager.deregisterDriver(d_";
  protected final String TEXT_41 = ");" + NL + "                java.sql.DriverManager.registerDriver(d_";
  protected final String TEXT_42 = ");" + NL + "            } catch (java.lang.Exception e_";
  protected final String TEXT_43 = ") {" + NL + "            \t\t//do nothing" + NL + "            }" + NL + "        }" + NL + "    }";
  ...
  protected final String TEXT_155 = NL + NL + "\tglobalMap.put(\"schema_\" + \"";
