...
public class TMomOutputBeginJava
{
  ...
  protected final String TEXT_250 = NL + "\t\t\tglobalMap.put(\"producer_";
  protected final String TEXT_251 = "\",producer_";
  protected final String TEXT_252 = ");" + NL + "\t\t\tglobalMap.put(\"session_";
  protected final String TEXT_253 = "\",session_";
  protected final String TEXT_254 = ");" + NL + "\t\t\tglobalMap.put(\"connection_";
