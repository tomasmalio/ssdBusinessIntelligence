...
public class TSQSQueueAttributesBeginJava
{
  protected static String nl;
  public static synchronized TSQSQueueAttributesBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSQSQueueAttributesBeginJava result = new TSQSQueueAttributesBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_76 = NL + "\ttry{" + NL + "\t\tcom.amazonaws.services.sqs.model.GetQueueAttributesRequest ";
  protected final String TEXT_77 = "_receiveAttributsRequest = new com.amazonaws.services.sqs.model.GetQueueAttributesRequest(";
  protected final String TEXT_78 = ").withAttributeNames(\"All\");" + NL + "\t\tcom.amazonaws.services.sqs.model.GetQueueAttributesResult ";
  protected final String TEXT_79 = "_receiveAttributesResult = conn_";
  protected final String TEXT_80 = ".getQueueAttributes(";
  protected final String TEXT_81 = "_receiveAttributsRequest);" + NL + "\t\tjava.util.Map<String, String> ";
  protected final String TEXT_82 = "_receiveAttributeMap = ";
  protected final String TEXT_83 = "_receiveAttributesResult.getAttributes();" + NL + "" + NL + "\t\t";
  protected final String TEXT_84 = NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_85 = ".";
  protected final String TEXT_86 = " = ";
  protected final String TEXT_87 = "_receiveAttributeMap.get(\"";
  protected final String TEXT_88 = "\");" + NL + "   \t";
  protected final String TEXT_89 = NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_90 = ".";
  protected final String TEXT_91 = " = ParserUtils.parseTo_Integer(";
  protected final String TEXT_92 = "_receiveAttributeMap.get(\"";
  protected final String TEXT_93 = "\"));" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_94 = NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_95 = ".";
  protected final String TEXT_96 = " = ParserUtils.parseTo_Boolean(";
  protected final String TEXT_97 = "_receiveAttributeMap.get(\"";
  protected final String TEXT_98 = "\"));" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_99 = NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_100 = ".";
  protected final String TEXT_101 = " = ParserUtils.parseTo_Long(";
  protected final String TEXT_102 = "_receiveAttributeMap.get(\"";
  protected final String TEXT_103 = "\"));" + NL + "\t";
  protected final String TEXT_104 = NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_105 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_106 = " - Change message visibility successfully.\");" + NL + "\t\t";
  protected final String TEXT_107 = NL + "\t}catch(java.lang.Exception e_";
  ...
  protected final String TEXT_116 = NL + "\t}finally{" + NL + "\t\tif(conn_";
  protected final String TEXT_117 = " !=null){" + NL + "\t\t\tconn_";
  protected final String TEXT_118 = ".shutdown();" + NL + "\t\t}" + NL + "\t\t";
