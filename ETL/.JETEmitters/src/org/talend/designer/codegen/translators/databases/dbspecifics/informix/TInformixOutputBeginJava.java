...
public class TInformixOutputBeginJava {
  ...
  protected final String TEXT_147 = ".commit();";
  ...
  protected final String TEXT_400 = NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_504 = ".prepareStatement(\"SELECT COUNT(*) FROM \" + tableName_";
  ...
  protected final String TEXT_573 = NL + NL + "        int commitEvery_";
  protected final String TEXT_574 = " = ";
  protected final String TEXT_575 = ";" + NL + "" + NL + "        int commitCounter_";
