...
public class TTaCoKitGuessSchemaEnd_tailJava
{
  protected static String nl;
  public static synchronized TTaCoKitGuessSchemaEnd_tailJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TTaCoKitGuessSchemaEnd_tailJava result = new TTaCoKitGuessSchemaEnd_tailJava();
    nl = null;
    return result;
  }
