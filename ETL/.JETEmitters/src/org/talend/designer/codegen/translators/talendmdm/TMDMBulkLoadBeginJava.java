...
public class TMDMBulkLoadBeginJava
{
  ...
  protected final String TEXT_68 = " == null) {" + NL + "            Boolean transInitStart_";
  protected final String TEXT_69 = " = false;" + NL + "            synchronized(globalMap){" + NL + "                if(globalMap.containsKey(transKey_";
  protected final String TEXT_70 = " + \"_initStart\")){" + NL + "                    transInitStart_";
  protected final String TEXT_71 = " = true;" + NL + "                }else{" + NL + "                    globalMap.put(transKey_";
  protected final String TEXT_72 = " + \"_initStart\", true);" + NL + "                }" + NL + "            }" + NL + "            if(transInitStart_";
  protected final String TEXT_73 = " == false){" + NL + "                String murl_";
  protected final String TEXT_74 = " = (String)globalMap.get(\"mdmUrl_";
  protected final String TEXT_75 = "\");" + NL + "                if(murl_";
  protected final String TEXT_76 = ".endsWith(\"?wsdl\")) {" + NL + "                    murl_";
  protected final String TEXT_77 = " = murl_";
  protected final String TEXT_78 = ".substring(0, murl_";
  protected final String TEXT_79 = ".length() - 5);" + NL + "                }" + NL + "                String turl_";
  protected final String TEXT_80 = " = com.talend.mdm.transaction.client.MDMTransactionClient.getMDMTransactionURL(murl_";
  protected final String TEXT_81 = ", true);" + NL + "                String username_";
  protected final String TEXT_82 = " = (String)globalMap.get(\"username_";
  protected final String TEXT_83 = "\");" + NL + "                String password_";
  protected final String TEXT_84 = " = (String)globalMap.get(\"password_";
  protected final String TEXT_85 = "\");" + NL + "                if((Boolean)globalMap.get(\"useClientTranId_";
  protected final String TEXT_86 = "\")){" + NL + "                    List<String> cookies_";
  protected final String TEXT_87 = " = com.talend.mdm.transaction.client.MDMTransactionClient.getCookies(turl_";
  protected final String TEXT_88 = ",username_";
  protected final String TEXT_89 = ",password_";
  protected final String TEXT_90 = ");" + NL + "                    mdmTransaction_";
  protected final String TEXT_91 = " = new com.talend.mdm.transaction.client.MDMTransaction();" + NL + "                    mdmTransaction_";
  protected final String TEXT_92 = ".setUrl(turl_";
  protected final String TEXT_93 = ");" + NL + "                    mdmTransaction_";
  protected final String TEXT_94 = ".setId(\"";
  protected final String TEXT_95 = "_\" + java.util.UUID.randomUUID());" + NL + "                    mdmTransaction_";
  protected final String TEXT_96 = ".setUsername(username_";
  protected final String TEXT_97 = ");" + NL + "                    mdmTransaction_";
  protected final String TEXT_98 = ".setPassword(password_";
  protected final String TEXT_99 = ");" + NL + "                    mdmTransaction_";
  protected final String TEXT_100 = ".setCookies(cookies_";
  protected final String TEXT_101 = ");" + NL + "                }else{";
  protected final String TEXT_102 = NL + "                    mdmTransaction_";
  protected final String TEXT_103 = " = com.talend.mdm.transaction.client.MDMTransactionClient.newTransaction(turl_";
  protected final String TEXT_104 = ",username_";
  protected final String TEXT_105 = ",password_";
  protected final String TEXT_106 = ");" + NL + "                }" + NL + "            }else{" + NL + "                while(mdmTransaction_";
  protected final String TEXT_107 = " == null){" + NL + "                    Thread.sleep(10);" + NL + "                    mdmTransaction_";
  protected final String TEXT_108 = " = (com.talend.mdm.transaction.client.MDMTransaction)globalMap.get(transKey_";
  protected final String TEXT_109 = ");" + NL + "                }" + NL + "            }" + NL + "            globalMap.put(transKey_";
  protected final String TEXT_110 = ", mdmTransaction_";
  protected final String TEXT_111 = ");";
  protected final String TEXT_112 = NL + "        }" + NL + "        bulkloadClient_";
  protected final String TEXT_113 = ".setTransactionId(mdmTransaction_";
  protected final String TEXT_114 = ".getId());" + NL + "        bulkloadClient_";
  protected final String TEXT_115 = ".setCookies(mdmTransaction_";
  protected final String TEXT_116 = ".getCookies());" + NL + "    }";
  protected final String TEXT_117 = NL + NL + "bulkloadClient_";
  protected final String TEXT_118 = ".startThreadCount();" + NL + "bulkloadClient_";
  protected final String TEXT_119 = ".setOptions(new org.talend.mdm.bulkload.client.BulkloadOptions(";
  protected final String TEXT_120 = ", ";
  protected final String TEXT_121 = ", ";
  protected final String TEXT_122 = ", ";
  protected final String TEXT_123 = "));" + NL + "int count_";
  protected final String TEXT_124 = " = 0;" + NL + "org.talend.mdm.bulkload.client.InputStreamMerger inputStreamMerger_";
