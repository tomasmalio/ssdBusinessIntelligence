...
public class TSQSQueuePurgeBeginJava
{
  ...
  protected final String TEXT_78 = " - Purging a queue with name:\" + ";
  protected final String TEXT_79 = ");" + NL + "\t\t";
  protected final String TEXT_80 = NL + "        conn_";
  protected final String TEXT_81 = ".purgeQueue(new com.amazonaws.services.sqs.model.PurgeQueueRequest(";
  protected final String TEXT_82 = "));" + NL + "        " + NL + "\t\t";
  protected final String TEXT_83 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_84 = " - Purge queue successfully.\");" + NL + "\t\t";
