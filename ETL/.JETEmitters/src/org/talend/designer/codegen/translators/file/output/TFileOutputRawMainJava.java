...
public class TFileOutputRawMainJava
{
  ...
  protected final String TEXT_36 = ".close();" + NL + "\t\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\t    org.apache.commons.io.FileUtils.writeStringToFile(file_";
  protected final String TEXT_37 = ", content_";
  protected final String TEXT_38 = ".toString(), ";
  protected final String TEXT_39 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t} catch (java.lang.Exception e_";
