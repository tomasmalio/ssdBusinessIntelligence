...
public class TExtractJSONFieldsMainJava
{
  ...
  protected final String TEXT_347 = NL + NL + "String loopPath_";
  protected final String TEXT_348 = " = ";
  protected final String TEXT_349 = ";" + NL + "java.util.List<Object> resultset_";
  protected final String TEXT_350 = " = new java.util.ArrayList<Object>();" + NL + "" + NL + "boolean isStructError_";
  protected final String TEXT_351 = " = true;" + NL + "try {" + NL + "\tcom.jayway.jsonpath.ReadContext document_";
  protected final String TEXT_352 = " = com.jayway.jsonpath.JsonPath.parse(jsonStr_";
  protected final String TEXT_353 = ");" + NL + "\tcom.jayway.jsonpath.JsonPath compiledLoopPath_";
  protected final String TEXT_354 = " = jsonPathCache_";
  protected final String TEXT_355 = ".getCompiledJsonPath(loopPath_";
  protected final String TEXT_356 = ");" + NL + "\tObject result_";
  protected final String TEXT_357 = " = document_";
  protected final String TEXT_358 = ".read(compiledLoopPath_";
  protected final String TEXT_359 = ",net.minidev.json.JSONObject.class);" + NL + "\tif (result_";
  protected final String TEXT_360 = " instanceof net.minidev.json.JSONArray) {" + NL + "\t\tresultset_";
  protected final String TEXT_361 = " = (net.minidev.json.JSONArray) result_";
  protected final String TEXT_362 = ";" + NL + "\t} else {" + NL + "\t\tresultset_";
  protected final String TEXT_363 = ".add(result_";
  protected final String TEXT_364 = ");" + NL + "\t}" + NL + "\t" + NL + "\tisStructError_";
  protected final String TEXT_365 = " = false;" + NL + "} catch (java.lang.Exception ex_";
  protected final String TEXT_366 = ") {";
  protected final String TEXT_367 = NL + "\tthrow(ex_";
  protected final String TEXT_368 = ");";
  protected final String TEXT_369 = NL + "    \t";
  protected final String TEXT_370 = " = new ";
  protected final String TEXT_371 = "Struct();" + NL + "\t    ";
  protected final String TEXT_372 = ".errorJSONField = jsonStr_";
  protected final String TEXT_373 = ";" + NL + "    \t";
  protected final String TEXT_374 = ".errorMessage = ex_";
  protected final String TEXT_375 = ".getMessage() + \" - Line: \" + tos_count_";
  ...
  protected final String TEXT_383 = " - \" + ex_";
  protected final String TEXT_384 = ".getMessage());";
  protected final String TEXT_385 = NL + "\t\tSystem.err.println(ex_";
  protected final String TEXT_386 = ".getMessage());";
  protected final String TEXT_387 = NL + "}" + NL + "" + NL + "String jsonPath_";
  protected final String TEXT_388 = " = null;" + NL + "com.jayway.jsonpath.JsonPath compiledJsonPath_";
  protected final String TEXT_389 = " = null;" + NL + "" + NL + "Object value_";
  protected final String TEXT_390 = " = null;" + NL + "" + NL + "for(int i_";
  protected final String TEXT_391 = "=0; isStructError_";
  protected final String TEXT_392 = " || (i_";
  protected final String TEXT_393 = " < resultset_";
  protected final String TEXT_394 = ".size());i_";
  protected final String TEXT_395 = "++){" + NL + "\tif(!isStructError_";
  protected final String TEXT_396 = "){" + NL + "\t\tObject row_";
  protected final String TEXT_397 = " = resultset_";
  ...
  protected final String TEXT_404 = "Struct();" + NL + "\tnb_line_";
  protected final String TEXT_405 = "++;" + NL + "\ttry {";
  protected final String TEXT_406 = NL + "        \t\t";
  protected final String TEXT_407 = ".";
  protected final String TEXT_408 = " = ";
  protected final String TEXT_409 = ".";
  protected final String TEXT_410 = ";";
  protected final String TEXT_411 = NL + "\t\tjsonPath_";
  protected final String TEXT_412 = " = ";
  protected final String TEXT_413 = ";" + NL + "\t\tcompiledJsonPath_";
  protected final String TEXT_414 = " = jsonPathCache_";
  protected final String TEXT_415 = ".getCompiledJsonPath(jsonPath_";
  protected final String TEXT_416 = ");" + NL + "\t\t" + NL + "\t\ttry {" + NL + "\t\t\tvalue_";
  protected final String TEXT_417 = " = compiledJsonPath_";
  protected final String TEXT_418 = ".read(row_";
  protected final String TEXT_419 = ");";
  protected final String TEXT_420 = NL + "\t\t\t\t";
  protected final String TEXT_421 = ".";
  protected final String TEXT_422 = " = value_";
  protected final String TEXT_423 = " == null ? ";
  protected final String TEXT_424 = NL;
  protected final String TEXT_425 = NL + "\t\t";
  protected final String TEXT_426 = NL + "\t\t";
  protected final String TEXT_427 = NL + NL + " : value_";
  protected final String TEXT_428 = ".toString();";
  protected final String TEXT_429 = NL + "\t\t\t\tif(value_";
  protected final String TEXT_430 = " != null && !value_";
  protected final String TEXT_431 = ".toString().isEmpty()) {";
  protected final String TEXT_432 = NL + "\t\t\t\t\t";
  protected final String TEXT_433 = ".";
  protected final String TEXT_434 = " = value_";
  protected final String TEXT_435 = ".toString();";
  protected final String TEXT_436 = NL + "\t\t\t\t\t";
  protected final String TEXT_437 = ".";
  protected final String TEXT_438 = " = ParserUtils.parseTo_Date(value_";
  protected final String TEXT_439 = ".toString(), ";
  protected final String TEXT_440 = ");";
  protected final String TEXT_441 = NL + "        \t\t    ";
  protected final String TEXT_442 = ".";
  protected final String TEXT_443 = " = ParserUtils.parseTo_List(value_";
  protected final String TEXT_444 = ".toString(),\",\");" + NL + "        \t\t";
  protected final String TEXT_445 = NL + "\t\t\t\t\t";
  protected final String TEXT_446 = ".";
  protected final String TEXT_447 = " = ParserUtils.parseTo_";
  protected final String TEXT_448 = "(value_";
  ...
  protected final String TEXT_456 = NL + NL + ";" + NL + "\t\t\t\t}";
  protected final String TEXT_457 = NL + "\t\t} catch (com.jayway.jsonpath.PathNotFoundException e_";
  ...
  protected final String TEXT_467 = "\t" + NL + "\t} catch (java.lang.Exception ex_";
  protected final String TEXT_468 = ") {";
  protected final String TEXT_469 = NL + "    \tthrow(ex_";
  protected final String TEXT_470 = ");";
  protected final String TEXT_471 = NL + "    \t\t";
  protected final String TEXT_472 = " = new ";
  protected final String TEXT_473 = "Struct();";
  ...
  protected final String TEXT_480 = ".errorJSONField = jsonStr_";
  protected final String TEXT_481 = ";" + NL + "\t\t    ";
  protected final String TEXT_482 = ".errorMessage = ex_";
  protected final String TEXT_483 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_484 = ";" + NL + "\t\t    ";
  protected final String TEXT_485 = " = null;";
  protected final String TEXT_486 = NL + "\t\t\tlog.error(\"";
  protected final String TEXT_487 = " - \" + ex_";
  protected final String TEXT_488 = ".getMessage());";
  protected final String TEXT_489 = NL + "\t\t    System.err.println(ex_";
  protected final String TEXT_490 = ".getMessage());" + NL + "\t\t    ";
  protected final String TEXT_491 = " = null;";
  protected final String TEXT_492 = NL + "\t\t    ";
  protected final String TEXT_493 = ".errorJSONField = jsonStr_";
  protected final String TEXT_494 = ";" + NL + "\t\t    ";
  protected final String TEXT_495 = ".errorMessage = ex_";
  protected final String TEXT_496 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_497 = ";";
  protected final String TEXT_498 = "\t" + NL + "\t}" + NL + "\t" + NL + "\t}" + NL + "    " + NL + "\tisStructError_";
  protected final String TEXT_499 = " = false;" + NL + "\t";
  protected final String TEXT_500 = NL + "\tlog.debug(\"";
  protected final String TEXT_501 = " - Extracting the record \" + nb_line_";
