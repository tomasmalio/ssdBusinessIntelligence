...
public class TSybaseOutputBeginJava {
  ...
  protected final String TEXT_409 = NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_584 = ".createStatement();" + NL + "\t    stmt_";
  protected final String TEXT_585 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_586 = " +\" ON\");" + NL + "\t    ";
