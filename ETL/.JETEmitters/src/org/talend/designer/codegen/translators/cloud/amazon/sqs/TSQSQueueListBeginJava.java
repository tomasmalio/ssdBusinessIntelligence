...
public class TSQSQueueListBeginJava
{
  ...
  protected final String TEXT_76 = NL + "\tint nb_queue_";
  protected final String TEXT_77 = " = 0;" + NL + "\t";
  protected final String TEXT_78 = NL + "\t\tlog.info(\"";
  protected final String TEXT_79 = " - Retrieving queues from the server.\");" + NL + "\t";
  protected final String TEXT_80 = NL + "\t";
  protected final String TEXT_81 = NL + "\t\ttry{" + NL + "\t";
  protected final String TEXT_82 = NL + "\t" + NL + "\tfor (String queueUrl_";
  protected final String TEXT_83 = " : conn_";
  protected final String TEXT_84 = ".listQueues().getQueueUrls()) {" + NL + "\t\tnb_queue_";
  protected final String TEXT_85 = "++;" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_86 = "_CURRENT_QUEUE_NAME\", queueUrl_";
  protected final String TEXT_87 = ");" + NL + "\t\t";
  protected final String TEXT_88 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_89 = " - Retrieving the queue \" + nb_queue_";
  protected final String TEXT_90 = " + \".\");" + NL + "\t\t\tlog.trace(\"";
  protected final String TEXT_91 = " - Name of current queue : \" + queueUrl_";
