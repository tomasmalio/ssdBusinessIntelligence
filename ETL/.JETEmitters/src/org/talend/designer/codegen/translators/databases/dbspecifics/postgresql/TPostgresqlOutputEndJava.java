...
public class TPostgresqlOutputEndJava
{
  ...
  protected final String TEXT_152 = NL + "            pstmt_";
  protected final String TEXT_153 = ".close();";
  protected final String TEXT_154 = NL + "            SharedDBPreparedStatement.releasePreparedStatement(keyPsmt_";
  protected final String TEXT_155 = ");";
  protected final String TEXT_156 = NL + "        }";
  protected final String TEXT_157 = NL;
  protected final String TEXT_158 = NL + "\t\t\t";
  protected final String TEXT_159 = NL + "\t\t\tconn_";
  protected final String TEXT_160 = ".commit();" + NL + "\t\t\t";
