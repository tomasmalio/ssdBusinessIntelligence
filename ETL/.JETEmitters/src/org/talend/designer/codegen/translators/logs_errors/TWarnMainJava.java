...
public class TWarnMainJava
{
  ...
  protected final String TEXT_46 = "\t" + NL + "try {" + NL + "\t" + NL + "\tresumeUtil.addLog(\"USER_DEF_LOG\", \"NODE:";
  ...
  protected final String TEXT_63 = ");" + NL + "\t" + NL + "} catch (Exception e_";
  protected final String TEXT_64 = ") {" + NL + "\tlogIgnoredError(String.format(\"";
  protected final String TEXT_65 = " - tWarn failed to log message due to internal error: %s\", e_";
  protected final String TEXT_66 = "), e_";
