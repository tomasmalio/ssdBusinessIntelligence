...
public class TELTOracleOutputMainJava
{
  ...
  protected final String TEXT_232 = "System.out.println(\"Inserting with : \\n\" + insertQuery_";
  protected final String TEXT_233 = " + \"\\n\");";
  protected final String TEXT_234 = NL + "nb_line_inserted_";
  protected final String TEXT_235 = " = pstmt_";
  protected final String TEXT_236 = ".executeUpdate();";
  protected final String TEXT_237 = "System.out.println(\"--> \" + nb_line_inserted_";
  protected final String TEXT_238 = " + \" rows inserted. \\n\");";
  protected final String TEXT_239 = NL + NL + "\t";
  protected final String TEXT_240 = "System.out.println(\"Updating with : \\n\" + updateQuery_";
  protected final String TEXT_241 = " +\"\\n\");";
  protected final String TEXT_242 = NL + "nb_line_updated_";
  protected final String TEXT_243 = " = pstmt_";
  protected final String TEXT_244 = ".executeUpdate();";
  protected final String TEXT_245 = NL + "\t";
  protected final String TEXT_246 = "System.out.println(\"--> \" + nb_line_updated_";
  protected final String TEXT_247 = " + \" rows updated. \\n\");";
  protected final String TEXT_248 = NL + "\t";
  protected final String TEXT_249 = NL + "\t";
  protected final String TEXT_250 = "System.out.println(\"Deleting with : \\n\" + deleteQuery_";
  protected final String TEXT_251 = " +\"\\n\");";
  protected final String TEXT_252 = NL + "\t\t";
  protected final String TEXT_253 = NL + "\t\tnb_line_deleted_";
  protected final String TEXT_254 = " = pstmt_";
  protected final String TEXT_255 = ".executeUpdate();" + NL + "\t\t";
  protected final String TEXT_256 = NL + "\t";
  protected final String TEXT_257 = "System.out.println(\"--> \" + nb_line_deleted_";
  protected final String TEXT_258 = " + \" rows deleted. \\n\");";
  protected final String TEXT_259 = NL + "\t\t";
  protected final String TEXT_260 = NL + "\t";
  protected final String TEXT_261 = "System.out.println(\"Merge with : \\n\" + mergeQuery +\"\\n\");";
  protected final String TEXT_262 = NL + "\t\t";
  protected final String TEXT_263 = NL + "\t    nb_line_merged_";
  protected final String TEXT_264 = " = pstmt_";
  protected final String TEXT_265 = ".executeUpdate();" + NL + "\t\t";
  protected final String TEXT_266 = NL + "\t";
  protected final String TEXT_267 = "System.out.println(\"--> \" + nb_line_merged_";
  protected final String TEXT_268 = " + \" rows merged. \\n\");";
  protected final String TEXT_269 = NL + "\t";
  protected final String TEXT_270 = NL + NL + "pstmt_";
  protected final String TEXT_271 = ".close();" + NL;
  protected final String TEXT_272 = NL + "    if(conn_";
  protected final String TEXT_273 = " != null && !conn_";
  protected final String TEXT_274 = ".isClosed()) {" + NL + "\t\t";
  protected final String TEXT_275 = NL + "    }";
  protected final String TEXT_276 = NL + "nb_line_";
  protected final String TEXT_277 = " = nb_line_updated_";
  protected final String TEXT_278 = " + nb_line_inserted_";
  protected final String TEXT_279 = " + nb_line_deleted_";
  protected final String TEXT_280 = " + nb_line_merged_";
  ...
  protected final String TEXT_284 = "_NB_LINE_UPDATED\",nb_line_updated_";
  protected final String TEXT_285 = ");" + NL + "globalMap.put(\"";
  protected final String TEXT_286 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_287 = ");" + NL + "globalMap.put(\"";
  protected final String TEXT_288 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_289 = ");" + NL + "globalMap.put(\"";
  protected final String TEXT_290 = "_NB_LINE_MERGED\",nb_line_merged_";
  protected final String TEXT_291 = ");" + NL;
  protected final String TEXT_292 = NL + "\tlog.info(\"";
  protected final String TEXT_293 = " - Has ";
  protected final String TEXT_294 = " records count: \" + nb_line_";
