...
public class TAdvancedFileOutputXMLMainJava {
  ...
  protected final String TEXT_362 = NL + "\t\tnestXMLTool_";
  protected final String TEXT_363 = ".getElement(";
  protected final String TEXT_364 = ",new String[]{" + NL + "\t\t";
  protected final String TEXT_365 = NL + "\t\t\t\t,\"";
  protected final String TEXT_366 = "\"" + NL + "\t\t\t";
  protected final String TEXT_367 = "\t\t" + NL + "\t\t\t\t\"";
  protected final String TEXT_368 = "\"" + NL + "\t\t\t";
  protected final String TEXT_369 = NL + "\t\t})" + NL + "\t\t";
  protected final String TEXT_370 = NL + "    \t// buffer the start tabs to group buffer" + NL + "    \tgroupBuffer_";
  protected final String TEXT_371 = "[";
  protected final String TEXT_372 = "] = buf_";
  protected final String TEXT_373 = ".toString();" + NL + "        buf_";
  protected final String TEXT_374 = " = new StringBuffer();";
  protected final String TEXT_375 = NL + "\t\tstartTabs_";
  protected final String TEXT_376 = "[";
  protected final String TEXT_377 = "] = buf_";
  protected final String TEXT_378 = ".toString();" + NL + "        buf_";
  protected final String TEXT_379 = " = new StringBuffer();";
  protected final String TEXT_380 = NL + "\t\tout_";
  protected final String TEXT_381 = ".write(buf_";
  protected final String TEXT_382 = ".toString());" + NL + "        buf_";
  protected final String TEXT_383 = " = new StringBuffer();";
  protected final String TEXT_384 = NL + "\t\tif( false";
  protected final String TEXT_385 = " || valueMap_";
  protected final String TEXT_386 = ".get(\"";
  protected final String TEXT_387 = "\") != null";
  protected final String TEXT_388 = " || true " + NL + "                    \t";
  ...
  protected final String TEXT_397 = NL + "\t\tbuf_";
  protected final String TEXT_398 = ".append(\" xmlns:xsi=\\\"http://www.w3.org/2001/XMLSchema-instance\\\"\");" + NL + "\t\tbuf_";
  protected final String TEXT_399 = ".append(\" xsi:noNamespaceSchemaLocation= \\\"\"+ file_";
  protected final String TEXT_400 = ".substring(file_";
  protected final String TEXT_401 = ".lastIndexOf(\"/\")+1)+\".xsd\"+\"\\\"\");";
  protected final String TEXT_402 = NL + "\t\tif(";
  protected final String TEXT_403 = " == null){" + NL + "\t\t\tbuf_";
  protected final String TEXT_404 = ".append(\" xsi:nil=\\\"true\\\"\");" + NL + "\t\t}";
  ...
  protected final String TEXT_413 = NL + "\t\tbuf_";
  protected final String TEXT_414 = ".append(\"</";
  protected final String TEXT_415 = ">\");";
  protected final String TEXT_416 = NL + "\t\tif(";
  protected final String TEXT_417 = "!=null){" + NL + "\t\t\tif(routines.system.XMLHelper.getInstance().isValid(";
  protected final String TEXT_418 = ")){" + NL + "\t\t\t\tbuf_";
  protected final String TEXT_419 = ".append(";
  protected final String TEXT_420 = ");" + NL + "\t\t\t} else {" + NL + "\t\t\t\tbuf_";
  ...
  protected final String TEXT_424 = "!=null){" + NL + "\t\t\tbuf_";
  protected final String TEXT_425 = ".append(TalendString.checkCDATAForXML(";
  protected final String TEXT_426 = "));" + NL + "\t\t}";
  protected final String TEXT_427 = NL + "\t\tif(routines.system.XMLHelper.getInstance().isValid(\"";
  protected final String TEXT_428 = "\")){" + NL + "\t\t\tbuf_";
  protected final String TEXT_429 = ".append(\"";
  protected final String TEXT_430 = "\");" + NL + "\t\t} else {" + NL + "\t\t\tbuf_";
  protected final String TEXT_431 = ".append(TalendString.checkCDATAForXML(\"";
  protected final String TEXT_432 = "\"));" + NL + "\t\t}";
  protected final String TEXT_433 = NL + "\t\t  if (";
  protected final String TEXT_434 = "!=null){" + NL + "\t\t\tbuf_";
  protected final String TEXT_435 = ".append(\" ";
  protected final String TEXT_436 = "=\\\"\"+TalendString.replaceSpecialCharForXML(";
  protected final String TEXT_437 = ")+\"\\\"\");" + NL + "\t\t  } ";
  protected final String TEXT_438 = " else{" + NL + "\t\t    buf_";
  ...
  protected final String TEXT_443 = "=\\\"\"+TalendString.replaceSpecialCharForXML(\"";
  protected final String TEXT_444 = "\")+\"\\\"\");";
  protected final String TEXT_445 = NL + "\t\t    buf_";
  protected final String TEXT_446 = ".append(\" ";
  protected final String TEXT_447 = "=\\\"\\\"\");" + NL + "\t\t  ";
  protected final String TEXT_448 = NL + "\t\tif(";
  protected final String TEXT_449 = "!=null){";
  protected final String TEXT_450 = NL + "        \tbuf_";
  protected final String TEXT_451 = ".append(\" xmlns=\\\"\"+TalendString.replaceSpecialCharForXML(";
  protected final String TEXT_452 = ")+\"\\\"\");";
  protected final String TEXT_453 = NL + "\t\t\tbuf_";
  protected final String TEXT_454 = ".append(\" xmlns:";
  protected final String TEXT_455 = "=\\\"\"+TalendString.replaceSpecialCharForXML(";
  protected final String TEXT_456 = ")+\"\\\"\");";
  protected final String TEXT_457 = NL + "\t\t}";
  protected final String TEXT_458 = NL + "        \tbuf_";
  protected final String TEXT_459 = ".append(\" xmlns=\\\"\"+TalendString.replaceSpecialCharForXML(\"";
  protected final String TEXT_460 = "\")+\"\\\"\");";
  protected final String TEXT_461 = NL + "\t\t\tbuf_";
  protected final String TEXT_462 = ".append(\" xmlns:";
  protected final String TEXT_463 = "=\\\"\"+TalendString.replaceSpecialCharForXML(\"";
  protected final String TEXT_464 = "\")+\"\\\"\");";
  protected final String TEXT_465 = NL;
  protected final String TEXT_466 = NL + "\tnb_line_";
  protected final String TEXT_467 = "++;" + NL + "\tvalueMap_";
  protected final String TEXT_468 = ".clear();";
  protected final String TEXT_469 = NL + "\tadvancedXMLUtil_";
  protected final String TEXT_470 = ".putValue_";
  protected final String TEXT_471 = "(";
  protected final String TEXT_472 = ",valueMap_";
  protected final String TEXT_473 = ",compactFormat_";
  protected final String TEXT_474 = ");";
  protected final String TEXT_475 = NL + "\tvalueMap_";
  protected final String TEXT_476 = ".put(\"";
  protected final String TEXT_477 = "\", ";
  protected final String TEXT_478 = ");";
  protected final String TEXT_479 = NL + "\t";
  protected final String TEXT_480 = NL + "\t" + NL + "\t// build root xml tree " + NL + "\tif (needRoot_";
  protected final String TEXT_481 = ") {" + NL + "\t\tneedRoot_";
  protected final String TEXT_482 = "=false;" + NL + "\t\tif(orders_";
  protected final String TEXT_483 = ".length>0){" + NL + "\t\t\torders_";
  protected final String TEXT_484 = "[0] = 0;" + NL + "\t\t}";
  protected final String TEXT_485 = NL + "\t\troot4Group_";
  protected final String TEXT_486 = " =  ";
  protected final String TEXT_487 = ";" + NL + "\t}else{" + NL + "\t\t";
  protected final String TEXT_488 = NL + "\t}" + NL + "\t// build group xml tree ";
  ...
  protected final String TEXT_495 = " == null){" + NL + "\t\t\t\tfirstGroupPathElement_";
  protected final String TEXT_496 = " = (org.dom4j.Element)doc_";
  protected final String TEXT_497 = ".selectSingleNode(\"";
  protected final String TEXT_498 = "\");" + NL + "\t\t\t\tif(firstGroupPathElement_";
  protected final String TEXT_499 = " == null) {" + NL + "\t\t\t\t\tSystem.err.println(\"WARN : the root tag is not same when appending\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_500 = NL + "\t\t\t\t\tlog.error(\"";
  protected final String TEXT_501 = " - the root tag is not same when appending\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_502 = NL + "\t\t\t\t} else { " + NL + "\t\t\t\t\tString subRootPath = firstGroupPathElement_";
  protected final String TEXT_503 = ".getPath().replace(\"*[name()='\",\"\").replace(\"']\", \"\");" + NL + "\t\t\t\t\tif(!\"";
  protected final String TEXT_504 = "\".equals(subRootPath)) {" + NL + "\t\t\t\t\t\tSystem.err.println(\"WARN : the root tag is not same on namespace prefix when appending\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_505 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_506 = " - the root tag is not same on namespace prefix when appending\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_507 = NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t}else{" + NL + "\t\t\t\tfirstGroupPathElement_";
  protected final String TEXT_508 = " = firstGroupPathElement_";
  protected final String TEXT_509 = ".getParent();" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_510 = NL + "\t\t" + NL + "\t\tboolean bl_";
  protected final String TEXT_511 = "= false;//true:find the insert node;false:not";
  protected final String TEXT_512 = NL + "\t\tif(bl_";
  protected final String TEXT_513 = "==false){" + NL + "\t\t\tjava.util.List<org.dom4j.Element> listNodes= ";
  protected final String TEXT_514 = ".elements();" + NL + "\t\t\tif(listNodes!=null && listNodes.size()>0){" + NL + "\t\t\t\tint j=0;" + NL + "\t\t\t\tfor(j=0;j<listNodes.size();j++){" + NL + "\t\t\t\t\torg.dom4j.Element tempElem =listNodes.get(j);" + NL + "\t\t\t\t\tif((\"";
  protected final String TEXT_515 = "\").equals(tempElem.getPath()!=null ? tempElem.getPath().replace(\"*[name()='\",\"\").replace(\"']\", \"\") : \"\")){";
  protected final String TEXT_516 = NL + "\t\t\t\t\t\tif(advancedXMLUtil_";
  protected final String TEXT_517 = ".generateCodeDom4j_FindInsertNode";
  protected final String TEXT_518 = "(tempElem,valueMap_";
  protected final String TEXT_519 = ")){";
  protected final String TEXT_520 = NL + "\t\t\t\t\t\tif(";
  protected final String TEXT_521 = "){";
  protected final String TEXT_522 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_523 = NL + "\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\tif(j>=listNodes.size()){" + NL + "\t\t\t\t\tbl_";
  protected final String TEXT_524 = "=true;" + NL + "\t\t\t\t}" + NL + "\t\t\t}else{" + NL + "\t\t\t\tbl_";
  protected final String TEXT_525 = "=true;" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\tif(bl_";
  protected final String TEXT_526 = "==true){";
  protected final String TEXT_527 = NL + "\t\t\t\t\t\torg.dom4j.Element group";
  protected final String TEXT_528 = "__";
  protected final String TEXT_529 = " = advancedXMLUtil_";
  protected final String TEXT_530 = ".generateCodeDom4j_UnFindInsertNode";
  protected final String TEXT_531 = "(nestXMLTool_";
  protected final String TEXT_532 = ",valueMap_";
  protected final String TEXT_533 = ",";
  protected final String TEXT_534 = ",orders_";
  protected final String TEXT_535 = ",bl_";
  protected final String TEXT_536 = ");";
  protected final String TEXT_537 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_538 = NL + "\t\t}";
  protected final String TEXT_539 = NL + "\tboolean isNewElememt_";
  protected final String TEXT_540 = " = false;";
  protected final String TEXT_541 = NL + "\tif(isNewElememt_";
  protected final String TEXT_542 = " || groupbyList_";
  protected final String TEXT_543 = ".size()<=";
  protected final String TEXT_544 = " || groupbyList_";
  protected final String TEXT_545 = ".get(";
  protected final String TEXT_546 = ")==null";
  protected final String TEXT_547 = NL + "\t|| advancedXMLUtil_";
  protected final String TEXT_548 = ".getValue_";
  protected final String TEXT_549 = "_";
  protected final String TEXT_550 = "(groupbyList_";
  protected final String TEXT_551 = ",valueMap_";
  protected final String TEXT_552 = ")";
  protected final String TEXT_553 = NL + "\t|| ( groupbyList_";
  protected final String TEXT_554 = ".get(";
  protected final String TEXT_555 = ").get(";
  protected final String TEXT_556 = ")!=null " + NL + "\t\t? !groupbyList_";
  ...
  protected final String TEXT_563 = NL + "\t\t\t\torg.dom4j.Element group";
  protected final String TEXT_564 = "__";
  protected final String TEXT_565 = "=advancedXMLUtil_";
  protected final String TEXT_566 = ".generateCodeDom4j_group";
  protected final String TEXT_567 = "(nestXMLTool_";
  protected final String TEXT_568 = ",valueMap_";
  protected final String TEXT_569 = ",";
  protected final String TEXT_570 = ",orders_";
  protected final String TEXT_571 = ");";
  protected final String TEXT_572 = NL + "\t\t\t\t";
  protected final String TEXT_573 = NL + "\t\tif(groupbyList_";
  protected final String TEXT_574 = ".size()<=";
  protected final String TEXT_575 = "){" + NL + "        \tgroupbyList_";
  protected final String TEXT_576 = ".add(new java.util.ArrayList<String>());" + NL + "        }else{" + NL + "        \tgroupbyList_";
  protected final String TEXT_577 = ".get(";
  protected final String TEXT_578 = ").clear();" + NL + "        }";
  protected final String TEXT_579 = NL + "\t\tadvancedXMLUtil_";
  protected final String TEXT_580 = ".setValue_";
  protected final String TEXT_581 = "_";
  protected final String TEXT_582 = "(groupbyList_";
  protected final String TEXT_583 = ",valueMap_";
  protected final String TEXT_584 = ");";
  protected final String TEXT_585 = NL + "\t\tgroupbyList_";
  protected final String TEXT_586 = ".get(";
  protected final String TEXT_587 = ").add(";
  protected final String TEXT_588 = ");";
  protected final String TEXT_589 = NL + "        isNewElememt_";
  protected final String TEXT_590 = "=true;" + NL + "        if(groupElementList_";
  ...
  protected final String TEXT_594 = ");" + NL + "        }else{" + NL + "        \tgroupElementList_";
  protected final String TEXT_595 = ".set(";
  protected final String TEXT_596 = ",";
  protected final String TEXT_597 = ");" + NL + "        }" + NL + "        " + NL + "\t}else{" + NL + "\t\t";
  protected final String TEXT_598 = NL + "\t}" + NL;
  protected final String TEXT_599 = NL + "\t// build loop xml tree";
  protected final String TEXT_600 = NL + "\t\t\torg.dom4j.Element loop_";
  protected final String TEXT_601 = "=advancedXMLUtil_";
  protected final String TEXT_602 = ".generateCodeDom4j_Loop(nestXMLTool_";
  protected final String TEXT_603 = ",valueMap_";
  protected final String TEXT_604 = ",";
  protected final String TEXT_605 = ",orders_";
  protected final String TEXT_606 = ", bl_";
  protected final String TEXT_607 = ");";
  protected final String TEXT_608 = NL + "\t\t\t\t";
  protected final String TEXT_609 = NL + "    currentRowCount_";
  protected final String TEXT_610 = "++;" + NL + "    if(currentRowCount_";
  protected final String TEXT_611 = " == ";
  protected final String TEXT_612 = "){" + NL + "    \tneedRoot_";
  protected final String TEXT_613 = "  = true;" + NL + "    \tfileName_";
  protected final String TEXT_614 = " = file_";
  protected final String TEXT_615 = " + currentFileCount_";
  protected final String TEXT_616 = " + suffix_";
  protected final String TEXT_617 = ";" + NL + "        currentRowCount_";
  protected final String TEXT_618 = " = 0;" + NL + "        currentFileCount_";
  protected final String TEXT_619 = "++;" + NL + "    \tgroupbyList_";
  protected final String TEXT_620 = ".clear();" + NL + "" + NL + "    \tjava.io.FileOutputStream stream_";
  protected final String TEXT_621 = " = new java.io.FileOutputStream(fileName_";
  protected final String TEXT_622 = ");" + NL + "        org.dom4j.io.XMLWriter output_";
  protected final String TEXT_623 = " = new org.dom4j.io.XMLWriter(stream_";
  protected final String TEXT_624 = ", format_";
  protected final String TEXT_625 = ");";
  protected final String TEXT_626 = NL + "\t\tdoc_";
  protected final String TEXT_627 = ".getRootElement().addAttribute(\"xsi:noNamespaceSchemaLocation\", file_";
  protected final String TEXT_628 = ".substring(file_";
  protected final String TEXT_629 = ".lastIndexOf(\"/\")+1)+\".xsd\");" + NL + "        doc_";
  protected final String TEXT_630 = ".getRootElement().addNamespace(\"xsi\", \"http://www.w3.org/2001/XMLSchema-instance\");";
  protected final String TEXT_631 = "        " + NL + "        nestXMLTool_";
  protected final String TEXT_632 = ".replaceDefaultNameSpace(doc_";
  protected final String TEXT_633 = ".getRootElement());";
  protected final String TEXT_634 = NL + "\t\tnestXMLTool_";
  protected final String TEXT_635 = ".removeEmptyElement(doc_";
  protected final String TEXT_636 = ".getRootElement());";
  protected final String TEXT_637 = NL + "        output_";
  protected final String TEXT_638 = ".write(doc_";
  protected final String TEXT_639 = ");" + NL + "        output_";
  protected final String TEXT_640 = ".close();" + NL + "        doc_";
  protected final String TEXT_641 = "  = org.dom4j.DocumentHelper.createDocument();";
  protected final String TEXT_642 = NL + "\t\t\tdoc_";
  protected final String TEXT_643 = ".addDocType(";
  protected final String TEXT_644 = ", null, ";
  protected final String TEXT_645 = ");";
  protected final String TEXT_646 = NL + "\t\t\tdoc_";
  protected final String TEXT_647 = ".addProcessingInstruction(\"xml-stylesheet\", inMap_";
  protected final String TEXT_648 = ");";
  protected final String TEXT_649 = NL + "    \tgroupElementList_";
  protected final String TEXT_650 = ".clear();" + NL + "    }";
  protected final String TEXT_651 = NL + "\tStringBuffer buf_";
  protected final String TEXT_652 = " = new StringBuffer();" + NL + "\t//init value is 0 not -1, because it will output the root tab when all the row value is null." + NL + "\tint unNullMaxIndex_";
  protected final String TEXT_653 = " = 0;" + NL + "" + NL + "\t// build root xml tree " + NL + "\tif (needRoot_";
  protected final String TEXT_654 = ") {" + NL + "\t\tneedRoot_";
  protected final String TEXT_655 = "=false;";
  protected final String TEXT_656 = NL + "\t\t\tbuf_";
  protected final String TEXT_657 = "=advancedXMLUtil_";
  protected final String TEXT_658 = ".generateCodeNull_rootEmptySpace";
  protected final String TEXT_659 = "(buf_";
  protected final String TEXT_660 = ",out_";
  protected final String TEXT_661 = ",startTabs_";
  protected final String TEXT_662 = ",endTabs_";
  protected final String TEXT_663 = ",valueMap_";
  protected final String TEXT_664 = ");";
  protected final String TEXT_665 = NL + "\t\tif( false";
  protected final String TEXT_666 = NL + "\t\t\t\t\t|| advancedXMLUtil_";
  protected final String TEXT_667 = ".generateCodeNull_conditMain";
  protected final String TEXT_668 = "_";
  protected final String TEXT_669 = "(valueMap_";
  protected final String TEXT_670 = ")";
  protected final String TEXT_671 = " || valueMap_";
  protected final String TEXT_672 = ".get(\"";
  protected final String TEXT_673 = "\") != null";
  protected final String TEXT_674 = NL + "\t\t){" + NL + "\t\t\tunNullMaxIndex_";
  protected final String TEXT_675 = " = ";
  protected final String TEXT_676 = ";" + NL + "\t\t}";
  protected final String TEXT_677 = NL + "\t\tendTabs_";
  protected final String TEXT_678 = "[";
  protected final String TEXT_679 = "] = buf_";
  protected final String TEXT_680 = ".toString();" + NL + "\t\tbuf_";
  protected final String TEXT_681 = " = new StringBuffer();";
  protected final String TEXT_682 = NL + "\t}" + NL + "\t" + NL + "\t// build group xml tree ";
  protected final String TEXT_683 = NL + "\tboolean isNewElememt_";
  protected final String TEXT_684 = " = false;" + NL + "\t//The index of group element which is the first new group in groups." + NL + "\tint newTabIndex_";
  protected final String TEXT_685 = " = -1;" + NL + "\t//Buffer all group tab XML, then set to startTabBuffer." + NL + "    String[] groupBuffer_";
  protected final String TEXT_686 = " = new String[";
  protected final String TEXT_687 = "];" + NL + "    String[] groupEndBuffer_";
  protected final String TEXT_688 = " = new String[";
  protected final String TEXT_689 = "];";
  protected final String TEXT_690 = NL + NL + "\t// need a new group element ";
  protected final String TEXT_691 = " or not" + NL + "\tif(isNewElememt_";
  protected final String TEXT_692 = " || groupbyList_";
  protected final String TEXT_693 = ".size()<=";
  protected final String TEXT_694 = " || groupbyList_";
  protected final String TEXT_695 = ".get(";
  protected final String TEXT_696 = ")==null";
  protected final String TEXT_697 = NL + "\t|| advancedXMLUtil_";
  protected final String TEXT_698 = ".getValue_";
  protected final String TEXT_699 = "_";
  protected final String TEXT_700 = "(groupbyList_";
  protected final String TEXT_701 = ",valueMap_";
  protected final String TEXT_702 = ")";
  protected final String TEXT_703 = NL + "\t|| ( groupbyList_";
  protected final String TEXT_704 = ".get(";
  protected final String TEXT_705 = ").get(";
  protected final String TEXT_706 = ")!=null " + NL + "\t\t? !groupbyList_";
  protected final String TEXT_707 = ".get(";
  protected final String TEXT_708 = ").get(";
  protected final String TEXT_709 = ").equals(";
  protected final String TEXT_710 = ") " + NL + "\t\t: ";
  protected final String TEXT_711 = "!=null )";
  protected final String TEXT_712 = NL + "\t){" + NL + "\t\t// Is the first new element in groups." + NL + "\t\tif(isNewElememt_";
  protected final String TEXT_713 = " == false && groupbyList_";
  protected final String TEXT_714 = ".size()>";
  protected final String TEXT_715 = "){" + NL + "\t\t\tnewTabIndex_";
  protected final String TEXT_716 = " = ";
  protected final String TEXT_717 = ";" + NL + "\t\t}" + NL + "" + NL + "\t\t// count the groupby element" + NL + "\t\tif(groupbyList_";
  protected final String TEXT_718 = ".size()<=";
  protected final String TEXT_719 = "){" + NL + "        \tgroupbyList_";
  protected final String TEXT_720 = ".add(new java.util.ArrayList<String>());" + NL + "        }else{" + NL + "        \tgroupbyList_";
  protected final String TEXT_721 = ".get(";
  protected final String TEXT_722 = ").clear();" + NL + "        }";
  protected final String TEXT_723 = NL + "\t\tadvancedXMLUtil_";
  protected final String TEXT_724 = ".setValue_";
  protected final String TEXT_725 = "_";
  protected final String TEXT_726 = "(groupbyList_";
  protected final String TEXT_727 = ",valueMap_";
  protected final String TEXT_728 = ");";
  protected final String TEXT_729 = NL + "\t\tgroupbyList_";
  protected final String TEXT_730 = ".get(";
  protected final String TEXT_731 = ").add(";
  protected final String TEXT_732 = ");";
  protected final String TEXT_733 = NL + "        isNewElememt_";
  protected final String TEXT_734 = "=true;" + NL + "\t}" + NL + "\t" + NL + "\t// subtree XML string generate";
  protected final String TEXT_735 = NL + "\t\tbuf_";
  protected final String TEXT_736 = "=advancedXMLUtil_";
  protected final String TEXT_737 = ".generateCodeNull_emptySpace";
  protected final String TEXT_738 = "(buf_";
  protected final String TEXT_739 = ",valueMap_";
  protected final String TEXT_740 = ",groupBuffer_";
  protected final String TEXT_741 = ");";
  protected final String TEXT_742 = NL + "\tif( false";
  protected final String TEXT_743 = NL + "\t\t\t\t\t|| advancedXMLUtil_";
  protected final String TEXT_744 = ".generateCodeNull_conditGroup";
  protected final String TEXT_745 = "_";
  protected final String TEXT_746 = "(valueMap_";
  protected final String TEXT_747 = ")";
  protected final String TEXT_748 = " || valueMap_";
  protected final String TEXT_749 = ".get(\"";
  protected final String TEXT_750 = "\") != null";
  protected final String TEXT_751 = NL + "\t){" + NL + "\t\tunNullMaxIndex_";
  protected final String TEXT_752 = " = ";
  protected final String TEXT_753 = ";" + NL + "\t}";
  protected final String TEXT_754 = NL + "\t// buffer the end tabs to groupEnd buffer" + NL + "\tgroupEndBuffer_";
  protected final String TEXT_755 = "[";
  protected final String TEXT_756 = "] = buf_";
  protected final String TEXT_757 = ".toString();" + NL + "    buf_";
  protected final String TEXT_758 = " = new StringBuffer();";
  protected final String TEXT_759 = NL + "\t//output the previous groups as there's a new group" + NL + "    if (newTabIndex_";
  protected final String TEXT_760 = " >= 0) {" + NL + "        //out_";
  protected final String TEXT_761 = ".newLine();//Track code";
  protected final String TEXT_762 = NL + "\t\t// output unNull tabs in start tabs buffer" + NL + "        if (preUnNullMaxIndex_";
  protected final String TEXT_763 = " >= 0) {" + NL + "            for (int i_";
  protected final String TEXT_764 = " = 0; i_";
  protected final String TEXT_765 = " < startTabs_";
  protected final String TEXT_766 = ".length; i_";
  protected final String TEXT_767 = "++) {" + NL + "                if (i_";
  protected final String TEXT_768 = " <= preUnNullMaxIndex_";
  protected final String TEXT_769 = ") {" + NL + "                    if (startTabs_";
  protected final String TEXT_770 = "[i_";
  protected final String TEXT_771 = "] != null) {" + NL + "                        out_";
  protected final String TEXT_772 = ".write(startTabs_";
  protected final String TEXT_773 = "[i_";
  protected final String TEXT_774 = "]);" + NL + "                    }" + NL + "                    startTabs_";
  protected final String TEXT_775 = "[i_";
  protected final String TEXT_776 = "] = null;" + NL + "                }" + NL + "            }" + NL + "        }";
  protected final String TEXT_777 = NL + "\t\t//output all start tabs buffer" + NL + "\t\tfor (int i_";
  protected final String TEXT_778 = " = 0; i_";
  protected final String TEXT_779 = " < startTabs_";
  protected final String TEXT_780 = ".length; i_";
  protected final String TEXT_781 = "++) {" + NL + "            if (startTabs_";
  protected final String TEXT_782 = "[i_";
  protected final String TEXT_783 = "] != null) {" + NL + "                out_";
  protected final String TEXT_784 = ".write(startTabs_";
  protected final String TEXT_785 = "[i_";
  protected final String TEXT_786 = "]);" + NL + "            }" + NL + "            startTabs_";
  protected final String TEXT_787 = "[i_";
  protected final String TEXT_788 = "] = null;" + NL + "        }";
  protected final String TEXT_789 = NL + "        // output endtabs" + NL + "        if (preUnNullMaxIndex_";
  protected final String TEXT_790 = " >= preNewTabIndex_";
  protected final String TEXT_791 = NL + "            && preUnNullMaxIndex_";
  protected final String TEXT_792 = " >= ";
  protected final String TEXT_793 = " + newTabIndex_";
  protected final String TEXT_794 = ") {" + NL + "            for (int i_";
  protected final String TEXT_795 = " = preUnNullMaxIndex_";
  protected final String TEXT_796 = "; i_";
  protected final String TEXT_797 = " >= ";
  protected final String TEXT_798 = " + newTabIndex_";
  protected final String TEXT_799 = "; i_";
  protected final String TEXT_800 = "--) {" + NL + "            \tif(endTabs_";
  protected final String TEXT_801 = "[i_";
  protected final String TEXT_802 = "]!=null){" + NL + "            \t\tout_";
  protected final String TEXT_803 = ".write(endTabs_";
  protected final String TEXT_804 = "[i_";
  protected final String TEXT_805 = "]);" + NL + "            \t}" + NL + "            \tendTabs_";
  protected final String TEXT_806 = "[i_";
  protected final String TEXT_807 = "] = null;";
  protected final String TEXT_808 = "out_";
  protected final String TEXT_809 = ".newLine(); ";
  protected final String TEXT_810 = NL + "                out_";
  protected final String TEXT_811 = ".write(endTabStrs_";
  protected final String TEXT_812 = NL + "                        .get(i_";
  protected final String TEXT_813 = "));" + NL + "            }" + NL + "        } else {";
  protected final String TEXT_814 = NL + "            for (int i_";
  protected final String TEXT_815 = " = preNewTabIndex_";
  protected final String TEXT_816 = " - 1; i_";
  protected final String TEXT_817 = " >= ";
  protected final String TEXT_818 = " + newTabIndex_";
  protected final String TEXT_819 = "; i_";
  protected final String TEXT_820 = "--) {" + NL + "            \tif(endTabs_";
  protected final String TEXT_821 = "[i_";
  protected final String TEXT_822 = "]!=null){" + NL + "            \t\tout_";
  protected final String TEXT_823 = ".write(endTabs_";
  protected final String TEXT_824 = "[i_";
  protected final String TEXT_825 = "]);" + NL + "            \t}" + NL + "            \tendTabs_";
  protected final String TEXT_826 = "[i_";
  protected final String TEXT_827 = "] = null;" + NL + "            \t";
  protected final String TEXT_828 = "out_";
  protected final String TEXT_829 = ".newLine(); ";
  protected final String TEXT_830 = NL + "                out_";
  protected final String TEXT_831 = ".write(endTabStrs_";
  protected final String TEXT_832 = NL + "                        .get(i_";
  protected final String TEXT_833 = "));" + NL + "            }";
  protected final String TEXT_834 = NL + "        }";
  protected final String TEXT_835 = NL + "        preNewTabIndex_";
  protected final String TEXT_836 = " = newTabIndex_";
  protected final String TEXT_837 = " + ";
  protected final String TEXT_838 = ";" + NL + "    }" + NL + "" + NL + "    // set new element groupbuffer to startbuffer" + NL + "    for (int i_";
  protected final String TEXT_839 = " = 0; i_";
  protected final String TEXT_840 = " < groupBuffer_";
  protected final String TEXT_841 = ".length; i_";
  protected final String TEXT_842 = "++) {" + NL + "        // when newTabIndex is null, must use the perNewTabIndex" + NL + "        if (i_";
  protected final String TEXT_843 = " >= preNewTabIndex_";
  protected final String TEXT_844 = " - ";
  protected final String TEXT_845 = ") {" + NL + "            startTabs_";
  protected final String TEXT_846 = "[i_";
  protected final String TEXT_847 = " + ";
  protected final String TEXT_848 = "] = groupBuffer_";
  protected final String TEXT_849 = "[i_";
  protected final String TEXT_850 = "];" + NL + "            endTabs_";
  protected final String TEXT_851 = "[i_";
  protected final String TEXT_852 = " + ";
  protected final String TEXT_853 = "] = groupEndBuffer_";
  protected final String TEXT_854 = "[i_";
  protected final String TEXT_855 = "];" + NL + "        }" + NL + "    }";
  protected final String TEXT_856 = NL + "\t//reset the preUnNullMaxIndex" + NL + "\tif(unNullMaxIndex_";
  protected final String TEXT_857 = ">=0){" + NL + "    \tpreUnNullMaxIndex_";
  protected final String TEXT_858 = "=unNullMaxIndex_";
  protected final String TEXT_859 = ";" + NL + "\t}else{" + NL + "\t\tif(preUnNullMaxIndex_";
  protected final String TEXT_860 = ">";
  protected final String TEXT_861 = "){" + NL + "\t\t\tpreUnNullMaxIndex_";
  protected final String TEXT_862 = "=";
  protected final String TEXT_863 = ";" + NL + "\t\t}" + NL + "\t}";
  protected final String TEXT_864 = NL + "\t// build loop xml tree";
  protected final String TEXT_865 = NL + "\t\tif( false";
  protected final String TEXT_866 = NL + "\t\t\t\t\t|| advancedXMLUtil_";
  protected final String TEXT_867 = ".generateCodeNull_conditLoop_";
  protected final String TEXT_868 = "(valueMap_";
  protected final String TEXT_869 = ")";
  protected final String TEXT_870 = " || valueMap_";
  protected final String TEXT_871 = ".get(\"";
  protected final String TEXT_872 = "\") != null";
  protected final String TEXT_873 = " || true " + NL + "    \t";
  protected final String TEXT_874 = NL + "\t\t){";
  protected final String TEXT_875 = NL + "\t\tadvancedXMLUtil_";
  protected final String TEXT_876 = ".generateCodeNull_loopEmptySpace(buf_";
  protected final String TEXT_877 = ",out_";
  protected final String TEXT_878 = ",endTabs_";
  protected final String TEXT_879 = ",valueMap_";
  protected final String TEXT_880 = ");";
  protected final String TEXT_881 = NL + "\t\t// output all buffer" + NL + "\t\tfor (int i_";
  protected final String TEXT_882 = " = 0; i_";
  protected final String TEXT_883 = " < startTabs_";
  protected final String TEXT_884 = ".length; i_";
  protected final String TEXT_885 = "++) {" + NL + "            if (startTabs_";
  protected final String TEXT_886 = "[i_";
  protected final String TEXT_887 = "] != null && startTabs_";
  protected final String TEXT_888 = "[i_";
  protected final String TEXT_889 = "].length() > 0) {" + NL + "                out_";
  protected final String TEXT_890 = ".write(startTabs_";
  protected final String TEXT_891 = "[i_";
  protected final String TEXT_892 = "]);" + NL + "                startTabs_";
  protected final String TEXT_893 = "[i_";
  protected final String TEXT_894 = "] = null;" + NL + "            }" + NL + "        }" + NL + "\t\tout_";
  protected final String TEXT_895 = ".write(buf_";
  protected final String TEXT_896 = ".toString());" + NL + "\t\tpreNewTabIndex_";
  protected final String TEXT_897 = " = ";
  protected final String TEXT_898 = ";";
  protected final String TEXT_899 = NL + "            preUnNullMaxIndex_";
  protected final String TEXT_900 = " = ";
  protected final String TEXT_901 = ";" + NL + "\t\t}";
  protected final String TEXT_902 = NL + "    currentRowCount_";
  protected final String TEXT_903 = "++;" + NL + "    if(currentRowCount_";
  protected final String TEXT_904 = " == ";
  protected final String TEXT_905 = "){" + NL + "    \tneedRoot_";
  protected final String TEXT_906 = "  = true;" + NL + "    \tfileName_";
  protected final String TEXT_907 = " = file_";
  protected final String TEXT_908 = " + currentFileCount_";
  protected final String TEXT_909 = " + suffix_";
  protected final String TEXT_910 = ";" + NL + "        currentRowCount_";
  protected final String TEXT_911 = " = 0;" + NL + "        currentFileCount_";
  protected final String TEXT_912 = "++;" + NL + "    \tgroupbyList_";
  protected final String TEXT_913 = ".clear();" + NL + " ";
  protected final String TEXT_914 = "   \t" + NL + "\tif (preUnNullMaxIndex_";
  protected final String TEXT_915 = " >= 0) {" + NL + "        // output all buffer" + NL + "        for (int j_";
  protected final String TEXT_916 = " = 0; j_";
  protected final String TEXT_917 = " <= preUnNullMaxIndex_";
  protected final String TEXT_918 = "; j_";
  protected final String TEXT_919 = "++) {" + NL + "            if (startTabs_";
  protected final String TEXT_920 = "[j_";
  protected final String TEXT_921 = "] != null)" + NL + "                out_";
  protected final String TEXT_922 = ".write(startTabs_";
  protected final String TEXT_923 = "[j_";
  protected final String TEXT_924 = "]);" + NL + "        }" + NL + "" + NL + "        if (preUnNullMaxIndex_";
  protected final String TEXT_925 = " < preNewTabIndex_";
  protected final String TEXT_926 = " ) {" + NL + "\t\t\tfor (int i_";
  protected final String TEXT_927 = " = preNewTabIndex_";
  protected final String TEXT_928 = " - 1; i_";
  protected final String TEXT_929 = " >= 0; i_";
  protected final String TEXT_930 = "--) {" + NL + "            \tif(endTabs_";
  protected final String TEXT_931 = "[i_";
  protected final String TEXT_932 = "]!=null){" + NL + "            \t\tout_";
  protected final String TEXT_933 = ".write(endTabs_";
  protected final String TEXT_934 = "[i_";
  protected final String TEXT_935 = "]);" + NL + "            \t}";
  protected final String TEXT_936 = "out_";
  protected final String TEXT_937 = ".newLine(); ";
  protected final String TEXT_938 = NL + "                out_";
  protected final String TEXT_939 = ".write(endTabStrs_";
  protected final String TEXT_940 = ".get(i_";
  protected final String TEXT_941 = "));" + NL + "            }" + NL + "        } else {" + NL + "            for (int i_";
  protected final String TEXT_942 = " = preUnNullMaxIndex_";
  protected final String TEXT_943 = "; i_";
  protected final String TEXT_944 = " >= 0; i_";
  protected final String TEXT_945 = "--) {" + NL + "            \tif(endTabs_";
  protected final String TEXT_946 = "[i_";
  protected final String TEXT_947 = "]!=null){" + NL + "            \t\tout_";
  protected final String TEXT_948 = ".write(endTabs_";
  protected final String TEXT_949 = "[i_";
  protected final String TEXT_950 = "]);" + NL + "            \t}";
  protected final String TEXT_951 = "out_";
  protected final String TEXT_952 = ".newLine(); ";
  protected final String TEXT_953 = NL + "                out_";
  protected final String TEXT_954 = ".write(endTabStrs_";
  protected final String TEXT_955 = ".get(i_";
  protected final String TEXT_956 = "));" + NL + "            }" + NL + "        }" + NL + "    }";
  protected final String TEXT_957 = NL + "\tfor (int i_";
  protected final String TEXT_958 = " = endTabStrs_";
  protected final String TEXT_959 = ".size() - 1; i_";
  protected final String TEXT_960 = " >= 0; i_";
  protected final String TEXT_961 = "--) {" + NL + "    \tif(endTabs_";
  protected final String TEXT_962 = "[i_";
  protected final String TEXT_963 = "]!=null){" + NL + "    \t\tout_";
  protected final String TEXT_964 = ".write(endTabs_";
  protected final String TEXT_965 = "[i_";
  protected final String TEXT_966 = "]);" + NL + "    \t}";
  protected final String TEXT_967 = "out_";
  protected final String TEXT_968 = ".newLine(); ";
  protected final String TEXT_969 = NL + "        out_";
  protected final String TEXT_970 = ".write(endTabStrs_";
  protected final String TEXT_971 = ".get(i_";
  protected final String TEXT_972 = "));" + NL + "    }";
  protected final String TEXT_973 = NL + "\t    preUnNullMaxIndex_";
  protected final String TEXT_974 = " = -1;" + NL + "        preNewTabIndex_";
  protected final String TEXT_975 = " = -1;" + NL + "    \tstartTabs_";
  protected final String TEXT_976 = " = new String[endTabStrs_";
  protected final String TEXT_977 = ".size()];" + NL + "    \tendTabs_";
  protected final String TEXT_978 = " = new String[endTabStrs_";
  protected final String TEXT_979 = ".size()];" + NL + "    \t" + NL + "\t\tout_";
  protected final String TEXT_980 = ".close();" + NL + "\t\tout_";
  protected final String TEXT_981 = " = new java.io.BufferedWriter(new java.io.OutputStreamWriter(new java.io.FileOutputStream(file_";
  protected final String TEXT_982 = " + currentFileCount_";
  protected final String TEXT_983 = " + suffix_";
  protected final String TEXT_984 = "), ";
  protected final String TEXT_985 = "));" + NL + "        out_";
  protected final String TEXT_986 = ".write(\"<?xml version=\\\"1.0\\\" encoding=\\\"\"+";
  protected final String TEXT_987 = "+\"\\\"?>\");" + NL + "        out_";
  protected final String TEXT_988 = ".newLine();" + NL + "        ";
  protected final String TEXT_989 = NL + "    \t\tout_";
  protected final String TEXT_990 = ".write(\"<!DOCTYPE \"+";
  protected final String TEXT_991 = "+\" SYSTEM \\\"\" + ";
  protected final String TEXT_992 = " + \"\\\">\");" + NL + "    \t\tout_";
  protected final String TEXT_993 = ".newLine();";
  protected final String TEXT_994 = NL + "\t\t\tout_";
  protected final String TEXT_995 = ".write(\"<?xml-stylesheet type=\\\"\"+";
  protected final String TEXT_996 = "+\"\\\" href=\\\"\"+";
  protected final String TEXT_997 = "+\"\\\">\");" + NL + "\t\t\tout_";
  protected final String TEXT_998 = ".newLine();";
