...
public class TS3DeleteBeginJava
{
  ...
  protected final String TEXT_182 = NL + "\ttry{" + NL + "\t\tString key_";
  protected final String TEXT_183 = " = ";
  protected final String TEXT_184 = ";" + NL + "\t\tif(key_";
  protected final String TEXT_185 = "!=null && key_";
  protected final String TEXT_186 = ".trim().length()>0){" + NL + "\t\t\t";
  protected final String TEXT_187 = "\t" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_188 = " - Deleting an object with key:\" + ";
  protected final String TEXT_189 = ");" + NL + "\t\t\t";
  protected final String TEXT_190 = NL + "\t\t\tconn_";
  protected final String TEXT_191 = ".deleteObject(";
  protected final String TEXT_192 = ", key_";
  protected final String TEXT_193 = ");" + NL + "\t\t\t";
  protected final String TEXT_194 = "\t" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_195 = " - Delete the object successfully.\");" + NL + "\t\t\t";
  protected final String TEXT_196 = NL + "\t\t}else{" + NL + "\t\t\tthrow(new RuntimeException(\"Please set key!\"));" + NL + "\t\t}" + NL + "\t}catch(java.lang.Exception e_";
