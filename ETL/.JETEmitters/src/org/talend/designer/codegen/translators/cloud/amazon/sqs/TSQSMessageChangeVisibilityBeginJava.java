...
public class TSQSMessageChangeVisibilityBeginJava
{
  ...
  protected final String TEXT_78 = " - Change message visibility recipet handle:\" + ";
  protected final String TEXT_79 = ");" + NL + "\t\t";
  protected final String TEXT_80 = NL + "\t\tconn_";
  protected final String TEXT_81 = ".changeMessageVisibility(new com.amazonaws.services.sqs.model.ChangeMessageVisibilityRequest(";
  protected final String TEXT_82 = ",";
  protected final String TEXT_83 = ",";
  protected final String TEXT_84 = "));" + NL + "\t\t";
  protected final String TEXT_85 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_86 = " - Change message visibility successfully.\");" + NL + "\t\t";
  ...
  protected final String TEXT_96 = NL + "\t}finally{" + NL + "\t\tif(conn_";
  protected final String TEXT_97 = " !=null){" + NL + "\t\t\tconn_";
  protected final String TEXT_98 = ".shutdown();" + NL + "\t\t}" + NL + "\t\t";
