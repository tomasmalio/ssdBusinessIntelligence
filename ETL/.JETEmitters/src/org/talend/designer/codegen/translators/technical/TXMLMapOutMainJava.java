...
public class TXMLMapOutMainJava {
  ...
  protected final String TEXT_10 = NL + "\t\t\t\ttreeNodeAPI_";
  protected final String TEXT_11 = ".clear();" + NL + "\t\t\t\t";
  protected final String TEXT_12 = NL + "\t\t\t\t\t//init document to flat tool" + NL + "\t\t\t\t\troutines.system.DocumentToFlat docToFlat_";
  protected final String TEXT_13 = "_";
  protected final String TEXT_14 = " = new routines.system.DocumentToFlat();" + NL + "\t\t\t\t\tdocToFlat_";
  protected final String TEXT_15 = "_";
  protected final String TEXT_16 = ".setOriginalLoop(\"";
  protected final String TEXT_17 = "\");" + NL + "\t\t\t\t\tdocToFlat_";
  protected final String TEXT_18 = "_";
  protected final String TEXT_19 = ".setIsOptional(";
  protected final String TEXT_20 = ");" + NL + "\t\t\t\t\tif(";
  protected final String TEXT_21 = ".";
  protected final String TEXT_22 = " == null " + NL + "\t\t\t\t\t\t|| ";
  protected final String TEXT_23 = ".";
  protected final String TEXT_24 = ".getDocument() == null) {" + NL + "\t\t\t\t\t\tthrow new RuntimeException(\"";
  protected final String TEXT_25 = ".";
  protected final String TEXT_26 = " can't be empty\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\torg.dom4j.Document doc_";
  protected final String TEXT_27 = "_";
  protected final String TEXT_28 = " = ";
  protected final String TEXT_29 = ".";
  protected final String TEXT_30 = ".getDocument();" + NL + "\t\t\t\t\tdocToFlat_";
  protected final String TEXT_31 = "_";
  protected final String TEXT_32 = ".setDoc(doc_";
  protected final String TEXT_33 = "_";
  protected final String TEXT_34 = ");" + NL + "\t\t\t\t\tdocToFlat_";
  protected final String TEXT_35 = "_";
  protected final String TEXT_36 = ".setDefineNS(";
  protected final String TEXT_37 = ");" + NL + "\t\t\t\t\tdocToFlat_";
  protected final String TEXT_38 = "_";
  protected final String TEXT_39 = ".setNamespaceTool(nsTool_";
  protected final String TEXT_40 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_41 = NL + "\t\t\t\t\t\t//old version, find NS from doc" + NL + "\t\t\t\t\t\tnsTool_";
  protected final String TEXT_42 = ".countNSMap(doc_";
  protected final String TEXT_43 = "_";
  protected final String TEXT_44 = ".getRootElement());" + NL + "\t\t\t\t\t\tjava.util.HashMap<String,String> xmlNameSpaceMap_";
  protected final String TEXT_45 = "_";
  protected final String TEXT_46 = " = nsTool_";
  protected final String TEXT_47 = ".xmlNameSpaceMap;" + NL + "\t\t\t\t\t";
  protected final String TEXT_48 = NL + "\t\t\t\t\t\tjava.util.HashMap<String,String> xmlNameSpaceMap_";
  protected final String TEXT_49 = "_";
  protected final String TEXT_50 = " = new java.util.HashMap<String,String>();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_51 = NL + "\t\t\t\t\t";
  protected final String TEXT_52 = NL + "\t\t\t\t\tdocToFlat_";
  protected final String TEXT_53 = "_";
  protected final String TEXT_54 = ".setXmlNameSpaceMap(xmlNameSpaceMap_";
  protected final String TEXT_55 = "_";
  protected final String TEXT_56 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_57 = NL + "\t\t\t\t\tjava.util.List<String> absolutePathMappingsList_";
  protected final String TEXT_58 = "_";
  protected final String TEXT_59 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\tjava.util.List<String> relativePathMappingsList_";
  protected final String TEXT_60 = "_";
  protected final String TEXT_61 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t";
  protected final String TEXT_62 = NL + "\t\t\t\t\tabsolutePathMappingsList_";
  protected final String TEXT_63 = "_";
  protected final String TEXT_64 = ".add(\"";
  protected final String TEXT_65 = "\");" + NL + "\t\t\t\t\trelativePathMappingsList_";
  protected final String TEXT_66 = "_";
  protected final String TEXT_67 = ".add(\"";
  protected final String TEXT_68 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_69 = NL + "\t\t\t\t\tString[] absolutePathMappings_";
  protected final String TEXT_70 = "_";
  protected final String TEXT_71 = " = absolutePathMappingsList_";
  protected final String TEXT_72 = "_";
  protected final String TEXT_73 = ".toArray(new String[0]);" + NL + "\t\t\t\t\tString[] relativePathMappings_";
  protected final String TEXT_74 = "_";
  protected final String TEXT_75 = " = relativePathMappingsList_";
  protected final String TEXT_76 = "_";
  protected final String TEXT_77 = ".toArray(new String[0]);" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\tdocToFlat_";
  protected final String TEXT_78 = "_";
  protected final String TEXT_79 = ".setAbsolutePathMappings(absolutePathMappings_";
  protected final String TEXT_80 = "_";
  protected final String TEXT_81 = ");" + NL + "\t\t\t\t\tdocToFlat_";
  protected final String TEXT_82 = "_";
  protected final String TEXT_83 = ".setCurrentRelativePathMappings(relativePathMappings_";
  protected final String TEXT_84 = "_";
  protected final String TEXT_85 = ");" + NL + "\t\t\t\t\t//generate document to flat data" + NL + "\t\t\t\t\tdocToFlat_";
  protected final String TEXT_86 = "_";
  protected final String TEXT_87 = ".flat();" + NL + "\t\t\t\t\t//get flat data" + NL + "\t\t\t\t\tjava.util.List<java.util.Map<String, String>> resultSet_";
  protected final String TEXT_88 = "_";
  protected final String TEXT_89 = " = docToFlat_";
  protected final String TEXT_90 = "_";
  protected final String TEXT_91 = ".getResultSet();" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\tfor (java.util.Map<String,String> oneRow_";
  protected final String TEXT_92 = "_";
  protected final String TEXT_93 = ": resultSet_";
  protected final String TEXT_94 = "_";
  protected final String TEXT_95 = ") { // G_TXM_M_001";
  protected final String TEXT_96 = NL + "\t\t\t\t\t\tnb_line_";
  protected final String TEXT_97 = "++;" + NL + "\t\t\t\t    \t";
  protected final String TEXT_98 = " = false;" + NL + "\t\t\t\t    \t";
  protected final String TEXT_99 = " = false;" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_100 = "=false;" + NL + "\t\t\t\t\t    isMatchDocRow";
  protected final String TEXT_101 = " = false;";
  protected final String TEXT_102 = NL + "\t\t\t\t    \ttreeNodeAPI_";
  protected final String TEXT_103 = ".clear();";
  protected final String TEXT_104 = NL + "\t\t\t\t    \tfor(java.util.Map.Entry<String, String> entry_";
  protected final String TEXT_105 = "_";
  protected final String TEXT_106 = " : oneRow_";
  protected final String TEXT_107 = "_";
  protected final String TEXT_108 = ".entrySet()) {" + NL + "\t\t\t\t\t\t\ttreeNodeAPI_";
  protected final String TEXT_109 = ".put(entry_";
  protected final String TEXT_110 = "_";
  protected final String TEXT_111 = ".getKey(),entry_";
  protected final String TEXT_112 = "_";
  protected final String TEXT_113 = ".getValue());" + NL + "\t\t\t\t\t\t}";
  protected final String TEXT_114 = NL + "\t\t\t\t\t";
  protected final String TEXT_115 = "\t";
  protected final String TEXT_116 = NL + "\t\t\t\t///////////////////////////////////////////////" + NL + "\t\t\t\t//Starting Lookup Table \"";
  protected final String TEXT_117 = "\" " + NL + "\t\t\t\t///////////////////////////////////////////////" + NL + "\t\t\t\t//tHash_Lookup_";
  protected final String TEXT_118 = ".initGet();" + NL + "\t\t\t\t";
  protected final String TEXT_119 = NL + "\t\t\t\t\t\tjava.util.HashMap<String,String> xmlNameSpaceMap_";
  protected final String TEXT_120 = " = new java.util.HashMap<String,String>();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_121 = NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_122 = "HashKey.documentLookupResult.clear();" + NL + "\t\t\t\t\t\tjava.util.Map<String,String> xpathToPatternMap_";
  protected final String TEXT_123 = " = new java.util.HashMap<String,String>();" + NL + "\t\t\t\t\t\tjava.util.Map<String,String> xpathToTypeMap_";
  protected final String TEXT_124 = " = new java.util.HashMap<String,String>();" + NL + "\t\t\t\t    ";
  protected final String TEXT_125 = NL + "\t\t\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_126 = NL + "\t\t\t\t\tboolean forceLoop";
  protected final String TEXT_127 = " = false;" + NL + "\t\t\t\t\t";
  protected final String TEXT_128 = " ";
  protected final String TEXT_129 = "ObjectFromLookup = null;" + NL + "\t\t\t\t\tboolean hasResultFromLookupCache";
  protected final String TEXT_130 = " = false;" + NL + "\t\t\t\t\tjava.util.Map<String,Object> cacheResult";
  protected final String TEXT_131 = " = new java.util.HashMap<String,Object>();" + NL + "\t\t\t\t";
  protected final String TEXT_132 = NL + "\t\t\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_133 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_134 = "HashKey = new ";
  protected final String TEXT_135 = "Struct() {" + NL + "\t\t\t\t\t\t\t{" + NL + "\t\t\t\t\t\t\t\tthis.loopKey = \"";
  protected final String TEXT_136 = "\";" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\tpublic int hashCode() {" + NL + "\t\t\t\t\t\t\t\tif(this.hashCodeDirty){" + NL + "\t\t\t\t\t\t\t\t\tfinal int prime = PRIME;" + NL + "\t\t\t\t\t\t\t\t\tint result = DEFAULT_HASHCODE;" + NL + "\t\t\t\t\t";
  protected final String TEXT_137 = NL + "\t\t\t\t        \t\t\tresult = prime * result + (this.";
  protected final String TEXT_138 = " ? 1231 : 1237);" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_139 = NL + "\t\t\t\t\t\t\t\t\tresult = prime * result + (int) this.";
  protected final String TEXT_140 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_141 = NL + "\t\t\t\t\t\t\t\tresult = prime * result + java.util.Arrays.hashCode(this.";
  protected final String TEXT_142 = ");" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_143 = NL + "\t\t\t\t\t\t\t\tresult = prime * result + ((this.";
  protected final String TEXT_144 = " == null) ? 0 : this.";
  protected final String TEXT_145 = ".hashCode());" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_146 = NL + "\t\t\t\t\t\t\t\t\tresult = prime * result + ((this.loopKey == null) ? 0 : this.loopKey.hashCode());" + NL + "\t\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\tthis.hashCode = result;" + NL + "    \t\t\t\t\t\t\t\tthis.hashCodeDirty = false;\t" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\treturn this.hashCode;" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\tpublic boolean equals(Object obj) {" + NL + "\t\t\t\t\t\t\t\tif (this == obj) return true;" + NL + "\t\t\t\t\t\t\t\tif (obj == null) return false;" + NL + "\t\t\t\t\t\t\t\tif(!(obj instanceof ";
  protected final String TEXT_147 = "Struct)) return false;" + NL + "\t\t\t\t\t\t\t\tfinal ";
  protected final String TEXT_148 = "Struct other = (";
  protected final String TEXT_149 = "Struct) obj;" + NL + "\t\t\t\t\t\t\t\tif(!this.loopKey.equals(other.loopKey)) return false;";
  protected final String TEXT_150 = NL + "\t\t\t\t\t\t\t\t\t\tif (this.";
  protected final String TEXT_151 = " != other.";
  protected final String TEXT_152 = ") " + NL + "\t\t\t\t\t\t\t\t\t\t\treturn false;" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_153 = NL + "\t\t\t\t\t\t\t\t\t\tif(!java.util.Arrays.equals(this.";
  protected final String TEXT_154 = ", other.";
  protected final String TEXT_155 = ")) {" + NL + "\t\t\t\t\t\t\t\t\t\t\treturn false;" + NL + "\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_156 = NL + "\t\t\t\t\t\t\t\t\t\tif (this.";
  protected final String TEXT_157 = " == null) {" + NL + "\t\t\t\t\t\t\t\t\t\t\tif (other.";
  protected final String TEXT_158 = " != null) " + NL + "\t\t\t\t\t\t\t\t\t\t\t\treturn false;" + NL + "\t\t\t\t\t\t\t\t\t\t} else if (!this.";
  protected final String TEXT_159 = ".equals(other.";
  protected final String TEXT_160 = ")) " + NL + "\t\t\t\t\t\t\t\t\t\t\treturn false;" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_161 = NL + "\t\t\t\t\t\t\t\treturn true;" + NL + "\t\t\t\t\t\t\t} " + NL + "\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t};" + NL + "\t\t\t\t\t";
  protected final String TEXT_162 = NL + "\t\t   \t\t\t\tList<Object> lookupCacheKey";
  protected final String TEXT_163 = " = new java.util.ArrayList<Object>();" + NL + "\t\t   \t\t\t";
  protected final String TEXT_164 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_165 = "HashKey.documentLookupResult.put(\"";
  protected final String TEXT_166 = "\",";
  protected final String TEXT_167 = ");" + NL + "\t\t\t\t\t\t\txpathToPatternMap_";
  protected final String TEXT_168 = ".put(\"";
  protected final String TEXT_169 = "\",";
  protected final String TEXT_170 = ");" + NL + "\t\t\t\t\t\t\txpathToTypeMap_";
  protected final String TEXT_171 = ".put(\"";
  ...
  protected final String TEXT_178 = "HashKey.";
  protected final String TEXT_179 = " = ";
  protected final String TEXT_180 = ";" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_181 = "HashKey.hashCodeDirty = true;" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_182 = NL + "\t\t\t\t\t\tlookupCacheKey";
  protected final String TEXT_183 = ".add(";
  protected final String TEXT_184 = "HashKey);" + NL + "\t\t\t\t\t";
  protected final String TEXT_185 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t";
  protected final String TEXT_186 = NL + "\t\t\t\t\t\tif(!";
  protected final String TEXT_187 = "){//TD120" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_188 = NL + "\t\t\t\t\t\t\t\t\ttHash_Lookup_Cache_";
  protected final String TEXT_189 = ".lookup(lookupCacheKey";
  protected final String TEXT_190 = ");" + NL + "\t\t  \t\t\t\t\t\t\tif(tHash_Lookup_Cache_";
  protected final String TEXT_191 = ".hasNext()) {" + NL + "\t  \t\t\t\t\t\t\t\t\thasResultFromLookupCache";
  protected final String TEXT_192 = " = true;" + NL + "\t\t  \t\t\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_193 = NL + "\t\t\t\t\t\t\t\t\t\tglobalMap.put(";
  protected final String TEXT_194 = ", ";
  protected final String TEXT_195 = ");" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_196 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_197 = "Process(globalMap);" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_198 = NL + "\t\t\t\t\t\t\t\t\ttHash_Lookup_";
  protected final String TEXT_199 = " = " + NL + "\t\t\t\t\t\t\t\t\t\t(org.talend.designer.components.lookup.persistent.Persistent";
  protected final String TEXT_200 = "LookupManager<";
  protected final String TEXT_201 = "Struct>) " + NL + "\t\t\t\t\t\t\t\t\t\t\t((org.talend.designer.components.lookup.persistent.Persistent";
  protected final String TEXT_202 = "LookupManager<";
  ...
  protected final String TEXT_206 = " = " + NL + "\t\t\t\t\t\t\t\t\t(org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<";
  protected final String TEXT_207 = "Struct>) " + NL + "\t\t\t\t\t\t\t\t\t\t((org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<";
  protected final String TEXT_208 = "Struct>) " + NL + "\t\t\t\t\t\t\t\t\t\t\tglobalMap.get( \"tHash_Lookup_";
  protected final String TEXT_209 = "\" ));" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_210 = NL + "\t\t\t\t\t    \t\t\ttHash_Lookup_";
  protected final String TEXT_211 = ".initGet();" + NL + "\t\t\t\t\t    \t\t";
  protected final String TEXT_212 = NL + "\t\t\t\t\t    \t\t\ttHash_Lookup_";
  protected final String TEXT_213 = ".lookup( ";
  protected final String TEXT_214 = "HashKey );" + NL + "\t\t\t\t\t    \t\t";
  protected final String TEXT_215 = NL + "\t\t\t\t\t    \t\t\ttHash_Lookup_";
  protected final String TEXT_216 = ".lookup();" + NL + "\t\t\t\t\t    \t\t";
  protected final String TEXT_217 = NL + "\t\t\t\t\t\t    \t\t}" + NL + "\t\t\t\t\t\t\t    ";
  protected final String TEXT_218 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_219 = NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_220 = NL + "\t\t\t\t\t\t\t\t\ttHash_Lookup_";
  protected final String TEXT_221 = ".lookup( ";
  protected final String TEXT_222 = "HashKey );" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_223 = NL + "\t\t\t\t\t\t\t\t\ttHash_Lookup_";
  protected final String TEXT_224 = ".lookup();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_225 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_226 = NL + "\t\t\t\t\t\t\tif(hasResultFromLookupCache";
  protected final String TEXT_227 = "  || tHash_Lookup_";
  protected final String TEXT_228 = ".hasNext()){" + NL + "\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_229 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_230 = " = true;" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_231 = " = true;" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_232 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_233 = " = ";
  protected final String TEXT_234 = "Default;" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_235 = NL + "\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_236 = NL + "\t\t\t\t\t\t\t\tforceLoop";
  protected final String TEXT_237 = " = true;" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_238 = NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t}//TD120" + NL + "\t\t\t\t   " + NL + "\t\t\t\t   \t\t";
  protected final String TEXT_239 = NL + "\t\t\t\t   \t\t\tif(";
  protected final String TEXT_240 = ") {" + NL + "\t\t\t\t   \t\t\t\tforceLoop";
  protected final String TEXT_241 = " = true;" + NL + "\t\t\t\t   \t\t\t}" + NL + "\t\t\t\t   \t\t";
  ...
  protected final String TEXT_247 = NL + "\t\t\t\t\t    if(hasResultFromLookupCache";
  protected final String TEXT_248 = ") {//TD10086" + NL + "\t\t\t\t\t    \t";
  protected final String TEXT_249 = NL + "\t\t\t\t\t    \tjava.util.Map<String,Object> cacheResult_";
  protected final String TEXT_250 = " = tHash_Lookup_Cache_";
  protected final String TEXT_251 = ".next();" + NL + "\t\t\t\t\t    \t\t";
  protected final String TEXT_252 = NL + "\t\t\t\t\t    \t\t\ttreeNodeAPI_";
  protected final String TEXT_253 = ".put(\"";
  protected final String TEXT_254 = "\",StringUtils.valueOf(cacheResult_";
  protected final String TEXT_255 = ".get(\"";
  protected final String TEXT_256 = "\")));" + NL + "\t\t\t\t\t    \t\t";
  protected final String TEXT_257 = NL + "\t\t\t\t    \t\t\t";
  protected final String TEXT_258 = " = (";
  protected final String TEXT_259 = ")cacheResult_";
  protected final String TEXT_260 = ".get(\"";
  protected final String TEXT_261 = "\");" + NL + "\t\t\t\t\t    \t";
  protected final String TEXT_262 = NL + "\t\t\t\t\t    } else if(!";
  protected final String TEXT_263 = ") {" + NL + "\t\t\t\t\t\t  \t";
  protected final String TEXT_264 = NL + "\t\t\t\t\t\t   \tisMatchDocRow";
  protected final String TEXT_265 = " = false;" + NL + "\t\t\t\t\t\t  \t";
  protected final String TEXT_266 = NL + "\t\t\t\t\t\t\twhile (tHash_Lookup_";
  protected final String TEXT_267 = ".hasNext()) {//TD119" + NL + "\t\t\t\t\t\t\t\tfromLookup_";
  protected final String TEXT_268 = " = null;" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_269 = " = ";
  protected final String TEXT_270 = "Default;" + NL + "\t\t\t\t\t\t\t\tfromLookup_";
  protected final String TEXT_271 = " = tHash_Lookup_";
  protected final String TEXT_272 = ".next();" + NL + "\t\t\t\t\t\t\t\tif (fromLookup_";
  protected final String TEXT_273 = " != null) {" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_274 = NL + "\t\t\t\t\t\t\t\t\t//begin to lookup Document Object (case 1:lookup doc key exists),(case 2:lookup doc key not exists but lookup line doc output exist)" + NL + "\t\t\t\t\t\t\t\t\troutines.system.Document lookupDoc_";
  protected final String TEXT_275 = " = fromLookup_";
  protected final String TEXT_276 = ".";
  protected final String TEXT_277 = ";" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_278 = NL + "\t\t\t\t\t\t\t\t\tboolean quit";
  protected final String TEXT_279 = " = false;" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_280 = NL + "\t\t\t\t\t\t\t\t\tjava.util.Map<String,String> xPathAsOutput_";
  protected final String TEXT_281 = " = new java.util.HashMap<String,String>();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_282 = NL + "\t\t\t\t\t\t\t\t\txPathAsOutput_";
  protected final String TEXT_283 = ".put(\"";
  protected final String TEXT_284 = "\",\"";
  protected final String TEXT_285 = "\");" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_286 = NL + "\t\t\t\t\t\t\t\t\tif(lookupDoc_";
  protected final String TEXT_287 = " == null) {" + NL + "\t\t\t\t\t\t\t\t\t\tthrow new RuntimeException(\"";
  protected final String TEXT_288 = ".";
  protected final String TEXT_289 = " can't be empty\");" + NL + "\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\tList<java.util.Map<String,Object>> result_";
  protected final String TEXT_290 = " = lookupDoc_";
  protected final String TEXT_291 = ".LookupDocument(\"";
  protected final String TEXT_292 = "\",";
  protected final String TEXT_293 = ",";
  protected final String TEXT_294 = "HashKey.documentLookupResult," + NL + "\t\t\t\t\t\t\t\t\t\txPathAsOutput_";
  protected final String TEXT_295 = ",xmlNameSpaceMap_";
  protected final String TEXT_296 = ",xpathToTypeMap_";
  protected final String TEXT_297 = ",xpathToPatternMap_";
  protected final String TEXT_298 = ",\"";
  protected final String TEXT_299 = "\");" + NL + "\t\t\t\t\t\t\t\t\tif(result_";
  protected final String TEXT_300 = " == null || result_";
  protected final String TEXT_301 = ".size() == 0) {" + NL + "\t\t\t\t\t\t\t\t\t\t// not find" + NL + "\t\t\t\t\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\t\t\t\t\t//find and cache it,now only memory,inner join and unique match mode" + NL + "\t\t\t\t\t\t\t\t\t\t//once find,not reject." + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_302 = NL + "\t\t\t\t\t\t\t\t\t\tisMatchDocRow";
  protected final String TEXT_303 = " = true;" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_304 = NL + "\t\t\t\t\t\t\t\t\t\tfor(java.util.Map<String,Object> docRow_";
  protected final String TEXT_305 = " : result_";
  protected final String TEXT_306 = ") {" + NL + "\t\t\t\t\t\t\t\t\t\t\tfor(String path_";
  protected final String TEXT_307 = " : docRow_";
  protected final String TEXT_308 = ".keySet()) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\ttreeNodeAPI_";
  ...
  protected final String TEXT_314 = ".put(path_";
  protected final String TEXT_315 = ",StringUtils.valueOf(docRow_";
  protected final String TEXT_316 = ".get(path_";
  protected final String TEXT_317 = ")));" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_318 = NL + "\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_319 = NL + "\t\t\t\t\t\t\t\t\t\tquit";
  protected final String TEXT_320 = " = true;" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_321 = NL + "\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_322 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_323 = " = fromLookup_";
  protected final String TEXT_324 = ";" + NL + "\t\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_325 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_326 = NL + "\t\t\t\t\t\t\t\t\t\tif(isMatchDocRow";
  protected final String TEXT_327 = ") {" + NL + "\t\t\t\t\t\t\t\t\t\t\tcacheResult";
  protected final String TEXT_328 = ".put(\"";
  protected final String TEXT_329 = "\",";
  protected final String TEXT_330 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\ttHash_Lookup_Cache_";
  protected final String TEXT_331 = ".put(lookupCacheKey";
  protected final String TEXT_332 = ",cacheResult";
  protected final String TEXT_333 = "); " + NL + "\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_334 = NL + "\t\t\t\t\t\t\t\t\t\tcacheResult";
  protected final String TEXT_335 = ".put(\"";
  protected final String TEXT_336 = "\",";
  protected final String TEXT_337 = "); " + NL + "\t\t\t\t\t\t\t\t\t\ttHash_Lookup_Cache_";
  protected final String TEXT_338 = ".put(lookupCacheKey";
  protected final String TEXT_339 = ",cacheResult";
  protected final String TEXT_340 = "); " + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_341 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_342 = NL + "\t\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_343 = NL + "\t\t\t\t\t\t\t\t\t\tif(quit";
  protected final String TEXT_344 = ") {//for first match,once find in document,no need to continue to lookup." + NL + "\t\t\t\t\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_345 = NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t}//TD119" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_346 = NL + "\t\t\t\t\t\t   \t";
  protected final String TEXT_347 = " = !isMatchDocRow";
  protected final String TEXT_348 = " && !hasResultFromLookupCache";
  protected final String TEXT_349 = ";" + NL + "\t\t\t\t\t\t    ";
  protected final String TEXT_350 = " = ";
  protected final String TEXT_351 = ";" + NL + "\t\t\t\t\t\t  \t";
  protected final String TEXT_352 = NL + "\t\t\t\t\t\t  \t";
  protected final String TEXT_353 = NL + "\t\t\t\t\t\t  \tif(!isMatchDocRow";
  protected final String TEXT_354 = " && !hasResultFromLookupCache";
  protected final String TEXT_355 = ") {" + NL + "\t\t\t\t\t\t  \t\t";
  protected final String TEXT_356 = " = ";
  protected final String TEXT_357 = "Default;" + NL + "\t\t\t\t\t\t  \t}" + NL + "\t\t\t\t\t\t  \t";
  protected final String TEXT_358 = NL + "\t\t\t\t\t\t  \t";
  protected final String TEXT_359 = NL + "\t\t\t\t\t\t  \t\t//do nothing" + NL + "\t\t\t\t\t\t  \t";
  protected final String TEXT_360 = NL + "\t\t\t\t  \t\t}//TD10086" + NL + "\t\t\t\t  \t\t" + NL + "\t\t\t\t  \t\t";
  protected final String TEXT_361 = NL + "\t\t\t\t  \t\t\tif(!";
  protected final String TEXT_362 = " &&" + NL + "\t\t\t\t  \t\t\t\t!(";
  protected final String TEXT_363 = ")" + NL + "\t\t\t\t  \t\t\t) {" + NL + "\t\t\t\t  \t\t\t\t";
  protected final String TEXT_364 = " = ";
  protected final String TEXT_365 = "Default;" + NL + "\t\t\t\t  \t\t\t\t" + NL + "\t\t\t\t  \t\t\t\t";
  protected final String TEXT_366 = " " + NL + "\t\t\t\t  \t\t\t\ttreeNodeAPI_";
  ...
  protected final String TEXT_374 = NL + "\t\t\t\t  \t\tboolean fromCache";
  protected final String TEXT_375 = " = hasResultFromLookupCache";
  protected final String TEXT_376 = ";" + NL + "\t\t\t\t  \t\tList<java.util.Map<String,Object>> multipleResultSet";
  protected final String TEXT_377 = " = new java.util.ArrayList<java.util.Map<String,Object>>();" + NL + "\t\t\t\t  \t\t//the var for cache the ";
  protected final String TEXT_378 = "Struct" + NL + "\t\t\t\t  \t\tjava.util.Map<String,Object> oneRow_";
  protected final String TEXT_379 = " = null;" + NL + "\t\t\t\t\t\tif(hasResultFromLookupCache";
  protected final String TEXT_380 = ") {" + NL + "\t\t\t\t\t    \t";
  protected final String TEXT_381 = NL + "\t\t\t\t\t    \tjava.util.Map<String,Object> cacheResult_";
  protected final String TEXT_382 = " = tHash_Lookup_Cache_";
  protected final String TEXT_383 = ".next();" + NL + "\t\t\t\t\t    \tmultipleResultSet";
  protected final String TEXT_384 = ".add(cacheResult_";
  protected final String TEXT_385 = ");" + NL + "\t\t\t\t\t    \t";
  protected final String TEXT_386 = NL + "\t\t\t\t\t    } else if(!";
  protected final String TEXT_387 = ") {" + NL + "\t\t\t\t\t    \t";
  protected final String TEXT_388 = NL + "\t\t\t\t\t\t   \tisMatchDocRow";
  protected final String TEXT_389 = " = false;" + NL + "\t\t\t\t\t\t  \t";
  protected final String TEXT_390 = NL + "\t\t\t\t\t    \twhile (tHash_Lookup_";
  protected final String TEXT_391 = ".hasNext()) {" + NL + "\t\t\t\t\t    \t\tfromLookup_";
  protected final String TEXT_392 = " = null;" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_393 = " = ";
  protected final String TEXT_394 = "Default;" + NL + "\t\t\t\t\t\t\t\tfromLookup_";
  protected final String TEXT_395 = " = tHash_Lookup_";
  protected final String TEXT_396 = ".next();" + NL + "\t\t\t\t\t\t\t\tif(fromLookup_";
  protected final String TEXT_397 = " != null) {" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_398 = NL + "\t\t\t\t\t\t\t\t\troutines.system.Document lookupDoc_";
  protected final String TEXT_399 = " = fromLookup_";
  protected final String TEXT_400 = ".";
  protected final String TEXT_401 = ";" + NL + "\t\t\t\t\t\t\t\t\tjava.util.Map<String,String> xPathAsOutput_";
  protected final String TEXT_402 = " = new java.util.HashMap<String,String>();" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_403 = NL + "\t\t\t\t\t\t\t\t\t\txPathAsOutput_";
  protected final String TEXT_404 = ".put(\"";
  protected final String TEXT_405 = "\",\"";
  protected final String TEXT_406 = "\");" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_407 = NL + "\t\t\t\t\t\t\t\t\tif(lookupDoc_";
  protected final String TEXT_408 = " == null) {" + NL + "\t\t\t\t\t\t\t\t\t\tthrow new RuntimeException(\"";
  protected final String TEXT_409 = ".";
  protected final String TEXT_410 = " can't be empty\");" + NL + "\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\tList<java.util.Map<String,Object>> result_";
  protected final String TEXT_411 = " = lookupDoc_";
  protected final String TEXT_412 = ".LookupDocument(\"";
  protected final String TEXT_413 = "\",";
  protected final String TEXT_414 = ",";
  protected final String TEXT_415 = "HashKey.documentLookupResult," + NL + "\t\t\t\t\t\t\t\t\t\txPathAsOutput_";
  protected final String TEXT_416 = ",xmlNameSpaceMap_";
  protected final String TEXT_417 = ",xpathToTypeMap_";
  protected final String TEXT_418 = ",xpathToPatternMap_";
  protected final String TEXT_419 = ",\"";
  protected final String TEXT_420 = "\");" + NL + "\t\t\t\t\t\t\t\t\tif(result_";
  protected final String TEXT_421 = " == null || result_";
  protected final String TEXT_422 = ".size() == 0) {" + NL + "\t\t\t\t\t\t\t\t\t\t//do nothing" + NL + "\t\t\t\t\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_423 = NL + "\t\t\t\t\t\t\t\t\t\tisMatchDocRow";
  protected final String TEXT_424 = " = true;" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_425 = NL + "\t\t\t\t\t\t\t\t\t\tfor(java.util.Map<String,Object> docRow_";
  protected final String TEXT_426 = " : result_";
  protected final String TEXT_427 = ") {" + NL + "\t\t\t\t\t\t\t\t\t\t\tdocRow_";
  protected final String TEXT_428 = ".put(\"";
  protected final String TEXT_429 = "\",fromLookup_";
  protected final String TEXT_430 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\tmultipleResultSet";
  protected final String TEXT_431 = ".add(docRow_";
  protected final String TEXT_432 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_433 = NL + "\t\t\t\t\t\t\t\t\t\t\tfor(String path_";
  protected final String TEXT_434 = " : docRow_";
  protected final String TEXT_435 = ".keySet()) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tcacheResult";
  protected final String TEXT_436 = ".put(path_";
  protected final String TEXT_437 = ",StringUtils.valueOf(docRow_";
  protected final String TEXT_438 = ".get(path_";
  protected final String TEXT_439 = ")));" + NL + "\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t\t\tcacheResult";
  protected final String TEXT_440 = ".put(\"";
  protected final String TEXT_441 = "\",fromLookup_";
  protected final String TEXT_442 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\ttHash_Lookup_Cache_";
  protected final String TEXT_443 = ".put(lookupCacheKey";
  protected final String TEXT_444 = ",cacheResult";
  protected final String TEXT_445 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_446 = NL + "\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_447 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_448 = "\t" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_449 = " = fromLookup_";
  protected final String TEXT_450 = ";" + NL + "\t\t\t\t\t\t\t\t\t//construct the resultset for mutiple lookup when no document lookup." + NL + "\t\t\t\t\t\t\t\t\toneRow_";
  protected final String TEXT_451 = " = new java.util.HashMap<String, Object>();" + NL + "\t\t\t\t\t\t\t\t\toneRow_";
  protected final String TEXT_452 = ".put(\"";
  protected final String TEXT_453 = "\",";
  protected final String TEXT_454 = ");" + NL + "\t\t\t\t\t\t\t\t\tmultipleResultSet";
  protected final String TEXT_455 = ".add(oneRow_";
  protected final String TEXT_456 = ");" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_457 = NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t    \t}//end while" + NL + "\t\t\t\t\t    \t" + NL + "\t\t\t\t\t    }//end else if" + NL + "\t\t\t\t\t    //now not support cache all_matches lookup" + NL + "\t\t\t\t\t    ";
  protected final String TEXT_458 = NL + "\t\t\t\t\t    \tforceLoop";
  ...
  protected final String TEXT_464 = " = !isMatchDocRow";
  protected final String TEXT_465 = " && !hasResultFromLookupCache";
  protected final String TEXT_466 = ";" + NL + "\t\t\t\t\t    ";
  protected final String TEXT_467 = " = ";
  protected final String TEXT_468 = ";" + NL + "\t\t\t\t\t    forceLoop";
  protected final String TEXT_469 = " = ";
  protected final String TEXT_470 = ";" + NL + "\t\t\t\t\t  \t";
  protected final String TEXT_471 = NL + "\t\t\t\t\t    " + NL + "\t\t\t\t\t    java.util.Iterator<java.util.Map<String,Object>> iter";
  protected final String TEXT_472 = " = multipleResultSet";
  protected final String TEXT_473 = ".iterator();" + NL + "\t\t\t\t\t    while(iter";
  protected final String TEXT_474 = ".hasNext() || forceLoop";
  protected final String TEXT_475 = ") { // G_TM_M_002" + NL + "\t\t\t\t\t    \t";
  protected final String TEXT_476 = " = ";
  protected final String TEXT_477 = "Default;" + NL + "\t\t\t\t\t    \t";
  protected final String TEXT_478 = "Struct tempLookup";
  protected final String TEXT_479 = " = null; " + NL + "\t\t\t\t\t    \tif(!forceLoop";
  protected final String TEXT_480 = ") {" + NL + "\t\t\t\t\t\t    \tjava.util.Map<String,Object> oneRow";
  protected final String TEXT_481 = " = iter";
  protected final String TEXT_482 = ".next();" + NL + "\t\t\t\t\t\t   \t\t";
  protected final String TEXT_483 = NL + "\t\t\t\t\t\t    \t\t\ttreeNodeAPI_";
  protected final String TEXT_484 = ".put(\"";
  protected final String TEXT_485 = "\",StringUtils.valueOf(oneRow";
  protected final String TEXT_486 = ".get(\"";
  protected final String TEXT_487 = "\")));" + NL + "\t\t\t\t\t\t    \t";
  protected final String TEXT_488 = NL + "\t\t\t\t\t    \t\ttempLookup";
  protected final String TEXT_489 = " = (";
  protected final String TEXT_490 = ")oneRow";
  protected final String TEXT_491 = ".get(\"";
  protected final String TEXT_492 = "\");" + NL + "\t\t\t\t\t    \t\tif(tempLookup";
  protected final String TEXT_493 = "!=null) {" + NL + "\t\t\t\t\t    \t\t\t";
  protected final String TEXT_494 = " = tempLookup";
  ...
  protected final String TEXT_500 = "Default;" + NL + "\t\t\t\t  \t\t\t\t" + NL + "\t\t\t\t  \t\t\t\t\t";
  protected final String TEXT_501 = " " + NL + "\t\t\t\t  \t\t\t\t\ttreeNodeAPI_";
  protected final String TEXT_502 = ".put(\"";
  protected final String TEXT_503 = "\",null);" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_504 = NL + "\t\t\t\t  \t\t\t\t" + NL + "\t\t\t\t  \t\t\t\t\t";
  protected final String TEXT_505 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_506 = " = true;\t\t\t  \t\t\t\t" + NL + "\t\t\t\t  \t\t\t\t\t";
  protected final String TEXT_507 = NL + "\t\t\t\t  \t\t\t\t}" + NL + "\t\t\t\t\t    \t\t";
  protected final String TEXT_508 = NL + "\t\t\t\t    \t\t}" + NL + "\t\t\t\t    \t\tforceLoop";
  protected final String TEXT_509 = " = false;" + NL + "\t\t\t\t  \t\t";
  protected final String TEXT_510 = NL + "\t\t\t\t  \t\t/////////////////////////////////////////////////////////////////////////////////////////////////" + NL + "\t\t\t\t  \t\t" + NL + "\t\t\t\t\t";
  protected final String TEXT_511 = NL + "\t\t\t\t";
  protected final String TEXT_512 = NL + "{ // start of Var scope" + NL + "" + NL + "\t// ###############################" + NL + "\t// # Vars tables";
  protected final String TEXT_513 = NL + NL + "\t\t\t";
  protected final String TEXT_514 = NL + "\t\t// ###############################" + NL + "\t\t// # Output table";
  protected final String TEXT_515 = NL;
  protected final String TEXT_516 = NL + "\t\t\t\t}// G_TM_M_002";
  protected final String TEXT_517 = NL + "\t\t\t\t}//close G_TXM_M_001";
  protected final String TEXT_518 = NL + "\t\t\t\t\t}";
  protected final String TEXT_519 = NL + "\t\t\t";
  protected final String TEXT_520 = NL;
  protected final String TEXT_521 = NL + "\t\t\t\t    gen_Doc_";
  protected final String TEXT_522 = "_";
  protected final String TEXT_523 = " = new GenerateDocument_";
  protected final String TEXT_524 = "();" + NL + "\t\t\t\t    " + NL + "\t\t\t\t\t";
  protected final String TEXT_525 = "_tmp = new ";
  protected final String TEXT_526 = "Struct();" + NL + "\t\t\t\t";
  protected final String TEXT_527 = "   " + NL + "\t\t\t\t\t";
  protected final String TEXT_528 = "_tmp.";
  protected final String TEXT_529 = " = null;" + NL + "\t\t\t\t\t";
  protected final String TEXT_530 = NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_531 = NL + "\t\ttreeNodeAPI_";
  protected final String TEXT_532 = ".clear();" + NL + "\t\t";
  protected final String TEXT_533 = NL + "\t\t\t\t//init document to flat tool" + NL + "\t\t\t\troutines.system.DocumentToFlat docToFlat_";
  protected final String TEXT_534 = " = new routines.system.DocumentToFlat();" + NL + "\t\t\t\tdocToFlat_";
  protected final String TEXT_535 = ".setOriginalLoop(\"";
  protected final String TEXT_536 = "\");" + NL + "\t\t\t\tdocToFlat_";
  protected final String TEXT_537 = ".setIsOptional(";
  protected final String TEXT_538 = ");" + NL + "\t\t\t\tif(";
  protected final String TEXT_539 = ".";
  protected final String TEXT_540 = " == null || ";
  protected final String TEXT_541 = ".";
  protected final String TEXT_542 = ".getDocument() == null) {" + NL + "\t\t\t\t\tthrow new RuntimeException(\"";
  protected final String TEXT_543 = ".";
  protected final String TEXT_544 = " can't be empty\");" + NL + "\t\t\t\t}" + NL + "\t\t\t\torg.dom4j.Document doc_";
  protected final String TEXT_545 = " = ";
  protected final String TEXT_546 = ".";
  protected final String TEXT_547 = ".getDocument();" + NL + "\t\t\t\tdocToFlat_";
  protected final String TEXT_548 = ".setDoc(doc_";
  protected final String TEXT_549 = ");" + NL + "\t\t\t\tdocToFlat_";
  protected final String TEXT_550 = ".setDefineNS(";
  protected final String TEXT_551 = ");" + NL + "\t\t\t\tdocToFlat_";
  protected final String TEXT_552 = ".setNamespaceTool(nsTool_";
  protected final String TEXT_553 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_554 = NL + "\t\t\t\t\t//old version, find NS from doc" + NL + "\t\t\t\t\tnsTool_";
  protected final String TEXT_555 = ".countNSMap(doc_";
  protected final String TEXT_556 = ".getRootElement());" + NL + "\t\t\t\t\tjava.util.HashMap<String,String> xmlNameSpaceMap_";
  protected final String TEXT_557 = " = nsTool_";
  protected final String TEXT_558 = ".xmlNameSpaceMap;" + NL + "\t\t\t\t";
  protected final String TEXT_559 = NL + "\t\t\t\t\tjava.util.HashMap<String,String> xmlNameSpaceMap_";
  protected final String TEXT_560 = " = new java.util.HashMap<String,String>();" + NL + "\t\t\t\t\t";
  protected final String TEXT_561 = NL + "\t\t\t\t";
  protected final String TEXT_562 = NL + "\t\t\t\tdocToFlat_";
  protected final String TEXT_563 = ".setXmlNameSpaceMap(xmlNameSpaceMap_";
  protected final String TEXT_564 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_565 = NL + "\t\t\t\tString[] absolutePathMappings_";
  protected final String TEXT_566 = " = new String[";
  protected final String TEXT_567 = "];" + NL + "\t\t\t\tString[] relativePathMappings_";
  protected final String TEXT_568 = " = new String[";
  protected final String TEXT_569 = "];" + NL + "\t\t\t\t";
  protected final String TEXT_570 = NL + "\t\t\t\tabsolutePathMappings_";
  protected final String TEXT_571 = "[";
  protected final String TEXT_572 = "] = \"";
  protected final String TEXT_573 = "\";" + NL + "\t\t\t\trelativePathMappings_";
  protected final String TEXT_574 = "[";
  protected final String TEXT_575 = "] = \"";
  protected final String TEXT_576 = "\";" + NL + "\t\t\t\t";
  protected final String TEXT_577 = NL + "\t\t\t\tdocToFlat_";
  protected final String TEXT_578 = ".setAbsolutePathMappings(absolutePathMappings_";
  protected final String TEXT_579 = ");" + NL + "\t\t\t\tdocToFlat_";
  protected final String TEXT_580 = ".setCurrentRelativePathMappings(relativePathMappings_";
  protected final String TEXT_581 = ");" + NL + "\t\t\t\t//generate document to flat data" + NL + "\t\t\t\tdocToFlat_";
  protected final String TEXT_582 = ".flat();" + NL + "\t\t\t\t//get flat data" + NL + "\t\t\t\tjava.util.List<java.util.Map<String, String>> resultSet_";
  protected final String TEXT_583 = " = docToFlat_";
  protected final String TEXT_584 = ".getResultSet();" + NL + "\t\t\t\t" + NL + "\t\t\t\tfor (java.util.Map<String,String> oneRow_";
  protected final String TEXT_585 = ": resultSet_";
  protected final String TEXT_586 = ") { // G_TXM_M_001" + NL + "\t\t\t\t\tnb_line_";
  protected final String TEXT_587 = "++;" + NL + "\t\t\t    \t";
  protected final String TEXT_588 = " = false;" + NL + "\t\t\t    \t";
  protected final String TEXT_589 = " = false;" + NL + "\t\t\t\t\t";
  protected final String TEXT_590 = "=false;" + NL + "\t\t\t\t    isMatchDocRow";
  protected final String TEXT_591 = " = false;" + NL + "\t\t\t\t\t" + NL + "\t\t\t    \ttreeNodeAPI_";
  protected final String TEXT_592 = ".clear();" + NL + "\t\t\t    \tfor(java.util.Map.Entry<String, String> entry_";
  protected final String TEXT_593 = " : oneRow_";
  protected final String TEXT_594 = ".entrySet()) {" + NL + "\t\t\t\t\t\ttreeNodeAPI_";
  protected final String TEXT_595 = ".put(entry_";
  protected final String TEXT_596 = ".getKey(),entry_";
  protected final String TEXT_597 = ".getValue());" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_598 = NL;
  protected final String TEXT_599 = NL + NL + "\t\t";
  protected final String TEXT_600 = "\t";
  protected final String TEXT_601 = NL + "\t\t\t\t///////////////////////////////////////////////" + NL + "\t\t\t\t//Starting Lookup Table \"";
  protected final String TEXT_602 = "\" " + NL + "\t\t\t\t///////////////////////////////////////////////" + NL + "\t\t\t\t//tHash_Lookup_";
  protected final String TEXT_603 = ".initGet();" + NL + "\t\t\t\t";
  protected final String TEXT_604 = NL + "\t\t\t\t\t\tjava.util.HashMap<String,String> xmlNameSpaceMap_";
  protected final String TEXT_605 = " = new java.util.HashMap<String,String>();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_606 = NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_607 = "HashKey.documentLookupResult.clear();" + NL + "\t\t\t\t\t\tjava.util.Map<String,String> xpathToPatternMap_";
  protected final String TEXT_608 = " = new java.util.HashMap<String,String>();" + NL + "\t\t\t\t\t\tjava.util.Map<String,String> xpathToTypeMap_";
  protected final String TEXT_609 = " = new java.util.HashMap<String,String>();" + NL + "\t\t\t\t    ";
  protected final String TEXT_610 = NL + "\t\t\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_611 = NL + "\t\t\t\t\tboolean forceLoop";
  protected final String TEXT_612 = " = false;" + NL + "\t\t\t\t\t";
  protected final String TEXT_613 = " ";
  protected final String TEXT_614 = "ObjectFromLookup = null;" + NL + "\t\t\t\t\tboolean hasResultFromLookupCache";
  protected final String TEXT_615 = " = false;" + NL + "\t\t\t\t\tjava.util.Map<String,Object> cacheResult";
  protected final String TEXT_616 = " = new java.util.HashMap<String,Object>();" + NL + "\t\t\t\t";
  protected final String TEXT_617 = NL + "\t\t\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_618 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_619 = "HashKey = new ";
  protected final String TEXT_620 = "Struct() {" + NL + "\t\t\t\t\t\t\t{" + NL + "\t\t\t\t\t\t\t\tthis.loopKey = \"";
  protected final String TEXT_621 = "\";" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\tpublic int hashCode() {" + NL + "\t\t\t\t\t\t\t\tif(this.hashCodeDirty){" + NL + "\t\t\t\t\t\t\t\t\tfinal int prime = PRIME;" + NL + "\t\t\t\t\t\t\t\t\tint result = DEFAULT_HASHCODE;" + NL + "\t\t\t\t\t";
  protected final String TEXT_622 = NL + "\t\t\t\t        \t\t\tresult = prime * result + (this.";
  protected final String TEXT_623 = " ? 1231 : 1237);" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_624 = NL + "\t\t\t\t\t\t\t\t\tresult = prime * result + (int) this.";
  protected final String TEXT_625 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_626 = NL + "\t\t\t\t\t\t\t\tresult = prime * result + java.util.Arrays.hashCode(this.";
  protected final String TEXT_627 = ");" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_628 = NL + "\t\t\t\t\t\t\t\tresult = prime * result + ((this.";
  protected final String TEXT_629 = " == null) ? 0 : this.";
  protected final String TEXT_630 = ".hashCode());" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_631 = NL + "\t\t\t\t\t\t\t\t\tresult = prime * result + ((this.loopKey == null) ? 0 : this.loopKey.hashCode());" + NL + "\t\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\tthis.hashCode = result;" + NL + "    \t\t\t\t\t\t\t\tthis.hashCodeDirty = false;\t" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\treturn this.hashCode;" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\tpublic boolean equals(Object obj) {" + NL + "\t\t\t\t\t\t\t\tif (this == obj) return true;" + NL + "\t\t\t\t\t\t\t\tif (obj == null) return false;" + NL + "\t\t\t\t\t\t\t\tif(!(obj instanceof ";
  protected final String TEXT_632 = "Struct)) return false;" + NL + "\t\t\t\t\t\t\t\tfinal ";
  protected final String TEXT_633 = "Struct other = (";
  protected final String TEXT_634 = "Struct) obj;" + NL + "\t\t\t\t\t\t\t\tif(!this.loopKey.equals(other.loopKey)) return false;";
  protected final String TEXT_635 = NL + "\t\t\t\t\t\t\t\t\t\tif (this.";
  protected final String TEXT_636 = " != other.";
  protected final String TEXT_637 = ") " + NL + "\t\t\t\t\t\t\t\t\t\t\treturn false;" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_638 = NL + "\t\t\t\t\t\t\t\t\t\tif(!java.util.Arrays.equals(this.";
  protected final String TEXT_639 = ", other.";
  protected final String TEXT_640 = ")) {" + NL + "\t\t\t\t\t\t\t\t\t\t\treturn false;" + NL + "\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_641 = NL + "\t\t\t\t\t\t\t\t\t\tif (this.";
  protected final String TEXT_642 = " == null) {" + NL + "\t\t\t\t\t\t\t\t\t\t\tif (other.";
  protected final String TEXT_643 = " != null) " + NL + "\t\t\t\t\t\t\t\t\t\t\t\treturn false;" + NL + "\t\t\t\t\t\t\t\t\t\t} else if (!this.";
  protected final String TEXT_644 = ".equals(other.";
  protected final String TEXT_645 = ")) " + NL + "\t\t\t\t\t\t\t\t\t\t\treturn false;" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_646 = NL + "\t\t\t\t\t\t\t\treturn true;" + NL + "\t\t\t\t\t\t\t} " + NL + "\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t};" + NL + "\t\t\t\t\t";
  protected final String TEXT_647 = NL + "\t\t   \t\t\t\tList<Object> lookupCacheKey";
  protected final String TEXT_648 = " = new java.util.ArrayList<Object>();" + NL + "\t\t   \t\t\t";
  protected final String TEXT_649 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_650 = "HashKey.documentLookupResult.put(\"";
  protected final String TEXT_651 = "\",";
  protected final String TEXT_652 = ");" + NL + "\t\t\t\t\t\t\txpathToPatternMap_";
  protected final String TEXT_653 = ".put(\"";
  protected final String TEXT_654 = "\",";
  protected final String TEXT_655 = ");" + NL + "\t\t\t\t\t\t\txpathToTypeMap_";
  protected final String TEXT_656 = ".put(\"";
  protected final String TEXT_657 = "\",\"";
  protected final String TEXT_658 = "\");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_659 = NL + "\t\t\t\t\t\t\t\tlookupCacheKey";
  protected final String TEXT_660 = ".add(";
  protected final String TEXT_661 = ");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_662 = NL + "\t\t\t\t\t   \t";
  protected final String TEXT_663 = "HashKey.";
  protected final String TEXT_664 = " = ";
  protected final String TEXT_665 = ";" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_666 = "HashKey.hashCodeDirty = true;" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_667 = NL + "\t\t\t\t\t\tlookupCacheKey";
  protected final String TEXT_668 = ".add(";
  protected final String TEXT_669 = "HashKey);" + NL + "\t\t\t\t\t";
  protected final String TEXT_670 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t";
  protected final String TEXT_671 = NL + "\t\t\t\t\t\tif(!";
  protected final String TEXT_672 = "){//TD120" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_673 = NL + "\t\t\t\t\t\t\t\t\ttHash_Lookup_Cache_";
  protected final String TEXT_674 = ".lookup(lookupCacheKey";
  protected final String TEXT_675 = ");" + NL + "\t\t  \t\t\t\t\t\t\tif(tHash_Lookup_Cache_";
  protected final String TEXT_676 = ".hasNext()) {" + NL + "\t  \t\t\t\t\t\t\t\t\thasResultFromLookupCache";
  protected final String TEXT_677 = " = true;" + NL + "\t\t  \t\t\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_682 = "Process(globalMap);" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_683 = NL + "\t\t\t\t\t\t\t\t\ttHash_Lookup_";
  protected final String TEXT_684 = " = " + NL + "\t\t\t\t\t\t\t\t\t\t(org.talend.designer.components.lookup.persistent.Persistent";
  protected final String TEXT_685 = "LookupManager<";
  protected final String TEXT_686 = "Struct>) " + NL + "\t\t\t\t\t\t\t\t\t\t\t((org.talend.designer.components.lookup.persistent.Persistent";
  protected final String TEXT_687 = "LookupManager<";
  protected final String TEXT_688 = "Struct>) " + NL + "\t\t\t\t\t\t\t\t\t\t\t\t globalMap.get( \"tHash_Lookup_";
  protected final String TEXT_689 = "\" ));" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_690 = NL + "\t\t\t\t\t\t\t\t\ttHash_Lookup_";
  protected final String TEXT_691 = " = " + NL + "\t\t\t\t\t\t\t\t\t(org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<";
  protected final String TEXT_692 = "Struct>) " + NL + "\t\t\t\t\t\t\t\t\t\t((org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<";
  protected final String TEXT_693 = "Struct>) " + NL + "\t\t\t\t\t\t\t\t\t\t\tglobalMap.get( \"tHash_Lookup_";
  protected final String TEXT_694 = "\" ));" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_695 = NL + "\t\t\t\t\t    \t\t\ttHash_Lookup_";
  protected final String TEXT_696 = ".initGet();" + NL + "\t\t\t\t\t    \t\t";
  protected final String TEXT_697 = NL + "\t\t\t\t\t    \t\t\ttHash_Lookup_";
  protected final String TEXT_698 = ".lookup( ";
  protected final String TEXT_699 = "HashKey );" + NL + "\t\t\t\t\t    \t\t";
  protected final String TEXT_700 = NL + "\t\t\t\t\t    \t\t\ttHash_Lookup_";
  protected final String TEXT_701 = ".lookup();" + NL + "\t\t\t\t\t    \t\t";
  protected final String TEXT_702 = NL + "\t\t\t\t\t\t    \t\t}" + NL + "\t\t\t\t\t\t\t    ";
  protected final String TEXT_703 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_704 = NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_705 = NL + "\t\t\t\t\t\t\t\t\ttHash_Lookup_";
  protected final String TEXT_706 = ".lookup( ";
  protected final String TEXT_707 = "HashKey );" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_708 = NL + "\t\t\t\t\t\t\t\t\ttHash_Lookup_";
  protected final String TEXT_709 = ".lookup();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_710 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_711 = NL + "\t\t\t\t\t\t\tif(hasResultFromLookupCache";
  protected final String TEXT_712 = "  || tHash_Lookup_";
  protected final String TEXT_713 = ".hasNext()){" + NL + "\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_719 = "Default;" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_720 = NL + "\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_721 = NL + "\t\t\t\t\t\t\t\tforceLoop";
  protected final String TEXT_722 = " = true;" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_723 = NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t}//TD120" + NL + "\t\t\t\t   " + NL + "\t\t\t\t   \t\t";
  protected final String TEXT_724 = NL + "\t\t\t\t   \t\t\tif(";
  protected final String TEXT_725 = ") {" + NL + "\t\t\t\t   \t\t\t\tforceLoop";
  protected final String TEXT_726 = " = true;" + NL + "\t\t\t\t   \t\t\t}" + NL + "\t\t\t\t   \t\t";
  protected final String TEXT_727 = NL + "\t\t\t\t   " + NL + "\t\t\t\t   \t\t";
  protected final String TEXT_728 = "Struct fromLookup_";
  protected final String TEXT_729 = " = null;" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_730 = " = ";
  protected final String TEXT_731 = "Default;" + NL + "\t\t\t\t   " + NL + "\t\t\t\t   \t\t";
  protected final String TEXT_732 = NL + "\t\t\t\t\t    if(hasResultFromLookupCache";
  protected final String TEXT_733 = ") {//TD10086" + NL + "\t\t\t\t\t    \t";
  protected final String TEXT_734 = NL + "\t\t\t\t\t    \tjava.util.Map<String,Object> cacheResult_";
  protected final String TEXT_735 = " = tHash_Lookup_Cache_";
  protected final String TEXT_736 = ".next();" + NL + "\t\t\t\t\t    \t\t";
  protected final String TEXT_737 = NL + "\t\t\t\t\t    \t\t\ttreeNodeAPI_";
  protected final String TEXT_738 = ".put(\"";
  protected final String TEXT_739 = "\",StringUtils.valueOf(cacheResult_";
  protected final String TEXT_740 = ".get(\"";
  protected final String TEXT_741 = "\")));" + NL + "\t\t\t\t\t    \t\t";
  protected final String TEXT_742 = NL + "\t\t\t\t    \t\t\t";
  protected final String TEXT_743 = " = (";
  protected final String TEXT_744 = ")cacheResult_";
  protected final String TEXT_745 = ".get(\"";
  protected final String TEXT_746 = "\");" + NL + "\t\t\t\t\t    \t";
  protected final String TEXT_747 = NL + "\t\t\t\t\t    } else if(!";
  protected final String TEXT_748 = ") {" + NL + "\t\t\t\t\t\t  \t";
  protected final String TEXT_749 = NL + "\t\t\t\t\t\t   \tisMatchDocRow";
  protected final String TEXT_750 = " = false;" + NL + "\t\t\t\t\t\t  \t";
  protected final String TEXT_751 = NL + "\t\t\t\t\t\t\twhile (tHash_Lookup_";
  protected final String TEXT_752 = ".hasNext()) {//TD119" + NL + "\t\t\t\t\t\t\t\tfromLookup_";
  protected final String TEXT_753 = " = null;" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_754 = " = ";
  protected final String TEXT_755 = "Default;" + NL + "\t\t\t\t\t\t\t\tfromLookup_";
  protected final String TEXT_756 = " = tHash_Lookup_";
  protected final String TEXT_757 = ".next();" + NL + "\t\t\t\t\t\t\t\tif (fromLookup_";
  protected final String TEXT_758 = " != null) {" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_759 = NL + "\t\t\t\t\t\t\t\t\t//begin to lookup Document Object (case 1:lookup doc key exists),(case 2:lookup doc key not exists but lookup line doc output exist)" + NL + "\t\t\t\t\t\t\t\t\troutines.system.Document lookupDoc_";
  protected final String TEXT_760 = " = fromLookup_";
  protected final String TEXT_761 = ".";
  protected final String TEXT_762 = ";" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_763 = NL + "\t\t\t\t\t\t\t\t\tboolean quit";
  protected final String TEXT_764 = " = false;" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_765 = NL + "\t\t\t\t\t\t\t\t\tjava.util.Map<String,String> xPathAsOutput_";
  protected final String TEXT_766 = " = new java.util.HashMap<String,String>();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_767 = NL + "\t\t\t\t\t\t\t\t\txPathAsOutput_";
  protected final String TEXT_768 = ".put(\"";
  protected final String TEXT_769 = "\",\"";
  protected final String TEXT_770 = "\");" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_771 = NL + "\t\t\t\t\t\t\t\t\tif(lookupDoc_";
  protected final String TEXT_772 = " == null) {" + NL + "\t\t\t\t\t\t\t\t\t\tthrow new RuntimeException(\"";
  protected final String TEXT_773 = ".";
  protected final String TEXT_774 = " can't be empty\");" + NL + "\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\tList<java.util.Map<String,Object>> result_";
  protected final String TEXT_775 = " = lookupDoc_";
  protected final String TEXT_776 = ".LookupDocument(\"";
  protected final String TEXT_777 = "\",";
  protected final String TEXT_778 = ",";
  protected final String TEXT_779 = "HashKey.documentLookupResult," + NL + "\t\t\t\t\t\t\t\t\t\txPathAsOutput_";
  protected final String TEXT_780 = ",xmlNameSpaceMap_";
  protected final String TEXT_781 = ",xpathToTypeMap_";
  protected final String TEXT_782 = ",xpathToPatternMap_";
  protected final String TEXT_783 = ",\"";
  protected final String TEXT_784 = "\");" + NL + "\t\t\t\t\t\t\t\t\tif(result_";
  protected final String TEXT_785 = " == null || result_";
  protected final String TEXT_786 = ".size() == 0) {" + NL + "\t\t\t\t\t\t\t\t\t\t// not find" + NL + "\t\t\t\t\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\t\t\t\t\t//find and cache it,now only memory,inner join and unique match mode" + NL + "\t\t\t\t\t\t\t\t\t\t//once find,not reject." + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_787 = NL + "\t\t\t\t\t\t\t\t\t\tisMatchDocRow";
  protected final String TEXT_788 = " = true;" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_789 = NL + "\t\t\t\t\t\t\t\t\t\tfor(java.util.Map<String,Object> docRow_";
  protected final String TEXT_790 = " : result_";
  protected final String TEXT_791 = ") {" + NL + "\t\t\t\t\t\t\t\t\t\t\tfor(String path_";
  protected final String TEXT_792 = " : docRow_";
  protected final String TEXT_793 = ".keySet()) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\ttreeNodeAPI_";
  protected final String TEXT_794 = ".put(path_";
  protected final String TEXT_795 = ", StringUtils.valueOf(docRow_";
  protected final String TEXT_796 = ".get(path_";
  protected final String TEXT_797 = ")));" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_798 = NL + "\t\t\t\t\t\t\t\t\t\t\t\tcacheResult";
  protected final String TEXT_799 = ".put(path_";
  protected final String TEXT_800 = ",StringUtils.valueOf(docRow_";
  protected final String TEXT_801 = ".get(path_";
  protected final String TEXT_802 = ")));" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_803 = NL + "\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_804 = NL + "\t\t\t\t\t\t\t\t\t\tquit";
  protected final String TEXT_805 = " = true;" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_806 = NL + "\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_807 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_808 = " = fromLookup_";
  protected final String TEXT_809 = ";" + NL + "\t\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_810 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_811 = NL + "\t\t\t\t\t\t\t\t\t\tif(isMatchDocRow";
  protected final String TEXT_812 = ") {" + NL + "\t\t\t\t\t\t\t\t\t\t\tcacheResult";
  protected final String TEXT_813 = ".put(\"";
  protected final String TEXT_814 = "\",";
  protected final String TEXT_815 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\ttHash_Lookup_Cache_";
  protected final String TEXT_816 = ".put(lookupCacheKey";
  protected final String TEXT_817 = ",cacheResult";
  protected final String TEXT_818 = "); " + NL + "\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_819 = NL + "\t\t\t\t\t\t\t\t\t\tcacheResult";
  protected final String TEXT_820 = ".put(\"";
  protected final String TEXT_821 = "\",";
  protected final String TEXT_822 = "); " + NL + "\t\t\t\t\t\t\t\t\t\ttHash_Lookup_Cache_";
  protected final String TEXT_823 = ".put(lookupCacheKey";
  protected final String TEXT_824 = ",cacheResult";
  protected final String TEXT_825 = "); " + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_826 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_827 = NL + "\t\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_828 = NL + "\t\t\t\t\t\t\t\t\t\tif(quit";
  protected final String TEXT_829 = ") {//for first match,once find in document,no need to continue to lookup." + NL + "\t\t\t\t\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_830 = NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t}//TD119" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_831 = NL + "\t\t\t\t\t\t   \t";
  protected final String TEXT_832 = " = !isMatchDocRow";
  protected final String TEXT_833 = " && !hasResultFromLookupCache";
  protected final String TEXT_834 = ";" + NL + "\t\t\t\t\t\t    ";
  protected final String TEXT_835 = " = ";
  protected final String TEXT_836 = ";" + NL + "\t\t\t\t\t\t  \t";
  protected final String TEXT_837 = NL + "\t\t\t\t\t\t  \t";
  protected final String TEXT_838 = NL + "\t\t\t\t\t\t  \tif(!isMatchDocRow";
  protected final String TEXT_839 = " && !hasResultFromLookupCache";
  protected final String TEXT_840 = ") {" + NL + "\t\t\t\t\t\t  \t\t";
  protected final String TEXT_841 = " = ";
  protected final String TEXT_842 = "Default;" + NL + "\t\t\t\t\t\t  \t}" + NL + "\t\t\t\t\t\t  \t";
  protected final String TEXT_843 = NL + "\t\t\t\t\t\t  \t";
  protected final String TEXT_844 = NL + "\t\t\t\t\t\t  \t\t//do nothing" + NL + "\t\t\t\t\t\t  \t";
  protected final String TEXT_845 = NL + "\t\t\t\t  \t\t}//TD10086" + NL + "\t\t\t\t  \t\t" + NL + "\t\t\t\t  \t\t";
  protected final String TEXT_846 = NL + "\t\t\t\t  \t\t\tif(!";
  protected final String TEXT_847 = " &&" + NL + "\t\t\t\t  \t\t\t\t!(";
  protected final String TEXT_848 = ")" + NL + "\t\t\t\t  \t\t\t) {" + NL + "\t\t\t\t  \t\t\t\t";
  protected final String TEXT_849 = " = ";
  protected final String TEXT_850 = "Default;" + NL + "\t\t\t\t  \t\t\t\t" + NL + "\t\t\t\t  \t\t\t\t";
  protected final String TEXT_851 = " " + NL + "\t\t\t\t  \t\t\t\ttreeNodeAPI_";
  protected final String TEXT_852 = ".put(\"";
  ...
  protected final String TEXT_858 = NL + "\t\t\t\t  \t\t" + NL + "\t\t\t\t  \t\t//////////////////////////////////////////////////////////////////////////////////////////////" + NL + "\t\t\t\t  \t\t";
  protected final String TEXT_859 = NL + "\t\t\t\t  \t\tboolean fromCache";
  protected final String TEXT_860 = " = hasResultFromLookupCache";
  protected final String TEXT_861 = ";" + NL + "\t\t\t\t  \t\tList<java.util.Map<String,Object>> multipleResultSet";
  protected final String TEXT_862 = " = new java.util.ArrayList<java.util.Map<String,Object>>();" + NL + "\t\t\t\t  \t\t//the var for cache the ";
  protected final String TEXT_863 = "Struct" + NL + "\t\t\t\t  \t\tjava.util.Map<String,Object> oneRow_";
  protected final String TEXT_864 = " = null;" + NL + "\t\t\t\t\t\tif(hasResultFromLookupCache";
  protected final String TEXT_865 = ") {" + NL + "\t\t\t\t\t    \t";
  protected final String TEXT_866 = NL + "\t\t\t\t\t    \tjava.util.Map<String,Object> cacheResult_";
  protected final String TEXT_867 = " = tHash_Lookup_Cache_";
  protected final String TEXT_868 = ".next();" + NL + "\t\t\t\t\t    \tmultipleResultSet";
  protected final String TEXT_869 = ".add(cacheResult_";
  protected final String TEXT_870 = ");" + NL + "\t\t\t\t\t    \t";
  protected final String TEXT_871 = NL + "\t\t\t\t\t    } else if(!";
  protected final String TEXT_872 = ") {" + NL + "\t\t\t\t\t    \t";
  protected final String TEXT_873 = NL + "\t\t\t\t\t\t   \tisMatchDocRow";
  protected final String TEXT_874 = " = false;" + NL + "\t\t\t\t\t\t  \t";
  protected final String TEXT_875 = NL + "\t\t\t\t\t    \twhile (tHash_Lookup_";
  protected final String TEXT_876 = ".hasNext()) {" + NL + "\t\t\t\t\t    \t\tfromLookup_";
  protected final String TEXT_877 = " = null;" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_878 = " = ";
  protected final String TEXT_879 = "Default;" + NL + "\t\t\t\t\t\t\t\tfromLookup_";
  protected final String TEXT_880 = " = tHash_Lookup_";
  protected final String TEXT_881 = ".next();" + NL + "\t\t\t\t\t\t\t\tif(fromLookup_";
  protected final String TEXT_882 = " != null) {" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_883 = NL + "\t\t\t\t\t\t\t\t\troutines.system.Document lookupDoc_";
  protected final String TEXT_884 = " = fromLookup_";
  protected final String TEXT_885 = ".";
  protected final String TEXT_886 = ";" + NL + "\t\t\t\t\t\t\t\t\tjava.util.Map<String,String> xPathAsOutput_";
  protected final String TEXT_887 = " = new java.util.HashMap<String,String>();" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_888 = NL + "\t\t\t\t\t\t\t\t\t\txPathAsOutput_";
  protected final String TEXT_889 = ".put(\"";
  protected final String TEXT_890 = "\",\"";
  protected final String TEXT_891 = "\");" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_892 = NL + "\t\t\t\t\t\t\t\t\tif(lookupDoc_";
  protected final String TEXT_893 = " == null) {" + NL + "\t\t\t\t\t\t\t\t\t\tthrow new RuntimeException(\"";
  protected final String TEXT_894 = ".";
  protected final String TEXT_895 = " can't be empty\");" + NL + "\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\tList<java.util.Map<String,Object>> result_";
  protected final String TEXT_896 = " = lookupDoc_";
  protected final String TEXT_897 = ".LookupDocument(\"";
  protected final String TEXT_898 = "\",";
  protected final String TEXT_899 = ",";
  protected final String TEXT_900 = "HashKey.documentLookupResult," + NL + "\t\t\t\t\t\t\t\t\t\txPathAsOutput_";
  protected final String TEXT_901 = ",xmlNameSpaceMap_";
  protected final String TEXT_902 = ",xpathToTypeMap_";
  protected final String TEXT_903 = ",xpathToPatternMap_";
  protected final String TEXT_904 = ",\"";
  protected final String TEXT_905 = "\");" + NL + "\t\t\t\t\t\t\t\t\tif(result_";
  protected final String TEXT_906 = " == null || result_";
  protected final String TEXT_907 = ".size() == 0) {" + NL + "\t\t\t\t\t\t\t\t\t\t//do nothing" + NL + "\t\t\t\t\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_908 = NL + "\t\t\t\t\t\t\t\t\t\tisMatchDocRow";
  protected final String TEXT_909 = " = true;" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_910 = NL + "\t\t\t\t\t\t\t\t\t\tfor(java.util.Map<String,Object> docRow_";
  protected final String TEXT_911 = " : result_";
  protected final String TEXT_912 = ") {" + NL + "\t\t\t\t\t\t\t\t\t\t\tdocRow_";
  protected final String TEXT_913 = ".put(\"";
  protected final String TEXT_914 = "\",fromLookup_";
  protected final String TEXT_915 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\tmultipleResultSet";
  protected final String TEXT_916 = ".add(docRow_";
  protected final String TEXT_917 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_918 = NL + "\t\t\t\t\t\t\t\t\t\t\tfor(String path_";
  protected final String TEXT_919 = " : docRow_";
  protected final String TEXT_920 = ".keySet()) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tcacheResult";
  protected final String TEXT_921 = ".put(path_";
  protected final String TEXT_922 = ",StringUtils.valueOf(docRow_";
  protected final String TEXT_923 = ".get(path_";
  protected final String TEXT_924 = ")));" + NL + "\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t\t\tcacheResult";
  protected final String TEXT_925 = ".put(\"";
  protected final String TEXT_926 = "\",fromLookup_";
  protected final String TEXT_927 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\ttHash_Lookup_Cache_";
  protected final String TEXT_928 = ".put(lookupCacheKey";
  protected final String TEXT_929 = ",cacheResult";
  protected final String TEXT_930 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_931 = NL + "\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_932 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_933 = "\t" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_934 = " = fromLookup_";
  protected final String TEXT_935 = ";" + NL + "\t\t\t\t\t\t\t\t\t//construct the resultset for mutiple lookup when no document lookup." + NL + "\t\t\t\t\t\t\t\t\toneRow_";
  protected final String TEXT_936 = " = new java.util.HashMap<String, Object>();" + NL + "\t\t\t\t\t\t\t\t\toneRow_";
  protected final String TEXT_937 = ".put(\"";
  protected final String TEXT_938 = "\",";
  protected final String TEXT_939 = ");" + NL + "\t\t\t\t\t\t\t\t\tmultipleResultSet";
  protected final String TEXT_940 = ".add(oneRow_";
  protected final String TEXT_941 = ");" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_942 = NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t    \t}//end while" + NL + "\t\t\t\t\t    \t" + NL + "\t\t\t\t\t    }//end else if" + NL + "\t\t\t\t\t    //now not support cache all_matches lookup" + NL + "\t\t\t\t\t    ";
  protected final String TEXT_943 = NL + "\t\t\t\t\t    \tforceLoop";
  protected final String TEXT_944 = " = !isMatchDocRow";
  protected final String TEXT_945 = " && !hasResultFromLookupCache";
  protected final String TEXT_946 = ";" + NL + "\t\t\t\t\t    ";
  protected final String TEXT_947 = NL + "\t\t\t\t\t    " + NL + "\t\t\t\t\t    ";
  protected final String TEXT_948 = NL + "\t\t\t\t\t   \t";
  protected final String TEXT_949 = " = !isMatchDocRow";
  protected final String TEXT_950 = " && !hasResultFromLookupCache";
  protected final String TEXT_951 = ";" + NL + "\t\t\t\t\t    ";
  protected final String TEXT_952 = " = ";
  protected final String TEXT_953 = ";" + NL + "\t\t\t\t\t    forceLoop";
  protected final String TEXT_954 = " = ";
  protected final String TEXT_955 = ";" + NL + "\t\t\t\t\t  \t";
  protected final String TEXT_956 = NL + "\t\t\t\t\t    " + NL + "\t\t\t\t\t    java.util.Iterator<java.util.Map<String,Object>> iter";
  protected final String TEXT_957 = " = multipleResultSet";
  protected final String TEXT_958 = ".iterator();" + NL + "\t\t\t\t\t    while(iter";
  protected final String TEXT_959 = ".hasNext() || forceLoop";
  protected final String TEXT_960 = ") { // G_TM_M_002" + NL + "\t\t\t\t\t    \t";
  protected final String TEXT_961 = " = ";
  protected final String TEXT_962 = "Default;" + NL + "\t\t\t\t\t    \t";
  protected final String TEXT_963 = "Struct tempLookup";
  protected final String TEXT_964 = " = null; " + NL + "\t\t\t\t\t    \tif(!forceLoop";
  protected final String TEXT_965 = ") {" + NL + "\t\t\t\t\t\t    \tjava.util.Map<String,Object> oneRow";
  protected final String TEXT_966 = " = iter";
  protected final String TEXT_967 = ".next();" + NL + "\t\t\t\t\t\t   \t\t";
  protected final String TEXT_968 = NL + "\t\t\t\t\t\t    \t\t\ttreeNodeAPI_";
  protected final String TEXT_969 = ".put(\"";
  protected final String TEXT_970 = "\",StringUtils.valueOf(oneRow";
  protected final String TEXT_971 = ".get(\"";
  protected final String TEXT_972 = "\")));" + NL + "\t\t\t\t\t\t    \t";
  protected final String TEXT_973 = NL + "\t\t\t\t\t    \t\ttempLookup";
  protected final String TEXT_974 = " = (";
  protected final String TEXT_975 = ")oneRow";
  protected final String TEXT_976 = ".get(\"";
  protected final String TEXT_977 = "\");" + NL + "\t\t\t\t\t    \t\tif(tempLookup";
  protected final String TEXT_978 = "!=null) {" + NL + "\t\t\t\t\t    \t\t\t";
  protected final String TEXT_979 = " = tempLookup";
  ...
  protected final String TEXT_985 = "Default;" + NL + "\t\t\t\t  \t\t\t\t" + NL + "\t\t\t\t  \t\t\t\t\t";
  protected final String TEXT_986 = " " + NL + "\t\t\t\t  \t\t\t\t\ttreeNodeAPI_";
  protected final String TEXT_987 = ".put(\"";
  protected final String TEXT_988 = "\",null);" + NL + "\t\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_993 = NL + "\t\t\t\t    \t\t}" + NL + "\t\t\t\t    \t\tforceLoop";
  protected final String TEXT_994 = " = false;" + NL + "\t\t\t\t  \t\t";
  protected final String TEXT_995 = NL + "\t\t\t\t  \t\t/////////////////////////////////////////////////////////////////////////////////////////////////" + NL + "\t\t\t\t  \t\t" + NL + "\t\t\t\t\t";
  protected final String TEXT_996 = NL + "\t\t\t\t";
  protected final String TEXT_997 = NL + "{ // start of Var scope" + NL + "" + NL + "\t// ###############################" + NL + "\t// # Vars tables" + NL;
  protected final String TEXT_998 = NL + NL + "\t\t\t";
  protected final String TEXT_999 = NL + "\t\t// ###############################" + NL + "\t\t// # Output tables";
  protected final String TEXT_1000 = NL;
  protected final String TEXT_1001 = NL;
  protected final String TEXT_1002 = NL + "\t\t}// G_TM_M_002";
  protected final String TEXT_1003 = NL + "\t\t}//G_TXM_M_001 close" + NL + "\t";
