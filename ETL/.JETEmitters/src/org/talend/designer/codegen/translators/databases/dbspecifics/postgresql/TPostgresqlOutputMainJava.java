...
public class TPostgresqlOutputMainJava {
  ...
  protected final String TEXT_71 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_72 = "));";
  protected final String TEXT_73 = NL + "                    stmtCreate_";
  protected final String TEXT_74 = ".execute(((\"";
  protected final String TEXT_75 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_76 = ".";
  protected final String TEXT_77 = ", \"";
  protected final String TEXT_78 = "\")";
  protected final String TEXT_79 = ".toUpperCase()";
  ...
  protected final String TEXT_91 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_99 = ".toUpperCase()";
  ...
  protected final String TEXT_251 = ".getTables(null, conn_";
  protected final String TEXT_252 = ".getSchema(), tableForSearch_";
  protected final String TEXT_253 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_254 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_255 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_256 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  ...
  protected final String TEXT_263 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_264 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_265 = ".next()) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_266 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  ...
  protected final String TEXT_309 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_318 = ".commit();";
  protected final String TEXT_319 = NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_327 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_328 = ".";
  protected final String TEXT_329 = ", \"";
  protected final String TEXT_330 = "\")";
  protected final String TEXT_331 = ".toUpperCase()";
  ...
  protected final String TEXT_348 = ".executeUpdate(\"";
  protected final String TEXT_349 = "\");";
  protected final String TEXT_350 = NL + "            stmtClear_";
  protected final String TEXT_351 = ".close();";
  protected final String TEXT_352 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_353 = " = conn_";
  protected final String TEXT_354 = ".createStatement();";
  protected final String TEXT_355 = NL + "                              stmtTruncCount_";
  protected final String TEXT_356 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_357 = "));";
  protected final String TEXT_358 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_359 = " = stmtTruncCount_";
  protected final String TEXT_360 = ".executeQuery(\"";
  protected final String TEXT_361 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_362 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_363 = ".next()) {" + NL + "                rsTruncCountNumber_";
  protected final String TEXT_364 = " = rsTruncCount_";
  protected final String TEXT_365 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_366 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_367 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_374 = ".commit();";
  protected final String TEXT_375 = NL + "            stmtTrunc_";
  protected final String TEXT_376 = ".executeUpdate(\"";
  protected final String TEXT_377 = "\");";
  protected final String TEXT_378 = NL + "                if(!conn_";
  protected final String TEXT_379 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_380 = ".commit();" + NL + "                }";
  protected final String TEXT_381 = NL + "            deletedCount_";
  protected final String TEXT_382 = " += rsTruncCountNumber_";
  ...
  protected final String TEXT_387 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_388 = " = stmtTruncCount_";
  protected final String TEXT_389 = ".executeQuery(\"";
  protected final String TEXT_390 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_394 = ".commit();";
  ...
  protected final String TEXT_428 = " = null;" + NL + "    String keyPsmt_";
  ...
  protected final String TEXT_443 = ", \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_450 = " + \"\\\" SET \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_474 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_480 = ", \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_487 = " + \"\\\" SET \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_510 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_531 = " + \"\\\" SET \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_532 = ".";
  protected final String TEXT_533 = ", \"";
  protected final String TEXT_534 = "\")+\" WHERE ";
  protected final String TEXT_535 = "\";";
  protected final String TEXT_536 = NL + "\t    pstmtUpdate_";
  ...
  protected final String TEXT_573 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_574 = " = insertIgnore_";
  protected final String TEXT_575 = ".split(\"\\\\?\");";
  protected final String TEXT_576 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_577 = " = insert_";
  protected final String TEXT_578 = ".split(\"\\\\?\");";
  protected final String TEXT_579 = NL + "\t\t}" + NL + "\t";
  protected final String TEXT_580 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_581 = " = buffersSize_";
  protected final String TEXT_582 = ";";
  protected final String TEXT_583 = NL + "\t\t\t\tbatchSize_";
  ...
  protected final String TEXT_592 = NL + "                            geometryColumnName_";
  protected final String TEXT_593 = " = \"";
  protected final String TEXT_594 = "\";" + NL + "                            if (firstGeometry_";
  protected final String TEXT_595 = ") {" + NL + "                                dimension_";
  protected final String TEXT_596 = " = 2;" + NL + "" + NL + "                                // A null first geometry will lead to unknown coordinate system" + NL + "                                if (";
  protected final String TEXT_597 = ".";
  protected final String TEXT_598 = " == null) {" + NL + "                            \t    SRID_";
  protected final String TEXT_599 = " = -1;" + NL + "                                } else {" + NL + "                                    org.opengis.referencing.crs.CoordinateReferenceSystem refSys_";
  protected final String TEXT_600 = " =" + NL + "                                        ((org.talend.sdi.geometry.Geometry) ";
  protected final String TEXT_601 = ".";
  protected final String TEXT_602 = ").getCRS();" + NL + "                                    if (refSys_";
  protected final String TEXT_603 = " != null) {" + NL + "                                        dimension_";
  protected final String TEXT_604 = " = refSys_";
  protected final String TEXT_605 = ".getCoordinateSystem().getDimension();" + NL + "                                        try {" + NL + "                                            java.util.Set ident_";
  protected final String TEXT_606 = " = refSys_";
  protected final String TEXT_607 = ".getIdentifiers();" + NL + "                                            if ((ident_";
  protected final String TEXT_608 = " == null || ident_";
  protected final String TEXT_609 = ".isEmpty())" + NL + "                                                && refSys_";
  protected final String TEXT_610 = " == org.geotools.referencing.crs.DefaultGeographicCRS.WGS84) {" + NL + "                                                SRID_";
  protected final String TEXT_611 = " = 4326;" + NL + "                                            } else {" + NL + "                                                String code_";
  protected final String TEXT_612 = " = ((org.geotools.referencing.NamedIdentifier) ident_";
  protected final String TEXT_613 = ".toArray()[0]).getCode();" + NL + "                                                SRID_";
  protected final String TEXT_614 = " = Integer.parseInt(code_";
  protected final String TEXT_615 = ");" + NL + "                                            }" + NL + "                                        } catch (java.lang.Exception e) {" + NL + "                                            String SRIDError_";
  protected final String TEXT_616 = " = \"SRID_";
  protected final String TEXT_617 = " could not be determined\";";
  protected final String TEXT_618 = NL + "                                            System.out.println(SRIDError_";
  protected final String TEXT_619 = ");" + NL + "                                            SRID_";
  protected final String TEXT_620 = " = -1;" + NL + "                                        }" + NL + "                                     }  else {" + NL + "                                        SRID_";
  protected final String TEXT_621 = " = -1;" + NL + "                                     }" + NL + "                                     firstGeometry_";
  protected final String TEXT_622 = " = false;" + NL + "                                 }" + NL + "                            }";
  protected final String TEXT_623 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_624 = ",";
  protected final String TEXT_625 = ".";
  protected final String TEXT_626 = ", ";
  protected final String TEXT_627 = ",insertSQLSplits_";
  protected final String TEXT_628 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_629 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_640 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_641 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_642 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_643 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_644 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_645 = "++;" + NL + "\t\t\t\t";
  protected final String TEXT_646 = NL + "                \tsp_";
  protected final String TEXT_647 = " = conn_";
  protected final String TEXT_648 = ".setSavepoint();" + NL + "\t\t\t\t";
  protected final String TEXT_649 = NL + "                insertedCount_";
  protected final String TEXT_650 = " = insertedCount_";
  protected final String TEXT_651 = " + pstmt_";
  protected final String TEXT_652 = ".executeUpdate();";
  protected final String TEXT_653 = NL + "\t\t\t\t";
  protected final String TEXT_654 = NL + "\t                conn_";
  protected final String TEXT_655 = ".releaseSavepoint(sp_";
  protected final String TEXT_656 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_657 = NL + "            } catch(java.lang.Exception e) {" + NL + "\t\t\t\t";
  protected final String TEXT_658 = NL + "\t                conn_";
  protected final String TEXT_659 = ".rollback(sp_";
  protected final String TEXT_660 = ");" + NL + "\t            ";
  protected final String TEXT_661 = NL + "                whetherReject_";
  ...
  protected final String TEXT_676 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_677 = NL + "                        ";
  protected final String TEXT_678 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_679 = ";";
  protected final String TEXT_680 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_686 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_687 = ",";
  protected final String TEXT_688 = ".";
  protected final String TEXT_689 = ", ";
  protected final String TEXT_690 = ",updateSQLSplits_";
  protected final String TEXT_691 = ");";
  protected final String TEXT_692 = NL + "\t\t\t\t\tint count_";
  protected final String TEXT_693 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_721 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_722 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_723 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_724 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_725 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_726 = "++;" + NL + "\t\t\t\t";
  protected final String TEXT_727 = NL + "\t                sp_";
  protected final String TEXT_728 = " = conn_";
  protected final String TEXT_729 = ".setSavepoint();" + NL + "\t            ";
  protected final String TEXT_730 = NL + "                updatedCount_";
  protected final String TEXT_731 = " = updatedCount_";
  protected final String TEXT_732 = " + pstmt_";
  protected final String TEXT_733 = ".executeUpdate();";
  protected final String TEXT_734 = NL + "\t\t\t\t";
  protected final String TEXT_735 = NL + "                \tconn_";
  protected final String TEXT_736 = ".releaseSavepoint(sp_";
  protected final String TEXT_737 = ");";
  protected final String TEXT_738 = NL + "            } catch(java.lang.Exception e) {" + NL + "\t\t\t\t";
  protected final String TEXT_739 = NL + "\t                conn_";
  protected final String TEXT_740 = ".rollback(sp_";
  ...
  protected final String TEXT_761 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_781 = ",updateSQLSplits_";
  protected final String TEXT_782 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_783 = NL + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_784 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_785 = ".";
  protected final String TEXT_786 = ", pstmtUpdate_";
  ...
  protected final String TEXT_810 = NL + "                try {" + NL + "\t\t\t\t\t";
  protected final String TEXT_811 = NL + "\t                    sp_";
  protected final String TEXT_812 = " = conn_";
  protected final String TEXT_813 = ".setSavepoint();" + NL + "\t                ";
  protected final String TEXT_814 = NL + "                    updatedCount_";
  ...
  protected final String TEXT_820 = NL + "    \t                conn_";
  protected final String TEXT_821 = ".releaseSavepoint(sp_";
  protected final String TEXT_822 = ");" + NL + "    \t            ";
  protected final String TEXT_823 = NL + "                } catch(java.lang.Exception e) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_824 = NL + "    \t                conn_";
  protected final String TEXT_825 = ".rollback(sp_";
  ...
  protected final String TEXT_830 = NL + "                        nb_line_";
  protected final String TEXT_831 = "++;";
  protected final String TEXT_832 = NL + "                            ";
  protected final String TEXT_833 = " = new ";
  protected final String TEXT_834 = "Struct();";
  protected final String TEXT_835 = NL + "                                ";
  protected final String TEXT_836 = ".";
  protected final String TEXT_837 = " = ";
  protected final String TEXT_838 = ".";
  protected final String TEXT_839 = ";";
  protected final String TEXT_840 = NL + "                            rejectedCount_";
  protected final String TEXT_841 = " = rejectedCount_";
  protected final String TEXT_842 = " + 1;";
  protected final String TEXT_843 = NL + "                            ";
  protected final String TEXT_844 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_845 = NL + "                            ";
  protected final String TEXT_846 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_847 = ";";
  protected final String TEXT_848 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_849 = NL + "                }" + NL + "            } else {";
  ...
  protected final String TEXT_869 = NL + "                try {" + NL + "\t\t\t\t\t";
  protected final String TEXT_870 = NL + "\t                    sp_";
  protected final String TEXT_871 = " = conn_";
  protected final String TEXT_872 = ".setSavepoint();" + NL + "\t                ";
  protected final String TEXT_873 = NL + "                    insertedCount_";
  ...
  protected final String TEXT_879 = NL + "    \t                conn_";
  protected final String TEXT_880 = ".releaseSavepoint(sp_";
  protected final String TEXT_881 = ");" + NL + "    \t            ";
  protected final String TEXT_882 = NL + "                } catch(java.lang.Exception e) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_883 = NL + "    \t                conn_";
  protected final String TEXT_884 = ".rollback(sp_";
  ...
  protected final String TEXT_907 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_908 = NL + "                }" + NL + "            }";
  protected final String TEXT_909 = NL + "            int updateFlag_";
  protected final String TEXT_910 = "=0;";
  ...
  protected final String TEXT_919 = ",updateSQLSplits_";
  protected final String TEXT_920 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_921 = NL + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_922 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_946 = NL + "                globalMap.put(\"";
  protected final String TEXT_947 = "_QUERY\", query_";
  protected final String TEXT_948 = ".toString().trim());";
  protected final String TEXT_949 = NL + NL + "            try {" + NL + "\t\t\t\t";
  protected final String TEXT_950 = NL + "\t                sp_";
  protected final String TEXT_951 = " = conn_";
  protected final String TEXT_952 = ".setSavepoint();" + NL + "\t            ";
  protected final String TEXT_953 = NL + "                updateFlag_";
  ...
  protected final String TEXT_959 = NL + "\t                conn_";
  protected final String TEXT_960 = ".releaseSavepoint(sp_";
  protected final String TEXT_961 = ");" + NL + "\t            ";
  protected final String TEXT_962 = NL + "            if(updateFlag_";
  protected final String TEXT_963 = " == 0) {" + NL + "            \t";
  protected final String TEXT_964 = NL + "\t\t\t\tquery_";
  protected final String TEXT_965 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_966 = NL + "                        ";
  protected final String TEXT_967 = NL + "                            query_";
  protected final String TEXT_968 = " = ";
  protected final String TEXT_969 = ";";
  protected final String TEXT_970 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_971 = ",";
  protected final String TEXT_972 = ".";
  protected final String TEXT_973 = ", ";
  protected final String TEXT_974 = ",insertSQLSplits_";
  protected final String TEXT_975 = ");" + NL + "\t                \t\t\t";
  protected final String TEXT_976 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_977 = ".";
  protected final String TEXT_978 = ", pstmtInsert_";
  protected final String TEXT_979 = ", ";
  protected final String TEXT_980 = ", \"";
  protected final String TEXT_981 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_982 = NL + "                    globalMap.put(\"";
  protected final String TEXT_983 = "_QUERY\", query_";
  protected final String TEXT_984 = ".toString().trim());";
  protected final String TEXT_985 = NL + "\t\t\t\t\t";
  protected final String TEXT_986 = NL + "\t                    sp_";
  protected final String TEXT_987 = " = conn_";
  protected final String TEXT_988 = ".setSavepoint();" + NL + "\t                ";
  protected final String TEXT_989 = NL + "                    insertedCount_";
  protected final String TEXT_990 = " = insertedCount_";
  protected final String TEXT_991 = " + pstmtInsert_";
  protected final String TEXT_992 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_993 = "++;";
  protected final String TEXT_994 = NL + "\t\t\t\t\t";
  protected final String TEXT_995 = NL + "    \t                conn_";
  protected final String TEXT_996 = ".releaseSavepoint(sp_";
  protected final String TEXT_997 = ");" + NL + "    \t            ";
  protected final String TEXT_998 = NL + "    \t            }else{" + NL + "    \t\t\t\t\tnb_line_";
  protected final String TEXT_999 = "++;" + NL + "     \t\t\t\t\t";
  protected final String TEXT_1000 = NL + "    \t\t\t\t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_1001 = NL + "    \t                conn_";
  protected final String TEXT_1002 = ".rollback(sp_";
  ...
  protected final String TEXT_1007 = NL + "                        nb_line_";
  protected final String TEXT_1008 = "++;";
  protected final String TEXT_1009 = NL + "                            ";
  protected final String TEXT_1010 = " = new ";
  protected final String TEXT_1011 = "Struct();";
  protected final String TEXT_1012 = NL + "                                ";
  protected final String TEXT_1013 = ".";
  protected final String TEXT_1014 = " = ";
  protected final String TEXT_1015 = ".";
  protected final String TEXT_1016 = ";";
  protected final String TEXT_1017 = NL + "                            rejectedCount_";
  protected final String TEXT_1018 = " = rejectedCount_";
  protected final String TEXT_1019 = " + 1;";
  protected final String TEXT_1020 = NL + "                            ";
  protected final String TEXT_1021 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1022 = NL + "                            ";
  protected final String TEXT_1023 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1024 = ";";
  protected final String TEXT_1025 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_1026 = NL + "                }";
  protected final String TEXT_1027 = NL + "\t\t\t\t\t";
  protected final String TEXT_1028 = NL + "                    \t";
  protected final String TEXT_1029 = NL + "\t                        query_";
  ...
  protected final String TEXT_1039 = NL + "    \t\tpstmt_";
  protected final String TEXT_1040 = ".addBatch();" + NL + "\t\t\tnb_line_";
  ...
  protected final String TEXT_1044 = NL + "            try {" + NL + "\t\t\t\t";
  protected final String TEXT_1045 = NL + "\t                sp_";
  protected final String TEXT_1046 = " = conn_";
  protected final String TEXT_1047 = ".setSavepoint();" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_1054 = NL + "\t                conn_";
  protected final String TEXT_1055 = ".releaseSavepoint(sp_";
  protected final String TEXT_1056 = ");" + NL + "\t            ";
  protected final String TEXT_1057 = NL + "            } catch(java.lang.Exception e) {" + NL + "\t\t\t\t";
  protected final String TEXT_1058 = NL + "\t                conn_";
  protected final String TEXT_1059 = ".rollback(sp_";
  ...
  protected final String TEXT_1064 = NL + "                    nb_line_";
  ...
  protected final String TEXT_1078 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_1084 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_1095 = NL + "    \t\t\tif ((batchSize_";
  protected final String TEXT_1096 = " > 0) && (batchSize_";
  protected final String TEXT_1097 = " <= batchSizeCounter_";
  protected final String TEXT_1098 = ")) {" + NL + "                try {" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_1099 = " = 0;" + NL + "\t\t\t\t\t\t    ";
  protected final String TEXT_1100 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1101 = ": pstmt_";
  protected final String TEXT_1102 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  ...
  protected final String TEXT_1107 = NL + "\t\t\t\t    \t\tinsertedCount_";
  protected final String TEXT_1108 = " += countSum_";
  protected final String TEXT_1109 = ";" + NL + "\t\t\t\t    \t";
  protected final String TEXT_1110 = NL + "\t\t\t\t    \t\tupdatedCount_";
  protected final String TEXT_1111 = " += countSum_";
  protected final String TEXT_1112 = ";" + NL + "\t\t\t\t    \t";
  protected final String TEXT_1113 = NL + "\t\t\t\t    \t    deletedCount_";
  ...
  protected final String TEXT_1117 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_1118 = "){" + NL + "\t\t\t\t    \tjava.sql.SQLException ne_";
  protected final String TEXT_1119 = " = e_";
  protected final String TEXT_1120 = ".getNextException(),sqle_";
  protected final String TEXT_1121 = "=null;" + NL + "\t\t\t\t    \tString errormessage_";
  protected final String TEXT_1122 = ";" + NL + "\t\t\t\t\t\tif (ne_";
  protected final String TEXT_1123 = " != null) {" + NL + "\t\t\t\t\t\t\t// build new exception to provide the original cause" + NL + "\t\t\t\t\t\t\tsqle_";
  protected final String TEXT_1124 = " = new java.sql.SQLException(e_";
  protected final String TEXT_1125 = ".getMessage() + \"\\ncaused by: \" + ne_";
  protected final String TEXT_1126 = ".getMessage(), ne_";
  protected final String TEXT_1127 = ".getSQLState(), ne_";
  protected final String TEXT_1128 = ".getErrorCode(), ne_";
  protected final String TEXT_1129 = ");" + NL + "\t\t\t\t\t\t\terrormessage_";
  protected final String TEXT_1130 = " = sqle_";
  protected final String TEXT_1131 = ".getMessage();" + NL + "\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\terrormessage_";
  protected final String TEXT_1132 = " = e_";
  protected final String TEXT_1133 = ".getMessage();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t    \t";
  protected final String TEXT_1134 = NL + "\t\t\t\t    \t\tif (ne_";
  protected final String TEXT_1135 = " != null) {" + NL + "\t\t\t\t    \t\t\tthrow(sqle_";
  protected final String TEXT_1136 = ");" + NL + "\t\t\t\t    \t\t}else{" + NL + "\t\t\t\t            \tthrow(e_";
  protected final String TEXT_1137 = ");" + NL + "\t\t\t\t            }" + NL + "\t\t\t\t    \t";
  protected final String TEXT_1138 = NL + "\t\t\t\t    \tint countSum_";
  protected final String TEXT_1139 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1140 = ": e_";
  protected final String TEXT_1141 = ".getUpdateCounts()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1142 = " += (countEach_";
  protected final String TEXT_1143 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_1154 = NL + "\t\t\t\t    \tSystem.err.println(errormessage_";
  protected final String TEXT_1155 = ");" + NL + "\t\t\t\t    \t";
  protected final String TEXT_1156 = NL + "\t\t\t\t\t}" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_1157 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_1158 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_1159 = " <= commitCounter_";
  protected final String TEXT_1160 = ") {";
  protected final String TEXT_1161 = NL + "                if ((batchSize_";
  protected final String TEXT_1162 = " > 0) && (batchSizeCounter_";
  protected final String TEXT_1163 = " > 0)) {" + NL + "                try {" + NL + "                \t\tint countSum_";
  protected final String TEXT_1164 = " = 0;" + NL + "                \t\t    ";
  protected final String TEXT_1165 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1166 = ": pstmt_";
  protected final String TEXT_1167 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1168 = " += (countEach_";
  protected final String TEXT_1169 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1170 = ");" + NL + "\t\t\t\t\t\t}";
  protected final String TEXT_1171 = NL + "            \t    \t";
  protected final String TEXT_1172 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_1173 = " += countSum_";
  protected final String TEXT_1174 = ";" + NL + "            \t    \t";
  protected final String TEXT_1175 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_1176 = " += countSum_";
  protected final String TEXT_1177 = ";" + NL + "            \t    \t";
  protected final String TEXT_1178 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_1179 = " += countSum_";
  protected final String TEXT_1180 = ";" + NL + "            \t    \t";
  protected final String TEXT_1181 = NL + "                batchSizeCounter_";
  protected final String TEXT_1182 = " = 0;" + NL + "               }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_1183 = "){" + NL + "\t\t\t    \tjava.sql.SQLException ne_";
  protected final String TEXT_1184 = " = e_";
  protected final String TEXT_1185 = ".getNextException(),sqle_";
  protected final String TEXT_1186 = "=null;" + NL + "\t\t\t    \tString errormessage_";
  protected final String TEXT_1187 = ";" + NL + "\t\t\t\t\tif (ne_";
  protected final String TEXT_1188 = " != null) {" + NL + "\t\t\t\t\t\t// build new exception to provide the original cause" + NL + "\t\t\t\t\t\tsqle_";
  protected final String TEXT_1189 = " = new java.sql.SQLException(e_";
  protected final String TEXT_1190 = ".getMessage() + \"\\ncaused by: \" + ne_";
  protected final String TEXT_1191 = ".getMessage(), ne_";
  protected final String TEXT_1192 = ".getSQLState(), ne_";
  protected final String TEXT_1193 = ".getErrorCode(), ne_";
  protected final String TEXT_1194 = ");" + NL + "\t\t\t\t\t\terrormessage_";
  protected final String TEXT_1195 = " = sqle_";
  protected final String TEXT_1196 = ".getMessage();" + NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\terrormessage_";
  protected final String TEXT_1197 = " = e_";
  protected final String TEXT_1198 = ".getMessage();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t    \t";
  protected final String TEXT_1199 = NL + "\t\t\t    \t\tif (ne_";
  protected final String TEXT_1200 = " != null) {" + NL + "\t\t\t    \t\t\tthrow(sqle_";
  protected final String TEXT_1201 = ");" + NL + "\t\t\t    \t\t}else{" + NL + "\t\t\t            \tthrow(e_";
  ...
  protected final String TEXT_1205 = ": e_";
  protected final String TEXT_1206 = ".getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1207 = " += (countEach_";
  protected final String TEXT_1208 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1209 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_1210 = NL + "\t\t\t    \t\tinsertedCount_";
  protected final String TEXT_1211 = " += countSum_";
  protected final String TEXT_1212 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_1213 = NL + "\t\t\t    \t\tupdatedCount_";
  protected final String TEXT_1214 = " += countSum_";
  protected final String TEXT_1215 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_1216 = NL + "\t\t\t    \t    deletedCount_";
  protected final String TEXT_1217 = " += countSum_";
  protected final String TEXT_1218 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_1219 = NL + "\t\t\t    \tSystem.err.println(errormessage_";
  protected final String TEXT_1220 = ");" + NL + "\t\t\t    \t";
  protected final String TEXT_1221 = NL + "\t\t\t\t}" + NL + "            }";
  protected final String TEXT_1222 = NL + "                \tconn_";
  protected final String TEXT_1223 = ".commit();" + NL + "                \t";
  protected final String TEXT_1224 = NL + "                \tcommitCounter_";
  protected final String TEXT_1225 = "=0;" + NL + "                }";
