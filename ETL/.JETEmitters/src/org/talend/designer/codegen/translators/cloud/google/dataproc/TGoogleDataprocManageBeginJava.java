...
public class TGoogleDataprocManageBeginJava
{
  ...
  protected final String TEXT_4 = "_initializationActions = new java.util.ArrayList<>();" + NL + "\t\tjava.util.List<String> ";
  protected final String TEXT_5 = "_tags = new java.util.ArrayList<>();";
  protected final String TEXT_6 = NL + "\t\t\t";
  protected final String TEXT_7 = "_initializationActions.add(new org.talend.bigdata.manage.google.dataproc.DataprocCreateCluster.InitializationActionHolder(";
  protected final String TEXT_8 = ", ";
  protected final String TEXT_9 = "));";
  protected final String TEXT_10 = NL + "\t\t\t";
  protected final String TEXT_11 = "_tags.add(";
  protected final String TEXT_12 = ");";
  protected final String TEXT_13 = NL + "\t\torg.talend.bigdata.manage.google.dataproc.DataprocCreateCluster.newBuilder() //" + NL + "         .withProjectId(";
  protected final String TEXT_14 = ") //" + NL + "\t\t\t.withClusterName(";
  protected final String TEXT_15 = ") //" + NL + "         .withRegion(\"global\") //" + NL + "         .withZone(";
  protected final String TEXT_16 = ") //" + NL + "         .withVersion(";
  protected final String TEXT_17 = ") //" + NL + "         .withMasterNumInstances(";
  protected final String TEXT_18 = ") //" + NL + "         .withMasterBootDiskSizeGb(";
  protected final String TEXT_19 = ") //" + NL + "         .withMasterNumLocalSsds(";
  protected final String TEXT_20 = ") //" + NL + "         .withMasterInstanceType(";
  protected final String TEXT_21 = ") //" + NL + "         .withWorkerNumInstances(";
  protected final String TEXT_22 = ") //" + NL + "         .withWorkerBootDiskSizeGb(";
  protected final String TEXT_23 = ") //" + NL + "         .withWorkerInstanceType(";
  protected final String TEXT_24 = ") //" + NL + "         .withSecondaryWorkerNumInstances(";
  protected final String TEXT_25 = ") //" + NL + "         .withTalendJobName(projectName + \"_\" + jobName + \"_\" + jobVersion.replace(\".\",\"_\") + \"_\" + pid) //" + NL + "         .withWaitForClusterReady(";
  protected final String TEXT_26 = ") //";
  protected final String TEXT_27 = NL + "         \t.withNetworkName(";
  protected final String TEXT_28 = ") //";
  protected final String TEXT_29 = NL + "         \t.withSubnetworkName(";
  protected final String TEXT_30 = ") //";
  protected final String TEXT_31 = NL + "\t\t\t\t.withServiceAccountCredentialsPath(";
  protected final String TEXT_32 = ") //";
  protected final String TEXT_33 = NL + "         .withInitializationActions(";
  protected final String TEXT_34 = "_initializationActions) //" + NL + "         .withTags(";
  protected final String TEXT_35 = "_tags) //" + NL + "         .build() //" + NL + "         .run();";
  protected final String TEXT_36 = NL + "\t\torg.talend.bigdata.manage.google.dataproc.DataprocDeleteCluster.newBuilder() //" + NL + "         .withProjectId(";
  protected final String TEXT_37 = ") //" + NL + "\t\t\t.withClusterName(";
  protected final String TEXT_38 = ") //" + NL + "\t\t\t.withRegion(\"global\") //" + NL + "         .withTalendJobName(projectName + \"_\" + jobName + \"_\" + jobVersion.replace(\".\",\"_\") + \"_\" + pid) //";
  protected final String TEXT_39 = NL + "\t\t\t\t.withServiceAccountCredentialsPath(";
  protected final String TEXT_40 = ") //";
  protected final String TEXT_41 = NL + "\t\t\t.build() //" + NL + "\t\t\t.run();";
  ...
  public String generate(Object argument)
  {
    ...
    stringBuffer.append(tag.get("TAG"));
